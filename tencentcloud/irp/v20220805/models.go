...
type DescribeGoodsRecommendRequestParams struct {
	...
	UserIdList []*StrUserIdInfo `json:"UserIdList,omitnil" name:"UserIdList"`

	// 推荐返回数量，默认10个，最多支持50个的内容返回。如果有更多数量要求，<a href="https://console.cloud.tencent.com/workorder/category" target="_blank">提单</a>沟通解决
	GoodsCnt *int64 `json:"GoodsCnt,omitnil" name:"GoodsCnt"`

	// 当场景是相关推荐时该值必填，场景是非相关推荐时该值无效
	CurrentGoodsId *string `json:"CurrentGoodsId,omitnil" name:"CurrentGoodsId"`

	// 用户的实时特征信息，用作特征
	UserPortraitInfo *UserPortraitInfo `json:"UserPortraitInfo,omitnil" name:"UserPortraitInfo"`

	// 本次请求针对该用户需要过滤的物品列表(不超过100个)
	BlackGoodsList []*string `json:"BlackGoodsList,omitnil" name:"BlackGoodsList"`
...
type DescribeGoodsRecommendResponseParams struct {
	// 推荐返回的商品信息列表
	DataList []*RecGoodsData `json:"DataList,omitnil" name:"DataList"`
...
type DocItem struct {
	...
	PublishTimestamp *int64 `json:"PublishTimestamp,omitnil" name:"PublishTimestamp"`

	// 内容过期时间，秒级时间戳（1639624786），如未填，则默认PublishTimestamp往后延一年，用作特征，过期则不会被推荐，<b>强烈建议</b>
	ExpireTimestamp *int64 `json:"ExpireTimestamp,omitnil" name:"ExpireTimestamp"`

	// 类目层级数，例如3级类目，则填3，和CategoryPath字段的类数据匹配，<b>强烈建议</b>
	CategoryLevel *int64 `json:"CategoryLevel,omitnil" name:"CategoryLevel"`

	// 类目路径，一级二级三级等依次用英文冒号联接，和CategoryLevel字段值匹配，如体育：“足球:巴塞罗那”。<b>用于物料池管理，强烈建议</b>
	CategoryPath *string `json:"CategoryPath,omitnil" name:"CategoryPath"`
	...
	ContentUrl *string `json:"ContentUrl,omitnil" name:"ContentUrl"`
	...
	// 作者粉丝数，<b>用作特征</b>
	AuthorFans *int64 `json:"AuthorFans,omitnil" name:"AuthorFans"`

	// 作者评级，<b>用作特征</b>
	AuthorLevel *string `json:"AuthorLevel,omitnil" name:"AuthorLevel"`

	// 内容累计收藏次数，<b>用作特征</b>
	CollectCnt *int64 `json:"CollectCnt,omitnil" name:"CollectCnt"`

	// 内容累积点赞次数，<b>用作特征</b>
	PraiseCnt *int64 `json:"PraiseCnt,omitnil" name:"PraiseCnt"`

	// 内容累计评论次数，<b>用作特征</b>
	CommentCnt *int64 `json:"CommentCnt,omitnil" name:"CommentCnt"`

	// 内容累计分享次数，<b>用作特征</b>
	ShareCnt *int64 `json:"ShareCnt,omitnil" name:"ShareCnt"`

	// 内容累积打赏数，<b>用作特征</b>
	RewardCnt *int64 `json:"RewardCnt,omitnil" name:"RewardCnt"`
...
type FeedBehaviorInfo struct {
	...
	BehaviorType *string `json:"BehaviorType,omitnil" name:"BehaviorType"`
	...
	BehaviorValue *string `json:"BehaviorValue,omitnil" name:"BehaviorValue"`

	// 行为发生的时间戳： 秒级时间戳，尽量实时上报，最长不超过半小时否则会影响推荐结果的准确性
	BehaviorTimestamp *int64 `json:"BehaviorTimestamp,omitnil" name:"BehaviorTimestamp"`
	...
	ItemTraceId *string `json:"ItemTraceId,omitnil" name:"ItemTraceId"`

	// 内容类型，跟内容上报类型一致，用于效果分析，不做内容校验，<b>强烈建议</b>
	ItemType *string `json:"ItemType,omitnil" name:"ItemType"`

	// 相关推荐场景点击进入详情页的内容id，该字段用来注明行为发生于哪个内容的详情页推荐中，<b>相关推荐场景强烈建议</b>
	ReferrerItemId *string `json:"ReferrerItemId,omitnil" name:"ReferrerItemId"`

	// 用户设备ID数组，可传入用户的多个类型ID，详见UserIdInfo结构体，建议补齐，<b>用于构建用户画像信息</b>
	UserIdList []*UserIdInfo `json:"UserIdList,omitnil" name:"UserIdList"`
	...
	Network *string `json:"Network,omitnil" name:"Network"`
...
type FeedRecommendRequestParams struct {
	...
	// 当场景是相关推荐时该值必填，场景是非相关推荐时该值无效
	CurrentItemId *string `json:"CurrentItemId,omitnil" name:"CurrentItemId"`
}
...
type FeedRecommendResponseParams struct {
	// 推荐返回的内容信息列表
	DataList []*RecItemData `json:"DataList,omitnil" name:"DataList"`
...
type FeedUserInfo struct {
	...
	DislikeInfoList []*DislikeInfo `json:"DislikeInfoList,omitnil" name:"DislikeInfoList"`
	...
	Degree *string `json:"Degree,omitnil" name:"Degree"`

	// 用户毕业学校全称
	School *string `json:"School,omitnil" name:"School"`

	// 用户职业
	Occupation *string `json:"Occupation,omitnil" name:"Occupation"`
	...
	ResidentCountry *string `json:"ResidentCountry,omitnil" name:"ResidentCountry"`

	// 用户常驻省份，ISO 3166-2行政区编码，如中国参考<a href="https://zh.wikipedia.org/wiki/ISO_3166-2:CN" target="_blank">ISO_3166-2:CN</a>，广东省：“CN-GD”
	ResidentProvince *string `json:"ResidentProvince,omitnil" name:"ResidentProvince"`

	// 用户常驻城市，统一用国家最新标准地区行政编码，如：<a href="https://www.mca.gov.cn/article/sj/xzqh/2020/" target="_blank">2020年行政区编码</a>，
	ResidentCity *string `json:"ResidentCity,omitnil" name:"ResidentCity"`

	// 用户注册时间，秒级时间戳（1639624786）
	RegisterTimestamp *int64 `json:"RegisterTimestamp,omitnil" name:"RegisterTimestamp"`

	// 用户会员等级
	MembershipLevel *string `json:"MembershipLevel,omitnil" name:"MembershipLevel"`

	// 用户上一次登录时间，秒级时间戳（1639624786）
	LastLoginTimestamp *int64 `json:"LastLoginTimestamp,omitnil" name:"LastLoginTimestamp"`
...
type GoodsBehaviorInfo struct {
	...
	GoodsId *string `json:"GoodsId,omitnil" name:"GoodsId"`
	...
	GoodsTraceId *string `json:"GoodsTraceId,omitnil" name:"GoodsTraceId"`

	// 相关推荐场景点击进入详情页的内容id，该字段用来注明行为发生于哪个内容的详情页推荐中，<b>相关推荐场景强烈建议</b>
	ReferrerGoodsId *string `json:"ReferrerGoodsId,omitnil" name:"ReferrerGoodsId"`

	// 订单商品购买个数，当behaviorType=order，buy或addcart时有值，<b>用作特征</b>
	OrderGoodsCnt *int64 `json:"OrderGoodsCnt,omitnil" name:"OrderGoodsCnt"`

	// 订单总金额，当behaviorType=order或buy时有值（单位：元，统一货币体系，如统一为RMB，美元等），<b>用作特征</b>
	OrderAmount *float64 `json:"OrderAmount,omitnil" name:"OrderAmount"`
...
type GoodsInfo struct {
	...
	SpuId *string `json:"SpuId,omitnil" name:"SpuId"`
	...
	ShopId *string `json:"ShopId,omitnil" name:"ShopId"`

	// 商品原始价格（单位：元，统一货币体系，如统一为RMB或美元等），<b>用作特征，强烈建议</b>
	OrgPrice *float64 `json:"OrgPrice,omitnil" name:"OrgPrice"`

	// 商品当前价格（单位：元，统一货币体系，如统一为RMB或美元等），<b>用作特征，强烈建议</b>
	CurPrice *float64 `json:"CurPrice,omitnil" name:"CurPrice"`
	...
	PicUrlList []*string `json:"PicUrlList,omitnil" name:"PicUrlList"`
	...
	FreeShipping *int64 `json:"FreeShipping,omitnil" name:"FreeShipping"`

	// 商品邮费（单位：元，统一货币体系，如统一为RMB或美元等），<b>用作特征</b>
	ShippingPrice *float64 `json:"ShippingPrice,omitnil" name:"ShippingPrice"`
	...
	// 商品累积成交次数，<b>用作特征</b>
	OrderCnt *int64 `json:"OrderCnt,omitnil" name:"OrderCnt"`
...
type ReportFeedBehaviorRequestParams struct {
	...
	// 上报的行为数据数组，数量不超过50
	FeedBehaviorList []*FeedBehaviorInfo `json:"FeedBehaviorList,omitnil" name:"FeedBehaviorList"`
}
...
type ReportFeedItemRequestParams struct {
	...
	FeedItemList []*DocItem `json:"FeedItemList,omitnil" name:"FeedItemList"`
}
...
type ReportFeedUserRequestParams struct {
	...
	// 上报的用户信息数组，数量不超过50
	FeedUserList []*FeedUserInfo `json:"FeedUserList,omitnil" name:"FeedUserList"`
}
...
type ReportGoodsBehaviorRequestParams struct {
	...
	GoodsBehaviorList []*GoodsBehaviorInfo `json:"GoodsBehaviorList,omitnil" name:"GoodsBehaviorList"`
}
...
type ReportGoodsInfoRequestParams struct {
	...
	// 上报的商品数组，一次数量不超过50
	GoodsList []*GoodsInfo `json:"GoodsList,omitnil" name:"GoodsList"`
}
