...
type DescribeGoodsRecommendRequestParams struct {
	...
	UserIdList []*StrUserIdInfo `json:"UserIdList,omitnil,omitempty" name:"UserIdList"`

	// 推荐返回数量，默认10个，最多支持50个的内容返回。如果有更多数量要求，<a href="https://console.cloud.tencent.com/workorder/category" target="_blank">提单</a>沟通解决
	GoodsCnt *int64 `json:"GoodsCnt,omitnil,omitempty" name:"GoodsCnt"`

	// 当场景是相关推荐时该值必填，场景是非相关推荐时该值无效
	CurrentGoodsId *string `json:"CurrentGoodsId,omitnil,omitempty" name:"CurrentGoodsId"`

	// 用户的实时特征信息，用作特征
	UserPortraitInfo *UserPortraitInfo `json:"UserPortraitInfo,omitnil,omitempty" name:"UserPortraitInfo"`

	// 本次请求针对该用户需要过滤的物品列表(不超过100个)
	BlackGoodsList []*string `json:"BlackGoodsList,omitnil,omitempty" name:"BlackGoodsList"`
...
type DescribeGoodsRecommendResponseParams struct {
	// 推荐返回的商品信息列表
	DataList []*RecGoodsData `json:"DataList,omitnil,omitempty" name:"DataList"`
...
type DocItem struct {
	...
	ContentUrl *string `json:"ContentUrl,omitnil,omitempty" name:"ContentUrl"`
...
type FeedBehaviorInfo struct {
	...
	BehaviorType *string `json:"BehaviorType,omitnil,omitempty" name:"BehaviorType"`
	...
	ItemTraceId *string `json:"ItemTraceId,omitnil,omitempty" name:"ItemTraceId"`
...
type GoodsBehaviorInfo struct {
	...
	GoodsId *string `json:"GoodsId,omitnil,omitempty" name:"GoodsId"`
	...
	GoodsTraceId *string `json:"GoodsTraceId,omitnil,omitempty" name:"GoodsTraceId"`

	// 相关推荐场景点击进入详情页的内容id，该字段用来注明行为发生于哪个内容的详情页推荐中，<b>相关推荐场景强烈建议</b>
	ReferrerGoodsId *string `json:"ReferrerGoodsId,omitnil,omitempty" name:"ReferrerGoodsId"`

	// 订单商品购买个数，当behaviorType=order，buy或addcart时有值，<b>用作特征</b>
	OrderGoodsCnt *int64 `json:"OrderGoodsCnt,omitnil,omitempty" name:"OrderGoodsCnt"`

	// 订单总金额，当behaviorType=order或buy时有值（单位：元，统一货币体系，如统一为RMB，美元等），<b>用作特征</b>
	OrderAmount *float64 `json:"OrderAmount,omitnil,omitempty" name:"OrderAmount"`
...
type GoodsInfo struct {
	...
	SpuId *string `json:"SpuId,omitnil,omitempty" name:"SpuId"`
	...
	ShopId *string `json:"ShopId,omitnil,omitempty" name:"ShopId"`

	// 商品原始价格（单位：元，统一货币体系，如统一为RMB或美元等），<b>用作特征，强烈建议</b>
	OrgPrice *float64 `json:"OrgPrice,omitnil,omitempty" name:"OrgPrice"`

	// 商品当前价格（单位：元，统一货币体系，如统一为RMB或美元等），<b>用作特征，强烈建议</b>
	CurPrice *float64 `json:"CurPrice,omitnil,omitempty" name:"CurPrice"`
	...
	FreeShipping *int64 `json:"FreeShipping,omitnil,omitempty" name:"FreeShipping"`

	// 商品邮费（单位：元，统一货币体系，如统一为RMB或美元等），<b>用作特征</b>
	ShippingPrice *float64 `json:"ShippingPrice,omitnil,omitempty" name:"ShippingPrice"`
	...
	// 商品累积成交次数，<b>用作特征</b>
	OrderCnt *int64 `json:"OrderCnt,omitnil,omitempty" name:"OrderCnt"`
...
type ReportFeedBehaviorRequestParams struct {
	...
	// 上报的行为数据数组，数量不超过50
	FeedBehaviorList []*FeedBehaviorInfo `json:"FeedBehaviorList,omitnil,omitempty" name:"FeedBehaviorList"`
}
...
type ReportFeedItemRequestParams struct {
	...
	FeedItemList []*DocItem `json:"FeedItemList,omitnil,omitempty" name:"FeedItemList"`
}
...
type ReportFeedUserRequestParams struct {
	...
	// 上报的用户信息数组，数量不超过50
	FeedUserList []*FeedUserInfo `json:"FeedUserList,omitnil,omitempty" name:"FeedUserList"`
}
...
type ReportGoodsBehaviorRequestParams struct {
	...
	GoodsBehaviorList []*GoodsBehaviorInfo `json:"GoodsBehaviorList,omitnil,omitempty" name:"GoodsBehaviorList"`
}
...
type ReportGoodsInfoRequestParams struct {
	...
	// 上报的商品数组，一次数量不超过50
	GoodsList []*GoodsInfo `json:"GoodsList,omitnil,omitempty" name:"GoodsList"`
}
