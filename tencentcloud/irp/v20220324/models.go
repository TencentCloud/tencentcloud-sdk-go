...
type AuthorInfo struct {
	...
	// 关注类型：1-关注，2-取关
	// 注意：此字段可能返回 null，表示取不到有效值。
	FollowType *int64 `json:"FollowType,omitnil" name:"FollowType"`
...
type DocBehavior struct {
	...
	// 行为类型
	BehaviorType *int64 `json:"BehaviorType,omitnil" name:"BehaviorType"`
	...
	RecTraceId *string `json:"RecTraceId,omitnil" name:"RecTraceId"`
	...
	// 物料类型
	ItemType *int64 `json:"ItemType,omitnil" name:"ItemType"`

	// 微信开放平台上查看appId
	AppId *string `json:"AppId,omitnil" name:"AppId"`

	// 回传video_over事件的时候，回传的用户播放视频的总时长（真正播放的，拖动不算，单位为秒）
	VideoPlayDuration *int64 `json:"VideoPlayDuration,omitnil" name:"VideoPlayDuration"`
...
type DocItem struct {
	...
	// 内容类型
	ItemType *uint64 `json:"ItemType,omitnil" name:"ItemType"`
	...
	// 视频url
	VideoUrlList []*string `json:"VideoUrlList,omitnil" name:"VideoUrlList"`
	...
	PoolIdList []*string `json:"PoolIdList,omitnil" name:"PoolIdList"`
...
type PortraitInfo struct {
	...
	// 用户常驻区县
	ResidentDistrict *string `json:"ResidentDistrict,omitnil" name:"ResidentDistrict"`

	// 用户手机的MD5值
	PhoneMd5 *string `json:"PhoneMd5,omitnil" name:"PhoneMd5"`

	// 用户手机的IMEI号
	PhoneImei *string `json:"PhoneImei,omitnil" name:"PhoneImei"`
	...
	// 用户关注作者列表
	AuthorInfoList []*AuthorInfo `json:"AuthorInfoList,omitnil" name:"AuthorInfoList"`
	...
	// 设备AndroidId信息
	AndroidId *string `json:"AndroidId,omitnil" name:"AndroidId"`
}
...
type RecommendContentRequestParams struct {
	...
	ResponseTimeout *int64 `json:"ResponseTimeout,omitnil" name:"ResponseTimeout"`
	...
	ItemTypeRatio *string `json:"ItemTypeRatio,omitnil" name:"ItemTypeRatio"`
}
...
type ReportActionRequestParams struct {
	...
	// 上报的行为对象数组，数量不超过50
	DocBehaviorList []*DocBehavior `json:"DocBehaviorList,omitnil" name:"DocBehaviorList"`
}
...
type ReportMaterialRequestParams struct {
	...
	// 上报的信息流数组，一次数量不超过50
	DocItemList []*DocItem `json:"DocItemList,omitnil" name:"DocItemList"`
}
...
type ReportPortraitRequestParams struct {
	...
	// 上报的用户画像数组，数量不超过50
	PortraitList []*PortraitInfo `json:"PortraitList,omitnil" name:"PortraitList"`
}
...
type UserIdInfo struct {
	...
	// 1000 - 客户自定义id
	UserIdType *int64 `json:"UserIdType,omitnil" name:"UserIdType"`
