...
type DescribeConnectionConfigResponseParams struct {
	// 单分片入流量带宽限制，单位：MB。
	InNetLimit *int64 `json:"InNetLimit,omitnil,omitempty" name:"InNetLimit"`

	// 单分片出流量带宽限制，单位：MB。
	OutNetLimit *int64 `json:"OutNetLimit,omitnil,omitempty" name:"OutNetLimit"`
...
type DescribeInstanceBackupsResponseParams struct {
	...
	// 实例备份信息列表。
	BackupRecord []*BackupInfo `json:"BackupRecord,omitnil,omitempty" name:"BackupRecord"`
...
type ReplicaGroup struct {
	...
	// 节点组节点列表。
	KeeWiDBNodes []*KeeWiDBNode `json:"KeeWiDBNodes,omitnil,omitempty" name:"KeeWiDBNodes"`
}
