...
type CreateInstancesRequestParams struct {
	...
	ReplicasNum *int64 `json:"ReplicasNum,omitnil" name:"ReplicasNum"`
	...
	MachineMemory *int64 `json:"MachineMemory,omitnil" name:"MachineMemory"`
	...
	MachineCpu *int64 `json:"MachineCpu,omitnil" name:"MachineCpu"`

	// 项目id，取值以用户账户>用户账户相关接口查询>项目列表返回的projectId为准。
	ProjectId *int64 `json:"ProjectId,omitnil" name:"ProjectId"`

	// 数据压缩开关。<ul><li>ON：开启，默认开启压缩。</li><li>OFF：关闭。</li>
	Compression *string `json:"Compression,omitnil" name:"Compression"`
}
...
type DescribeConnectionConfigResponseParams struct {
	// 单分片入流量带宽限制，单位：MB。
	InNetLimit *int64 `json:"InNetLimit,omitnil" name:"InNetLimit"`
...
type DescribeInstanceBackupsResponseParams struct {
	...
	// 废弃字段。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BackupSet []*BinlogInfo `json:"BackupSet,omitnil" name:"BackupSet"`

	// 实例备份信息列表。
	BackupRecord []*BackupInfo `json:"BackupRecord,omitnil" name:"BackupRecord"`
...
type DescribeInstanceNodeInfoResponseParams struct {
	...
	// Proxy 节点信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Proxy []*ProxyNodeInfo `json:"Proxy,omitnil" name:"Proxy"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	Redis []*RedisNodeInfo `json:"Redis,omitnil" name:"Redis"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	Tendis []*InstanceNodeInfo `json:"Tendis,omitnil" name:"Tendis"`

	// KeewiDB 节点数量。
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeeWiDBCount *int64 `json:"KeeWiDBCount,omitnil" name:"KeeWiDBCount"`

	// KeewiDB 节点信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeeWiDB []*InstanceNodeInfo `json:"KeeWiDB,omitnil" name:"KeeWiDB"`
...
type InstanceInfo struct {
	...
	// 实例的节点详细信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	NodeSet []*NodeInfo `json:"NodeSet,omitnil" name:"NodeSet"`
	...
	// 单分片磁盘大小，单位：MB
	DiskShardSize *int64 `json:"DiskShardSize,omitnil" name:"DiskShardSize"`

	// 3
	DiskShardNum *int64 `json:"DiskShardNum,omitnil" name:"DiskShardNum"`

	// 1
	DiskReplicasNum *int64 `json:"DiskReplicasNum,omitnil" name:"DiskReplicasNum"`
}
...
type ReplicaGroup struct {
	...
	// 节点组节点列表。
	KeeWiDBNodes []*KeeWiDBNode `json:"KeeWiDBNodes,omitnil" name:"KeeWiDBNodes"`
}
