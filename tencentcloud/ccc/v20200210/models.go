...
type CreateAICallRequestParams struct {
	...
	TransferToAgentEnable *bool `json:"TransferToAgentEnable,omitnil,omitempty" name:"TransferToAgentEnable"`

	// <p>TransferToAgentEnable为true的时候生效: 转智能体配置</p>
	TransferToAgentItems []*TransferToAgentItem `json:"TransferToAgentItems,omitnil,omitempty" name:"TransferToAgentItems"`
	...
	CustomSTTConfig *string `json:"CustomSTTConfig,omitnil,omitempty" name:"CustomSTTConfig"`
}
...
func (r *CreateAICallRequest) FromJsonString(s string) error {
	...
	delete(f, "TransferToAgentEnable")
	delete(f, "TransferToAgentItems")
...
type TelCdrInfo struct {
	...
	//
	// Deprecated: IVRKeyPressed is deprecated.
	...
	//
	// Deprecated: PostIVRKeyPressed is deprecated.
	PostIVRKeyPressed []*IVRKeyPressedElement `json:"PostIVRKeyPressed,omitnil,omitempty" name:"PostIVRKeyPressed"`

	// <p>满意度按键信息 Key 为 noInput 表示进入满意度但无按键</p>
	PostIVRKeyPressedEx []*IVRKeyPressedElement `json:"PostIVRKeyPressedEx,omitnil,omitempty" name:"PostIVRKeyPressedEx"`
...
type TransferToAgentItem struct {
	// <p>转智能体的function calling 名称</p>
	TransferToAgentName *string `json:"TransferToAgentName,omitnil,omitempty" name:"TransferToAgentName"`

	// <p>转智能体描述</p>
	TransferToAgentDesc *string `json:"TransferToAgentDesc,omitnil,omitempty" name:"TransferToAgentDesc"`

	// <p>目标智能体ID</p>
	TransferToAgentId *uint64 `json:"TransferToAgentId,omitnil,omitempty" name:"TransferToAgentId"`
}
