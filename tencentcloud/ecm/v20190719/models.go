...
type AssignIpv6AddressesRequestParams struct {
	...
	// CUCC：中国联通
	// CMCC：中国移动
	ISPType *string `json:"ISPType,omitnil" name:"ISPType"`

	// 是否跳过校验一个网卡只能分配一个IPv6 CIDR。该字段通常为true（用于兼容存量子机只有一个地址的情形）。
	SkipCheckIPv6Address *bool `json:"SkipCheckIPv6Address,omitnil" name:"SkipCheckIPv6Address"`
...
type AssignIpv6CidrBlocksRequestParams struct {
	...
	ISPTypes []*ISPTypeItem `json:"ISPTypes,omitnil" name:"ISPTypes"`
...
type AssignIpv6CidrBlocksResponseParams struct {
	// IPv6网段和所属运营商。	
	IPv6CidrBlockSet []*ISPIPv6CidrBlock `json:"IPv6CidrBlockSet,omitnil" name:"IPv6CidrBlockSet"`
...
type ImportCustomImageRequestParams struct {
	...
	InitFlag *string `json:"InitFlag,omitnil" name:"InitFlag"`

	// 镜像文件描述，多层镜像按顺序传入
	ImageUrls []*ImageUrl `json:"ImageUrls,omitnil" name:"ImageUrls"`
}
...
type ModifyIpv6AddressesBandwidthRequestParams struct {
	...
	Ipv6AddressIds []*string `json:"Ipv6AddressIds,omitnil" name:"Ipv6AddressIds"`
}
...
type Module struct {
	...
	// 是否禁止外网ip
	DisableWanIp *int64 `json:"DisableWanIp,omitnil" name:"DisableWanIp"`
}
...
type Node struct {
	...
	// 节点是否支持LB
	LBSupported *bool `json:"LBSupported,omitnil" name:"LBSupported"`
}
