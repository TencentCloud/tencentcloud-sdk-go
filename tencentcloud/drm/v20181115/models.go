...
type AddFairPlayPemResponseParams struct {
	...
	FairPlayPemId *uint64 `json:"FairPlayPemId,omitnil" name:"FairPlayPemId"`
...
type CreateEncryptKeysRequestParams struct {
	...
	// 设置的加密密钥列表。
	Keys []*KeyParam `json:"Keys,omitnil" name:"Keys"`
...
type CreateLicenseRequestParams struct {
	...
	LicenseRequest *string `json:"LicenseRequest,omitnil" name:"LicenseRequest"`
	...
	// 播放策略参数。
	PlaybackPolicy *PlaybackPolicy `json:"PlaybackPolicy,omitnil" name:"PlaybackPolicy"`
}
...
type DescribeAllKeysRequestParams struct {
	...
	RsaPublicKey *string `json:"RsaPublicKey,omitnil" name:"RsaPublicKey"`
...
type DescribeFairPlayPemResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	FairPlayPems []*FairPlayPemDigestInfo `json:"FairPlayPems,omitnil" name:"FairPlayPems"`
...
type DescribeKeysResponseParams struct {
	...
	// Fairplay方案无该值。
	Pssh *string `json:"Pssh,omitnil" name:"Pssh"`
...
type DrmOutputObject struct {
	...
	// 输出对象参数。
	Para *DrmOutputPara `json:"Para,omitnil" name:"Para"`
}
...
type FairPlayPemDigestInfo struct {
	...
	// 私钥的md5 信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Md5Pem *string `json:"Md5Pem,omitnil" name:"Md5Pem"`

	// ASK的md5信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Md5Ask *string `json:"Md5Ask,omitnil" name:"Md5Ask"`
...
type Key struct {
	...
	// 该key生成时的时间戳
	// 注意：此字段可能返回 null，表示取不到有效值。
	InsertTimestamp *uint64 `json:"InsertTimestamp,omitnil" name:"InsertTimestamp"`
}
...
type PlaybackPolicy struct {
	// 播放许可证的有效期
	LicenseDurationSeconds *uint64 `json:"LicenseDurationSeconds,omitnil" name:"LicenseDurationSeconds"`

	// 开始播放后，允许最长播放时间
	PlaybackDurationSeconds *uint64 `json:"PlaybackDurationSeconds,omitnil" name:"PlaybackDurationSeconds"`
}

// Predefined struct for user
type StartEncryptionRequestParams struct {
	// cos的end point。
	CosEndPoint *string `json:"CosEndPoint,omitnil" name:"CosEndPoint"`
	...
	// 存储在COS上的原始内容信息
	SourceObject *DrmSourceObject `json:"SourceObject,omitnil" name:"SourceObject"`

	// 加密后的内容存储到COS的对象
	OutputObjects []*DrmOutputObject `json:"OutputObjects,omitnil" name:"OutputObjects"`
}
