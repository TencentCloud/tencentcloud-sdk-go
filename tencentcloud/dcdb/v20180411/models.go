...
type DescribeShardSpecResponseParams struct {
	// 按机型分类的可售卖规格列表
	SpecConfig []*SpecConfig `json:"SpecConfig,omitnil" name:"SpecConfig"`
...
type DescribeUserTasksRequestParams struct {
	...
	FlowTypes []*int64 `json:"FlowTypes,omitnil" name:"FlowTypes"`
	...
	// 任务ID的数组
	UTaskIds []*int64 `json:"UTaskIds,omitnil" name:"UTaskIds"`
...
type DescribeUserTasksResponseParams struct {
	...
	// 任务列表
	FlowSet []*UserTaskInfo `json:"FlowSet,omitnil" name:"FlowSet"`
...
type Project struct {
	...
	// 来源平台
	SrcPlat *string `json:"SrcPlat,omitnil" name:"SrcPlat"`

	// 来源AppId
	SrcAppId *int64 `json:"SrcAppId,omitnil" name:"SrcAppId"`
...
type RegionInfo struct {
	...
	// 可选择的主可用区和从可用区
	AvailableChoice []*ShardZoneChooseInfo `json:"AvailableChoice,omitnil" name:"AvailableChoice"`
}
...
type SpecConfig struct {
	...
	// 规格列表
	SpecConfigInfos []*SpecConfigInfo `json:"SpecConfigInfos,omitnil" name:"SpecConfigInfos"`
}
...
type UserTaskInfo struct {
	...
	UserTaskType *int64 `json:"UserTaskType,omitnil" name:"UserTaskType"`
	...
	// 客户端参数
	InputData *string `json:"InputData,omitnil" name:"InputData"`
