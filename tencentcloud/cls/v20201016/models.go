...
func (r *CreateAlarmRequest) FromJsonString(s string) error {
	...
	delete(f, "Status")
	if len(f) > 0 {
		return errors.New("CreateAlarmRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CreateExportRequest) FromJsonString(s string) error {
	...
	delete(f, "Format")
	if len(f) > 0 {
		return errors.New("CreateExportRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CreateIndexRequest) FromJsonString(s string) error {
	...
	delete(f, "Status")
	if len(f) > 0 {
		return errors.New("CreateIndexRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CreateMachineGroupRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("CreateMachineGroupRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteAlarmNoticeRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("DeleteAlarmNoticeRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteAlarmRequest) FromJsonString(s string) error {
	...
	delete(f, "AlarmId")
	if len(f) > 0 {
		return errors.New("DeleteAlarmRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteExportRequest) FromJsonString(s string) error {
	...
	delete(f, "ExportId")
	if len(f) > 0 {
		return errors.New("DeleteExportRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteIndexRequest) FromJsonString(s string) error {
	...
	delete(f, "TopicId")
	if len(f) > 0 {
		return errors.New("DeleteIndexRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteMachineGroupRequest) FromJsonString(s string) error {
	...
	delete(f, "GroupId")
	if len(f) > 0 {
		return errors.New("DeleteMachineGroupRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeExportsRequest) FromJsonString(s string) error {
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return errors.New("DescribeExportsRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeIndexRequest) FromJsonString(s string) error {
	...
	delete(f, "TopicId")
	if len(f) > 0 {
		return errors.New("DescribeIndexRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeLogContextRequest) FromJsonString(s string) error {
	...
	delete(f, "NextLogs")
	if len(f) > 0 {
		return errors.New("DescribeLogContextRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeMachineGroupsRequest) FromJsonString(s string) error {
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return errors.New("DescribeMachineGroupsRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribePartitionsRequest) FromJsonString(s string) error {
	...
	delete(f, "TopicId")
	if len(f) > 0 {
		return errors.New("DescribePartitionsRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *GetAlarmLogRequest) FromJsonString(s string) error {
	...
	delete(f, "Sort")
	if len(f) > 0 {
		return errors.New("GetAlarmLogRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *MergePartitionRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("MergePartitionRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyAlarmRequest) FromJsonString(s string) error {
	...
	delete(f, "Status")
	if len(f) > 0 {
		return errors.New("ModifyAlarmRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyIndexRequest) FromJsonString(s string) error {
	...
	delete(f, "Rule")
	if len(f) > 0 {
		return errors.New("ModifyIndexRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyMachineGroupRequest) FromJsonString(s string) error {
	...
	delete(f, "ServiceLogging")
	if len(f) > 0 {
		return errors.New("ModifyMachineGroupRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *SearchLogRequest) FromJsonString(s string) error {
	...
	delete(f, "Sort")
	if len(f) > 0 {
		return errors.New("SearchLogRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *SplitPartitionRequest) FromJsonString(s string) error {
	...
	delete(f, "Number")
	if len(f) > 0 {
		return errors.New("SplitPartitionRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
