...
func (r *CreateDomainAliasRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("CreateDomainAliasRequest has unknown keys!")
	}
...
func (r *CreateDomainGroupRequest) FromJsonString(s string) error {
	...
	delete(f, "GroupName")
	if len(f) > 0 {
		return errors.New("CreateDomainGroupRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CreateRecordBatchRequest) FromJsonString(s string) error {
	...
	delete(f, "RecordList")
	if len(f) > 0 {
		return errors.New("CreateRecordBatchRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CreateRecordRequest) FromJsonString(s string) error {
	...
	delete(f, "Status")
	if len(f) > 0 {
		return errors.New("CreateRecordRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteDomainAliasRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DeleteDomainAliasRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteRecordRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DeleteRecordRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DeleteShareDomainRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DeleteShareDomainRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeBatchTaskRequest) FromJsonString(s string) error {
	...
	delete(f, "JobId")
	if len(f) > 0 {
		return errors.New("DescribeBatchTaskRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeDomainListRequest) FromJsonString(s string) error {
	...
	delete(f, "Keyword")
	if len(f) > 0 {
		return errors.New("DescribeDomainListRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeDomainLogListRequest) FromJsonString(s string) error {
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return errors.New("DescribeDomainLogListRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeDomainPurviewRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DescribeDomainPurviewRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeDomainRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DescribeDomainRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeDomainShareInfoRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DescribeDomainShareInfoRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeRecordLineListRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DescribeRecordLineListRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeRecordListRequest) FromJsonString(s string) error {
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return errors.New("DescribeRecordListRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeRecordRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("DescribeRecordRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeRecordTypeRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainGrade")
	if len(f) > 0 {
		return errors.New("DescribeRecordTypeRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeUserDetailRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("DescribeUserDetailRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyDomainLockRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("ModifyDomainLockRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyDomainOwnerRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("ModifyDomainOwnerRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyDomainRemarkRequest) FromJsonString(s string) error {
	...
	delete(f, "Remark")
	if len(f) > 0 {
		return errors.New("ModifyDomainRemarkRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyDomainStatusRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("ModifyDomainStatusRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyDomainUnlockRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("ModifyDomainUnlockRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyDynamicDNSRequest) FromJsonString(s string) error {
	...
	delete(f, "RecordLineId")
	if len(f) > 0 {
		return errors.New("ModifyDynamicDNSRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyRecordBatchRequest) FromJsonString(s string) error {
	...
	delete(f, "MX")
	if len(f) > 0 {
		return errors.New("ModifyRecordBatchRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyRecordRemarkRequest) FromJsonString(s string) error {
	...
	delete(f, "Remark")
	if len(f) > 0 {
		return errors.New("ModifyRecordRemarkRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyRecordRequest) FromJsonString(s string) error {
	...
	delete(f, "Status")
	if len(f) > 0 {
		return errors.New("ModifyRecordRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyRecordStatusRequest) FromJsonString(s string) error {
	...
	delete(f, "DomainId")
	if len(f) > 0 {
		return errors.New("ModifyRecordStatusRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
