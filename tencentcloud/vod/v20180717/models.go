...
type AIAnalysisTemplateItem struct {
	...
	// 智能精彩集锦任务控制参数。
	HighlightConfigure *HighlightsConfigureInfo `json:"HighlightConfigure,omitnil" name:"HighlightConfigure"`
...
type AIRecognitionTemplateItem struct {
	...
	// 头尾识别控制参数。
	// 注意：此字段可能返回 null，表示取不到有效值。
	HeadTailConfigure *HeadTailConfigureInfo `json:"HeadTailConfigure,omitnil" name:"HeadTailConfigure"`

	// 拆条识别控制参数。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SegmentConfigure *SegmentConfigureInfo `json:"SegmentConfigure,omitnil" name:"SegmentConfigure"`
	...
	// 物体识别控制参数。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ObjectConfigure *ObjectConfigureInfo `json:"ObjectConfigure,omitnil" name:"ObjectConfigure"`

	// 截图时间间隔，单位：秒。
	ScreenshotInterval *float64 `json:"ScreenshotInterval,omitnil" name:"ScreenshotInterval"`
...
type AccelerateAreaInfo struct {
	...
	TencentDisableReason *string `json:"TencentDisableReason,omitnil" name:"TencentDisableReason"`

	// 加速域名对应的 CNAME 域名。
	TencentEdgeDomain *string `json:"TencentEdgeDomain,omitnil" name:"TencentEdgeDomain"`
}
...
type AdaptiveDynamicStreamingTemplate struct {
	...
	// <li>VOD：云点播。</li>
	// 默认值为 VOD 。
	DrmKeyProvider *string `json:"DrmKeyProvider,omitnil" name:"DrmKeyProvider"`
...
type AiAnalysisTaskClassificationOutput struct {
	...
	ClassificationSetFileUrl *string `json:"ClassificationSetFileUrl,omitnil" name:"ClassificationSetFileUrl"`

	// 视频智能分类列表文件 URL 失效时间，使用  [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
	ClassificationSetFileUrlExpireTime *string `json:"ClassificationSetFileUrlExpireTime,omitnil" name:"ClassificationSetFileUrlExpireTime"`
}
...
type AiAnalysisTaskCoverOutput struct {
	...
	CoverSetFileUrl *string `json:"CoverSetFileUrl,omitnil" name:"CoverSetFileUrl"`

	// 智能封面列表文件 URL 失效时间，使用  [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
	CoverSetFileUrlExpireTime *string `json:"CoverSetFileUrlExpireTime,omitnil" name:"CoverSetFileUrlExpireTime"`
}
...
type AiAnalysisTaskHighlightOutput struct {
	...
	HighlightSetFileUrl *string `json:"HighlightSetFileUrl,omitnil" name:"HighlightSetFileUrl"`

	// 视频智能精彩片段列表文件 URL 失效时间，使用  [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
	HighlightSetFileUrlExpireTime *string `json:"HighlightSetFileUrlExpireTime,omitnil" name:"HighlightSetFileUrlExpireTime"`
}
...
type AiAnalysisTaskTagOutput struct {
	...
	TagSetFileUrl *string `json:"TagSetFileUrl,omitnil" name:"TagSetFileUrl"`

	// 视频智能标签列表文件 URL 失效时间，使用  [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。
	TagSetFileUrlExpireTime *string `json:"TagSetFileUrlExpireTime,omitnil" name:"TagSetFileUrlExpireTime"`
}
...
type AiRecognitionResult struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	HeadTailTask *AiRecognitionTaskHeadTailResult `json:"HeadTailTask,omitnil" name:"HeadTailTask"`

	// 视频拆条识别结果，当 Type 为
	//  SegmentRecognition 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SegmentTask *AiRecognitionTaskSegmentResult `json:"SegmentTask,omitnil" name:"SegmentTask"`
...
type AiRecognitionTaskAsrFullTextResultOutput struct {
	...
	SubtitleSet []*AiRecognitionTaskAsrFullTextResultOutputSubtitleItem `json:"SubtitleSet,omitnil" name:"SubtitleSet"`

	// 生成的字幕文件 Url，对应 [语音全文识别任务控制参数](https://cloud.tencent.com/document/api/266/31773#AsrFullTextConfigureInfo) SubtitleFormat。
	SubtitleUrl *string `json:"SubtitleUrl,omitnil" name:"SubtitleUrl"`
}
...
type AiRecognitionTaskAsrWordsResultOutput struct {
	...
	ResultSetFileUrl *string `json:"ResultSetFileUrl,omitnil" name:"ResultSetFileUrl"`
...
type AiRecognitionTaskHeadTailResult struct {
	...
	// 视频片头片尾识别任务输入信息。
	Input *AiRecognitionTaskHeadTailResultInput `json:"Input,omitnil" name:"Input"`

	// 视频片头片尾识别任务输出信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *AiRecognitionTaskHeadTailResultOutput `json:"Output,omitnil" name:"Output"`
...
type AiRecognitionTaskHeadTailResultOutput struct {
	// 片头识别置信度。取值：0~100。
	HeadConfidence *float64 `json:"HeadConfidence,omitnil" name:"HeadConfidence"`

	// 视频片头的结束时间点，单位：秒。
	HeadTimeOffset *float64 `json:"HeadTimeOffset,omitnil" name:"HeadTimeOffset"`

	// 片尾识别置信度。取值：0~100。
	TailConfidence *float64 `json:"TailConfidence,omitnil" name:"TailConfidence"`

	// 视频片尾的开始时间点，单位：秒。
	TailTimeOffset *float64 `json:"TailTimeOffset,omitnil" name:"TailTimeOffset"`
}
...
type AiRecognitionTaskSegmentResult struct {
	...
	// 视频拆条任务输入信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Input *AiRecognitionTaskSegmentResultInput `json:"Input,omitnil" name:"Input"`

	// 视频拆条任务输出信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *AiRecognitionTaskSegmentResultOutput `json:"Output,omitnil" name:"Output"`
...
type AiRecognitionTaskSegmentResultOutput struct {
	// 视频拆条片段列表。
	// <font color=red>注意</font> ：该列表最多仅展示前 100 个元素。如希望获得完整结果，请从 SegmentSetFileUrl 对应的文件中获取。
	SegmentSet []*AiRecognitionTaskSegmentSegmentItem `json:"SegmentSet,omitnil" name:"SegmentSet"`
...
type AiRecognitionTaskSegmentSegmentItem struct {
	...
	// 特殊字段，请忽略。
	SpecialInfo *string `json:"SpecialInfo,omitnil" name:"SpecialInfo"`
}
...
type ApplyUploadRequestParams struct {
	...
	MediaType *string `json:"MediaType,omitnil" name:"MediaType"`
	...
	CoverType *string `json:"CoverType,omitnil" name:"CoverType"`
...
type ApplyUploadResponseParams struct {
	...
	VodSessionKey *string `json:"VodSessionKey,omitnil" name:"VodSessionKey"`

	// 媒体存储路径，用于上传接口存储媒体的对象键（Key）。
	MediaStoragePath *string `json:"MediaStoragePath,omitnil" name:"MediaStoragePath"`

	// 封面存储路径，用于上传接口存储封面的对象键（Key）。
	CoverStoragePath *string `json:"CoverStoragePath,omitnil" name:"CoverStoragePath"`

	// 临时凭证，用于上传接口的权限验证。
	TempCertificate *TempCertificate `json:"TempCertificate,omitnil" name:"TempCertificate"`
...
type AsrFullTextConfigureInfo struct {
	...
	SubtitleFormats []*string `json:"SubtitleFormats,omitnil" name:"SubtitleFormats"`
	...
	SrcLanguage *string `json:"SrcLanguage,omitnil" name:"SrcLanguage"`
}
...
type AsrFullTextConfigureInfoForUpdate struct {
	...
	// 字幕格式列表操作信息。
	SubtitleFormatsOperation *SubtitleFormatsOperation `json:"SubtitleFormatsOperation,omitnil" name:"SubtitleFormatsOperation"`
...
type AttachMediaSubtitlesRequestParams struct {
	...
	AdaptiveDynamicStreamingDefinition *uint64 `json:"AdaptiveDynamicStreamingDefinition,omitnil" name:"AdaptiveDynamicStreamingDefinition"`

	// 字幕的唯一标识。
	SubtitleIds []*string `json:"SubtitleIds,omitnil" name:"SubtitleIds"`
...
type AudioTrackItem struct {
	...
	SourceMedia *string `json:"SourceMedia,omitnil" name:"SourceMedia"`

	// 音频片段取自素材文件的起始时间，单位为秒。0 表示从素材开始位置截取。默认为0。
	SourceMediaStartTime *float64 `json:"SourceMediaStartTime,omitnil" name:"SourceMediaStartTime"`
	...
	TargetDuration *float64 `json:"TargetDuration,omitnil" name:"TargetDuration"`

	// 对音频片段进行的操作，如音量调节等。
	AudioOperations []*AudioTransform `json:"AudioOperations,omitnil" name:"AudioOperations"`
}
...
type AudioTransform struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	VolumeParam *AudioVolumeParam `json:"VolumeParam,omitnil" name:"VolumeParam"`
}
...
type AudioVolumeParam struct {
	...
	// <li>1表示静音。</li>
	// 默认是0。
	Mute *int64 `json:"Mute,omitnil" name:"Mute"`
	...
	// <li>0和1：表示不改变。</li>
	// 默认是0。
	Gain *float64 `json:"Gain,omitnil" name:"Gain"`
}
...
type ClipTask2017 struct {
	...
	// 视频剪辑任务源文件 ID。
	SrcFileId *string `json:"SrcFileId,omitnil" name:"SrcFileId"`

	// 视频剪辑输出的文件信息。
	FileInfo *ClipFileInfo2017 `json:"FileInfo,omitnil" name:"FileInfo"`
}
...
type CommitUploadResponseParams struct {
	...
	// 媒体播放地址。
	MediaUrl *string `json:"MediaUrl,omitnil" name:"MediaUrl"`
...
type ComposeMediaOutput struct {
	...
	// 输出的视频信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoStream *OutputVideoStream `json:"VideoStream,omitnil" name:"VideoStream"`

	// 输出的音频信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AudioStream *OutputAudioStream `json:"AudioStream,omitnil" name:"AudioStream"`
...
type ComposeMediaRequestParams struct {
	...
	Tracks []*MediaTrack `json:"Tracks,omitnil" name:"Tracks"`

	// 输出的媒体文件信息。
	Output *ComposeMediaOutput `json:"Output,omitnil" name:"Output"`
...
type ComposeMediaTask struct {
	...
	// 制作媒体文件任务的输入。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Input *ComposeMediaTaskInput `json:"Input,omitnil" name:"Input"`

	// 制作媒体文件任务的输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *ComposeMediaTaskOutput `json:"Output,omitnil" name:"Output"`
...
type ConcatTask2017 struct {
	...
	// 视频拼接源文件信息。
	FileInfoSet []*ConcatFileInfo2017 `json:"FileInfoSet,omitnil" name:"FileInfoSet"`
}
...
type ConfirmEventsRequestParams struct {
	...
	// 数组长度限制：16。
	EventHandles []*string `json:"EventHandles,omitnil" name:"EventHandles"`
...
type ContentReviewResult struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	PornImageResult *PornImageResult `json:"PornImageResult,omitnil" name:"PornImageResult"`

	// 图片画面中的鉴别令人不安全的信息结果，当 Type 为 Terrorism.Image 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	TerrorismImageResult *TerrorismImageResult `json:"TerrorismImageResult,omitnil" name:"TerrorismImageResult"`

	// 图片画面中的鉴别令人不适宜信息结果，当 Type 为 Political.Image 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	PoliticalImageResult *PoliticalImageResult `json:"PoliticalImageResult,omitnil" name:"PoliticalImageResult"`

	// 图片 OCR 文字中的鉴别令人反感的信息结果，当 Type 为 Porn.Ocr 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	PornOcrResult *ContentReviewOcrResult `json:"PornOcrResult,omitnil" name:"PornOcrResult"`

	// 图片 OCR 中的鉴别令人不安全的信息结果，当 Type 为 Terrorism.Ocr 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	TerrorismOcrResult *ContentReviewOcrResult `json:"TerrorismOcrResult,omitnil" name:"TerrorismOcrResult"`

	// 图片 OCR 文字中的鉴别令人不适宜信息结果，当 Type 为 Political.Ocr 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	PoliticalOcrResult *ContentReviewOcrResult `json:"PoliticalOcrResult,omitnil" name:"PoliticalOcrResult"`
}
...
type CoverBySnapshotTaskInput struct {
	...
	PositionType *string `json:"PositionType,omitnil" name:"PositionType"`

	// 截图位置：
	// <li>对于依照时间点截图，该值表示指定视频第几秒的截图作为封面</li>
	// <li>对于依照百分比截图，该值表示使用视频百分之多少的截图作为封面</li>
	PositionValue *float64 `json:"PositionValue,omitnil" name:"PositionValue"`
...
type CreateEnhanceMediaTemplateRequestParams struct {
	...
	// 输出目标视频控制信息。
	TargetVideoInfo *RebuildMediaTargetVideoStream `json:"TargetVideoInfo,omitnil" name:"TargetVideoInfo"`

	// 输出目标音频控制信息。
	TargetAudioInfo *RebuildMediaTargetAudioStream `json:"TargetAudioInfo,omitnil" name:"TargetAudioInfo"`
...
type CreateHeadTailTemplateRequestParams struct {
	...
	HeadCandidateSet []*string `json:"HeadCandidateSet,omitnil" name:"HeadCandidateSet"`

	// 片尾候选列表，填写视频的 FileId。转码时将自动选择与正片宽高比最接近的一个片尾（相同宽高比时，靠前的候选项优先）。最多支持 5 个候选片尾。
	TailCandidateSet []*string `json:"TailCandidateSet,omitnil" name:"TailCandidateSet"`
...
type CreateImageProcessingTemplateRequestParams struct {
	...
	// <li>长度限制：10。</li>
	Operations []*ImageOperation `json:"Operations,omitnil" name:"Operations"`
...
type CreateImageSpriteTask2017 struct {
	...
	// 截取雪碧图输出的地址。
	ImageSpriteUrlSet []*string `json:"ImageSpriteUrlSet,omitnil" name:"ImageSpriteUrlSet"`

	// 雪碧图子图位置与时间关系 WebVtt 文件地址。
	WebVttUrl *string `json:"WebVttUrl,omitnil" name:"WebVttUrl"`
}
...
type CreateProcedureTemplateRequestParams struct {
	...
	// 音视频审核类型任务参数。
	ReviewAudioVideoTask *ProcedureReviewAudioVideoTaskInput `json:"ReviewAudioVideoTask,omitnil" name:"ReviewAudioVideoTask"`
}
...
type CreateQualityInspectTemplateRequestParams struct {
	...
	// 视频画面抖动重影检测的控制参数。
	JitterConfigure *JitterConfigureInfo `json:"JitterConfigure,omitnil" name:"JitterConfigure"`

	// 视频画面模糊检测的控制参数。
	BlurConfigure *BlurConfigureInfo `json:"BlurConfigure,omitnil" name:"BlurConfigure"`

	// 视频画面低光、过曝检测的控制参数。
	AbnormalLightingConfigure *AbnormalLightingConfigureInfo `json:"AbnormalLightingConfigure,omitnil" name:"AbnormalLightingConfigure"`

	// 视频画面花屏检测的控制参数。
	CrashScreenConfigure *CrashScreenConfigureInfo `json:"CrashScreenConfigure,omitnil" name:"CrashScreenConfigure"`

	// 视频画面黑边、白边、黑屏、白屏检测的控制参数。
	BlackWhiteEdgeConfigure *BlackWhiteEdgeConfigureInfo `json:"BlackWhiteEdgeConfigure,omitnil" name:"BlackWhiteEdgeConfigure"`

	// 视频画面噪点检测的控制参数。
	NoiseConfigure *NoiseConfigureInfo `json:"NoiseConfigure,omitnil" name:"NoiseConfigure"`

	// 视频画面马赛克检测的控制参数。
	MosaicConfigure *MosaicConfigureInfo `json:"MosaicConfigure,omitnil" name:"MosaicConfigure"`

	// 视频画面二维码检测的控制参数。
	QRCodeConfigure *QRCodeConfigureInfo `json:"QRCodeConfigure,omitnil" name:"QRCodeConfigure"`

	// 音频（静音、低音、爆音）检测的控制参数。
	VoiceConfigure *VoiceConfigureInfo `json:"VoiceConfigure,omitnil" name:"VoiceConfigure"`

	// 视频画面质量评价的控制参数。
	QualityEvaluationConfigure *QualityEvaluationConfigureInfo `json:"QualityEvaluationConfigure,omitnil" name:"QualityEvaluationConfigure"`
}
...
type CreateRebuildMediaTemplateRequestParams struct {
	...
	// <li>1：去除</li>
	// 默认值 0。
	RemoveAudio *string `json:"RemoveAudio,omitnil" name:"RemoveAudio"`
}
...
type CreateSuperPlayerConfigRequestParams struct {
	...
	AudioVideoType *string `json:"AudioVideoType,omitnil" name:"AudioVideoType"`
	...
	DrmSwitch *string `json:"DrmSwitch,omitnil" name:"DrmSwitch"`
	...
	DrmStreamingsInfo *DrmStreamingsInfo `json:"DrmStreamingsInfo,omitnil" name:"DrmStreamingsInfo"`

	// 允许输出的转码模板 ID。
	// 
	// 当 AudioVideoType 为 Transcode 时必填。
	TranscodeDefinition *uint64 `json:"TranscodeDefinition,omitnil" name:"TranscodeDefinition"`
...
type DailyPlayStatInfo struct {
	...
	// 播放流量，单位：字节。
	Traffic *uint64 `json:"Traffic,omitnil" name:"Traffic"`
}
...
type DeleteMediaRequestParams struct {
	...
	DeleteParts []*MediaDeleteItem `json:"DeleteParts,omitnil" name:"DeleteParts"`
}
...
type DescribeAllClassResponseParams struct {
	// 分类信息集合
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassInfoSet []*MediaClassInfo `json:"ClassInfoSet,omitnil" name:"ClassInfoSet"`
...
type DescribeCDNStatDetailsRequestParams struct {
	...
	Isps []*string `json:"Isps,omitnil" name:"Isps"`
	...
	DataInterval *uint64 `json:"DataInterval,omitnil" name:"DataInterval"`
}
...
type DescribeCDNStatDetailsResponseParams struct {
	...
	// CDN 用量数据。
	Data []*StatDataItem `json:"Data,omitnil" name:"Data"`
...
type DescribeCDNUsageDataResponseParams struct {
	// 时间粒度，单位：分钟。
	DataInterval *int64 `json:"DataInterval,omitnil" name:"DataInterval"`
...
type DescribeCdnLogsResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	OverseaCdnLogs []*CdnLogInfo `json:"OverseaCdnLogs,omitnil" name:"OverseaCdnLogs"`

	// 国内CDN节点的日志下载列表。
	// 注意：此字段可能返回 null，表示取不到有效值。
	DomesticCdnLogs []*CdnLogInfo `json:"DomesticCdnLogs,omitnil" name:"DomesticCdnLogs"`
...
type DescribeClientUploadAccelerationUsageDataResponseParams struct {
	// 客户端上传加速统计数据。
	ClientUploadAccelerationUsageDataSet []*StatDataItem `json:"ClientUploadAccelerationUsageDataSet,omitnil" name:"ClientUploadAccelerationUsageDataSet"`
...
type DescribeDailyMediaPlayStatResponseParams struct {
	// 播放统计数据。
	DailyPlayStatInfoSet []*DailyPlayStatInfo `json:"DailyPlayStatInfoSet,omitnil" name:"DailyPlayStatInfoSet"`
...
type DescribeDailyPlayStatFileListResponseParams struct {
	// 播放统计文件列表。
	PlayStatFileSet []*PlayStatFileInfo `json:"PlayStatFileSet,omitnil" name:"PlayStatFileSet"`
...
type DescribeDrmDataKeyRequestParams struct {
	// 加密后的数据密钥列表，最大支持10个。
	EdkList []*string `json:"EdkList,omitnil" name:"EdkList"`
...
type DescribeDrmDataKeyResponseParams struct {
	// 密钥列表，包含加密的数据密钥。
	KeyList []*SimpleAesEdkPair `json:"KeyList,omitnil" name:"KeyList"`
...
type DescribeDrmKeyProviderInfoResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	SDMCInfo *SDMCDrmKeyProviderInfo `json:"SDMCInfo,omitnil" name:"SDMCInfo"`
...
type DescribeEnhanceMediaTemplatesResponseParams struct {
	...
	// 音画质重生模板详情列表。
	RebuildMediaTemplateSet []*RebuildMediaTemplate `json:"RebuildMediaTemplateSet,omitnil" name:"RebuildMediaTemplateSet"`
...
type DescribeEventConfigResponseParams struct {
	...
	NotificationUrl *string `json:"NotificationUrl,omitnil" name:"NotificationUrl"`

	// 是否接收 [视频上传完成](https://cloud.tencent.com/document/product/266/7830) 事件通知，"OFF" 为忽略该事件通知，"ON" 为接收事件通知。
	UploadMediaCompleteEventSwitch *string `json:"UploadMediaCompleteEventSwitch,omitnil" name:"UploadMediaCompleteEventSwitch"`

	// 是否接收 [视频删除完成](https://cloud.tencent.com/document/product/266/13434) 事件通知，"OFF" 为忽略该事件通知，"ON" 为接收事件通知。
	DeleteMediaCompleteEventSwitch *string `json:"DeleteMediaCompleteEventSwitch,omitnil" name:"DeleteMediaCompleteEventSwitch"`
...
type DescribeEventsStateResponseParams struct {
	...
	CountOfEventsToPull *uint64 `json:"CountOfEventsToPull,omitnil" name:"CountOfEventsToPull"`
...
type DescribeFileAttributesTask struct {
	...
	// 获取媒体文件属性任务的输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *DescribeFileAttributesTaskOutput `json:"Output,omitnil" name:"Output"`
...
type DescribeHeadTailTemplatesResponseParams struct {
	...
	// 片头片尾模板详情列表。
	HeadTailTemplateSet []*HeadTailTemplate `json:"HeadTailTemplateSet,omitnil" name:"HeadTailTemplateSet"`
...
type DescribeImageProcessingTemplatesResponseParams struct {
	...
	// 图片处理模板详情列表。
	ImageProcessingTemplateSet []*ImageProcessingTemplate `json:"ImageProcessingTemplateSet,omitnil" name:"ImageProcessingTemplateSet"`
...
type DescribeImageReviewUsageDataResponseParams struct {
	...
	ImageReviewUsageDataSet []*ImageReviewUsageDataItem `json:"ImageReviewUsageDataSet,omitnil" name:"ImageReviewUsageDataSet"`
...
type DescribeLicenseUsageDataResponseParams struct {
	...
	LicenseUsageDataSet []*LicenseUsageDataItem `json:"LicenseUsageDataSet,omitnil" name:"LicenseUsageDataSet"`
...
type DescribeMediaInfosResponseParams struct {
	...
	// 不存在的文件 ID 列表。
	NotExistFileIdSet []*string `json:"NotExistFileIdSet,omitnil" name:"NotExistFileIdSet"`
...
type DescribeMediaPlayStatDetailsResponseParams struct {
	// 播放统计数据。
	PlayStatInfoSet []*PlayStatInfo `json:"PlayStatInfoSet,omitnil" name:"PlayStatInfoSet"`
...
type DescribeMediaProcessUsageDataResponseParams struct {
	...
	MediaProcessDataSet []*TaskStatData `json:"MediaProcessDataSet,omitnil" name:"MediaProcessDataSet"`
...
type DescribePrepaidProductsResponseParams struct {
	// 购买的预付费商品实例列表。
	ProductInstanceSet []*ProductInstance `json:"ProductInstanceSet,omitnil" name:"ProductInstanceSet"`
...
type DescribeProcedureTemplatesResponseParams struct {
	...
	// 任务流模板详情列表。
	ProcedureTemplateSet []*ProcedureTemplate `json:"ProcedureTemplateSet,omitnil" name:"ProcedureTemplateSet"`
...
type DescribeQualityInspectTemplatesResponseParams struct {
	...
	// 音画质检测模板详情列表。
	QualityInspectTemplateSet []*QualityInspectTemplateItem `json:"QualityInspectTemplateSet,omitnil" name:"QualityInspectTemplateSet"`
...
type DescribeReviewTemplatesResponseParams struct {
	...
	// 审核模板详情列表。
	ReviewTemplateSet []*ReviewTemplate `json:"ReviewTemplateSet,omitnil" name:"ReviewTemplateSet"`
...
type DescribeRoundPlaysRequestParams struct {
	...
	RoundPlayIds []*string `json:"RoundPlayIds,omitnil" name:"RoundPlayIds"`
...
type DescribeRoundPlaysResponseParams struct {
	...
	// 轮播播单详情列表。
	RoundPlaySet []*RoundPlayInfo `json:"RoundPlaySet,omitnil" name:"RoundPlaySet"`
...
type DescribeStorageDataResponseParams struct {
	// 当前媒体总量。
	MediaCount *uint64 `json:"MediaCount,omitnil" name:"MediaCount"`

	// 当前总存储量，单位是字节。
	TotalStorage *uint64 `json:"TotalStorage,omitnil" name:"TotalStorage"`

	// 当前标准存储量，单位是字节。
	StandardStorage *uint64 `json:"StandardStorage,omitnil" name:"StandardStorage"`

	// 当前低频存储量，单位是字节。
	InfrequentStorage *uint64 `json:"InfrequentStorage,omitnil" name:"InfrequentStorage"`

	// 当前归档存储量，单位是字节。
	ArchiveStorage *uint64 `json:"ArchiveStorage,omitnil" name:"ArchiveStorage"`

	// 当前深度归档存储量，单位是字节。
	DeepArchiveStorage *uint64 `json:"DeepArchiveStorage,omitnil" name:"DeepArchiveStorage"`

	// 各计费区域的存储用量。
	StorageStat []*StorageStatData `json:"StorageStat,omitnil" name:"StorageStat"`
...
type DescribeStorageRegionsResponseParams struct {
	// 存储地域信息列表。
	StorageRegionInfos []*StorageRegionInfo `json:"StorageRegionInfos,omitnil" name:"StorageRegionInfos"`
...
type DescribeSubAppIdsRequestParams struct {
	...
	// 标签信息，查询指定标签的子应用列表。
	Tags []*ResourceTag `json:"Tags,omitnil" name:"Tags"`
...
type DescribeSubAppIdsResponseParams struct {
	// 子应用信息集合。
	SubAppIdInfoSet []*SubAppIdInfo `json:"SubAppIdInfoSet,omitnil" name:"SubAppIdInfoSet"`
...
type DescribeSuperPlayerConfigsResponseParams struct {
	...
	// 播放器配置数组。
	PlayerConfigSet []*PlayerConfig `json:"PlayerConfigSet,omitnil" name:"PlayerConfigSet"`
...
type DescribeTasksRequestParams struct {
	...
	// 过滤条件：任务结束时间。
	FinishTime *TimeRange `json:"FinishTime,omitnil" name:"FinishTime"`
...
type DescribeVodDomainsResponseParams struct {
	...
	// 域名信息列表。
	DomainSet []*DomainDetailInfo `json:"DomainSet,omitnil" name:"DomainSet"`
...
type DomainDetailInfo struct {
	...
	// 加速地区信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AccelerateAreaInfos []*AccelerateAreaInfo `json:"AccelerateAreaInfos,omitnil" name:"AccelerateAreaInfos"`
	...
	// HTTPS 配置信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	HTTPSConfig *DomainHTTPSConfig `json:"HTTPSConfig,omitnil" name:"HTTPSConfig"`

	// [Key 防盗链](https://cloud.tencent.com/document/product/266/14047)配置信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	UrlSignatureAuthPolicy *UrlSignatureAuthPolicy `json:"UrlSignatureAuthPolicy,omitnil" name:"UrlSignatureAuthPolicy"`

	// [Referer 防盗链](https://cloud.tencent.com/document/product/266/14046)配置信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RefererAuthPolicy *RefererAuthPolicy `json:"RefererAuthPolicy,omitnil" name:"RefererAuthPolicy"`
	...
	// 域名 QUIC 配置信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	QUICConfig *DomainQUICConfig `json:"QUICConfig,omitnil" name:"QUICConfig"`
}
...
type DrmStreamingsInfo struct {
	...
	SimpleAesDefinition *uint64 `json:"SimpleAesDefinition,omitnil" name:"SimpleAesDefinition"`

	// 保护类型为 Widevine 的转自适应码流模板 ID。
	WidevineDefinition *uint64 `json:"WidevineDefinition,omitnil" name:"WidevineDefinition"`

	// 保护类型为 FairPlay 的转自适应码流模板 ID。
	FairPlayDefinition *uint64 `json:"FairPlayDefinition,omitnil" name:"FairPlayDefinition"`
}
...
type EditMediaTask struct {
	...
	ProcedureTaskId *string `json:"ProcedureTaskId,omitnil" name:"ProcedureTaskId"`
	...
	ReviewAudioVideoTaskId *string `json:"ReviewAudioVideoTaskId,omitnil" name:"ReviewAudioVideoTaskId"`
...
type EditMediaTaskInput struct {
	...
	StreamInfoSet []*EditMediaStreamInfo `json:"StreamInfoSet,omitnil" name:"StreamInfoSet"`
}
...
type EventContent struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	RemoveWatermarkCompleteEvent *RemoveWatermarkTask `json:"RemoveWatermarkCompleteEvent,omitnil" name:"RemoveWatermarkCompleteEvent"`

	// 视频取回完成事件，当事件类型为 RestoreMediaComplete 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RestoreMediaCompleteEvent *RestoreMediaTask `json:"RestoreMediaCompleteEvent,omitnil" name:"RestoreMediaCompleteEvent"`

	// 音画质重生完成事件，当事件类型为 RebuildMediaComplete 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RebuildMediaCompleteEvent *RebuildMediaTask `json:"RebuildMediaCompleteEvent,omitnil" name:"RebuildMediaCompleteEvent"`
...
type ExtractTraceWatermarkTask struct {
	...
	// 提取溯源水印任务输入信息。
	Input *ExtractTraceWatermarkTaskInput `json:"Input,omitnil" name:"Input"`

	// 提取溯源水印任务输出信息。
	Output *ExtractTraceWatermarkTaskOutput `json:"Output,omitnil" name:"Output"`
...
type FileDeleteTask struct {
	// 删除文件 ID 列表。
	FileIdSet []*string `json:"FileIdSet,omitnil" name:"FileIdSet"`

	// 删除文件结果信息列表。
	FileDeleteResultInfo []*FileDeleteResultItem `json:"FileDeleteResultInfo,omitnil" name:"FileDeleteResultInfo"`
}
...
type FileReviewInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	MediaReviewInfo *ReviewInfo `json:"MediaReviewInfo,omitnil" name:"MediaReviewInfo"`

	// 媒体封面审核信息\*。
	// 
	// \* 只展示通过 [音视频审核(ReviewAudioVideo)](https://cloud.tencent.com/document/api/266/80283) 或 [图片审核(ReviewImage)](https://cloud.tencent.com/document/api/266/73217) 发起的审核结果信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	CoverReviewInfo *ReviewInfo `json:"CoverReviewInfo,omitnil" name:"CoverReviewInfo"`
}
...
type FileUploadTask struct {
	...
	// 上传完成后生成的媒体文件基础信息。
	MediaBasicInfo *MediaBasicInfo `json:"MediaBasicInfo,omitnil" name:"MediaBasicInfo"`
...
type ImageBlur struct {
	...
	Radius *int64 `json:"Radius,omitnil" name:"Radius"`

	// 正态分布的标准差，必须大于0。当 Type 取值为 Gaussian 时此字段有效。
	Sigma *int64 `json:"Sigma,omitnil" name:"Sigma"`
}
...
type ImageOperation struct {
	...
	Scale *ImageScale `json:"Scale,omitnil" name:"Scale"`

	// 图片裁剪处理，仅当 Type 为 CenterCut 时有效。
	CenterCut *ImageCenterCut `json:"CenterCut,omitnil" name:"CenterCut"`

	// 图片模糊处理，仅当 Type 为 Blur 时有效。
	Blur *ImageBlur `json:"Blur,omitnil" name:"Blur"`
}
...
type ImageScale struct {
	...
	LongEdge *uint64 `json:"LongEdge,omitnil" name:"LongEdge"`

	// 输出图片的短边长度，单位为像素。当 Type 取值为 ShortEdgeFirst 时此字段有效。
	ShortEdge *uint64 `json:"ShortEdge,omitnil" name:"ShortEdge"`
}
...
type ImageTransform struct {
	...
	// 当 Type = Flip 时有效。
	Flip *string `json:"Flip,omitnil" name:"Flip"`
}
...
type LiveRealTimeClipRequestParams struct {
	...
	IsPersistence *int64 `json:"IsPersistence,omitnil" name:"IsPersistence"`
	...
	MetaDataRequired *uint64 `json:"MetaDataRequired,omitnil" name:"MetaDataRequired"`
	...
	StreamInfo *LiveRealTimeClipStreamInfo `json:"StreamInfo,omitnil" name:"StreamInfo"`
...
type LiveRealTimeClipResponseParams struct {
	...
	SegmentSet []*LiveRealTimeClipMediaSegmentInfo `json:"SegmentSet,omitnil" name:"SegmentSet"`
...
type MediaAdaptiveDynamicStreamingInfo struct {
	// 转自适应码流信息数组。
	AdaptiveDynamicStreamingSet []*AdaptiveDynamicStreamingInfoItem `json:"AdaptiveDynamicStreamingSet,omitnil" name:"AdaptiveDynamicStreamingSet"`
}
...
type MediaAnimatedGraphicsInfo struct {
	// 视频转动图结果信息
	AnimatedGraphicsSet []*MediaAnimatedGraphicsItem `json:"AnimatedGraphicsSet,omitnil" name:"AnimatedGraphicsSet"`
}
...
type MediaBasicInfo struct {
	...
	ClassPath *string `json:"ClassPath,omitnil" name:"ClassPath"`
	...
	// 该媒体文件的来源信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SourceInfo *MediaSourceData `json:"SourceInfo,omitnil" name:"SourceInfo"`
...
type MediaClassInfo struct {
	...
	// 当前分类的第一级子类 ID 集合。
	SubClassIdSet []*int64 `json:"SubClassIdSet,omitnil" name:"SubClassIdSet"`
...
type MediaImageSpriteInfo struct {
	...
	ImageSpriteSet []*MediaImageSpriteItem `json:"ImageSpriteSet,omitnil" name:"ImageSpriteSet"`
}
...
type MediaImageSpriteItem struct {
	...
	// 每一张雪碧图大图的地址。
	ImageUrlSet []*string `json:"ImageUrlSet,omitnil" name:"ImageUrlSet"`
...
type MediaInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	BasicInfo *MediaBasicInfo `json:"BasicInfo,omitnil" name:"BasicInfo"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	TranscodeInfo *MediaTranscodeInfo `json:"TranscodeInfo,omitnil" name:"TranscodeInfo"`

	// 转动图结果信息。对视频转动图（如 gif）后，动图相关信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AnimatedGraphicsInfo *MediaAnimatedGraphicsInfo `json:"AnimatedGraphicsInfo,omitnil" name:"AnimatedGraphicsInfo"`

	// 采样截图信息。对视频采样截图后，相关截图信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SampleSnapshotInfo *MediaSampleSnapshotInfo `json:"SampleSnapshotInfo,omitnil" name:"SampleSnapshotInfo"`

	// 雪碧图信息。对视频截取雪碧图之后，雪碧的相关信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ImageSpriteInfo *MediaImageSpriteInfo `json:"ImageSpriteInfo,omitnil" name:"ImageSpriteInfo"`

	// 指定时间点截图信息。对视频依照指定时间点截图后，各个截图的信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SnapshotByTimeOffsetInfo *MediaSnapshotByTimeOffsetInfo `json:"SnapshotByTimeOffsetInfo,omitnil" name:"SnapshotByTimeOffsetInfo"`

	// 视频打点信息。对视频设置的各个打点信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeyFrameDescInfo *MediaKeyFrameDescInfo `json:"KeyFrameDescInfo,omitnil" name:"KeyFrameDescInfo"`

	// 转自适应码流信息。包括规格、加密类型、打包格式等相关信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AdaptiveDynamicStreamingInfo *MediaAdaptiveDynamicStreamingInfo `json:"AdaptiveDynamicStreamingInfo,omitnil" name:"AdaptiveDynamicStreamingInfo"`

	// 小程序审核信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MiniProgramReviewInfo *MediaMiniProgramReviewInfo `json:"MiniProgramReviewInfo,omitnil" name:"MiniProgramReviewInfo"`

	// 字幕信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SubtitleInfo *MediaSubtitleInfo `json:"SubtitleInfo,omitnil" name:"SubtitleInfo"`
	...
	// 审核信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ReviewInfo *FileReviewInfo `json:"ReviewInfo,omitnil" name:"ReviewInfo"`
}
...
type MediaKeyFrameDescInfo struct {
	// 视频打点信息数组。
	KeyFrameDescSet []*MediaKeyFrameDescItem `json:"KeyFrameDescSet,omitnil" name:"KeyFrameDescSet"`
}
...
type MediaMiniProgramReviewInfo struct {
	// 音视频审核信息列表。
	MiniProgramReviewList []*MediaMiniProgramReviewInfoItem `json:"MiniProgramReviewList,omitnil" name:"MiniProgramReviewList"`
}
...
type MediaMiniProgramReviewInfoItem struct {
	...
	// <li>Pass：成功。</li>
	// <li>Rejected：未通过。</li>
	ReviewResult *string `json:"ReviewResult,omitnil" name:"ReviewResult"`

	// 小程序音视频审核元素。
	ReviewSummary []*MediaMiniProgramReviewElem `json:"ReviewSummary,omitnil" name:"ReviewSummary"`
}
...
type MediaProcessTaskCoverBySnapshotResult struct {
	...
	// 对视频截图做封面任务的输入。
	Input *CoverBySnapshotTaskInput `json:"Input,omitnil" name:"Input"`

	// 对视频截图做封面任务的输出。
	Output *CoverBySnapshotTaskOutput `json:"Output,omitnil" name:"Output"`
...
type MediaProcessTaskInput struct {
	...
	// 对视频截图做封面任务列表。
	CoverBySnapshotTaskSet []*CoverBySnapshotTaskInput `json:"CoverBySnapshotTaskSet,omitnil" name:"CoverBySnapshotTaskSet"`
...
type MediaProcessTaskResult struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	CoverBySnapshotTask *MediaProcessTaskCoverBySnapshotResult `json:"CoverBySnapshotTask,omitnil" name:"CoverBySnapshotTask"`
...
type MediaSampleSnapshotInfo struct {
	...
	SampleSnapshotSet []*MediaSampleSnapshotItem `json:"SampleSnapshotSet,omitnil" name:"SampleSnapshotSet"`
}
...
type MediaSnapshotByTimeOffsetInfo struct {
	...
	SnapshotByTimeOffsetSet []*MediaSnapshotByTimeOffsetItem `json:"SnapshotByTimeOffsetSet,omitnil" name:"SnapshotByTimeOffsetSet"`
}
...
type MediaSubtitleInfo struct {
	// 字幕信息列表。
	SubtitleSet []*MediaSubtitleItem `json:"SubtitleSet,omitnil" name:"SubtitleSet"`
}
...
type MediaTrack struct {
	...
	// 轨道上的媒体片段列表。
	TrackItems []*MediaTrackItem `json:"TrackItems,omitnil" name:"TrackItems"`
}
...
type MediaTrackItem struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoItem *VideoTrackItem `json:"VideoItem,omitnil" name:"VideoItem"`

	// 音频片段，当 Type = Audio 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AudioItem *AudioTrackItem `json:"AudioItem,omitnil" name:"AudioItem"`

	// 贴图片段，当 Type = Sticker 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	StickerItem *StickerTrackItem `json:"StickerItem,omitnil" name:"StickerItem"`

	// 转场，当 Type = Transition 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	TransitionItem *MediaTransitionItem `json:"TransitionItem,omitnil" name:"TransitionItem"`

	// 空白片段，当 Type = Empty 时有效。空片段用于时间轴的占位。<li>如需要两个音频片段之间有一段时间的静音，可以用 EmptyTrackItem 来进行占位。</li>
	// <li>使用 EmptyTrackItem 进行占位，来定位某个Item。</li>
	// 注意：此字段可能返回 null，表示取不到有效值。
	EmptyItem *EmptyTrackItem `json:"EmptyItem,omitnil" name:"EmptyItem"`
}

type MediaTranscodeInfo struct {
	// 各规格的转码信息集合，每个元素代表一个规格的转码结果。
	TranscodeSet []*MediaTranscodeItem `json:"TranscodeSet,omitnil" name:"TranscodeSet"`
}
...
type MediaVideoStreamItem struct {
	...
	CodecTag *string `json:"CodecTag,omitnil" name:"CodecTag"`

	// 画面动态范围信息。
	// <li><font color=red>注意</font>：在 2023-01-10T00:00:00Z 后处理的转码文件，此字段有效。</li>
	DynamicRangeInfo *DynamicRangeInfo `json:"DynamicRangeInfo,omitnil" name:"DynamicRangeInfo"`
}
...
type ModifyAIAnalysisTemplateRequestParams struct {
	...
	// 智能精彩集锦任务控制参数。
	HighlightConfigure *HighlightsConfigureInfoForUpdate `json:"HighlightConfigure,omitnil" name:"HighlightConfigure"`
}
...
type ModifyAIRecognitionTemplateRequestParams struct {
	...
	// 视频片头片尾识别控制参数。
	HeadTailConfigure *HeadTailConfigureInfoForUpdate `json:"HeadTailConfigure,omitnil" name:"HeadTailConfigure"`

	// 视频拆条识别控制参数。
	SegmentConfigure *SegmentConfigureInfoForUpdate `json:"SegmentConfigure,omitnil" name:"SegmentConfigure"`
	...
	// 物体识别控制参数。
	ObjectConfigure *ObjectConfigureInfoForUpdate `json:"ObjectConfigure,omitnil" name:"ObjectConfigure"`
...
type ModifyMediaInfoRequestParams struct {
	...
	CoverData *string `json:"CoverData,omitnil" name:"CoverData"`

	// 新增的一组视频打点信息，如果某个偏移时间已存在打点，则会进行覆盖操作，单个媒体文件最多 100 个打点信息。同一个请求里，AddKeyFrameDescs 的时间偏移参数必须与 DeleteKeyFrameDescs 都不同。
	AddKeyFrameDescs []*MediaKeyFrameDescItem `json:"AddKeyFrameDescs,omitnil" name:"AddKeyFrameDescs"`

	// 要删除的一组视频打点信息的时间偏移，单位：秒。同一个请求里，AddKeyFrameDescs 的时间偏移参数必须与 DeleteKeyFrameDescs 都不同。
	DeleteKeyFrameDescs []*float64 `json:"DeleteKeyFrameDescs,omitnil" name:"DeleteKeyFrameDescs"`

	// 取值 1 表示清空视频打点信息，其他值无意义。
	// 同一个请求里，ClearKeyFrameDescs 与 AddKeyFrameDescs 不能同时出现。
	ClearKeyFrameDescs *int64 `json:"ClearKeyFrameDescs,omitnil" name:"ClearKeyFrameDescs"`

	// 新增的一组标签，单个媒体文件最多 16 个标签，单个标签最多 32 个字符。同一个请求里，AddTags 参数必须与 DeleteTags 都不同。
	AddTags []*string `json:"AddTags,omitnil" name:"AddTags"`

	// 要删除的一组标签。同一个请求里，AddTags 参数必须与 DeleteTags 都不同。
	DeleteTags []*string `json:"DeleteTags,omitnil" name:"DeleteTags"`

	// 取值 1 表示清空媒体文件所有标签，其他值无意义。
	// 同一个请求里，ClearTags 与 AddTags 不能同时出现。
	ClearTags *int64 `json:"ClearTags,omitnil" name:"ClearTags"`

	// 新增一组字幕。单个媒体文件最多 16 个字幕。同一个请求中，AddSubtitles 中指定的字幕 Id 必须与 DeleteSubtitleIds 都不相同。
	AddSubtitles []*MediaSubtitleInput `json:"AddSubtitles,omitnil" name:"AddSubtitles"`

	// 待删除字幕的唯一标识。同一个请求中，AddSubtitles 中指定的字幕 Id 必须与 DeleteSubtitleIds 都不相同。
	DeleteSubtitleIds []*string `json:"DeleteSubtitleIds,omitnil" name:"DeleteSubtitleIds"`

	// 取值 1 表示清空媒体文件所有的字幕信息，其他值无意义。
	// 同一个请求里，ClearSubtitles 与 AddSubtitles不能同时出现。
	ClearSubtitles *int64 `json:"ClearSubtitles,omitnil" name:"ClearSubtitles"`
}
...
type ModifyMediaInfoResponseParams struct {
	...
	// 新增的字幕信息。
	AddedSubtitleSet []*MediaSubtitleItem `json:"AddedSubtitleSet,omitnil" name:"AddedSubtitleSet"`
...
type ModifyQualityInspectTemplateRequestParams struct {
	...
	// 视频画面抖动重影检测的控制参数。
	JitterConfigure *JitterConfigureInfoForUpdate `json:"JitterConfigure,omitnil" name:"JitterConfigure"`

	// 视频画面模糊检测的控制参数。
	BlurConfigure *BlurConfigureInfoForUpdate `json:"BlurConfigure,omitnil" name:"BlurConfigure"`

	// 视频画面低光、过曝检测的控制参数。
	AbnormalLightingConfigure *AbnormalLightingConfigureInfoForUpdate `json:"AbnormalLightingConfigure,omitnil" name:"AbnormalLightingConfigure"`

	// 视频画面花屏检测的控制参数。
	CrashScreenConfigure *CrashScreenConfigureInfoForUpdate `json:"CrashScreenConfigure,omitnil" name:"CrashScreenConfigure"`

	// 视频画面黑边、白边、黑屏、白屏检测的控制参数。
	BlackWhiteEdgeConfigure *BlackWhiteEdgeConfigureInfoForUpdate `json:"BlackWhiteEdgeConfigure,omitnil" name:"BlackWhiteEdgeConfigure"`

	// 视频画面噪点检测的控制参数。
	NoiseConfigure *NoiseConfigureInfoForUpdate `json:"NoiseConfigure,omitnil" name:"NoiseConfigure"`

	// 视频画面马赛克检测的控制参数。
	MosaicConfigure *MosaicConfigureInfoForUpdate `json:"MosaicConfigure,omitnil" name:"MosaicConfigure"`

	// 视频画面二维码检测的控制参数。
	QRCodeConfigure *QRCodeConfigureInfoForUpdate `json:"QRCodeConfigure,omitnil" name:"QRCodeConfigure"`

	// 音频（静音、低音、爆音）检测的控制参数。
	VoiceConfigure *VoiceConfigureInfoForUpdate `json:"VoiceConfigure,omitnil" name:"VoiceConfigure"`

	// 视频画面质量评价的控制参数。
	QualityEvaluationConfigure *QualityEvaluationConfigureInfoForUpdate `json:"QualityEvaluationConfigure,omitnil" name:"QualityEvaluationConfigure"`
}
...
type ModifySuperPlayerConfigRequestParams struct {
	...
	// 允许输出的 DRM 自适应码流模板内容。
	DrmStreamingsInfo *DrmStreamingsInfoForUpdate `json:"DrmStreamingsInfo,omitnil" name:"DrmStreamingsInfo"`
...
type ObjectConfigureInfo struct {
	...
	ObjectLibrary *string `json:"ObjectLibrary,omitnil" name:"ObjectLibrary"`
}
...
type ParseStreamingManifestRequestParams struct {
	// 待解析的索引文件内容。
	MediaManifestContent *string `json:"MediaManifestContent,omitnil" name:"MediaManifestContent"`

	// 视频索引文件格式。默认 m3u8 格式。
	// <li>m3u8</li>
	// <li>mpd</li>
	ManifestType *string `json:"ManifestType,omitnil" name:"ManifestType"`
}
...
type ParseStreamingManifestResponseParams struct {
	// 分片文件列表。
	MediaSegmentSet []*string `json:"MediaSegmentSet,omitnil" name:"MediaSegmentSet"`
...
type PlayerConfig struct {
	...
	// 播放器对不于不同分辨率的子流展示名字。
	ResolutionNameSet []*ResolutionNameInfo `json:"ResolutionNameSet,omitnil" name:"ResolutionNameSet"`
...
type ProcedureReviewAudioVideoTaskInput struct {
	...
	ReviewContents []*string `json:"ReviewContents,omitnil" name:"ReviewContents"`
}
...
type ProcedureTemplate struct {
	...
	// 微信小程序发布任务参数。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MiniProgramPublishTask *WechatMiniProgramPublishTaskInput `json:"MiniProgramPublishTask,omitnil" name:"MiniProgramPublishTask"`
...
type ProcessImageRequestParams struct {
	...
	ContentReviewInput *ImageContentReviewInput `json:"ContentReviewInput,omitnil" name:"ContentReviewInput"`
...
type ProcessImageResponseParams struct {
	// 图片内容智能识别任务结果。
	ContentReviewResultSet []*ContentReviewResult `json:"ContentReviewResultSet,omitnil" name:"ContentReviewResultSet"`
...
type ProcessMediaByUrlRequestParams struct {
	...
	// 输出文件 COS 路径信息。
	OutputInfo *MediaOutputInfo `json:"OutputInfo,omitnil" name:"OutputInfo"`
...
type ProductInstance struct {
	...
	ProductInstanceId *string `json:"ProductInstanceId,omitnil" name:"ProductInstanceId"`

	// 系统最近一次扣除资源包的日期。使用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#iso-.E6.97.A5.E6.9C.9F.E6.A0.BC.E5.BC.8F)。
	LastConsumeDate *string `json:"LastConsumeDate,omitnil" name:"LastConsumeDate"`
	...
	ProductInstanceResourceSet []*ProductInstanceRecource `json:"ProductInstanceResourceSet,omitnil" name:"ProductInstanceResourceSet"`

	// 预付费资源包实例中包含的资源包列表。
	ResourceSet []*ProductInstanceResource `json:"ResourceSet,omitnil" name:"ResourceSet"`

	// 资源包实例的状态，取值有：
	// <li>Effective：生效，可用于计费抵扣。</li>
	// <li>Isolated：隔离，不可用于计费抵扣。</li>
	ProductInstanceStatus *string `json:"ProductInstanceStatus,omitnil" name:"ProductInstanceStatus"`
	...
	RenewStatus *string `json:"RenewStatus,omitnil" name:"RenewStatus"`
}
...
type PullEventsResponseParams struct {
	// 事件列表。
	// 注意：此字段可能返回 null，表示取不到有效值。
	EventSet []*EventContent `json:"EventSet,omitnil" name:"EventSet"`
...
type RebuildAudioInfo struct {
	// 音频降噪控制参数。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AudioDenoiseInfo *AudioDenoiseInfo `json:"AudioDenoiseInfo,omitnil" name:"AudioDenoiseInfo"`
}
...
type RebuildMediaRequestParams struct {
	...
	// 画质修复控制参数。
	RepairInfo *RepairInfo `json:"RepairInfo,omitnil" name:"RepairInfo"`

	// 智能插帧控制参数。
	VideoFrameInterpolationInfo *VideoFrameInterpolationInfo `json:"VideoFrameInterpolationInfo,omitnil" name:"VideoFrameInterpolationInfo"`

	// 画面超分控制参数。
	SuperResolutionInfo *SuperResolutionInfo `json:"SuperResolutionInfo,omitnil" name:"SuperResolutionInfo"`

	// 高动态范围类型控制参数。
	HDRInfo *HDRInfo `json:"HDRInfo,omitnil" name:"HDRInfo"`

	// 视频降噪控制参数。
	VideoDenoiseInfo *VideoDenoiseInfo `json:"VideoDenoiseInfo,omitnil" name:"VideoDenoiseInfo"`

	// 音频降噪控制参数。
	AudioDenoiseInfo *AudioDenoiseInfo `json:"AudioDenoiseInfo,omitnil" name:"AudioDenoiseInfo"`

	// 色彩增强控制参数。
	ColorInfo *ColorEnhanceInfo `json:"ColorInfo,omitnil" name:"ColorInfo"`

	// 细节增强控制参数。
	SharpInfo *SharpEnhanceInfo `json:"SharpInfo,omitnil" name:"SharpInfo"`

	// 人脸增强控制参数。
	FaceInfo *FaceEnhanceInfo `json:"FaceInfo,omitnil" name:"FaceInfo"`

	// 低光照控制参数。
	LowLightInfo *LowLightEnhanceInfo `json:"LowLightInfo,omitnil" name:"LowLightInfo"`

	// 去划痕控制参数。
	ScratchRepairInfo *ScratchRepairInfo `json:"ScratchRepairInfo,omitnil" name:"ScratchRepairInfo"`

	// 去伪影（毛刺）控制参数。
	ArtifactRepairInfo *ArtifactRepairInfo `json:"ArtifactRepairInfo,omitnil" name:"ArtifactRepairInfo"`

	// 音画质重生输出目标参数。
	TargetInfo *RebuildMediaTargetInfo `json:"TargetInfo,omitnil" name:"TargetInfo"`
...
type RebuildMediaTargetInfo struct {
	...
	// 输出的视频信息。
	VideoStream *RebuildMediaTargetVideoStream `json:"VideoStream,omitnil" name:"VideoStream"`

	// 输出的音频信息。
	AudioStream *RebuildMediaTargetAudioStream `json:"AudioStream,omitnil" name:"AudioStream"`
...
type RebuildMediaTask struct {
	...
	// 音画质重生任务的输入。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Input *RebuildMediaTaskInput `json:"Input,omitnil" name:"Input"`

	// 音画质重生任务的输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *RebuildMediaTaskOutput `json:"Output,omitnil" name:"Output"`
...
type ReduceMediaBitrateMediaProcessTaskResult struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	TranscodeTask *ReduceMediaBitrateTranscodeResult `json:"TranscodeTask,omitnil" name:"TranscodeTask"`

	// 降码率任务中对视频转自适应码流任务的查询结果，当任务类型为 AdaptiveDynamicStreaming 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AdaptiveDynamicStreamingTask *ReduceMediaBitrateAdaptiveDynamicStreamingResult `json:"AdaptiveDynamicStreamingTask,omitnil" name:"AdaptiveDynamicStreamingTask"`
}
...
type ReduceMediaBitrateTask struct {
	...
	// 降码率任务执行状态与结果。
	MediaProcessResultSet []*ReduceMediaBitrateMediaProcessTaskResult `json:"MediaProcessResultSet,omitnil" name:"MediaProcessResultSet"`
...
type RefererAuthPolicy struct {
	...
	BlankRefererAllowed *string `json:"BlankRefererAllowed,omitnil" name:"BlankRefererAllowed"`
}
...
type RemoveWatermarkTask struct {
	...
	// 智能去除水印任务的输入。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Input *RemoveWaterMarkTaskInput `json:"Input,omitnil" name:"Input"`

	// 智能去除水印任务的输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *RemoveWaterMarkTaskOutput `json:"Output,omitnil" name:"Output"`
...
type ResolutionNameInfo struct {
	// 视频短边长度，单位：像素。
	MinEdgeLength *uint64 `json:"MinEdgeLength,omitnil" name:"MinEdgeLength"`
...
type RestoreMediaTask struct {
	...
	// 文件原始存储类型。
	OriginalStorageClass *string `json:"OriginalStorageClass,omitnil" name:"OriginalStorageClass"`

	// 文件目标存储类型。对于临时取回，目标存储类型与原始存储类型相同。
	TargetStorageClass *string `json:"TargetStorageClass,omitnil" name:"TargetStorageClass"`
	...
	RestoreDay *int64 `json:"RestoreDay,omitnil" name:"RestoreDay"`
...
type ReviewAudioVideoSegmentItem struct {
	...
	// <li>ASR：语音中的文字；</li>
	// <li>Voice：声音。</li>
	Form *string `json:"Form,omitnil" name:"Form"`
...
type ReviewAudioVideoTask struct {
	...
	// 音视频审核任务的输入。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Input *ReviewAudioVideoTaskInput `json:"Input,omitnil" name:"Input"`

	// 音视频审核任务的输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *ReviewAudioVideoTaskOutput `json:"Output,omitnil" name:"Output"`
...
type ReviewAudioVideoTaskOutput struct {
	...
	SegmentSet []*ReviewAudioVideoSegmentItem `json:"SegmentSet,omitnil" name:"SegmentSet"`
	...
	// 封面审核结果。
	// 注意：此字段可能返回 null，表示取不到有效值。
	CoverReviewResult *ReviewImageResult `json:"CoverReviewResult,omitnil" name:"CoverReviewResult"`
}
...
type ReviewImageResponseParams struct {
	...
	ReviewResultSet []*ContentReviewResult `json:"ReviewResultSet,omitnil" name:"ReviewResultSet"`

	// 图片审核任务结果。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MediaReviewResult *ReviewImageResult `json:"MediaReviewResult,omitnil" name:"MediaReviewResult"`
...
type ReviewImageResult struct {
	...
	// 有违规信息的嫌疑的视频片段列表。
	// <font color=red>注意</font> ：该列表最多仅展示前 10个 元素。如希望获得完整结果，请从 SegmentSetFileUrl 对应的文件中获取。
	SegmentSet []*ReviewImageSegmentItem `json:"SegmentSet,omitnil" name:"SegmentSet"`
...
type ReviewInfo struct {
	...
	// <li>Abuse：谩骂；</li>
	// <li>Moan：娇喘。</li>
	TypeSet []*string `json:"TypeSet,omitnil" name:"TypeSet"`
...
type SDMCDrmKeyProviderInfo struct {
	...
	FairPlayCertificateUrl *string `json:"FairPlayCertificateUrl,omitnil" name:"FairPlayCertificateUrl"`
}
...
type SearchMediaRequestParams struct {
	...
	// <li>数组长度限制：10。</li>
	NamePrefixes []*string `json:"NamePrefixes,omitnil" name:"NamePrefixes"`

	// 文件描述集合，模糊匹配媒体文件的描述，匹配度越高，排序越优先。
	// <li>单个描述长度限制：100个字符。</li>
	// <li>数组长度限制：10。</li>
	Descriptions []*string `json:"Descriptions,omitnil" name:"Descriptions"`

	// 分类 ID 集合，匹配集合指定 ID 的分类及其所有子类。
	// <li>数组长度限制：10。</li>
	ClassIds []*int64 `json:"ClassIds,omitnil" name:"ClassIds"`
	...
	// <li>Audio: 音频文件</li>
	// <li>Image: 图片文件</li>
	Categories []*string `json:"Categories,omitnil" name:"Categories"`

	// 媒体文件来源集合，来源取值参见 [SourceType](https://cloud.tencent.com/document/product/266/31773#MediaSourceData)。
	// <li>数组长度限制：10。</li>
	SourceTypes []*string `json:"SourceTypes,omitnil" name:"SourceTypes"`

	// 推流直播码集合。匹配集合中的任意元素。
	// <li>数组长度限制：10。</li>
	StreamIds []*string `json:"StreamIds,omitnil" name:"StreamIds"`
	...
	// <li>数组长度限制：20。</li>
	StorageRegions []*string `json:"StorageRegions,omitnil" name:"StorageRegions"`
	...
	// <li> ARCHIVE：归档存储。</li>
	// <li> DEEP_ARCHIVE：深度归档存储。</li>
	StorageClasses []*string `json:"StorageClasses,omitnil" name:"StorageClasses"`

	// 媒体文件封装格式集合，匹配集合中任意元素。
	// <li>数组长度限制：10。</li>
	MediaTypes []*string `json:"MediaTypes,omitnil" name:"MediaTypes"`
	...
	ReviewResults []*string `json:"ReviewResults,omitnil" name:"ReviewResults"`

	// TRTC 应用 ID 集合。匹配集合中的任意元素。
	// <li>数组长度限制：10。</li>
	TrtcSdkAppIds []*uint64 `json:"TrtcSdkAppIds,omitnil" name:"TrtcSdkAppIds"`
	...
	// 该字段已无效。
	Vids []*string `json:"Vids,omitnil" name:"Vids"`
...
type SimpleAesEdkPair struct {
	// 加密后的数据密钥。
	Edk *string `json:"Edk,omitnil" name:"Edk"`

	// 数据密钥。返回的数据密钥 DK 为 Base64 编码字符串。
	Dk *string `json:"Dk,omitnil" name:"Dk"`
}
...
type SnapshotByTimeOffsetTask2017 struct {
	...
	// 截图结果信息。
	SnapshotInfoSet []*SnapshotByTimeOffset2017 `json:"SnapshotInfoSet,omitnil" name:"SnapshotInfoSet"`
}
...
type SpecificationDataItem struct {
	...
	// 统计数据。
	Data []*TaskStatDataItem `json:"Data,omitnil" name:"Data"`
}
...
type SplitMediaRequestParams struct {
	...
	Segments []*SplitMediaTaskConfig `json:"Segments,omitnil" name:"Segments"`
...
type SplitMediaTask struct {
	...
	// 视频拆条任务详细信息列表。
	FileInfoSet []*SplitMediaTaskSegmentInfo `json:"FileInfoSet,omitnil" name:"FileInfoSet"`
...
type SplitMediaTaskConfig struct {
	...
	// 视频拆条输出信息。
	OutputConfig *SplitMediaOutputConfig `json:"OutputConfig,omitnil" name:"OutputConfig"`
}
...
type SplitMediaTaskSegmentInfo struct {
	// 视频拆条任务输入信息。
	Input *SplitMediaTaskInput `json:"Input,omitnil" name:"Input"`

	// 视频拆条任务输出信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *TaskOutputMediaInfo `json:"Output,omitnil" name:"Output"`
...
type StickerTrackItem struct {
	...
	// 对贴图进行的操作，如图像旋转等。
	ImageOperations []*ImageTransform `json:"ImageOperations,omitnil" name:"ImageOperations"`
}
...
type SubAppIdInfo struct {
	...
	// 子应用名称。
	SubAppIdName *string `json:"SubAppIdName,omitnil" name:"SubAppIdName"`
...
type TaskStatData struct {
	...
	// 任务数统计数据概览，用量单位为秒。
	Summary []*TaskStatDataItem `json:"Summary,omitnil" name:"Summary"`
	...
	// <li>8K: 短边 ≤ 4320px</li>
	// <li>Audio: 音频</li>
	Details []*SpecificationDataItem `json:"Details,omitnil" name:"Details"`
}
...
type TaskStatDataItem struct {
	...
	// 任务用量。
	Usage *int64 `json:"Usage,omitnil" name:"Usage"`
}
...
type TranscodeTask2017 struct {
	...
	// 视频转码后生成的播放信息。
	PlayInfoSet []*TranscodePlayInfo2017 `json:"PlayInfoSet,omitnil" name:"PlayInfoSet"`
}
...
type VideoTemplateInfo struct {
	...
	// 默认值：OFF。
	PreserveHDRSwitch *string `json:"PreserveHDRSwitch,omitnil" name:"PreserveHDRSwitch"`
...
type WatermarkCycleConfigForUpdate struct {
	...
	DisplayDuration *float64 `json:"DisplayDuration,omitnil" name:"DisplayDuration"`

	// 一个水印周期的持续时间，单位：秒。
	// 填 0 表示水印只持续一个水印周期（即在整个视频里只显示 DisplayDuration 秒）。
	CycleDuration *float64 `json:"CycleDuration,omitnil" name:"CycleDuration"`
}
...
type WeChatMiniProgramPublishRequestParams struct {
	...
	SourceDefinition *int64 `json:"SourceDefinition,omitnil" name:"SourceDefinition"`
}
...
type WechatMiniProgramPublishTask struct {
	...
	SourceDefinition *uint64 `json:"SourceDefinition,omitnil" name:"SourceDefinition"`
...
type WechatPublishTask struct {
	...
	WechatStatus *string `json:"WechatStatus,omitnil" name:"WechatStatus"`

	// 微信 Vid。
	WechatVid *string `json:"WechatVid,omitnil" name:"WechatVid"`

	// 微信地址。
	WechatUrl *string `json:"WechatUrl,omitnil" name:"WechatUrl"`
}