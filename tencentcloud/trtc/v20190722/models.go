...
type CreatePictureRequestParams struct {
	...
	// 显示位置x轴方向
	XPosition *uint64 `json:"XPosition,omitnil" name:"XPosition"`

	// 显示位置y轴方向
	YPosition *uint64 `json:"YPosition,omitnil" name:"YPosition"`
}
...
type CreatePictureResponseParams struct {
	// 图片id
	PictureId *uint64 `json:"PictureId,omitnil" name:"PictureId"`
...
type DescribePictureResponseParams struct {
	...
	// 图片信息列表
	PictureInfo []*PictureInfo `json:"PictureInfo,omitnil" name:"PictureInfo"`
...
type DescribeRecordStatisticResponseParams struct {
	// 应用的用量信息数组。
	SdkAppIdUsages []*SdkAppIdRecordUsage `json:"SdkAppIdUsages,omitnil" name:"SdkAppIdUsages"`
...
type DescribeTRTCMarketQualityMetricDataResponseParams struct {
	// TRTC监控数据出参
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data *TRTCDataResp `json:"Data,omitnil" name:"Data"`
...
type DescribeTrtcMcuTranscodeTimeResponseParams struct {
	// 应用的用量信息数组。
	Usages []*OneSdkAppIdTranscodeTimeUsagesInfo `json:"Usages,omitnil" name:"Usages"`
...
type EncodeParams struct {
	...
	AudioSampleRate *uint64 `json:"AudioSampleRate,omitnil" name:"AudioSampleRate"`
	...
	AudioChannels *uint64 `json:"AudioChannels,omitnil" name:"AudioChannels"`

	// 混流-输出流宽，音视频输出时必填。取值范围[0,1920]，单位为像素值。
	VideoWidth *uint64 `json:"VideoWidth,omitnil" name:"VideoWidth"`

	// 混流-输出流高，音视频输出时必填。取值范围[0,1080]，单位为像素值。
	VideoHeight *uint64 `json:"VideoHeight,omitnil" name:"VideoHeight"`
	...
	VideoFramerate *uint64 `json:"VideoFramerate,omitnil" name:"VideoFramerate"`

	// 混流-输出流gop，音视频输出时必填。取值范围[1,5]，单位为秒。
	VideoGop *uint64 `json:"VideoGop,omitnil" name:"VideoGop"`
	...
	BackgroundColor *uint64 `json:"BackgroundColor,omitnil" name:"BackgroundColor"`

	// 混流-输出流背景图片，取值为实时音视频控制台上传的图片ID。
	BackgroundImageId *uint64 `json:"BackgroundImageId,omitnil" name:"BackgroundImageId"`
	...
	AudioCodec *uint64 `json:"AudioCodec,omitnil" name:"AudioCodec"`
...
type LayoutParams struct {
	...
	Template *uint64 `json:"Template,omitnil" name:"Template"`

	// 屏幕分享模板、悬浮模板、画中画模板中有效，代表大画面对应的用户ID。
	MainVideoUserId *string `json:"MainVideoUserId,omitnil" name:"MainVideoUserId"`

	// 屏幕分享模板、悬浮模板、画中画模板中有效，代表大画面对应的流类型，0为摄像头，1为屏幕分享。左侧大画面为web用户时此值填0。
	MainVideoStreamType *uint64 `json:"MainVideoStreamType,omitnil" name:"MainVideoStreamType"`

	// 画中画模板中有效，代表小画面的布局参数。
	SmallVideoLayoutParams *SmallVideoLayoutParams `json:"SmallVideoLayoutParams,omitnil" name:"SmallVideoLayoutParams"`

	// 屏幕分享模板有效。设置为1时代表大画面居右，小画面居左布局。默认为0。
	MainVideoRightAlign *uint64 `json:"MainVideoRightAlign,omitnil" name:"MainVideoRightAlign"`

	// 指定混视频的用户ID列表。设置此参数后，输出流混合此参数中包含用户的音视频，以及其他用户的纯音频。悬浮模板、九宫格、屏幕分享模板有效，最多可设置16个用户。
	MixVideoUids []*string `json:"MixVideoUids,omitnil" name:"MixVideoUids"`

	// 自定义模板中有效，指定用户视频在混合画面中的位置。
	PresetLayoutConfig []*PresetLayoutConfig `json:"PresetLayoutConfig,omitnil" name:"PresetLayoutConfig"`
	...
	// 水印参数。
	WaterMarkParams *WaterMarkParams `json:"WaterMarkParams,omitnil" name:"WaterMarkParams"`
...
type McuLayout struct {
	...
	TransparentUrl *string `json:"TransparentUrl,omitnil" name:"TransparentUrl"`
}
...
type OneSdkAppIdTranscodeTimeUsagesInfo struct {
	// 旁路转码时长查询结果数组
	SdkAppIdTranscodeTimeUsages []*SdkAppIdTrtcMcuTranscodeTimeUsage `json:"SdkAppIdTranscodeTimeUsages,omitnil" name:"SdkAppIdTranscodeTimeUsages"`
...
type OutputParams struct {
	...
	PureAudioStream *uint64 `json:"PureAudioStream,omitnil" name:"PureAudioStream"`
	...
	RecordAudioOnly *uint64 `json:"RecordAudioOnly,omitnil" name:"RecordAudioOnly"`
}
...
type PresetLayoutConfig struct {
	...
	MixInputType *uint64 `json:"MixInputType,omitnil" name:"MixInputType"`

	// 占位图ID。启用占位图功能时，在当前位置的用户没有上行视频时显示占位图。占位图大小不能超过2M，在实时音视频控制台上传并生成，https://cloud.tencent.com/document/product/647/50769
	PlaceImageId *uint64 `json:"PlaceImageId,omitnil" name:"PlaceImageId"`
}
...
type PublishCdnParams struct {
	...
	PublishCdnUrls []*string `json:"PublishCdnUrls,omitnil" name:"PublishCdnUrls"`
}
...
type RecordUsage struct {
	...
	// 视频时长-标清SD，单位：秒。
	Class1VideoTime *uint64 `json:"Class1VideoTime,omitnil" name:"Class1VideoTime"`

	// 视频时长-高清HD，单位：秒。
	Class2VideoTime *uint64 `json:"Class2VideoTime,omitnil" name:"Class2VideoTime"`

	// 视频时长-超清HD，单位：秒。
	Class3VideoTime *uint64 `json:"Class3VideoTime,omitnil" name:"Class3VideoTime"`

	// 语音时长，单位：秒。
	AudioTime *uint64 `json:"AudioTime,omitnil" name:"AudioTime"`
}
...
type SdkAppIdRecordUsage struct {
	...
	// 统计的时间点数据。
	Usages []*RecordUsage `json:"Usages,omitnil" name:"Usages"`
}
...
type SdkAppIdTrtcMcuTranscodeTimeUsage struct {
	...
	// 视频时长-标清SD，单位：秒。
	VideoTimeSd *uint64 `json:"VideoTimeSd,omitnil" name:"VideoTimeSd"`

	// 视频时长-高清HD，单位：秒。
	VideoTimeHd *uint64 `json:"VideoTimeHd,omitnil" name:"VideoTimeHd"`

	// 视频时长-全高清FHD，单位：秒。
	VideoTimeFhd *uint64 `json:"VideoTimeFhd,omitnil" name:"VideoTimeFhd"`
...
type StartMCUMixTranscodeByStrRoomIdRequestParams struct {
	...
	// 混流输出控制参数。
	OutputParams *OutputParams `json:"OutputParams,omitnil" name:"OutputParams"`

	// 混流输出编码参数。
	EncodeParams *EncodeParams `json:"EncodeParams,omitnil" name:"EncodeParams"`

	// 混流输出布局参数。
	LayoutParams *LayoutParams `json:"LayoutParams,omitnil" name:"LayoutParams"`

	// 第三方CDN转推参数。如需转推至腾讯云云直播，此参数无需填写，会默认转推
	PublishCdnParams *PublishCdnParams `json:"PublishCdnParams,omitnil" name:"PublishCdnParams"`
}
...
type TRTCDataResp struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	Series []*SeriesInfo `json:"Series,omitnil" name:"Series"`
