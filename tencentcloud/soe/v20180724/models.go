...
type InitOralProcessRequestParams struct {
	...
	// 1：非流式一次性评估
	// 推荐使用流式分片传输。
	WorkMode *int64 `json:"WorkMode,omitnil" name:"WorkMode"`
	...
	EvalMode *int64 `json:"EvalMode,omitnil" name:"EvalMode"`
	...
	ScoreCoeff *float64 `json:"ScoreCoeff,omitnil" name:"ScoreCoeff"`
	...
	SoeAppId *string `json:"SoeAppId,omitnil" name:"SoeAppId"`

	// 长效session标识，当该参数为1时，session的持续时间为300s，但会一定程度上影响第一个数据包的返回速度，且TransmitOralProcess必须同时为1才可生效。
	IsLongLifeSession *int64 `json:"IsLongLifeSession,omitnil" name:"IsLongLifeSession"`
	...
	SentenceInfoEnabled *int64 `json:"SentenceInfoEnabled,omitnil" name:"SentenceInfoEnabled"`
	...
	TextMode *int64 `json:"TextMode,omitnil" name:"TextMode"`
...
type Keyword struct {
	...
	EvalMode *uint64 `json:"EvalMode,omitnil" name:"EvalMode"`
	...
	// 评估语言，0：英文，1：中文。
	// ServerType不填默认为0
	ServerType *uint64 `json:"ServerType,omitnil" name:"ServerType"`

	// 输入文本模式，0: 普通文本，1：[音素结构](https://cloud.tencent.com/document/product/884/33698)文本。
	TextMode *uint64 `json:"TextMode,omitnil" name:"TextMode"`
}
...
type KeywordEvaluateRequestParams struct {
	...
	// 注意：序号上限为3000，不能超过上限。
	SeqId *uint64 `json:"SeqId,omitnil" name:"SeqId"`
	...
	VoiceFileType *uint64 `json:"VoiceFileType,omitnil" name:"VoiceFileType"`

	// 语音编码类型
	// 1:pcm
	VoiceEncodeType *uint64 `json:"VoiceEncodeType,omitnil" name:"VoiceEncodeType"`
	...
	// 关键词列表
	Keywords []*Keyword `json:"Keywords,omitnil" name:"Keywords"`

	// 业务应用ID，与账号应用APPID无关，是用来方便客户管理服务的参数，新的 SoeAppId 可以在[控制台](https://console.cloud.tencent.com/soe)【应用管理】下新建。如果没有新建SoeAppId，请勿填入该参数，否则会报欠费错误。使用指南：[业务应用](https://cloud.tencent.com/document/product/884/78824#.E4.B8.9A.E5.8A.A1.E5.BA.94.E7.94.A8)
	SoeAppId *string `json:"SoeAppId,omitnil" name:"SoeAppId"`

	// 查询标识，当该参数为1时，该请求为查询请求，请求返回该 Session 评估结果。
	IsQuery *uint64 `json:"IsQuery,omitnil" name:"IsQuery"`
}
...
type KeywordEvaluateResponseParams struct {
	// 关键词得分
	KeywordScores []*KeywordScore `json:"KeywordScores,omitnil" name:"KeywordScores"`
...
type KeywordScore struct {
	...
	PronCompletion *float64 `json:"PronCompletion,omitnil" name:"PronCompletion"`

	// 详细发音评估结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	Words []*WordRsp `json:"Words,omitnil" name:"Words"`

	// 建议评分，取值范围[0,100]，评分方式为建议评分 = 准确度（PronAccuracy）× 完整度（PronCompletion）×（2 - 完整度（PronCompletion）），如若评分策略不符合请参考Words数组中的详细分数自定义评分逻辑。
	SuggestedScore *float64 `json:"SuggestedScore,omitnil" name:"SuggestedScore"`
}

type PhoneInfo struct {
	// 当前音节语音起始时间点，单位为ms
	MemBeginTime *int64 `json:"MemBeginTime,omitnil" name:"MemBeginTime"`

	// 当前音节语音终止时间点，单位为ms
	MemEndTime *int64 `json:"MemEndTime,omitnil" name:"MemEndTime"`

	// 音节发音准确度，取值范围[-1, 100]，当取-1时指完全不匹配
	PronAccuracy *float64 `json:"PronAccuracy,omitnil" name:"PronAccuracy"`

	// 当前音节是否检测为重音
	DetectedStress *bool `json:"DetectedStress,omitnil" name:"DetectedStress"`

	// 当前音节，当前评测识别的音素
	Phone *string `json:"Phone,omitnil" name:"Phone"`

	// 当前音节是否应为重音
	Stress *bool `json:"Stress,omitnil" name:"Stress"`

	// 参考音素，在单词诊断模式下，代表标准音素
	ReferencePhone *string `json:"ReferencePhone,omitnil" name:"ReferencePhone"`

	// 当前词与输入语句的匹配情况，0：匹配单词、1：新增单词、2：缺少单词、3：错读的词、4：未录入单词。
	MatchTag *int64 `json:"MatchTag,omitnil" name:"MatchTag"`

	// 参考字符，在单词诊断模式下，代表音素对应的原始文本
	ReferenceLetter *string `json:"ReferenceLetter,omitnil" name:"ReferenceLetter"`
}
...
type SentenceInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	RefTextId *int64 `json:"RefTextId,omitnil" name:"RefTextId"`

	// 主题词命中标志，0表示没命中，1表示命中
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeyWordHits []*float64 `json:"KeyWordHits,omitnil" name:"KeyWordHits"`

	// 负向主题词命中标志，0表示没命中，1表示命中
	// 注意：此字段可能返回 null，表示取不到有效值。
	UnKeyWordHits []*float64 `json:"UnKeyWordHits,omitnil" name:"UnKeyWordHits"`
}

type Tone struct {
	// 检测结果是否有效
	// 注意：此字段可能返回 null，表示取不到有效值。
	Valid *bool `json:"Valid,omitnil" name:"Valid"`

	// 文本标准声调，数值范围[-1,1,2,3,4]
	// 注意：此字段可能返回 null，表示取不到有效值。
	RefTone *int64 `json:"RefTone,omitnil" name:"RefTone"`

	// 实际发音声调，数值范围[-1,1,2,3,4]
	// 注意：此字段可能返回 null，表示取不到有效值。
	HypothesisTone *int64 `json:"HypothesisTone,omitnil" name:"HypothesisTone"`
}
...
type TransmitOralProcessResponseParams struct {
	...
	SentenceInfoSet []*SentenceInfo `json:"SentenceInfoSet,omitnil" name:"SentenceInfoSet"`
...
type WordRsp struct {
	...
	// 音节评估详情
	PhoneInfos []*PhoneInfo `json:"PhoneInfos,omitnil" name:"PhoneInfos"`

	// 参考词，目前为保留字段。
	ReferenceWord *string `json:"ReferenceWord,omitnil" name:"ReferenceWord"`

	// 主题词命中标志，0表示没命中，1表示命中
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeywordTag *int64 `json:"KeywordTag,omitnil" name:"KeywordTag"`

	// 声调检测结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	Tone *Tone `json:"Tone,omitnil" name:"Tone"`
}