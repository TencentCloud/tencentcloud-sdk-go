...
type DescribeSubnetResponseParams struct {
	...
	SubnetList []*Subnet `json:"SubnetList,omitnil" name:"SubnetList"`
...
type DescribeSupportedHsmRequestParams struct {
	...
	HsmType *string `json:"HsmType,omitnil" name:"HsmType"`
}
...
type DescribeSupportedHsmResponseParams struct {
	// 当前地域所支持的设备列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	DeviceTypes []*DeviceInfo `json:"DeviceTypes,omitnil" name:"DeviceTypes"`
...
type DescribeUsgResponseParams struct {
	// 用户的安全组列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	SgList []*SgUnit `json:"SgList,omitnil" name:"SgList"`
...
type DescribeUsgRuleRequestParams struct {
	// 根据安全组Id获取安全组详情
	SgIds []*string `json:"SgIds,omitnil" name:"SgIds"`
}
...
type DescribeUsgRuleResponseParams struct {
	// 安全组详情
	// 注意：此字段可能返回 null，表示取不到有效值。
	SgRules []*UsgRuleDetail `json:"SgRules,omitnil" name:"SgRules"`
...
type DescribeVpcResponseParams struct {
	...
	// Vpc对象列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	VpcList []*Vpc `json:"VpcList,omitnil" name:"VpcList"`
...
type DescribeVsmAttributesResponseParams struct {
	...
	VsmType *int64 `json:"VsmType,omitnil" name:"VsmType"`
	...
	// 安全组详情信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	SgList []*UsgRuleDetail `json:"SgList,omitnil" name:"SgList"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	RemainSeconds *int64 `json:"RemainSeconds,omitnil" name:"RemainSeconds"`
...
type DescribeVsmsResponseParams struct {
	...
	// 资源信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	VsmList []*ResourceInfo `json:"VsmList,omitnil" name:"VsmList"`
...
type DeviceInfo struct {
	...
	// 此厂商旗下的设备信息列表
	HsmTypes []*HsmInfo `json:"HsmTypes,omitnil" name:"HsmTypes"`
}
...
type GetAlarmEventResponseParams struct {
	// 用户所有的告警策略
	// 注意：此字段可能返回 null，表示取不到有效值。
	AlarmConfig []*AlarmPolicy `json:"AlarmConfig,omitnil" name:"AlarmConfig"`
...
type GetVsmMonitorInfoResponseParams struct {
	// VSM监控信息
	MonitorInfo []*string `json:"MonitorInfo,omitnil" name:"MonitorInfo"`
...
type HsmInfo struct {
	...
	// 此类型的加密机所支持的VSM类型列表
	VsmTypes []*VsmInfo `json:"VsmTypes,omitnil" name:"VsmTypes"`
...
type SgUnit struct {
	...
	// 安全组名称
	// 注意：此字段可能返回 null，表示取不到有效值。
	SgName *string `json:"SgName,omitnil" name:"SgName"`

	// 备注
	// 注意：此字段可能返回 null，表示取不到有效值。
	SgRemark *string `json:"SgRemark,omitnil" name:"SgRemark"`
...
type Subnet struct {
	...
	// 可用IP数。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AvailableIpAddressCount *int64 `json:"AvailableIpAddressCount,omitnil" name:"AvailableIpAddressCount"`
	...
	// 总IP数
	// 注意：此字段可能返回 null，表示取不到有效值。
	TotalIpAddressCount *int64 `json:"TotalIpAddressCount,omitnil" name:"TotalIpAddressCount"`
...
type UsgRuleDetail struct {
	// 入站规则
	// 注意：此字段可能返回 null，表示取不到有效值。
	InBound []*UsgPolicy `json:"InBound,omitnil" name:"InBound"`

	// 出站规则
	// 注意：此字段可能返回 null，表示取不到有效值。
	OutBound []*UsgPolicy `json:"OutBound,omitnil" name:"OutBound"`
