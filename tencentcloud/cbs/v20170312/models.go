...
type Cdc struct {
	...
	CdcState *string `json:"CdcState,omitnil" name:"CdcState"`
	...
	// 独享集群的资源容量大小。
	// 注意：此字段可能返回 null，表示取不到有效值。
	CdcResource *CdcSize `json:"CdcResource,omitnil" name:"CdcResource"`
	...
	// 当前集群中已创建的云盘数量。
	DiskNumber *uint64 `json:"DiskNumber,omitnil" name:"DiskNumber"`
}
...
type DescribeDiskStoragePoolRequestParams struct {
	...
	CdcIds []*string `json:"CdcIds,omitnil" name:"CdcIds"`
...
type DescribeDiskStoragePoolResponseParams struct {
	...
	// 独享集群的详细信息列表
	CdcSet []*Cdc `json:"CdcSet,omitnil" name:"CdcSet"`

	// 独享集群的详细信息列表
	DiskStoragePoolSet []*Cdc `json:"DiskStoragePoolSet,omitnil" name:"DiskStoragePoolSet"`
...
type InquiryPriceRenewDisksRequestParams struct {
	...
	DiskChargePrepaids []*DiskChargePrepaid `json:"DiskChargePrepaids,omitnil" name:"DiskChargePrepaids"`

	// 指定云盘新的到期时间，形式如：2017-12-17 00:00:00。参数`NewDeadline`和`DiskChargePrepaids`是两种指定询价时长的方式，两者必传一个。
	NewDeadline *string `json:"NewDeadline,omitnil" name:"NewDeadline"`
...
type ModifyDisksChargeTypeRequestParams struct {
	...
	// 设置为后付费模式
	DiskChargePostpaid *bool `json:"DiskChargePostpaid,omitnil" name:"DiskChargePostpaid"`
}
