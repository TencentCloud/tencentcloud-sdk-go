...
type AnalyseParam struct {
	...
	// 需再次处理的KEY——模式
	// 注意：此字段可能返回 null，表示取不到有效值。
	InputValueType *string `json:"InputValueType,omitnil" name:"InputValueType"`

	// 需再次处理的KEY——KEY表达式
	// 注意：此字段可能返回 null，表示取不到有效值。
	InputValue *string `json:"InputValue,omitnil" name:"InputValue"`
}
...
type ClickHouseParam struct {
	...
	// ClickHouse的schema
	// 注意：此字段可能返回 null，表示取不到有效值。
	Schema []*ClickHouseSchema `json:"Schema,omitnil" name:"Schema"`
	...
	// 提高该参数值，有利于减少往  ClickHouse 投递的次数，但在错误消息过多及网络不稳定等极端情况下时，可能导致频繁重试影响效率。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ConsumerFetchMinBytes *int64 `json:"ConsumerFetchMinBytes,omitnil" name:"ConsumerFetchMinBytes"`

	// 每次从 topic 拉取消息最大等待时间，当超过当前最大等待时间时，即使没有拉取到 ConsumerFetchMinBytes 大小，也将进行 ClickHouse 投递操作。
	// 提高该参数值，有利于减少往  ClickHouse 投递的次数，但在错误消息过多及网络不稳定等极端情况下时，可能导致频繁重试影响效率。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ConsumerFetchMaxWaitMs *int64 `json:"ConsumerFetchMaxWaitMs,omitnil" name:"ConsumerFetchMaxWaitMs"`
}
...
type ClickHouseSchema struct {
	...
	// 该列对应的jsonKey名
	JsonKey *string `json:"JsonKey,omitnil" name:"JsonKey"`

	// 表列项的类型
	Type *string `json:"Type,omitnil" name:"Type"`

	// 列项是否允许为空
	AllowNull *bool `json:"AllowNull,omitnil" name:"AllowNull"`
}

type ClsParam struct {
	// 生产的信息是否为json格式
	DecodeJson *bool `json:"DecodeJson,omitnil" name:"DecodeJson"`
	...
	ContentKey *string `json:"ContentKey,omitnil" name:"ContentKey"`
...
type ConsumerGroupSpeed struct {
	...
	// 消费速度 Count/Minute
	Speed *uint64 `json:"Speed,omitnil" name:"Speed"`
}
...
type CosParam struct {
	...
	// 汇聚消息量的大小（单位：MB)
	AggregateBatchSize *uint64 `json:"AggregateBatchSize,omitnil" name:"AggregateBatchSize"`

	// 汇聚的时间间隔（单位：小时）
	AggregateInterval *uint64 `json:"AggregateInterval,omitnil" name:"AggregateInterval"`

	// 消息汇聚后的文件格式（支持csv, json）
	FormatOutputType *string `json:"FormatOutputType,omitnil" name:"FormatOutputType"`

	// 转储的对象目录前缀
	ObjectKeyPrefix *string `json:"ObjectKeyPrefix,omitnil" name:"ObjectKeyPrefix"`

	// 根据strptime 时间格式化的分区格式
	DirectoryTimeFormat *string `json:"DirectoryTimeFormat,omitnil" name:"DirectoryTimeFormat"`
}
...
type CreateCdcClusterRequestParams struct {
	...
	CdcVpcId *string `json:"CdcVpcId,omitnil" name:"CdcVpcId"`

	// 每个CDC集群有唯一一个子网ID
	CdcSubnetId *string `json:"CdcSubnetId,omitnil" name:"CdcSubnetId"`
...
type CreateCdcClusterResponseParams struct {
	// 无
	Result *CdcClusterResponse `json:"Result,omitnil" name:"Result"`
...
type CreateConnectResourceRequestParams struct {
	...
	// Dts配置，Type为DTS时必填
	DtsConnectParam *DtsConnectParam `json:"DtsConnectParam,omitnil" name:"DtsConnectParam"`

	// MongoDB配置，Type为MONGODB时必填
	MongoDBConnectParam *MongoDBConnectParam `json:"MongoDBConnectParam,omitnil" name:"MongoDBConnectParam"`

	// Es配置，Type为ES时必填
	EsConnectParam *EsConnectParam `json:"EsConnectParam,omitnil" name:"EsConnectParam"`

	// ClickHouse配置，Type为CLICKHOUSE时必填
	ClickHouseConnectParam *ClickHouseConnectParam `json:"ClickHouseConnectParam,omitnil" name:"ClickHouseConnectParam"`

	// MySQL配置，Type为MYSQL或TDSQL_C_MYSQL时必填
	MySQLConnectParam *MySQLConnectParam `json:"MySQLConnectParam,omitnil" name:"MySQLConnectParam"`

	// PostgreSQL配置，Type为POSTGRESQL或TDSQL_C_POSTGRESQL时必填
	PostgreSQLConnectParam *PostgreSQLConnectParam `json:"PostgreSQLConnectParam,omitnil" name:"PostgreSQLConnectParam"`

	// MariaDB配置，Type为MARIADB时必填
	MariaDBConnectParam *MariaDBConnectParam `json:"MariaDBConnectParam,omitnil" name:"MariaDBConnectParam"`

	// SQLServer配置，Type为SQLSERVER时必填
	SQLServerConnectParam *SQLServerConnectParam `json:"SQLServerConnectParam,omitnil" name:"SQLServerConnectParam"`

	// Doris 配置，Type为 DORIS 时必填
	DorisConnectParam *DorisConnectParam `json:"DorisConnectParam,omitnil" name:"DorisConnectParam"`

	// Kafka配置，Type为 KAFKA 时必填
	KafkaConnectParam *KafkaConnectParam `json:"KafkaConnectParam,omitnil" name:"KafkaConnectParam"`
}
...
type CreateConnectResourceResponseParams struct {
	// 连接源的Id
	Result *ConnectResourceResourceIdResp `json:"Result,omitnil" name:"Result"`
...
type CreateDatahubTaskRequestParams struct {
	...
	// 数据源
	SourceResource *DatahubResource `json:"SourceResource,omitnil" name:"SourceResource"`

	// 数据目标
	TargetResource *DatahubResource `json:"TargetResource,omitnil" name:"TargetResource"`

	// 数据处理规则
	TransformParam *TransformParam `json:"TransformParam,omitnil" name:"TransformParam"`

	// 实例连接参数【已废弃】
	PrivateLinkParam *PrivateLinkParam `json:"PrivateLinkParam,omitnil" name:"PrivateLinkParam"`

	// 选择所要绑定的SchemaId
	SchemaId *string `json:"SchemaId,omitnil" name:"SchemaId"`

	// 数据处理规则
	TransformsParam *TransformsParam `json:"TransformsParam,omitnil" name:"TransformsParam"`
...
type CreateDatahubTaskResponseParams struct {
	// 任务id
	Result *CreateDatahubTaskRes `json:"Result,omitnil" name:"Result"`
...
type CreateRouteRequestParams struct {
	...
	// 是否需要权限管理
	AuthFlag *int64 `json:"AuthFlag,omitnil" name:"AuthFlag"`
...
type CtsdbParam struct {
	...
	// Ctsdb的metric
	CtsdbMetric *string `json:"CtsdbMetric,omitnil" name:"CtsdbMetric"`
}
...
type DatahubResource struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	KafkaParam *KafkaParam `json:"KafkaParam,omitnil" name:"KafkaParam"`

	// EB配置，Type为EB时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	EventBusParam *EventBusParam `json:"EventBusParam,omitnil" name:"EventBusParam"`

	// MongoDB配置，Type为MONGODB时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	MongoDBParam *MongoDBParam `json:"MongoDBParam,omitnil" name:"MongoDBParam"`

	// Es配置，Type为ES时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	EsParam *EsParam `json:"EsParam,omitnil" name:"EsParam"`

	// Tdw配置，Type为TDW时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	TdwParam *TdwParam `json:"TdwParam,omitnil" name:"TdwParam"`

	// Dts配置，Type为DTS时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	DtsParam *DtsParam `json:"DtsParam,omitnil" name:"DtsParam"`

	// ClickHouse配置，Type为CLICKHOUSE时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClickHouseParam *ClickHouseParam `json:"ClickHouseParam,omitnil" name:"ClickHouseParam"`

	// Cls配置，Type为CLS时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClsParam *ClsParam `json:"ClsParam,omitnil" name:"ClsParam"`

	// Cos配置，Type为COS时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	CosParam *CosParam `json:"CosParam,omitnil" name:"CosParam"`

	// MySQL配置，Type为MYSQL时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	MySQLParam *MySQLParam `json:"MySQLParam,omitnil" name:"MySQLParam"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	TopicParam *TopicParam `json:"TopicParam,omitnil" name:"TopicParam"`

	// MariaDB配置，Type为MARIADB时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	MariaDBParam *MariaDBParam `json:"MariaDBParam,omitnil" name:"MariaDBParam"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	CtsdbParam *CtsdbParam `json:"CtsdbParam,omitnil" name:"CtsdbParam"`

	// Scf配置，Type为SCF时必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	ScfParam *ScfParam `json:"ScfParam,omitnil" name:"ScfParam"`
}
...
type DatahubTaskInfo struct {
	...
	// 任务当前处于的步骤
	// 注意：此字段可能返回 null，表示取不到有效值。
	TaskCurrentStep *string `json:"TaskCurrentStep,omitnil" name:"TaskCurrentStep"`
	...
	// 步骤列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	StepList []*string `json:"StepList,omitnil" name:"StepList"`
}
...
type DeleteDatahubTaskResponseParams struct {
	// 任务id
	// 注意：此字段可能返回 null，表示取不到有效值。
	Result *DatahubTaskIdRes `json:"Result,omitnil" name:"Result"`
...
type DescribeConnectResource struct {
	...
	// 该连接源关联的Datahub任务数
	// 注意：此字段可能返回 null，表示取不到有效值。
	DatahubTaskCount *int64 `json:"DatahubTaskCount,omitnil" name:"DatahubTaskCount"`

	// 连接源的当前所处步骤
	// 注意：此字段可能返回 null，表示取不到有效值。
	CurrentStep *string `json:"CurrentStep,omitnil" name:"CurrentStep"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	CtsdbConnectParam *CtsdbConnectParam `json:"CtsdbConnectParam,omitnil" name:"CtsdbConnectParam"`
...
type DescribeConnectResourceResponseParams struct {
	// 连接源的Id
	// 注意：此字段可能返回 null，表示取不到有效值。
	Result *DescribeConnectResourceResp `json:"Result,omitnil" name:"Result"`
...
type DescribeConnectResourcesResp struct {
	...
	// 连接源数据
	// 注意：此字段可能返回 null，表示取不到有效值。
	ConnectResourceList []*DescribeConnectResource `json:"ConnectResourceList,omitnil" name:"ConnectResourceList"`
}

// Predefined struct for user
type DescribeConnectResourcesResponseParams struct {
	// 连接源列表
	Result *DescribeConnectResourcesResp `json:"Result,omitnil" name:"Result"`
...
type DescribeDatahubTaskResponseParams struct {
	// 返回结果
	Result *DescribeDatahubTaskRes `json:"Result,omitnil" name:"Result"`
...
type DescribeDatahubTasksRes struct {
	...
	// Datahub任务信息列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	TaskList []*DatahubTaskInfo `json:"TaskList,omitnil" name:"TaskList"`
}

// Predefined struct for user
type DescribeDatahubTasksResponseParams struct {
	// 返回任务查询结果
	Result *DescribeDatahubTasksRes `json:"Result,omitnil" name:"Result"`
...
type DescribeTopicFlowRankingRequestParams struct {
	...
	RankingType *string `json:"RankingType,omitnil" name:"RankingType"`
...
type DescribeTopicFlowRankingResponseParams struct {
	// 流量排行
	Result *TopicFlowRankingResult `json:"Result,omitnil" name:"Result"`
...
type DorisConnectParam struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	BePort *int64 `json:"BePort,omitnil" name:"BePort"`
}
...
type DropCls struct {
	// 是否投递到cls
	// 注意：此字段可能返回 null，表示取不到有效值。
	DropInvalidMessageToCls *bool `json:"DropInvalidMessageToCls,omitnil" name:"DropInvalidMessageToCls"`

	// 投递cls的地域
	// 注意：此字段可能返回 null，表示取不到有效值。
	DropClsRegion *string `json:"DropClsRegion,omitnil" name:"DropClsRegion"`
	...
	// 投递cls的主题
	// 注意：此字段可能返回 null，表示取不到有效值。
	DropClsTopicId *string `json:"DropClsTopicId,omitnil" name:"DropClsTopicId"`

	// 投递cls的日志集id
	// 注意：此字段可能返回 null，表示取不到有效值。
	DropClsLogSet *string `json:"DropClsLogSet,omitnil" name:"DropClsLogSet"`
}
...
type DtsParam struct {
	...
	// Dts消费分组的账号
	GroupUser *string `json:"GroupUser,omitnil" name:"GroupUser"`

	// Dts消费分组的密码
	GroupPassword *string `json:"GroupPassword,omitnil" name:"GroupPassword"`

	// false同步原始数据，true同步解析后的json格式数据,默认true
	TranSql *bool `json:"TranSql,omitnil" name:"TranSql"`
}
...
type EsParam struct {
	...
	// Es自定义日期后缀
	DateFormat *string `json:"DateFormat,omitnil" name:"DateFormat"`

	// 非json格式数据的自定义key
	ContentKey *string `json:"ContentKey,omitnil" name:"ContentKey"`

	// Es是否抛弃非json格式的消息
	DropInvalidJsonMessage *bool `json:"DropInvalidJsonMessage,omitnil" name:"DropInvalidJsonMessage"`

	// 转储到Es中的文档ID取值字段名
	DocumentIdField *string `json:"DocumentIdField,omitnil" name:"DocumentIdField"`
	...
	// 死信队列
	DropDlq *FailureParam `json:"DropDlq,omitnil" name:"DropDlq"`

	// 使用数据订阅格式导入 es 时，消息与 es 索引字段映射关系。不填默认为默认字段匹配
	RecordMappingList []*EsRecordMapping `json:"RecordMappingList,omitnil" name:"RecordMappingList"`

	// 消息要映射为 es 索引中 @timestamp 的字段，如果当前配置为空，则使用消息的时间戳进行映射
	DateField *string `json:"DateField,omitnil" name:"DateField"`

	// 用来区分当前索引映射，属于新建索引还是存量索引。"EXIST_MAPPING"：从存量索引中选择；"NEW_MAPPING"：新建索引
	RecordMappingMode *string `json:"RecordMappingMode,omitnil" name:"RecordMappingMode"`
}
...
type FailureParam struct {
	...
	// 死信队列类型，CKAFKA，TOPIC
	// 注意：此字段可能返回 null，表示取不到有效值。
	DlqType *string `json:"DlqType,omitnil" name:"DlqType"`
}
...
type FieldParam struct {
	// 解析
	Analyse *AnalyseParam `json:"Analyse,omitnil" name:"Analyse"`

	// 二次解析
	// 注意：此字段可能返回 null，表示取不到有效值。
	SecondaryAnalyse *SecondaryAnalyseParam `json:"SecondaryAnalyse,omitnil" name:"SecondaryAnalyse"`

	// 数据处理
	// 注意：此字段可能返回 null，表示取不到有效值。
	SMT []*SMTParam `json:"SMT,omitnil" name:"SMT"`
	...
	// 解析结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	AnalyseResult []*SMTParam `json:"AnalyseResult,omitnil" name:"AnalyseResult"`

	// 二次解析结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	SecondaryAnalyseResult []*SMTParam `json:"SecondaryAnalyseResult,omitnil" name:"SecondaryAnalyseResult"`

	// JSON格式解析结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	AnalyseJsonResult *string `json:"AnalyseJsonResult,omitnil" name:"AnalyseJsonResult"`

	// JSON格式二次解析结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	SecondaryAnalyseJsonResult *string `json:"SecondaryAnalyseJsonResult,omitnil" name:"SecondaryAnalyseJsonResult"`
}
...
type FilterMapParam struct {
	...
	MatchMode *string `json:"MatchMode,omitnil" name:"MatchMode"`
...
type InstanceScalingDownRequestParams struct {
	...
	// 缩容模式  1:稳定变配 
	// 2.高速变配
	UpgradeStrategy *int64 `json:"UpgradeStrategy,omitnil" name:"UpgradeStrategy"`
...
type InstanceScalingDownResponseParams struct {
	// 缩容应答
	// 注意：此字段可能返回 null，表示取不到有效值。
	Result *ScalingDownResp `json:"Result,omitnil" name:"Result"`
...
type KVParam struct {
	...
	// 保留源Key，默认为false不保留
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeepOriginalKey *string `json:"KeepOriginalKey,omitnil" name:"KeepOriginalKey"`
}
...
type KafkaConnectParam struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	BrokerAddress *string `json:"BrokerAddress,omitnil" name:"BrokerAddress"`
...
type KafkaParam struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	OffsetType *string `json:"OffsetType,omitnil" name:"OffsetType"`
	...
	// 启用容错实例/开启死信队列
	// 注意：此字段可能返回 null，表示取不到有效值。
	EnableToleration *bool `json:"EnableToleration,omitnil" name:"EnableToleration"`

	// Qps 限制
	// 注意：此字段可能返回 null，表示取不到有效值。
	QpsLimit *uint64 `json:"QpsLimit,omitnil" name:"QpsLimit"`

	// Table到Topic的路由，「分发到多个topic」开关打开时必传
	// 注意：此字段可能返回 null，表示取不到有效值。
	TableMappings []*TableMapping `json:"TableMappings,omitnil" name:"TableMappings"`

	// 「分发到多个topic」开关，默认为false
	// 注意：此字段可能返回 null，表示取不到有效值。
	UseTableMapping *bool `json:"UseTableMapping,omitnil" name:"UseTableMapping"`

	// 使用的Topic是否需要自动创建（目前只支持SOURCE流入任务，如果不使用分发到多个topic，需要在Topic字段填写需要自动创建的topic名）
	// 注意：此字段可能返回 null，表示取不到有效值。
	UseAutoCreateTopic *bool `json:"UseAutoCreateTopic,omitnil" name:"UseAutoCreateTopic"`

	// 写入Topic时是否进行压缩，不开启填"none"，开启的话，填写"open"。
	// 注意：此字段可能返回 null，表示取不到有效值。
	CompressionType *string `json:"CompressionType,omitnil" name:"CompressionType"`

	// 源topic消息1条扩增成msgMultiple条写入目标topic(该参数目前只有ckafka流入ckafka适用)
	// 注意：此字段可能返回 null，表示取不到有效值。
	MsgMultiple *int64 `json:"MsgMultiple,omitnil" name:"MsgMultiple"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	ConnectorSyncType *string `json:"ConnectorSyncType,omitnil" name:"ConnectorSyncType"`

	// 数据同步专用参数, 当通过时,希望下游的消息写入分区与上游的一致,则填true,但下游分区小于上游时,会报错; 不需要一致则为false, 默认为false
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeepPartition *bool `json:"KeepPartition,omitnil" name:"KeepPartition"`
}
...
type ModifyConnectResourceRequestParams struct {
	...
	// Dts配置，Type为DTS时必填
	DtsConnectParam *DtsModifyConnectParam `json:"DtsConnectParam,omitnil" name:"DtsConnectParam"`

	// MongoDB配置，Type为MONGODB时必填
	MongoDBConnectParam *MongoDBModifyConnectParam `json:"MongoDBConnectParam,omitnil" name:"MongoDBConnectParam"`

	// Es配置，Type为ES时必填
	EsConnectParam *EsModifyConnectParam `json:"EsConnectParam,omitnil" name:"EsConnectParam"`

	// ClickHouse配置，Type为CLICKHOUSE时必填
	ClickHouseConnectParam *ClickHouseModifyConnectParam `json:"ClickHouseConnectParam,omitnil" name:"ClickHouseConnectParam"`

	// MySQL配置，Type为MYSQL或TDSQL_C_MYSQL时必填
	MySQLConnectParam *MySQLModifyConnectParam `json:"MySQLConnectParam,omitnil" name:"MySQLConnectParam"`

	// PostgreSQL配置，Type为POSTGRESQL或TDSQL_C_POSTGRESQL时必填
	PostgreSQLConnectParam *PostgreSQLModifyConnectParam `json:"PostgreSQLConnectParam,omitnil" name:"PostgreSQLConnectParam"`

	// MariaDB配置，Type为MARIADB时必填
	MariaDBConnectParam *MariaDBModifyConnectParam `json:"MariaDBConnectParam,omitnil" name:"MariaDBConnectParam"`

	// SQLServer配置，Type为SQLSERVER时必填
	SQLServerConnectParam *SQLServerModifyConnectParam `json:"SQLServerConnectParam,omitnil" name:"SQLServerConnectParam"`

	// Ctsdb配置，Type为CTSDB
	CtsdbConnectParam *CtsdbModifyConnectParam `json:"CtsdbConnectParam,omitnil" name:"CtsdbConnectParam"`

	// Doris配置，Type为DORIS
	DorisConnectParam *DorisModifyConnectParam `json:"DorisConnectParam,omitnil" name:"DorisConnectParam"`
...
type MongoDBParam struct {
	...
	// 是否复制存量数据，默认传参true
	CopyExisting *bool `json:"CopyExisting,omitnil" name:"CopyExisting"`
	...
	ListeningEvent *string `json:"ListeningEvent,omitnil" name:"ListeningEvent"`

	// 主从优先级，默认主节点
	ReadPreference *string `json:"ReadPreference,omitnil" name:"ReadPreference"`
...
type PostgreSQLParam struct {
	...
	DataFormat *string `json:"DataFormat,omitnil" name:"DataFormat"`
...
type RecordMapping struct {
	...
	// 当前列大小
	// 注意：此字段可能返回 null，表示取不到有效值。
	ColumnSize *string `json:"ColumnSize,omitnil" name:"ColumnSize"`

	// 当前列精度
	// 注意：此字段可能返回 null，表示取不到有效值。
	DecimalDigits *string `json:"DecimalDigits,omitnil" name:"DecimalDigits"`

	// 是否为自增列
	// 注意：此字段可能返回 null，表示取不到有效值。
	AutoIncrement *bool `json:"AutoIncrement,omitnil" name:"AutoIncrement"`
...
type RenewCkafkaInstanceResponseParams struct {
	// 返回值
	Result *RenewCkafkaInstanceResp `json:"Result,omitnil" name:"Result"`
...
type Route struct {
	...
	// 虚拟IP列表(1对1 broker节点)
	// 注意：此字段可能返回 null，表示取不到有效值。
	BrokerVipList []*VipEntity `json:"BrokerVipList,omitnil" name:"BrokerVipList"`
...
type RowParam struct {
	// 行内容，KEY_VALUE，VALUE
	RowContent *string `json:"RowContent,omitnil" name:"RowContent"`

	// key和value间的分隔符
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeyValueDelimiter *string `json:"KeyValueDelimiter,omitnil" name:"KeyValueDelimiter"`

	// 元素建的分隔符
	// 注意：此字段可能返回 null，表示取不到有效值。
	EntryDelimiter *string `json:"EntryDelimiter,omitnil" name:"EntryDelimiter"`
}
...
type SMTParam struct {
	...
	SchemeType *string `json:"SchemeType,omitnil" name:"SchemeType"`
	...
	// VALUE处理
	// 注意：此字段可能返回 null，表示取不到有效值。
	ValueOperate *ValueParam `json:"ValueOperate,omitnil" name:"ValueOperate"`
	...
	// VALUE处理链
	// 注意：此字段可能返回 null，表示取不到有效值。
	ValueOperates []*ValueParam `json:"ValueOperates,omitnil" name:"ValueOperates"`
}
...
type TdwParam struct {
	// Tdw的bid
	Bid *string `json:"Bid,omitnil" name:"Bid"`

	// Tdw的tid
	Tid *string `json:"Tid,omitnil" name:"Tid"`

	// 默认true
	IsDomestic *bool `json:"IsDomestic,omitnil" name:"IsDomestic"`

	// TDW地址，默认tl-tdbank-tdmanager.tencent-distribute.com
	TdwHost *string `json:"TdwHost,omitnil" name:"TdwHost"`

	// TDW端口，默认8099
	TdwPort *int64 `json:"TdwPort,omitnil" name:"TdwPort"`
}
...
type TopicFlowRanking struct {
	...
	// 副本数
	ReplicaNum *uint64 `json:"ReplicaNum,omitnil" name:"ReplicaNum"`

	// Topic 流量
	TopicTraffic *string `json:"TopicTraffic,omitnil" name:"TopicTraffic"`

	// Topic 消息堆积
	MessageHeap *uint64 `json:"MessageHeap,omitnil" name:"MessageHeap"`
}

type TopicFlowRankingResult struct {
	// Topic 流量数组
	TopicFlow []*TopicFlowRanking `json:"TopicFlow,omitnil" name:"TopicFlow"`

	// 消费者组消费速度排行速度
	ConsumeSpeed []*ConsumerGroupSpeed `json:"ConsumeSpeed,omitnil" name:"ConsumeSpeed"`

	// Topic 消息堆积/占用磁盘排行
	// 注意：此字段可能返回 null，表示取不到有效值。
	TopicMessageHeap []*TopicMessageHeapRanking `json:"TopicMessageHeap,omitnil" name:"TopicMessageHeap"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	BrokerTopicData []*BrokerTopicData `json:"BrokerTopicData,omitnil" name:"BrokerTopicData"`

	// 单个Broker 节点Topic 流量的大小(单位MB)
	BrokerTopicFlowData []*BrokerTopicFlowData `json:"BrokerTopicFlowData,omitnil" name:"BrokerTopicFlowData"`
}
...
type TransformParam struct {
	...
	AnalysisFormat *string `json:"AnalysisFormat,omitnil" name:"AnalysisFormat"`
	...
	// Map
	MapParam []*MapParam `json:"MapParam,omitnil" name:"MapParam"`

	// 过滤器
	FilterParam []*FilterMapParam `json:"FilterParam,omitnil" name:"FilterParam"`
	...
	// 解析结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	AnalyseResult []*MapParam `json:"AnalyseResult,omitnil" name:"AnalyseResult"`

	// 底层引擎是否使用eb
	// 注意：此字段可能返回 null，表示取不到有效值。
	UseEventBus *bool `json:"UseEventBus,omitnil" name:"UseEventBus"`
}
...
type TransformsParam struct {
	...
	// 处理链
	FieldChain []*FieldParam `json:"FieldChain,omitnil" name:"FieldChain"`
	...
	// 输出格式为ROW必填
	// 注意：此字段可能返回 null，表示取不到有效值。
	RowParam *RowParam `json:"RowParam,omitnil" name:"RowParam"`

	// 是否保留数据源Topic元数据信息（源Topic、Partition、Offset），默认为false
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeepMetadata *bool `json:"KeepMetadata,omitnil" name:"KeepMetadata"`

	// 数组解析
	// 注意：此字段可能返回 null，表示取不到有效值。
	BatchAnalyse *BatchAnalyseParam `json:"BatchAnalyse,omitnil" name:"BatchAnalyse"`
}

type UrlDecodeParam struct {
	// 编码
	// 注意：此字段可能返回 null，表示取不到有效值。
	CharsetName *string `json:"CharsetName,omitnil" name:"CharsetName"`
}
...
type ValueParam struct {
	...
	// 替换，TYPE=REPLACE时必传
	// 注意：此字段可能返回 null，表示取不到有效值。
	Replace *ReplaceParam `json:"Replace,omitnil" name:"Replace"`
	...
	// 时间转换，TYPE=DATE时必传
	// 注意：此字段可能返回 null，表示取不到有效值。
	Date *DateParam `json:"Date,omitnil" name:"Date"`

	// 正则替换，TYPE=REGEX_REPLACE时必传
	// 注意：此字段可能返回 null，表示取不到有效值。
	RegexReplace *RegexReplaceParam `json:"RegexReplace,omitnil" name:"RegexReplace"`

	// 值支持一拆多，TYPE=SPLIT时必传
	// 注意：此字段可能返回 null，表示取不到有效值。
	Split *SplitParam `json:"Split,omitnil" name:"Split"`

	// key-value二次解析，TYPE=KV时必传
	// 注意：此字段可能返回 null，表示取不到有效值。
	KV *KVParam `json:"KV,omitnil" name:"KV"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	JsonPathReplace *JsonPathReplaceParam `json:"JsonPathReplace,omitnil" name:"JsonPathReplace"`

	// Url解析
	// 注意：此字段可能返回 null，表示取不到有效值。
	UrlDecode *UrlDecodeParam `json:"UrlDecode,omitnil" name:"UrlDecode"`

	// 小写字符解析
	// 注意：此字段可能返回 null，表示取不到有效值。
	Lowercase *LowercaseParam `json:"Lowercase,omitnil" name:"Lowercase"`
}
...
type ZoneInfo struct {
	...
	// 额外标识
	ExtraFlag *string `json:"ExtraFlag,omitnil" name:"ExtraFlag"`
}
