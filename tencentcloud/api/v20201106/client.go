...
func (c *Client) DescribeProductsWithContext(ctx context.Context, request *DescribeProductsRequest) (response *DescribeProductsResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "api", APIVersion, "DescribeProducts")
...
func (c *Client) DescribeRegionsWithContext(ctx context.Context, request *DescribeRegionsRequest) (response *DescribeRegionsResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "api", APIVersion, "DescribeRegions")
...
func (c *Client) DescribeZonesWithContext(ctx context.Context, request *DescribeZonesRequest) (response *DescribeZonesResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "api", APIVersion, "DescribeZones")
