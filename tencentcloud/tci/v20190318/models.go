...
type AIAssistantRequestParams struct {
	...
	// 音频源的语言，默认0为英文，1为中文
	Lang *int64 `json:"Lang,omitnil" name:"Lang"`

	// 查询人员库列表
	LibrarySet []*string `json:"LibrarySet,omitnil" name:"LibrarySet"`

	// 视频评估时间，单位秒，点播场景默认值为2小时（无法探测长度时）或完整视频，直播场景默认值为10分钟或直播提前结束
	MaxVideoDuration *int64 `json:"MaxVideoDuration,omitnil" name:"MaxVideoDuration"`
	...
	Template *int64 `json:"Template,omitnil" name:"Template"`

	// 识别词库名列表，评估过程使用这些词汇库中的词汇进行词汇使用行为分析
	VocabLibNameList []*string `json:"VocabLibNameList,omitnil" name:"VocabLibNameList"`

	// 语音编码类型 1:pcm
	VoiceEncodeType *int64 `json:"VoiceEncodeType,omitnil" name:"VoiceEncodeType"`

	// 语音文件类型 1:raw, 2:wav, 3:mp3，10:视频（三种音频格式目前仅支持16k采样率16bit）
	VoiceFileType *int64 `json:"VoiceFileType,omitnil" name:"VoiceFileType"`
}
...
type AIAssistantResponseParams struct {
	// 图像任务直接返回结果
	ImageResults []*ImageTaskResult `json:"ImageResults,omitnil" name:"ImageResults"`
...
type ASRStat struct {
	...
	// Vad的平均音量
	AvgVolume *float64 `json:"AvgVolume,omitnil" name:"AvgVolume"`

	// Vad的最大音量
	MaxVolume *float64 `json:"MaxVolume,omitnil" name:"MaxVolume"`

	// Vad的最小音量
	MinVolume *float64 `json:"MinVolume,omitnil" name:"MinVolume"`

	// 当前音频的非发音时长
	MuteDuration *int64 `json:"MuteDuration,omitnil" name:"MuteDuration"`

	// 当前音频的发音时长
	SoundDuration *int64 `json:"SoundDuration,omitnil" name:"SoundDuration"`

	// 当前音频的总时长
	TotalDuration *int64 `json:"TotalDuration,omitnil" name:"TotalDuration"`

	// 当前音频的句子总数
	VadNum *int64 `json:"VadNum,omitnil" name:"VadNum"`

	// 当前音频的单词总数
	WordNum *int64 `json:"WordNum,omitnil" name:"WordNum"`
}
...
type ActionInfo struct {
	...
	BodyPosture *ActionType `json:"BodyPosture,omitnil" name:"BodyPosture"`

	// 举手识别结果，包含举手（hand）和未检测到举手（nothand）
	Handup *ActionType `json:"Handup,omitnil" name:"Handup"`

	// 是否低头识别结果，包含抬头（lookingahead）和未检测到抬头（notlookingahead）
	LookHead *ActionType `json:"LookHead,omitnil" name:"LookHead"`

	// 是否写字识别结果，包含写字（write）和未检测到写字（notlookingahead）
	Writing *ActionType `json:"Writing,omitnil" name:"Writing"`
...
type ActionStatistic struct {
	// 数量统计
	ActionCount []*ActionCountStatistic `json:"ActionCount,omitnil" name:"ActionCount"`

	// 时长统计
	ActionDuration []*ActionDurationStatistic `json:"ActionDuration,omitnil" name:"ActionDuration"`

	// 时长比例统计
	ActionDurationRatio []*ActionDurationRatioStatistic `json:"ActionDurationRatio,omitnil" name:"ActionDurationRatio"`
}
...
type AllMuteSlice struct {
	// 所有静音片段。
	MuteSlice []*MuteSlice `json:"MuteSlice,omitnil" name:"MuteSlice"`

	// 静音时长占比。
	MuteRatio *float64 `json:"MuteRatio,omitnil" name:"MuteRatio"`

	// 静音总时长。
	TotalMuteDuration *int64 `json:"TotalMuteDuration,omitnil" name:"TotalMuteDuration"`
}

type AttendanceInfo struct {
	// 识别到的人员信息
	Face *FrameInfo `json:"Face,omitnil" name:"Face"`
...
type BodyMovementResult struct {
	...
	// 4、other 其他
	Movements *string `json:"Movements,omitnil" name:"Movements"`
...
type CheckFacePhotoResponseParams struct {
	...
	CheckResult *int64 `json:"CheckResult,omitnil" name:"CheckResult"`
...
type CreateFaceResponseParams struct {
	// 人脸操作结果信息
	FaceInfoSet []*FaceInfo `json:"FaceInfoSet,omitnil" name:"FaceInfoSet"`
...
type CreateLibraryRequestParams struct {
	// 人员库名称
	LibraryName *string `json:"LibraryName,omitnil" name:"LibraryName"`
...
type CreatePersonRequestParams struct {
	...
	// 人员性别，0：未知 1：男性，2：女性
	Male *int64 `json:"Male,omitnil" name:"Male"`
	...
	// 人员学生号码
	StudentNumber *string `json:"StudentNumber,omitnil" name:"StudentNumber"`
...
type CreateVocabLibRequestParams struct {
	// 词汇库名称
	VocabLibName *string `json:"VocabLibName,omitnil" name:"VocabLibName"`
}
...
type CreateVocabRequestParams struct {
	...
	// 要添加的词汇列表
	VocabList []*string `json:"VocabList,omitnil" name:"VocabList"`
}
...
type DeleteFaceRequestParams struct {
	// 人脸标识符数组
	FaceIdSet []*string `json:"FaceIdSet,omitnil" name:"FaceIdSet"`
...
type DescribeAITaskResultResponseParams struct {
	// 音频分析结果
	AudioResult *StandardAudioResult `json:"AudioResult,omitnil" name:"AudioResult"`

	// 图像分析结果
	ImageResult *StandardImageResult `json:"ImageResult,omitnil" name:"ImageResult"`

	// 视频分析结果
	VideoResult *StandardVideoResult `json:"VideoResult,omitnil" name:"VideoResult"`
...
type DescribeAttendanceResultResponseParams struct {
	...
	AbsenceSetInLibs []*AbsenceInfo `json:"AbsenceSetInLibs,omitnil" name:"AbsenceSetInLibs"`

	// 确定出勤人员列表
	AttendanceSet []*AttendanceInfo `json:"AttendanceSet,omitnil" name:"AttendanceSet"`

	// 疑似出勤人员列表
	SuspectedSet []*SuspectedInfo `json:"SuspectedSet,omitnil" name:"SuspectedSet"`

	// 缺失人员的ID列表(只针对请求中的personids字段)
	AbsenceSet []*string `json:"AbsenceSet,omitnil" name:"AbsenceSet"`
...
type DescribeAudioTaskResponseParams struct {
	...
	AllMuteSlice *AllMuteSlice `json:"AllMuteSlice,omitnil" name:"AllMuteSlice"`

	// 返回的当前音频的统计信息。当进度为100时返回。
	AsrStat *ASRStat `json:"AsrStat,omitnil" name:"AsrStat"`

	// 返回当前音频流的详细信息，如果是流模式，返回的是对应流的详细信息，如果是 URL模式，返回的是查询的那一段seq对应的音频的详细信息。
	Texts []*WholeTextItem `json:"Texts,omitnil" name:"Texts"`

	// 返回词汇库中的单词出现的详细时间信息。
	VocabAnalysisDetailInfo []*VocabDetailInfomation `json:"VocabAnalysisDetailInfo,omitnil" name:"VocabAnalysisDetailInfo"`

	// 返回词汇库中的单词出现的次数信息。
	VocabAnalysisStatInfo []*VocabStatInfomation `json:"VocabAnalysisStatInfo,omitnil" name:"VocabAnalysisStatInfo"`

	// 返回音频全部文本。
	AllTexts *string `json:"AllTexts,omitnil" name:"AllTexts"`
...
type DescribeConversationTaskRequestParams struct {
	...
	Identity *int64 `json:"Identity,omitnil" name:"Identity"`
...
type DescribeHighlightResultResponseParams struct {
	// 精彩集锦详细信息。
	HighlightsInfo []*HighlightsInfomation `json:"HighlightsInfo,omitnil" name:"HighlightsInfo"`
...
type DescribeImageTaskResponseParams struct {
	// 任务处理结果
	ResultSet []*ImageTaskResult `json:"ResultSet,omitnil" name:"ResultSet"`
...
type DescribeImageTaskStatisticResponseParams struct {
	// 任务统计信息
	Statistic *ImageTaskStatistic `json:"Statistic,omitnil" name:"Statistic"`
...
type DescribeLibrariesResponseParams struct {
	// 人员库列表
	LibrarySet []*Library `json:"LibrarySet,omitnil" name:"LibrarySet"`
...
type DescribePersonResponseParams struct {
	// 人员人脸列表
	FaceSet []*Face `json:"FaceSet,omitnil" name:"FaceSet"`
...
type DescribePersonsResponseParams struct {
	// 人员列表
	PersonSet []*Person `json:"PersonSet,omitnil" name:"PersonSet"`
...
type DescribeVocabLibResponseParams struct {
	// 返回该appid下的所有词汇库名
	VocabLibNameSet []*string `json:"VocabLibNameSet,omitnil" name:"VocabLibNameSet"`
...
type DescribeVocabResponseParams struct {
	// 词汇列表
	VocabNameSet []*string `json:"VocabNameSet,omitnil" name:"VocabNameSet"`
...
type DetailInfo struct {
	...
	Value []*WordTimePair `json:"Value,omitnil" name:"Value"`
...
type DoubleVideoFunction struct {
	// 片头片尾增加图片开关
	EnableCoverPictures *bool `json:"EnableCoverPictures,omitnil" name:"EnableCoverPictures"`
}
...
type ExpressRatioStatistic struct {
	...
	// 表情
	Express *string `json:"Express,omitnil" name:"Express"`

	// 该表情时长占所有表情时长的比例
	Ratio *float64 `json:"Ratio,omitnil" name:"Ratio"`

	// 该表情时长占视频总时长的比例
	RatioUseDuration *float64 `json:"RatioUseDuration,omitnil" name:"RatioUseDuration"`
}
...
type Face struct {
	...
	// 人脸图片 URL
	FaceUrl *string `json:"FaceUrl,omitnil" name:"FaceUrl"`
...
type FaceDetectStatistic struct {
	// 人脸大小占画面平均占比
	FaceSizeRatio *float64 `json:"FaceSizeRatio,omitnil" name:"FaceSizeRatio"`

	// 检测到正脸次数
	FrontalFaceCount *int64 `json:"FrontalFaceCount,omitnil" name:"FrontalFaceCount"`

	// 正脸时长占比
	FrontalFaceRatio *float64 `json:"FrontalFaceRatio,omitnil" name:"FrontalFaceRatio"`

	// 正脸时长在总出现时常占比
	FrontalFaceRealRatio *float64 `json:"FrontalFaceRealRatio,omitnil" name:"FrontalFaceRealRatio"`

	// 人员唯一标识符
	PersonId *string `json:"PersonId,omitnil" name:"PersonId"`

	// 检测到侧脸次数
	SideFaceCount *int64 `json:"SideFaceCount,omitnil" name:"SideFaceCount"`

	// 侧脸时长占比
	SideFaceRatio *float64 `json:"SideFaceRatio,omitnil" name:"SideFaceRatio"`

	// 侧脸时长在总出现时常占比
	SideFaceRealRatio *float64 `json:"SideFaceRealRatio,omitnil" name:"SideFaceRealRatio"`
}
...
type FaceExpressStatistic struct {
	...
	// 表情统计结果
	ExpressRatio []*ExpressRatioStatistic `json:"ExpressRatio,omitnil" name:"ExpressRatio"`
}
...
type FaceInfoResult struct {
	// 人脸尺寸的占比
	FaceRatio *float64 `json:"FaceRatio,omitnil" name:"FaceRatio"`
...
type FacePoseResult struct {
	...
	// 围绕Z轴旋转角度，俯仰角
	Pitch *float64 `json:"Pitch,omitnil" name:"Pitch"`

	// 围绕X轴旋转角度，翻滚角
	Roll *float64 `json:"Roll,omitnil" name:"Roll"`

	// 围绕Y轴旋转角度，偏航角
	Yaw *float64 `json:"Yaw,omitnil" name:"Yaw"`
}
...
type FrameInfo struct {
	...
	// 截图的存储地址
	SnapshotUrl *string `json:"SnapshotUrl,omitnil" name:"SnapshotUrl"`

	// 相对于视频起始时间的时间戳，单位秒
	Ts *int64 `json:"Ts,omitnil" name:"Ts"`
}

type Function struct {
	// 输出全部文本标识，当该值设置为true时，会输出当前音频的全部文本
	EnableAllText *bool `json:"EnableAllText,omitnil" name:"EnableAllText"`

	// 输出关键词信息标识，当该值设置为true时，会输出当前音频的关键词信息。
	EnableKeyword *bool `json:"EnableKeyword,omitnil" name:"EnableKeyword"`

	// 静音检测标识，当设置为 true 时，需要设置静音时间阈值字段mute_threshold，统计结果中会返回静音片段。
	EnableMuteDetect *bool `json:"EnableMuteDetect,omitnil" name:"EnableMuteDetect"`

	// 输出音频统计信息标识，当设置为 true 时，任务查询结果会输出音频的统计信息（AsrStat）
	EnableVadInfo *bool `json:"EnableVadInfo,omitnil" name:"EnableVadInfo"`

	// 输出音频音量信息标识，当设置为 true 时，会输出当前音频音量信息。
	EnableVolume *bool `json:"EnableVolume,omitnil" name:"EnableVolume"`
}
...
type HLFunction struct {
	// 是否开启人脸检测
	EnableFaceDetect *bool `json:"EnableFaceDetect,omitnil" name:"EnableFaceDetect"`

	// 是否开启表情识别
	EnableFaceExpression *bool `json:"EnableFaceExpression,omitnil" name:"EnableFaceExpression"`

	// 是否开启人脸检索
	EnableFaceIdent *bool `json:"EnableFaceIdent,omitnil" name:"EnableFaceIdent"`

	// 是否开启视频集锦-老师关键字识别
	EnableKeywordWonderfulTime *bool `json:"EnableKeywordWonderfulTime,omitnil" name:"EnableKeywordWonderfulTime"`

	// 是否开启视频集锦-微笑识别
	EnableSmileWonderfulTime *bool `json:"EnableSmileWonderfulTime,omitnil" name:"EnableSmileWonderfulTime"`
}
...
type HighlightsInfomation struct {
	// 专注的起始与终止时间信息。
	Concentration []*TimeType `json:"Concentration,omitnil" name:"Concentration"`

	// 微笑的起始与终止时间信息。
	Smile []*TimeType `json:"Smile,omitnil" name:"Smile"`

	// 高光集锦视频地址，保存剪辑好的视频地址。
	HighlightsUrl *string `json:"HighlightsUrl,omitnil" name:"HighlightsUrl"`
...
type ImageTaskFunction struct {
	// 大教室场景学生肢体动作识别选项
	EnableActionClass *bool `json:"EnableActionClass,omitnil" name:"EnableActionClass"`
	...
	EnableFaceIdentify *bool `json:"EnableFaceIdentify,omitnil" name:"EnableFaceIdentify"`

	// 手势选项
	EnableGesture *bool `json:"EnableGesture,omitnil" name:"EnableGesture"`

	// 优图手势选项（该功能尚未支持）
	EnableHandTracking *bool `json:"EnableHandTracking,omitnil" name:"EnableHandTracking"`

	// 光照选项
	EnableLightJudge *bool `json:"EnableLightJudge,omitnil" name:"EnableLightJudge"`

	// 小班课场景学生肢体动作识别选项
	EnableStudentBodyMovements *bool `json:"EnableStudentBodyMovements,omitnil" name:"EnableStudentBodyMovements"`

	// 教师动作选项（该功能尚未支持）
	EnableTeacherBodyMovements *bool `json:"EnableTeacherBodyMovements,omitnil" name:"EnableTeacherBodyMovements"`

	// 判断老师是否在屏幕中（该功能尚未支持）
	EnableTeacherOutScreen *bool `json:"EnableTeacherOutScreen,omitnil" name:"EnableTeacherOutScreen"`
}

type ImageTaskResult struct {
	// 大教室场景学生肢体动作识别信息
	ActionInfo *ActionInfo `json:"ActionInfo,omitnil" name:"ActionInfo"`

	// 属性识别结果
	FaceAttr *FaceAttrResult `json:"FaceAttr,omitnil" name:"FaceAttr"`

	// 表情识别结果
	FaceExpression *FaceExpressionResult `json:"FaceExpression,omitnil" name:"FaceExpression"`

	// 人脸检索结果
	FaceIdentify *FaceIdentifyResult `json:"FaceIdentify,omitnil" name:"FaceIdentify"`

	// 人脸检测结果
	FaceInfo *FaceInfoResult `json:"FaceInfo,omitnil" name:"FaceInfo"`

	// 姿势识别结果
	FacePose *FacePoseResult `json:"FacePose,omitnil" name:"FacePose"`

	// 动作分类结果
	Gesture *GestureResult `json:"Gesture,omitnil" name:"Gesture"`

	// 手势分类结果
	HandTracking *HandTrackingResult `json:"HandTracking,omitnil" name:"HandTracking"`

	// 光照识别结果
	Light *LightResult `json:"Light,omitnil" name:"Light"`

	// 学生肢体动作识别结果
	StudentBodyMovement *StudentBodyMovementResult `json:"StudentBodyMovement,omitnil" name:"StudentBodyMovement"`

	// 老师肢体动作识别结果
	TeacherBodyMovement *BodyMovementResult `json:"TeacherBodyMovement,omitnil" name:"TeacherBodyMovement"`

	// 教师是否在屏幕内判断结果
	TeacherOutScreen *TeacherOutScreenResult `json:"TeacherOutScreen,omitnil" name:"TeacherOutScreen"`

	// 时间统计结果
	TimeInfo *TimeInfoResult `json:"TimeInfo,omitnil" name:"TimeInfo"`
}

type ImageTaskStatistic struct {
	// 人员检测统计信息
	FaceDetect []*FaceDetectStatistic `json:"FaceDetect,omitnil" name:"FaceDetect"`

	// 人脸表情统计信息
	FaceExpression []*FaceExpressStatistic `json:"FaceExpression,omitnil" name:"FaceExpression"`

	// 人脸检索统计信息
	FaceIdentify []*FaceIdentifyStatistic `json:"FaceIdentify,omitnil" name:"FaceIdentify"`

	// 姿势识别统计信息
	Gesture *ActionStatistic `json:"Gesture,omitnil" name:"Gesture"`

	// 手势识别统计信息
	Handtracking *ActionStatistic `json:"Handtracking,omitnil" name:"Handtracking"`

	// 光照统计信息
	Light *LightStatistic `json:"Light,omitnil" name:"Light"`

	// 学生动作统计信息
	StudentMovement *ActionStatistic `json:"StudentMovement,omitnil" name:"StudentMovement"`

	// 教师动作统计信息
	TeacherMovement *ActionStatistic `json:"TeacherMovement,omitnil" name:"TeacherMovement"`
}
...
type Library struct {
	...
	// 人员库人员数量
	PersonCount *int64 `json:"PersonCount,omitnil" name:"PersonCount"`
...
type LightResult struct {
	...
	LightLevel *string `json:"LightLevel,omitnil" name:"LightLevel"`

	// 光照亮度
	LightValue *float64 `json:"LightValue,omitnil" name:"LightValue"`
}
...
type LightStandard struct {
	...
	// 范围
	Range []*float64 `json:"Range,omitnil" name:"Range"`
}

type LightStatistic struct {
	// 各个时间点的光线值
	LightDistribution []*LightDistributionStatistic `json:"LightDistribution,omitnil" name:"LightDistribution"`

	// 光照程度比例统计结果
	LightLevelRatio []*LightLevelRatioStatistic `json:"LightLevelRatio,omitnil" name:"LightLevelRatio"`
}
...
type MuteSlice struct {
	// 起始时间。
	MuteBtm *int64 `json:"MuteBtm,omitnil" name:"MuteBtm"`

	// 终止时间。
	MuteEtm *int64 `json:"MuteEtm,omitnil" name:"MuteEtm"`
}
...
type PersonInfo struct {
	...
	// 视频集锦开始封面照片。
	CoverBeginUrl *string `json:"CoverBeginUrl,omitnil" name:"CoverBeginUrl"`

	// 视频集锦结束封面照片。
	CoverEndUrl *string `json:"CoverEndUrl,omitnil" name:"CoverEndUrl"`
}
...
type StudentBodyMovementResult struct {
	...
	// 举手识别结果置信度
	HandupConfidence *float64 `json:"HandupConfidence,omitnil" name:"HandupConfidence"`

	// 举手识别结果，包含举手（handup）和未举手（nothandup）
	HandupStatus *string `json:"HandupStatus,omitnil" name:"HandupStatus"`
	...
	// 站立识别结果置信度
	StandConfidence *float64 `json:"StandConfidence,omitnil" name:"StandConfidence"`

	// 站立识别结果，包含站立（stand）和坐着（sit）
	StandStatus *string `json:"StandStatus,omitnil" name:"StandStatus"`
...
type SubmitAudioTaskRequestParams struct {
	...
	MuteThreshold *int64 `json:"MuteThreshold,omitnil" name:"MuteThreshold"`
...
type SubmitCheckAttendanceTaskPlusRequestParams struct {
	...
	// 确定出勤阈值；默认为0.92
	AttendanceThreshold *float64 `json:"AttendanceThreshold,omitnil" name:"AttendanceThreshold"`

	// 是否开启陌生人模式，陌生人模式是指在任务中发现的非注册人脸库中的人脸也返回相关统计信息，默认不开启
	EnableStranger *bool `json:"EnableStranger,omitnil" name:"EnableStranger"`
	...
	NoticeUrl *string `json:"NoticeUrl,omitnil" name:"NoticeUrl"`
...
type SubmitCheckAttendanceTaskPlusResponseParams struct {
	...
	// 没有注册的人的ID列表
	NotRegisteredSet *string `json:"NotRegisteredSet,omitnil" name:"NotRegisteredSet"`
...
type SubmitConversationTaskRequestParams struct {
	...
	// 学生音频流
	StudentUrl *string `json:"StudentUrl,omitnil" name:"StudentUrl"`
...
type SubmitDoubleVideoHighlightsRequestParams struct {
	...
	LibIds []*string `json:"LibIds,omitnil" name:"LibIds"`

	// 详细功能开关配置项
	Functions *DoubleVideoFunction `json:"Functions,omitnil" name:"Functions"`

	// 需要匹配的人员信息列表。
	PersonInfoList []*PersonInfo `json:"PersonInfoList,omitnil" name:"PersonInfoList"`

	// 视频处理的抽帧间隔，单位毫秒。建议留空。
	FrameInterval *int64 `json:"FrameInterval,omitnil" name:"FrameInterval"`

	// 旧版本需要匹配的人员信息列表。
	PersonIds []*string `json:"PersonIds,omitnil" name:"PersonIds"`

	// 人脸检索的相似度阈值，默认值0.89。建议留空。
	SimThreshold *float64 `json:"SimThreshold,omitnil" name:"SimThreshold"`

	// 老师视频url
	TeacherFileContent *string `json:"TeacherFileContent,omitnil" name:"TeacherFileContent"`
}
...
type SubmitDoubleVideoHighlightsResponseParams struct {
	...
	NotRegistered []*string `json:"NotRegistered,omitnil" name:"NotRegistered"`
...
type SubmitHighlightsRequestParams struct {
	// 表情配置开关项。
	Functions *HLFunction `json:"Functions,omitnil" name:"Functions"`
	...
	// 关键词语言类型，0为英文，1为中文。
	KeywordsLanguage *int64 `json:"KeywordsLanguage,omitnil" name:"KeywordsLanguage"`

	// 关键词数组，当且仅当Funtions中的EnableKeywordWonderfulTime为true时有意义，匹配相应的关键字。
	KeywordsStrings []*string `json:"KeywordsStrings,omitnil" name:"KeywordsStrings"`
...
type SubmitImageTaskPlusRequestParams struct {
	...
	// 任务控制选项
	Functions *ImageTaskFunction `json:"Functions,omitnil" name:"Functions"`

	// 光照标准列表
	LightStandardSet []*LightStandard `json:"LightStandardSet,omitnil" name:"LightStandardSet"`
...
type SubmitImageTaskRequestParams struct {
	...
	// 结果更新回调地址。
	EventsCallBack *string `json:"EventsCallBack,omitnil" name:"EventsCallBack"`
...
type SuspectedInfo struct {
	// TopN匹配信息列表
	FaceSet []*FrameInfo `json:"FaceSet,omitnil" name:"FaceSet"`
...
type TextItem struct {
	// 当前句子包含的所有单词信息
	Words []*Word `json:"Words,omitnil" name:"Words"`

	// 当前句子的置信度
	Confidence *float64 `json:"Confidence,omitnil" name:"Confidence"`

	// 当前句子语音的起始时间点，单位为ms
	Mbtm *int64 `json:"Mbtm,omitnil" name:"Mbtm"`

	// 当前句子语音的终止时间点，单位为ms
	Metm *int64 `json:"Metm,omitnil" name:"Metm"`
	...
	// 当前句子的字节数
	TextSize *int64 `json:"TextSize,omitnil" name:"TextSize"`
}
...
type TransmitAudioStreamRequestParams struct {
	...
	SeqId *int64 `json:"SeqId,omitnil" name:"SeqId"`
	...
	UserVoiceData *string `json:"UserVoiceData,omitnil" name:"UserVoiceData"`
...
type VocabDetailInfomation struct {
	...
	VocabDetailInfo []*DetailInfo `json:"VocabDetailInfo,omitnil" name:"VocabDetailInfo"`
...
type VocabStatInfomation struct {
	// 单词出现在该音频中总次数
	VocabDetailInfo []*StatInfo `json:"VocabDetailInfo,omitnil" name:"VocabDetailInfo"`
...
type WholeTextItem struct {
	// 当前句子的信息
	TextItem *TextItem `json:"TextItem,omitnil" name:"TextItem"`
...
type Word struct {
	...
	// 当前词的字节数
	Wsize *int64 `json:"Wsize,omitnil" name:"Wsize"`
}
