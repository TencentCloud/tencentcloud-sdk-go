...
func (c *Client) CreateDedicatedClusterImageCacheWithContext(ctx context.Context, request *CreateDedicatedClusterImageCacheRequest) (response *CreateDedicatedClusterImageCacheResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "cdc", APIVersion, "CreateDedicatedClusterImageCache")
...
func (c *Client) DeleteDedicatedClusterImageCacheWithContext(ctx context.Context, request *DeleteDedicatedClusterImageCacheRequest) (response *DeleteDedicatedClusterImageCacheResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "cdc", APIVersion, "DeleteDedicatedClusterImageCache")
...
func (c *Client) DescribeDedicatedClusterCbsStatisticsWithContext(ctx context.Context, request *DescribeDedicatedClusterCbsStatisticsRequest) (response *DescribeDedicatedClusterCbsStatisticsResponse, err error) {
    ...
    c.InitBaseRequest(&request.BaseRequest, "cdc", APIVersion, "DescribeDedicatedClusterCbsStatistics")
