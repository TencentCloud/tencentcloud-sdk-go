...
type ScanFileHashRequestParams struct {
	...
	Md5s *string `json:"Md5s,omitnil,omitempty" name:"Md5s"`

	// 保留字段默认填0
	WithCategory *string `json:"WithCategory,omitnil,omitempty" name:"WithCategory"`

	// 松严规则控制字段默认填10（5-松、10-标准、15-严）
	SensitiveLevel *string `json:"SensitiveLevel,omitnil,omitempty" name:"SensitiveLevel"`
}
