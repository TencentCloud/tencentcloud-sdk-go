...
type ScanFileHashRequestParams struct {
	...
	Md5s *string `json:"Md5s,omitnil" name:"Md5s"`

	// 保留字段默认填0
	WithCategory *string `json:"WithCategory,omitnil" name:"WithCategory"`

	// 松严规则控制字段默认填10（5-松、10-标准、15-严）
	SensitiveLevel *string `json:"SensitiveLevel,omitnil" name:"SensitiveLevel"`
}
...
type ScanFileRequestParams struct {
	...
	// 文件下载url地址
	Sample *string `json:"Sample,omitnil" name:"Sample"`
