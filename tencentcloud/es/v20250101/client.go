...
func NewWebSearchRequest() (request *WebSearchRequest) {
    request = &WebSearchRequest{
        BaseRequest: &tchttp.BaseRequest{},
    }
    
    request.Init().WithApiInfo("es", APIVersion, "WebSearch")
    
    
    return
}

func NewWebSearchResponse() (response *WebSearchResponse) {
...
//  INTERNALERROR = "InternalError"
//  INVALIDPARAMETER = "InvalidParameter"
func (c *Client) WebSearch(request *WebSearchRequest) (response *WebSearchResponse, err error) {
    return c.WebSearchWithContext(context.Background(), request)
}
...
//  INTERNALERROR = "InternalError"
//  INVALIDPARAMETER = "InvalidParameter"
func (c *Client) WebSearchWithContext(ctx context.Context, request *WebSearchRequest) (response *WebSearchResponse, err error) {
    if request == nil {
        request = NewWebSearchRequest()
    }
    
    if c.GetCredential() == nil {
        return nil, errors.New("WebSearch require credential")
    }

    request.SetContext(ctx)
    
    response = NewWebSearchResponse()
    err = c.Send(request, response)
    return
}
