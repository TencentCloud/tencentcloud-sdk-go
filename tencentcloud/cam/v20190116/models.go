...
type DescribeMfaCodeStatusRequest struct {
	*tchttp.BaseRequest
	...
	// mfaKey
	Tmpcode *string `json:"Tmpcode,omitempty" name:"Tmpcode"`
...
func (r *DescribeMfaCodeStatusRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *DescribeMfaCodeStatusRequest) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}

type DescribeMfaCodeStatusResponse struct {
	*tchttp.BaseResponse
	Response *struct {
		...
		// 记住设备
	// 注意：此字段可能返回 null，表示取不到有效值。
		RmDevice *uint64 `json:"RmDevice,omitempty" name:"RmDevice"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
		...
		// 是否有OpenId
	// 注意：此字段可能返回 null，表示取不到有效值。
		HasOpenId *uint64 `json:"HasOpenId,omitempty" name:"HasOpenId"`
...
func (r *DescribeMfaCodeStatusResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *DescribeMfaCodeStatusResponse) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}
...
type DetectAuthRequest struct {
	*tchttp.BaseRequest
	...
	// 是否使用用户提交信息
	UseAuthInfo *uint64 `json:"UseAuthInfo,omitempty" name:"UseAuthInfo"`
...
type DetectMaskAuthRequest struct {
	*tchttp.BaseRequest
...
func (r *DetectMaskAuthRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *DetectMaskAuthRequest) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}

type DetectMaskAuthResponse struct {
	*tchttp.BaseResponse
	Response *struct {
...
func (r *DetectMaskAuthResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *DetectMaskAuthResponse) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}
...
func (r *DetectStateRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *DetectStateRequest) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}
...
func (r *DetectStateResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}

func (r *DetectStateResponse) FromJsonString(s string) error {
    return json.Unmarshal([]byte(s), &r)
}
