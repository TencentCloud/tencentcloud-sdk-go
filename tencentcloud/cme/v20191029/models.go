...
type AddTeamMemberRequestParams struct {
	...
	TeamMembers []*AddMemberInfo `json:"TeamMembers,omitnil,omitempty" name:"TeamMembers"`
...
type AudioMaterial struct {
	...
	MaterialStatus *MaterialStatus `json:"MaterialStatus,omitnil,omitempty" name:"MaterialStatus"`

	// 素材媒体文件的原始 URL 地址。
	OriginalUrl *string `json:"OriginalUrl,omitnil,omitempty" name:"OriginalUrl"`

	// 云点播媒资 FileId。
	VodFileId *string `json:"VodFileId,omitnil,omitempty" name:"VodFileId"`
}
...
type AudioStreamInfo struct {
	...
	// 采样率，单位：hz。
	SamplingRate *uint64 `json:"SamplingRate,omitnil,omitempty" name:"SamplingRate"`
...
type AuthorizationInfo struct {
	// 被授权者实体。
	Authorizee *Entity `json:"Authorizee,omitnil,omitempty" name:"Authorizee"`
	...
	// <li>W：可修改、删除媒资。</li>
	PermissionSet []*string `json:"PermissionSet,omitnil,omitempty" name:"PermissionSet"`
}
...
type CMEExportInfo struct {
	// 导出媒体归属，个人或团队。
	Owner *Entity `json:"Owner,omitnil,omitempty" name:"Owner"`
	...
	ThirdPartyPublishInfos []*ThirdPartyPublishInfo `json:"ThirdPartyPublishInfos,omitnil,omitempty" name:"ThirdPartyPublishInfos"`
}
...
type ClassDeletedEvent struct {
	...
	// 删除的分类路径列表。
	ClassPathSet []*string `json:"ClassPathSet,omitnil,omitempty" name:"ClassPathSet"`
}
...
type ClassMovedEvent struct {
	// 源分类归属。
	SourceOwner *Entity `json:"SourceOwner,omitnil,omitempty" name:"SourceOwner"`

	// 源分类路径列表。
	SourceClassPathSet []*string `json:"SourceClassPathSet,omitnil,omitempty" name:"SourceClassPathSet"`

	// 目标分类归属。
	DestinationOwner *Entity `json:"DestinationOwner,omitnil,omitempty" name:"DestinationOwner"`

	// 目标分类归属。
	DestinationClassPath *string `json:"DestinationClassPath,omitnil,omitempty" name:"DestinationClassPath"`
}
...
type CosPublishInputInfo struct {
	...
	VideoKey *string `json:"VideoKey,omitnil,omitempty" name:"VideoKey"`

	// 发布生成的封面在 COS 存储的对象键。
	CoverKey *string `json:"CoverKey,omitnil,omitempty" name:"CoverKey"`
}
...
type CreateLinkRequestParams struct {
	...
	DestinationId *string `json:"DestinationId,omitnil,omitempty" name:"DestinationId"`
...
type CreateProjectRequestParams struct {
	...
	SwitcherProjectInput *SwitcherProjectInput `json:"SwitcherProjectInput,omitnil,omitempty" name:"SwitcherProjectInput"`

	// 直播剪辑项目输入信息，暂未开放，请勿使用。
	LiveStreamClipProjectInput *LiveStreamClipProjectInput `json:"LiveStreamClipProjectInput,omitnil,omitempty" name:"LiveStreamClipProjectInput"`

	// 视频编辑项目输入信息，仅当项目类型为 VIDEO_EDIT 时必填。
	VideoEditProjectInput *VideoEditProjectInput `json:"VideoEditProjectInput,omitnil,omitempty" name:"VideoEditProjectInput"`

	// 视频拆条项目输入信息，仅当项目类型为 VIDEO_SEGMENTATION  时必填。
	VideoSegmentationProjectInput *VideoSegmentationProjectInput `json:"VideoSegmentationProjectInput,omitnil,omitempty" name:"VideoSegmentationProjectInput"`

	// 云转推项目输入信息，仅当项目类型为 STREAM_CONNECT 时必填。
	StreamConnectProjectInput *StreamConnectProjectInput `json:"StreamConnectProjectInput,omitnil,omitempty" name:"StreamConnectProjectInput"`

	// 录制回放项目输入信息，仅当项目类型为 RECORD_REPLAY 时必填。
	RecordReplayProjectInput *RecordReplayProjectInput `json:"RecordReplayProjectInput,omitnil,omitempty" name:"RecordReplayProjectInput"`

	// 媒体转推项目输入信息，仅当项目类型为 MEDIA_CAST 时必填。
	MediaCastProjectInput *MediaCastProjectInput `json:"MediaCastProjectInput,omitnil,omitempty" name:"MediaCastProjectInput"`
}
...
type CreateProjectResponseParams struct {
	...
	RtmpPushInputInfoSet []*RtmpPushInputInfo `json:"RtmpPushInputInfoSet,omitnil,omitempty" name:"RtmpPushInputInfoSet"`
...
type CreateTeamRequestParams struct {
	...
	// 团队所有者的备注，限30个字符。
	OwnerRemark *string `json:"OwnerRemark,omitnil,omitempty" name:"OwnerRemark"`
...
type CreateVideoEncodingPresetRequestParams struct {
	...
	VideoSetting *VideoEncodingPresetVideoSetting `json:"VideoSetting,omitnil,omitempty" name:"VideoSetting"`

	// 编码配置的音频设置。默认值参考VideoEncodingPresetAudioSetting 定义。
	AudioSetting *VideoEncodingPresetAudioSetting `json:"AudioSetting,omitnil,omitempty" name:"AudioSetting"`
}
...
type DescribeAccountsResponseParams struct {
	...
	// 账号信息列表。
	AccountInfoSet []*AccountInfo `json:"AccountInfoSet,omitnil,omitempty" name:"AccountInfoSet"`
...
type DescribeJoinTeamsResponseParams struct {
	...
	// 团队列表。
	TeamSet []*JoinTeamInfo `json:"TeamSet,omitnil,omitempty" name:"TeamSet"`
...
type DescribeLoginStatusResponseParams struct {
	// 用户登录状态列表。
	LoginStatusInfoSet []*LoginStatusInfo `json:"LoginStatusInfoSet,omitnil,omitempty" name:"LoginStatusInfoSet"`
...
type DescribeMaterialsRequestParams struct {
	...
	MaterialIds []*string `json:"MaterialIds,omitnil,omitempty" name:"MaterialIds"`
...
type DescribeMaterialsResponseParams struct {
	// 媒体列表信息。
	MaterialInfoSet []*MaterialInfo `json:"MaterialInfoSet,omitnil,omitempty" name:"MaterialInfoSet"`
...
type DescribePlatformsRequestParams struct {
	...
	Platforms []*string `json:"Platforms,omitnil,omitempty" name:"Platforms"`
...
type DescribePlatformsResponseParams struct {
	...
	// 平台信息列表。
	PlatformInfoSet []*PlatformInfo `json:"PlatformInfoSet,omitnil,omitempty" name:"PlatformInfoSet"`
...
type DescribeProjectsRequestParams struct {
	...
	AspectRatioSet []*string `json:"AspectRatioSet,omitnil,omitempty" name:"AspectRatioSet"`
...
type DescribeProjectsResponseParams struct {
	...
	// 项目信息列表。
	ProjectInfoSet []*ProjectInfo `json:"ProjectInfoSet,omitnil,omitempty" name:"ProjectInfoSet"`
...
type DescribeResourceAuthorizationResponseParams struct {
	...
	// 授权信息列表。
	AuthorizationInfoSet []*AuthorizationInfo `json:"AuthorizationInfoSet,omitnil,omitempty" name:"AuthorizationInfoSet"`
...
type DescribeSharedSpaceResponseParams struct {
	...
	// 各个共享空间对应的授权者信息。
	AuthorizerSet []*Authorizer `json:"AuthorizerSet,omitnil,omitempty" name:"AuthorizerSet"`
...
type DescribeTaskDetailResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoEditProjectOutput *VideoEditProjectOutput `json:"VideoEditProjectOutput,omitnil,omitempty" name:"VideoEditProjectOutput"`
...
type DescribeTasksRequestParams struct {
	...
	// 
	// 注：不填不使用任务类型进行过滤。
	TaskTypeSet []*string `json:"TaskTypeSet,omitnil,omitempty" name:"TaskTypeSet"`
...
type DescribeTasksResponseParams struct {
	...
	// 任务基础信息列表。
	TaskBaseInfoSet []*TaskBaseInfo `json:"TaskBaseInfoSet,omitnil,omitempty" name:"TaskBaseInfoSet"`
...
type DescribeTeamMembersResponseParams struct {
	...
	// 团队成员列表。
	MemberSet []*TeamMemberInfo `json:"MemberSet,omitnil,omitempty" name:"MemberSet"`
...
type DescribeTeamsRequestParams struct {
	...
	TeamIds []*string `json:"TeamIds,omitnil,omitempty" name:"TeamIds"`
...
type DescribeTeamsResponseParams struct {
	...
	// 团队列表。
	TeamSet []*TeamInfo `json:"TeamSet,omitnil,omitempty" name:"TeamSet"`
...
type DescribeVideoEncodingPresetsResponseParams struct {
	...
	// 视频编码配置信息。
	VideoEncodingPresetSet []*VideoEncodingPreset `json:"VideoEncodingPresetSet,omitnil,omitempty" name:"VideoEncodingPresetSet"`
...
type EventContent struct {
	...
	StorageNewFileCreatedEvent *StorageNewFileCreatedEvent `json:"StorageNewFileCreatedEvent,omitnil,omitempty" name:"StorageNewFileCreatedEvent"`

	// 云转推项目状态变更事件。仅当 EventType 为 Project.StreamConnect.StatusChanged 时有效。
	ProjectStreamConnectStatusChangedEvent *ProjectStreamConnectStatusChangedEvent `json:"ProjectStreamConnectStatusChangedEvent,omitnil,omitempty" name:"ProjectStreamConnectStatusChangedEvent"`

	// 导播台项目状态变更事件。仅当 EventType 为 Project.Switcher.StatusChanged 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProjectSwitcherStatusChangedEvent *ProjectSwitcherStatusChangedEvent `json:"ProjectSwitcherStatusChangedEvent,omitnil,omitempty" name:"ProjectSwitcherStatusChangedEvent"`

	// 媒体导入事件。仅当 EventType 为 Material.Imported 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialImportedEvent *MaterialImportedEvent `json:"MaterialImportedEvent,omitnil,omitempty" name:"MaterialImportedEvent"`

	// 媒体添加事件。仅当 EventType 为 Material.Added 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialAddedEvent *MaterialAddedEvent `json:"MaterialAddedEvent,omitnil,omitempty" name:"MaterialAddedEvent"`

	// 媒体移动事件。仅当 EventType 为 Material.Moved 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialMovedEvent *MaterialMovedEvent `json:"MaterialMovedEvent,omitnil,omitempty" name:"MaterialMovedEvent"`

	// 媒体更新事件。仅当 EventType 为 Material.Modified 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialModifiedEvent *MaterialModifiedEvent `json:"MaterialModifiedEvent,omitnil,omitempty" name:"MaterialModifiedEvent"`

	// 媒体删除事件。仅当 EventType 为 Material.Deleted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialDeletedEvent *MaterialDeletedEvent `json:"MaterialDeletedEvent,omitnil,omitempty" name:"MaterialDeletedEvent"`

	// 分类创建事件。仅当 EventType 为 Class.Created 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassCreatedEvent *ClassCreatedEvent `json:"ClassCreatedEvent,omitnil,omitempty" name:"ClassCreatedEvent"`

	// 分类移动事件。仅当 EventType 为 Class.Moved 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassMovedEvent *ClassMovedEvent `json:"ClassMovedEvent,omitnil,omitempty" name:"ClassMovedEvent"`

	// 分类删除事件。仅当 EventType 为 Class.Deleted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassDeletedEvent *ClassDeletedEvent `json:"ClassDeletedEvent,omitnil,omitempty" name:"ClassDeletedEvent"`

	// 视频导出完成事件。仅当 EventType 为 Task.VideoExportCompleted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoExportCompletedEvent *VideoExportCompletedEvent `json:"VideoExportCompletedEvent,omitnil,omitempty" name:"VideoExportCompletedEvent"`

	// 点播转直播项目状态变更事件。仅当 EventType 为 Project.MediaCast.StatusChanged 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProjectMediaCastStatusChangedEvent *ProjectMediaCastStatusChangedEvent `json:"ProjectMediaCastStatusChangedEvent,omitnil,omitempty" name:"ProjectMediaCastStatusChangedEvent"`
}
...
type ExportVideoByEditorTrackDataRequestParams struct {
	...
	ExportDestination *string `json:"ExportDestination,omitnil,omitempty" name:"ExportDestination"`
	...
	TrackData *string `json:"TrackData,omitnil,omitempty" name:"TrackData"`
	...
	CMEExportInfo *CMEExportInfo `json:"CMEExportInfo,omitnil,omitempty" name:"CMEExportInfo"`

	// 导出的云点播媒资信息。当导出目标为 VOD 时必填。
	VODExportInfo *VODExportInfo `json:"VODExportInfo,omitnil,omitempty" name:"VODExportInfo"`

	// 视频导出扩展参数。可以覆盖导出模板中的参数，灵活的指定导出规格及参数。
	ExportExtensionArgs *VideoExportExtensionArgs `json:"ExportExtensionArgs,omitnil,omitempty" name:"ExportExtensionArgs"`
...
type ExportVideoByTemplateRequestParams struct {
	...
	// 需要替换的素材信息。
	SlotReplacements []*SlotReplacementInfo `json:"SlotReplacements,omitnil,omitempty" name:"SlotReplacements"`
...
type ExportVideoByVideoSegmentationDataRequestParams struct {
	...
	// 指定需要导出的智能拆条片段的组 Id 。
	SegmentGroupId *string `json:"SegmentGroupId,omitnil,omitempty" name:"SegmentGroupId"`

	// 指定需要导出的智能拆条片段 Id  集合。
	SegmentIds []*string `json:"SegmentIds,omitnil,omitempty" name:"SegmentIds"`
...
// Predefined struct for user
type ForbidAccountRequestParams struct {
	// <p>平台 Id，指定访问的平台。关于平台概念，请参见文档 <a href="https://cloud.tencent.com/document/product/1156/43767">平台</a>。</p>
	Platform *string `json:"Platform,omitnil,omitempty" name:"Platform"`
...
type ForbidAccountRequest struct {
	*tchttp.BaseRequest
...
func (r *ForbidAccountRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ForbidAccountRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Operator")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ForbidAccountRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ForbidAccountResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ForbidAccountResponse struct {
	*tchttp.BaseResponse
	Response *ForbidAccountResponseParams `json:"Response"`
}

func (r *ForbidAccountResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ForbidAccountResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type GrantResourceAuthorizationRequestParams struct {
	...
	// 被授权目标，个人或者团队。
	Authorizees []*Entity `json:"Authorizees,omitnil,omitempty" name:"Authorizees"`
...
type HandleMediaCastProjectRequestParams struct {
	...
	SourceInfos []*MediaCastSourceInfo `json:"SourceInfos,omitnil,omitempty" name:"SourceInfos"`
	...
	PlaySetting *MediaCastPlaySetting `json:"PlaySetting,omitnil,omitempty" name:"PlaySetting"`
...
type HandleMediaCastProjectResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	PlayInfo *MediaCastPlayInfo `json:"PlayInfo,omitnil,omitempty" name:"PlayInfo"`

	// 输入源信息， Operation 为 AddSource 时返回添加成功的输入源信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SourceInfoSet []*MediaCastSourceInfo `json:"SourceInfoSet,omitnil,omitempty" name:"SourceInfoSet"`

	// 输出源信息， Operation 为 AddDestination 时返回添加成功的输出源信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	DestinationInfoSet []*MediaCastDestinationInfo `json:"DestinationInfoSet,omitnil,omitempty" name:"DestinationInfoSet"`
...
type HandleStreamConnectProjectRequestParams struct {
	...
	InputInfo *StreamInputInfo `json:"InputInfo,omitnil,omitempty" name:"InputInfo"`

	// 主备输入源标识，取值有：
	// <li> Main ：主源；</li>
	// <li> Backup ：备源。</li>
	InputEndpoint *string `json:"InputEndpoint,omitnil,omitempty" name:"InputEndpoint"`

	// 转推输出源操作参数。具体操作方式详见 [操作类型](#Operation) 及下文示例。
	OutputInfo *StreamConnectOutput `json:"OutputInfo,omitnil,omitempty" name:"OutputInfo"`

	// 云转推当前预计结束时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。具体操作方式详见 [操作类型](#Operation) 及下文示例。
	CurrentStopTime *string `json:"CurrentStopTime,omitnil,omitempty" name:"CurrentStopTime"`
...
type HandleStreamConnectProjectResponseParams struct {
	...
	StreamInputRtmpPushUrl *string `json:"StreamInputRtmpPushUrl,omitnil,omitempty" name:"StreamInputRtmpPushUrl"`

	// 点播输入源播放进度信息，当 Operation 取值 DescribeInputPlayInfo 且 InputType 为 VodPull 类型时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VodPullInputPlayInfo *VodPullInputPlayInfo `json:"VodPullInputPlayInfo,omitnil,omitempty" name:"VodPullInputPlayInfo"`
...
type ImportMaterialRequestParams struct {
	...
	ExternalMediaInfo *ExternalMediaInfo `json:"ExternalMediaInfo,omitnil,omitempty" name:"ExternalMediaInfo"`
	...
	// 媒体预处理任务参数 ID。可取值有：
	// <li>10：进行编辑预处理。</li>
	PreProcessDefinition *int64 `json:"PreProcessDefinition,omitnil,omitempty" name:"PreProcessDefinition"`
...
type ImportMaterialResponseParams struct {
	...
	PreProcessTaskId *string `json:"PreProcessTaskId,omitnil,omitempty" name:"PreProcessTaskId"`
...
type IntegerRange struct {
	// 按整形代表值的下限检索。
	LowerBound *int64 `json:"LowerBound,omitnil,omitempty" name:"LowerBound"`

	// 按整形代表值的上限检索。
	UpperBound *int64 `json:"UpperBound,omitnil,omitempty" name:"UpperBound"`
}
...
type LinkMaterial struct {
	...
	LinkStatus *string `json:"LinkStatus,omitnil,omitempty" name:"LinkStatus"`

	// 素材链接详细信息，当LinkType="MATERIAL"时有值。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LinkMaterialInfo *LinkMaterialInfo `json:"LinkMaterialInfo,omitnil,omitempty" name:"LinkMaterialInfo"`

	// 分类链接目标信息，当LinkType=“CLASS”时有值。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LinkClassInfo *ClassInfo `json:"LinkClassInfo,omitnil,omitempty" name:"LinkClassInfo"`
}

type LinkMaterialInfo struct {
	// 素材基本信息。
	BasicInfo *MaterialBasicInfo `json:"BasicInfo,omitnil,omitempty" name:"BasicInfo"`

	// 视频素材信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoMaterial *VideoMaterial `json:"VideoMaterial,omitnil,omitempty" name:"VideoMaterial"`

	// 音频素材信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AudioMaterial *AudioMaterial `json:"AudioMaterial,omitnil,omitempty" name:"AudioMaterial"`

	// 图片素材信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ImageMaterial *ImageMaterial `json:"ImageMaterial,omitnil,omitempty" name:"ImageMaterial"`
}
...
type ListMediaResponseParams struct {
	// 符合条件的媒体记录总数。
	MaterialTotalCount *int64 `json:"MaterialTotalCount,omitnil,omitempty" name:"MaterialTotalCount"`
...
type LiveStreamClipProjectInput struct {
	...
	StreamRecordDuration *uint64 `json:"StreamRecordDuration,omitnil,omitempty" name:"StreamRecordDuration"`
}
...
type MaterialAddedEvent struct {
	// 添加的媒体 Id 列表。
	MaterialIdSet []*string `json:"MaterialIdSet,omitnil,omitempty" name:"MaterialIdSet"`
...
type MaterialBasicInfo struct {
	...
	// 预置标签列表。
	PresetTagSet []*PresetTagInfo `json:"PresetTagSet,omitnil,omitempty" name:"PresetTagSet"`
...
type MaterialImportedEvent struct {
	// 导入的媒体信息列表。
	MediaInfoSet []*ImportMediaInfo `json:"MediaInfoSet,omitnil,omitempty" name:"MediaInfoSet"`
...
type MaterialInfo struct {
	...
	// 链接媒体信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LinkMaterial *LinkMaterial `json:"LinkMaterial,omitnil,omitempty" name:"LinkMaterial"`

	// 模板媒体信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoEditTemplateMaterial *VideoEditTemplateMaterial `json:"VideoEditTemplateMaterial,omitnil,omitempty" name:"VideoEditTemplateMaterial"`

	// 其他类型媒体信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OtherMaterial *OtherMaterial `json:"OtherMaterial,omitnil,omitempty" name:"OtherMaterial"`
}
...
type MaterialModifiedEvent struct {
	...
	PresetTagIdSet []*string `json:"PresetTagIdSet,omitnil,omitempty" name:"PresetTagIdSet"`
...
type MaterialMovedEvent struct {
	...
	// 源媒体分类路径。
	SourceClassPath *string `json:"SourceClassPath,omitnil,omitempty" name:"SourceClassPath"`
...
type MaterialStatus struct {
	...
	EditorUsableStatus *string `json:"EditorUsableStatus,omitnil,omitempty" name:"EditorUsableStatus"`
}
...
type MediaCastDestinationInterruptInfo struct {
	// 发生断流的输出源信息。
	DestinationInfo *MediaCastDestinationInfo `json:"DestinationInfo,omitnil,omitempty" name:"DestinationInfo"`
...
type MediaCastOutputMediaSetting struct {
	// 视频配置。
	VideoSetting *MediaCastVideoSetting `json:"VideoSetting,omitnil,omitempty" name:"VideoSetting"`

	// 视频配置是否和第一个输入源的视频配置相同，默认值：false。如果 FollowSourceInfo 的值为 true，忽略 VideoSetting 参数。
	FollowSourceInfo *bool `json:"FollowSourceInfo,omitnil,omitempty" name:"FollowSourceInfo"`
}
...
type MediaCastPlayInfo struct {
	...
	// 当前播放的输入源 Id。
	CurrentSourceId *string `json:"CurrentSourceId,omitnil,omitempty" name:"CurrentSourceId"`

	// 当前播放的输入源的播放位置，单位：秒。
	CurrentSourcePosition *float64 `json:"CurrentSourcePosition,omitnil,omitempty" name:"CurrentSourcePosition"`

	// 当前播放的输入源时长，单位：秒。
	CurrentSourceDuration *float64 `json:"CurrentSourceDuration,omitnil,omitempty" name:"CurrentSourceDuration"`

	// 输出源状态信息。
	DestinationStatusSet []*MediaCastDestinationStatus `json:"DestinationStatusSet,omitnil,omitempty" name:"DestinationStatusSet"`

	// 已经循环播放的次数。
	LoopCount *int64 `json:"LoopCount,omitnil,omitempty" name:"LoopCount"`
}
...
type MediaCastPlaySetting struct {
	...
	AutoStartTime *string `json:"AutoStartTime,omitnil,omitempty" name:"AutoStartTime"`
}
...
type MediaCastSourceInfo struct {
	...
	Offset *float64 `json:"Offset,omitnil,omitempty" name:"Offset"`
...
type MediaCastSourceInterruptInfo struct {
	// 发生断流的输入源信息。
	SourceInfo *MediaCastSourceInfo `json:"SourceInfo,omitnil,omitempty" name:"SourceInfo"`
...
type MediaReplacementInfo struct {
	...
	// 预处理操作。
	// 注：目前该功能暂不支持，请勿使用。
	PreprocessOperation *MediaPreprocessOperation `json:"PreprocessOperation,omitnil,omitempty" name:"PreprocessOperation"`
	...
	MuteSwitch *string `json:"MuteSwitch,omitnil,omitempty" name:"MuteSwitch"`
}
...
type MediaTransitionItem struct {
	// 转场 Id 。暂只支持一个转场。
	TransitionId *string `json:"TransitionId,omitnil,omitempty" name:"TransitionId"`
...
type ModifyVideoEncodingPresetRequestParams struct {
	...
	// 更改后的编码配置的视频设置。
	VideoSetting *VideoEncodingPresetVideoSettingForUpdate `json:"VideoSetting,omitnil,omitempty" name:"VideoSetting"`

	// 更改后的编码配置的音频设置。
	AudioSetting *VideoEncodingPresetAudioSettingForUpdate `json:"AudioSetting,omitnil,omitempty" name:"AudioSetting"`
}
...
type MoveResourceRequestParams struct {
	...
	SourceResource *ResourceInfo `json:"SourceResource,omitnil,omitempty" name:"SourceResource"`

	// 目标信息，包含分类及归属，仅支持移动资源到分类。
	DestinationResource *ResourceInfo `json:"DestinationResource,omitnil,omitempty" name:"DestinationResource"`
...
type ParseEventResponseParams struct {
	// 事件内容。
	EventContent *EventContent `json:"EventContent,omitnil,omitempty" name:"EventContent"`
...
type PlatformInfo struct {
	...
	// 云点播子应用 Id。
	VodSubAppId *uint64 `json:"VodSubAppId,omitnil,omitempty" name:"VodSubAppId"`
...
type PresetTagInfo struct {
	...
	// 父级预设 Id。
	ParentTagId *string `json:"ParentTagId,omitnil,omitempty" name:"ParentTagId"`
}
...
type ProjectInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	StreamConnectProjectInfo *StreamConnectProjectInfo `json:"StreamConnectProjectInfo,omitnil,omitempty" name:"StreamConnectProjectInfo"`

	// 点播转直播项目信息，仅当项目类别取值为 MEDIA_CAST 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MediaCastProjectInfo *MediaCastProjectInfo `json:"MediaCastProjectInfo,omitnil,omitempty" name:"MediaCastProjectInfo"`
...
type ProjectMediaCastStatusChangedEvent struct {
	...
	SourceInterruptInfo *MediaCastSourceInterruptInfo `json:"SourceInterruptInfo,omitnil,omitempty" name:"SourceInterruptInfo"`

	// 点播转直播输出断流信息，仅当 Status 取值 DestinationInterrupted 时有效。
	DestinationInterruptInfo *MediaCastDestinationInterruptInfo `json:"DestinationInterruptInfo,omitnil,omitempty" name:"DestinationInterruptInfo"`
}
...
type ProjectStreamConnectStatusChangedEvent struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	InputInterruptInfo *StreamConnectInputInterruptInfo `json:"InputInterruptInfo,omitnil,omitempty" name:"InputInterruptInfo"`

	// 云转推输出断流信息，仅当 Status 取值 OutputInterrupted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OutputInterruptInfo *StreamConnectOutputInterruptInfo `json:"OutputInterruptInfo,omitnil,omitempty" name:"OutputInterruptInfo"`
}
...
type RecordReplayProjectInput struct {
	// 录制拉流地址。
	PullStreamUrl *string `json:"PullStreamUrl,omitnil,omitempty" name:"PullStreamUrl"`

	// 录制文件归属者。
	MaterialOwner *Entity `json:"MaterialOwner,omitnil,omitempty" name:"MaterialOwner"`

	// 录制文件存储分类路径。
	MaterialClassPath *string `json:"MaterialClassPath,omitnil,omitempty" name:"MaterialClassPath"`
...
type RtmpPushInputInfo struct {
	// 直播推流地址有效期，单位：秒 。
	ExpiredSecond *uint64 `json:"ExpiredSecond,omitnil,omitempty" name:"ExpiredSecond"`
...
type SearchMaterialRequestParams struct {
	...
	// 指定搜索空间，数组长度不得超过5。
	SearchScopes []*SearchScope `json:"SearchScopes,omitnil,omitempty" name:"SearchScopes"`
	...
	MaterialTypes []*string `json:"MaterialTypes,omitnil,omitempty" name:"MaterialTypes"`
	...
	// 按媒体时长检索，单位s。
	DurationRange *IntegerRange `json:"DurationRange,omitnil,omitempty" name:"DurationRange"`

	// 按照媒体创建时间检索。
	CreateTimeRange *TimeRange `json:"CreateTimeRange,omitnil,omitempty" name:"CreateTimeRange"`
...
type SlotInfo struct {
	...
	DefaultMaterialId *string `json:"DefaultMaterialId,omitnil,omitempty" name:"DefaultMaterialId"`

	// 默认文本卡槽信息。当卡槽类型为 TEXT 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	DefaultTextSlotInfo *TextSlotInfo `json:"DefaultTextSlotInfo,omitnil,omitempty" name:"DefaultTextSlotInfo"`
...
type SlotReplacementInfo struct {
	...
	ReplacementType *string `json:"ReplacementType,omitnil,omitempty" name:"ReplacementType"`

	// 媒体替换信息，仅当要替换的媒体类型为音频、视频、图片时有效。
	MediaReplacementInfo *MediaReplacementInfo `json:"MediaReplacementInfo,omitnil,omitempty" name:"MediaReplacementInfo"`

	// 文本替换信息，仅当要替换的卡槽类型为文本时有效。
	TextReplacementInfo *TextReplacementInfo `json:"TextReplacementInfo,omitnil,omitempty" name:"TextReplacementInfo"`
}
...
type StreamConnectOutputInfo struct {
	// 输出源。
	// 注意：此字段可能返回 null，表示取不到有效值。
	StreamConnectOutput *StreamConnectOutput `json:"StreamConnectOutput,omitnil,omitempty" name:"StreamConnectOutput"`

	// 输出流状态：
	// <li>On ：开；</li>
	// <li>Off ：关 。</li>
	PushSwitch *string `json:"PushSwitch,omitnil,omitempty" name:"PushSwitch"`
}
...
type StreamConnectProjectInfo struct {
	...
	// <li>Main ：主输入源；</li>
	// <li>Backup ：备输入源。</li>
	CurrentInputEndpoint *string `json:"CurrentInputEndpoint,omitnil,omitempty" name:"CurrentInputEndpoint"`
	...
	LastStopTime *string `json:"LastStopTime,omitnil,omitempty" name:"LastStopTime"`

	// 云转推主输入源。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MainInput *StreamInputInfo `json:"MainInput,omitnil,omitempty" name:"MainInput"`

	// 云转推备输入源。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BackupInput *StreamInputInfo `json:"BackupInput,omitnil,omitempty" name:"BackupInput"`

	// 云转推输出源。
	OutputSet []*StreamConnectOutputInfo `json:"OutputSet,omitnil,omitempty" name:"OutputSet"`
}
...
type StreamConnectProjectInput struct {
	...
	// 云转推输出源信息。
	Outputs []*StreamConnectOutput `json:"Outputs,omitnil,omitempty" name:"Outputs"`
}
...
type StreamInputInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	VodPullInputInfo *VodPullInputInfo `json:"VodPullInputInfo,omitnil,omitempty" name:"VodPullInputInfo"`

	// 直播拉流信息，当 InputType = LivePull  时必填。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LivePullInputInfo *LivePullInputInfo `json:"LivePullInputInfo,omitnil,omitempty" name:"LivePullInputInfo"`

	// 直播推流信息，当 InputType = RtmpPush 时必填。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RtmpPushInputInfo *RtmpPushInputInfo `json:"RtmpPushInputInfo,omitnil,omitempty" name:"RtmpPushInputInfo"`
}
...
type SwitcherProjectInput struct {
	...
	PgmOutputConfig *SwitcherPgmOutputConfig `json:"PgmOutputConfig,omitnil,omitempty" name:"PgmOutputConfig"`
}
...
type ThirdPartyPublishInfo struct {
	// 发布通道  ID。
	ChannelMaterialId *string `json:"ChannelMaterialId,omitnil,omitempty" name:"ChannelMaterialId"`

	// 企鹅号发布信息，如果使用的发布通道为企鹅号时必填。
	PenguinMediaPlatformPublishInfo *PenguinMediaPlatformPublishInfo `json:"PenguinMediaPlatformPublishInfo,omitnil,omitempty" name:"PenguinMediaPlatformPublishInfo"`

	// 新浪微博发布信息，如果使用的发布通道为新浪微博时必填。
	WeiboPublishInfo *WeiboPublishInfo `json:"WeiboPublishInfo,omitnil,omitempty" name:"WeiboPublishInfo"`

	// 快手发布信息，如果使用的发布通道为快手时必填。
	KuaishouPublishInfo *KuaishouPublishInfo `json:"KuaishouPublishInfo,omitnil,omitempty" name:"KuaishouPublishInfo"`

	// 腾讯云对象存储发布信息， 如果使用的发布通道为腾讯云对象存储时必填。
	CosPublishInfo *CosPublishInputInfo `json:"CosPublishInfo,omitnil,omitempty" name:"CosPublishInfo"`
}
...
type VideoEditProjectInput struct {
	...
	VideoEditTemplateId *string `json:"VideoEditTemplateId,omitnil,omitempty" name:"VideoEditTemplateId"`
	...
	InitTracks []*MediaTrack `json:"InitTracks,omitnil,omitempty" name:"InitTracks"`
}
...
type VideoEditTemplateMaterial struct {
	...
	// 卡槽信息。
	SlotSet []*SlotInfo `json:"SlotSet,omitnil,omitempty" name:"SlotSet"`

	// 模板预览视频 URL 地址 。
	PreviewVideoUrl *string `json:"PreviewVideoUrl,omitnil,omitempty" name:"PreviewVideoUrl"`
}
...
type VideoEncodingPresetAudioSetting struct {
	...
	// <li>2：双声道。</li> 
	// 默认值：2。
	Channels *uint64 `json:"Channels,omitnil,omitempty" name:"Channels"`
...
type VideoEncodingPresetAudioSettingForUpdate struct {
	// 音频码率，单位：bps。
	// 不填则不修改。
	Bitrate *string `json:"Bitrate,omitnil,omitempty" name:"Bitrate"`
...
type VideoExportCompletedEvent struct {
	...
	// 任务输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *VideoEditProjectOutput `json:"Output,omitnil,omitempty" name:"Output"`
}
...
type VideoSegmentationProjectInput struct {
	...
	ProcessModel *string `json:"ProcessModel,omitnil,omitempty" name:"ProcessModel"`
}
