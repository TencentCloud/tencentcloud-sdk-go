...
type AddTeamMemberRequestParams struct {
	...
	TeamMembers []*AddMemberInfo `json:"TeamMembers,omitnil" name:"TeamMembers"`
...
type AudioMaterial struct {
	...
	// 素材媒体文件的播放 URL 地址。
	MaterialUrl *string `json:"MaterialUrl,omitnil" name:"MaterialUrl"`
	...
	MaterialStatus *MaterialStatus `json:"MaterialStatus,omitnil" name:"MaterialStatus"`

	// 素材媒体文件的原始 URL 地址。
	OriginalUrl *string `json:"OriginalUrl,omitnil" name:"OriginalUrl"`

	// 云点播媒资 FileId。
	VodFileId *string `json:"VodFileId,omitnil" name:"VodFileId"`
}
...
type AudioStreamInfo struct {
	...
	// 采样率，单位：hz。
	SamplingRate *uint64 `json:"SamplingRate,omitnil" name:"SamplingRate"`
...
type AuthorizationInfo struct {
	// 被授权者实体。
	Authorizee *Entity `json:"Authorizee,omitnil" name:"Authorizee"`
	...
	// <li>W：可修改、删除媒资。</li>
	PermissionSet []*string `json:"PermissionSet,omitnil" name:"PermissionSet"`
}
...
type CMEExportInfo struct {
	// 导出媒体归属，个人或团队。
	Owner *Entity `json:"Owner,omitnil" name:"Owner"`
	...
	ThirdPartyPublishInfos []*ThirdPartyPublishInfo `json:"ThirdPartyPublishInfos,omitnil" name:"ThirdPartyPublishInfos"`
}
...
type ClassDeletedEvent struct {
	...
	// 删除的分类路径列表。
	ClassPathSet []*string `json:"ClassPathSet,omitnil" name:"ClassPathSet"`
}
...
type ClassMovedEvent struct {
	// 源分类归属。
	SourceOwner *Entity `json:"SourceOwner,omitnil" name:"SourceOwner"`

	// 源分类路径列表。
	SourceClassPathSet []*string `json:"SourceClassPathSet,omitnil" name:"SourceClassPathSet"`

	// 目标分类归属。
	DestinationOwner *Entity `json:"DestinationOwner,omitnil" name:"DestinationOwner"`

	// 目标分类归属。
	DestinationClassPath *string `json:"DestinationClassPath,omitnil" name:"DestinationClassPath"`
}
...
type CosPublishInputInfo struct {
	...
	VideoKey *string `json:"VideoKey,omitnil" name:"VideoKey"`

	// 发布生成的封面在 COS 存储的对象键。
	CoverKey *string `json:"CoverKey,omitnil" name:"CoverKey"`
}
...
type CreateLinkRequestParams struct {
	...
	DestinationId *string `json:"DestinationId,omitnil" name:"DestinationId"`
...
type CreateProjectRequestParams struct {
	...
	AspectRatio *string `json:"AspectRatio,omitnil" name:"AspectRatio"`

	// 项目描述信息。
	Description *string `json:"Description,omitnil" name:"Description"`

	// 导播台项目输入信息，仅当项目类型为 SWITCHER 时必填。
	SwitcherProjectInput *SwitcherProjectInput `json:"SwitcherProjectInput,omitnil" name:"SwitcherProjectInput"`

	// 直播剪辑项目输入信息，暂未开放，请勿使用。
	LiveStreamClipProjectInput *LiveStreamClipProjectInput `json:"LiveStreamClipProjectInput,omitnil" name:"LiveStreamClipProjectInput"`

	// 视频编辑项目输入信息，仅当项目类型为 VIDEO_EDIT 时必填。
	VideoEditProjectInput *VideoEditProjectInput `json:"VideoEditProjectInput,omitnil" name:"VideoEditProjectInput"`

	// 视频拆条项目输入信息，仅当项目类型为 VIDEO_SEGMENTATION  时必填。
	VideoSegmentationProjectInput *VideoSegmentationProjectInput `json:"VideoSegmentationProjectInput,omitnil" name:"VideoSegmentationProjectInput"`

	// 云转推项目输入信息，仅当项目类型为 STREAM_CONNECT 时必填。
	StreamConnectProjectInput *StreamConnectProjectInput `json:"StreamConnectProjectInput,omitnil" name:"StreamConnectProjectInput"`

	// 录制回放项目输入信息，仅当项目类型为 RECORD_REPLAY 时必填。
	RecordReplayProjectInput *RecordReplayProjectInput `json:"RecordReplayProjectInput,omitnil" name:"RecordReplayProjectInput"`

	// 媒体转推项目输入信息，仅当项目类型为 MEDIA_CAST 时必填。
	MediaCastProjectInput *MediaCastProjectInput `json:"MediaCastProjectInput,omitnil" name:"MediaCastProjectInput"`
}
...
type CreateProjectResponseParams struct {
	...
	RtmpPushInputInfoSet []*RtmpPushInputInfo `json:"RtmpPushInputInfoSet,omitnil" name:"RtmpPushInputInfoSet"`
...
type CreateTeamRequestParams struct {
	...
	// 团队所有者的备注，限30个字符。
	OwnerRemark *string `json:"OwnerRemark,omitnil" name:"OwnerRemark"`
...
type CreateVideoEncodingPresetRequestParams struct {
	...
	VideoSetting *VideoEncodingPresetVideoSetting `json:"VideoSetting,omitnil" name:"VideoSetting"`

	// 编码配置的音频设置。默认值参考VideoEncodingPresetAudioSetting 定义。
	AudioSetting *VideoEncodingPresetAudioSetting `json:"AudioSetting,omitnil" name:"AudioSetting"`
}
...
type DescribeAccountsResponseParams struct {
	...
	// 账号信息列表。
	AccountInfoSet []*AccountInfo `json:"AccountInfoSet,omitnil" name:"AccountInfoSet"`
...
type DescribeJoinTeamsResponseParams struct {
	...
	// 团队列表。
	TeamSet []*JoinTeamInfo `json:"TeamSet,omitnil" name:"TeamSet"`
...
type DescribeLoginStatusResponseParams struct {
	// 用户登录状态列表。
	LoginStatusInfoSet []*LoginStatusInfo `json:"LoginStatusInfoSet,omitnil" name:"LoginStatusInfoSet"`
...
type DescribeMaterialsRequestParams struct {
	...
	MaterialIds []*string `json:"MaterialIds,omitnil" name:"MaterialIds"`
...
type DescribeMaterialsResponseParams struct {
	// 媒体列表信息。
	MaterialInfoSet []*MaterialInfo `json:"MaterialInfoSet,omitnil" name:"MaterialInfoSet"`
...
type DescribePlatformsRequestParams struct {
	...
	Platforms []*string `json:"Platforms,omitnil" name:"Platforms"`
...
type DescribePlatformsResponseParams struct {
	...
	// 平台信息列表。
	PlatformInfoSet []*PlatformInfo `json:"PlatformInfoSet,omitnil" name:"PlatformInfoSet"`
...
type DescribeProjectsRequestParams struct {
	...
	AspectRatioSet []*string `json:"AspectRatioSet,omitnil" name:"AspectRatioSet"`
	...
	// 
	// 注：不填不使用项目模式进行过滤。
	Modes []*string `json:"Modes,omitnil" name:"Modes"`
...
type DescribeProjectsResponseParams struct {
	...
	// 项目信息列表。
	ProjectInfoSet []*ProjectInfo `json:"ProjectInfoSet,omitnil" name:"ProjectInfoSet"`
...
type DescribeResourceAuthorizationResponseParams struct {
	...
	// 授权信息列表。
	AuthorizationInfoSet []*AuthorizationInfo `json:"AuthorizationInfoSet,omitnil" name:"AuthorizationInfoSet"`
...
type DescribeSharedSpaceResponseParams struct {
	...
	// 各个共享空间对应的授权者信息。
	AuthorizerSet []*Authorizer `json:"AuthorizerSet,omitnil" name:"AuthorizerSet"`
...
type DescribeTaskDetailResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoEditProjectOutput *VideoEditProjectOutput `json:"VideoEditProjectOutput,omitnil" name:"VideoEditProjectOutput"`
...
type DescribeTasksRequestParams struct {
	...
	// 
	// 注：不填不使用任务类型进行过滤。
	TaskTypeSet []*string `json:"TaskTypeSet,omitnil" name:"TaskTypeSet"`
...
type DescribeTasksResponseParams struct {
	...
	// 任务基础信息列表。
	TaskBaseInfoSet []*TaskBaseInfo `json:"TaskBaseInfoSet,omitnil" name:"TaskBaseInfoSet"`
...
type DescribeTeamMembersResponseParams struct {
	...
	// 团队成员列表。
	MemberSet []*TeamMemberInfo `json:"MemberSet,omitnil" name:"MemberSet"`
...
type DescribeTeamsRequestParams struct {
	...
	TeamIds []*string `json:"TeamIds,omitnil" name:"TeamIds"`
...
type DescribeTeamsResponseParams struct {
	...
	// 团队列表。
	TeamSet []*TeamInfo `json:"TeamSet,omitnil" name:"TeamSet"`
...
type DescribeVideoEncodingPresetsResponseParams struct {
	...
	// 视频编码配置信息。
	VideoEncodingPresetSet []*VideoEncodingPreset `json:"VideoEncodingPresetSet,omitnil" name:"VideoEncodingPresetSet"`
...
type EventContent struct {
	...
	StorageNewFileCreatedEvent *StorageNewFileCreatedEvent `json:"StorageNewFileCreatedEvent,omitnil" name:"StorageNewFileCreatedEvent"`

	// 云转推项目状态变更事件。仅当 EventType 为 Project.StreamConnect.StatusChanged 时有效。
	ProjectStreamConnectStatusChangedEvent *ProjectStreamConnectStatusChangedEvent `json:"ProjectStreamConnectStatusChangedEvent,omitnil" name:"ProjectStreamConnectStatusChangedEvent"`

	// 导播台项目状态变更事件。仅当 EventType 为 Project.Switcher.StatusChanged 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProjectSwitcherStatusChangedEvent *ProjectSwitcherStatusChangedEvent `json:"ProjectSwitcherStatusChangedEvent,omitnil" name:"ProjectSwitcherStatusChangedEvent"`

	// 媒体导入事件。仅当 EventType 为 Material.Imported 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialImportedEvent *MaterialImportedEvent `json:"MaterialImportedEvent,omitnil" name:"MaterialImportedEvent"`

	// 媒体添加事件。仅当 EventType 为 Material.Added 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialAddedEvent *MaterialAddedEvent `json:"MaterialAddedEvent,omitnil" name:"MaterialAddedEvent"`

	// 媒体移动事件。仅当 EventType 为 Material.Moved 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialMovedEvent *MaterialMovedEvent `json:"MaterialMovedEvent,omitnil" name:"MaterialMovedEvent"`

	// 媒体更新事件。仅当 EventType 为 Material.Modified 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialModifiedEvent *MaterialModifiedEvent `json:"MaterialModifiedEvent,omitnil" name:"MaterialModifiedEvent"`

	// 媒体删除事件。仅当 EventType 为 Material.Deleted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaterialDeletedEvent *MaterialDeletedEvent `json:"MaterialDeletedEvent,omitnil" name:"MaterialDeletedEvent"`

	// 分类创建事件。仅当 EventType 为 Class.Created 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassCreatedEvent *ClassCreatedEvent `json:"ClassCreatedEvent,omitnil" name:"ClassCreatedEvent"`

	// 分类移动事件。仅当 EventType 为 Class.Moved 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassMovedEvent *ClassMovedEvent `json:"ClassMovedEvent,omitnil" name:"ClassMovedEvent"`

	// 分类删除事件。仅当 EventType 为 Class.Deleted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ClassDeletedEvent *ClassDeletedEvent `json:"ClassDeletedEvent,omitnil" name:"ClassDeletedEvent"`

	// 视频导出完成事件。仅当 EventType 为 Task.VideoExportCompleted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoExportCompletedEvent *VideoExportCompletedEvent `json:"VideoExportCompletedEvent,omitnil" name:"VideoExportCompletedEvent"`

	// 点播转直播项目状态变更事件。仅当 EventType 为 Project.MediaCast.StatusChanged 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProjectMediaCastStatusChangedEvent *ProjectMediaCastStatusChangedEvent `json:"ProjectMediaCastStatusChangedEvent,omitnil" name:"ProjectMediaCastStatusChangedEvent"`
}
...
type ExportVideoByEditorTrackDataRequestParams struct {
	...
	ExportDestination *string `json:"ExportDestination,omitnil" name:"ExportDestination"`
	...
	TrackData *string `json:"TrackData,omitnil" name:"TrackData"`
	...
	CMEExportInfo *CMEExportInfo `json:"CMEExportInfo,omitnil" name:"CMEExportInfo"`
...
type ExportVideoByTemplateRequestParams struct {
	...
	// 需要替换的素材信息。
	SlotReplacements []*SlotReplacementInfo `json:"SlotReplacements,omitnil" name:"SlotReplacements"`
...
type ExportVideoByVideoSegmentationDataRequestParams struct {
	...
	// 指定需要导出的智能拆条片段的组 Id 。
	SegmentGroupId *string `json:"SegmentGroupId,omitnil" name:"SegmentGroupId"`

	// 指定需要导出的智能拆条片段 Id  集合。
	SegmentIds []*string `json:"SegmentIds,omitnil" name:"SegmentIds"`
...
type ExternalMediaInfo struct {
	...
	MediaKey *string `json:"MediaKey,omitnil" name:"MediaKey"`
...
type GrantResourceAuthorizationRequestParams struct {
	...
	// 被授权目标，个人或者团队。
	Authorizees []*Entity `json:"Authorizees,omitnil" name:"Authorizees"`
...
type HandleMediaCastProjectRequestParams struct {
	...
	SourceInfos []*MediaCastSourceInfo `json:"SourceInfos,omitnil" name:"SourceInfos"`
	...
	DestinationInfos []*MediaCastDestinationInfo `json:"DestinationInfos,omitnil" name:"DestinationInfos"`

	// 输出媒体配置。具体操作方式详见 [操作类型](#Operation) 及下文示例。
	// 当 Operation 为 ModfiyOutputSetting 时必填。
	OutputMediaSetting *MediaCastOutputMediaSetting `json:"OutputMediaSetting,omitnil" name:"OutputMediaSetting"`

	// 播放控制参数。具体操作方式详见 [操作类型](#Operation) 及下文示例。
	// 当 Operation 为 ModifyPlaySetting 时必填。
	PlaySetting *MediaCastPlaySetting `json:"PlaySetting,omitnil" name:"PlaySetting"`
...
type HandleMediaCastProjectResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	PlayInfo *MediaCastPlayInfo `json:"PlayInfo,omitnil" name:"PlayInfo"`

	// 输入源信息， Operation 为 AddSource 时返回添加成功的输入源信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	SourceInfoSet []*MediaCastSourceInfo `json:"SourceInfoSet,omitnil" name:"SourceInfoSet"`

	// 输出源信息， Operation 为 AddDestination 时返回添加成功的输出源信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	DestinationInfoSet []*MediaCastDestinationInfo `json:"DestinationInfoSet,omitnil" name:"DestinationInfoSet"`
...
type HandleStreamConnectProjectRequestParams struct {
	...
	InputInfo *StreamInputInfo `json:"InputInfo,omitnil" name:"InputInfo"`

	// 主备输入源标识，取值有：
	// <li> Main ：主源；</li>
	// <li> Backup ：备源。</li>
	InputEndpoint *string `json:"InputEndpoint,omitnil" name:"InputEndpoint"`

	// 转推输出源操作参数。具体操作方式详见 [操作类型](#Operation) 及下文示例。
	OutputInfo *StreamConnectOutput `json:"OutputInfo,omitnil" name:"OutputInfo"`

	// 云转推当前预计结束时间，采用 [ISO 日期格式](https://cloud.tencent.com/document/product/266/11732#I)。具体操作方式详见 [操作类型](#Operation) 及下文示例。
	CurrentStopTime *string `json:"CurrentStopTime,omitnil" name:"CurrentStopTime"`
...
type HandleStreamConnectProjectResponseParams struct {
	...
	StreamInputRtmpPushUrl *string `json:"StreamInputRtmpPushUrl,omitnil" name:"StreamInputRtmpPushUrl"`

	// 点播输入源播放进度信息，当 Operation 取值 DescribeInputPlayInfo 且 InputType 为 VodPull 类型时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VodPullInputPlayInfo *VodPullInputPlayInfo `json:"VodPullInputPlayInfo,omitnil" name:"VodPullInputPlayInfo"`
...
type ImportMaterialRequestParams struct {
	...
	ExternalMediaInfo *ExternalMediaInfo `json:"ExternalMediaInfo,omitnil" name:"ExternalMediaInfo"`
	...
	// 媒体预处理任务参数 ID。可取值有：
	// <li>10：进行编辑预处理。</li>
	PreProcessDefinition *int64 `json:"PreProcessDefinition,omitnil" name:"PreProcessDefinition"`
...
type ImportMaterialResponseParams struct {
	...
	PreProcessTaskId *string `json:"PreProcessTaskId,omitnil" name:"PreProcessTaskId"`
...
type IntegerRange struct {
	// 按整形代表值的下限检索。
	LowerBound *int64 `json:"LowerBound,omitnil" name:"LowerBound"`

	// 按整形代表值的上限检索。
	UpperBound *int64 `json:"UpperBound,omitnil" name:"UpperBound"`
}
...
type LinkMaterial struct {
	...
	LinkStatus *string `json:"LinkStatus,omitnil" name:"LinkStatus"`

	// 素材链接详细信息，当LinkType="MATERIAL"时有值。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LinkMaterialInfo *LinkMaterialInfo `json:"LinkMaterialInfo,omitnil" name:"LinkMaterialInfo"`

	// 分类链接目标信息，当LinkType=“CLASS”时有值。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LinkClassInfo *ClassInfo `json:"LinkClassInfo,omitnil" name:"LinkClassInfo"`
}

type LinkMaterialInfo struct {
	// 素材基本信息。
	BasicInfo *MaterialBasicInfo `json:"BasicInfo,omitnil" name:"BasicInfo"`

	// 视频素材信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoMaterial *VideoMaterial `json:"VideoMaterial,omitnil" name:"VideoMaterial"`

	// 音频素材信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AudioMaterial *AudioMaterial `json:"AudioMaterial,omitnil" name:"AudioMaterial"`

	// 图片素材信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ImageMaterial *ImageMaterial `json:"ImageMaterial,omitnil" name:"ImageMaterial"`
}
...
type ListMediaResponseParams struct {
	// 符合条件的媒体记录总数。
	MaterialTotalCount *int64 `json:"MaterialTotalCount,omitnil" name:"MaterialTotalCount"`
...
type LiveStreamClipProjectInput struct {
	...
	StreamRecordDuration *uint64 `json:"StreamRecordDuration,omitnil" name:"StreamRecordDuration"`
}
...
type MaterialAddedEvent struct {
	// 添加的媒体 Id 列表。
	MaterialIdSet []*string `json:"MaterialIdSet,omitnil" name:"MaterialIdSet"`
...
type MaterialBasicInfo struct {
	...
	// <li> LINK  :链接.</li>
	// <li> OTHER : 其他.</li>
	MaterialType *string `json:"MaterialType,omitnil" name:"MaterialType"`
	...
	// 预置标签列表。
	PresetTagSet []*PresetTagInfo `json:"PresetTagSet,omitnil" name:"PresetTagSet"`
	...
	// 该字段已废弃。
	// 注意：此字段可能返回 null，表示取不到有效值。
	TagInfoSet []*MaterialTagInfo `json:"TagInfoSet,omitnil" name:"TagInfoSet"`
}
...
type MaterialImportedEvent struct {
	// 导入的媒体信息列表。
	MediaInfoSet []*ImportMediaInfo `json:"MediaInfoSet,omitnil" name:"MediaInfoSet"`
...
type MaterialInfo struct {
	...
	// 链接媒体信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LinkMaterial *LinkMaterial `json:"LinkMaterial,omitnil" name:"LinkMaterial"`

	// 模板媒体信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoEditTemplateMaterial *VideoEditTemplateMaterial `json:"VideoEditTemplateMaterial,omitnil" name:"VideoEditTemplateMaterial"`

	// 其他类型媒体信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OtherMaterial *OtherMaterial `json:"OtherMaterial,omitnil" name:"OtherMaterial"`
}
...
type MaterialModifiedEvent struct {
	...
	PresetTagIdSet []*string `json:"PresetTagIdSet,omitnil" name:"PresetTagIdSet"`
...
type MaterialMovedEvent struct {
	...
	// 源媒体分类路径。
	SourceClassPath *string `json:"SourceClassPath,omitnil" name:"SourceClassPath"`
...
type MaterialStatus struct {
	...
	EditorUsableStatus *string `json:"EditorUsableStatus,omitnil" name:"EditorUsableStatus"`
}
...
type MediaCastDestinationInfo struct {
	...
	PushUrl *string `json:"PushUrl,omitnil" name:"PushUrl"`
...
type MediaCastDestinationInterruptInfo struct {
	// 发生断流的输出源信息。
	DestinationInfo *MediaCastDestinationInfo `json:"DestinationInfo,omitnil" name:"DestinationInfo"`
...
type MediaCastOutputMediaSetting struct {
	// 视频配置。
	VideoSetting *MediaCastVideoSetting `json:"VideoSetting,omitnil" name:"VideoSetting"`

	// 视频配置是否和第一个输入源的视频配置相同，默认值：false。如果 FollowSourceInfo 的值为 true，忽略 VideoSetting 参数。
	FollowSourceInfo *bool `json:"FollowSourceInfo,omitnil" name:"FollowSourceInfo"`
}
...
type MediaCastPlayInfo struct {
	...
	// 当前播放的输入源 Id。
	CurrentSourceId *string `json:"CurrentSourceId,omitnil" name:"CurrentSourceId"`

	// 当前播放的输入源的播放位置，单位：秒。
	CurrentSourcePosition *float64 `json:"CurrentSourcePosition,omitnil" name:"CurrentSourcePosition"`

	// 当前播放的输入源时长，单位：秒。
	CurrentSourceDuration *float64 `json:"CurrentSourceDuration,omitnil" name:"CurrentSourceDuration"`

	// 输出源状态信息。
	DestinationStatusSet []*MediaCastDestinationStatus `json:"DestinationStatusSet,omitnil" name:"DestinationStatusSet"`

	// 已经循环播放的次数。
	LoopCount *int64 `json:"LoopCount,omitnil" name:"LoopCount"`
}
...
type MediaCastPlaySetting struct {
	...
	AutoStartTime *string `json:"AutoStartTime,omitnil" name:"AutoStartTime"`
}
...
type MediaCastSourceInfo struct {
	...
	Offset *float64 `json:"Offset,omitnil" name:"Offset"`
...
type MediaCastSourceInterruptInfo struct {
	// 发生断流的输入源信息。
	SourceInfo *MediaCastSourceInfo `json:"SourceInfo,omitnil" name:"SourceInfo"`
...
type MediaCastVideoSetting struct {
	...
	FrameRate *float64 `json:"FrameRate,omitnil" name:"FrameRate"`
}
...
type MediaMetaData struct {
	...
	// 视频流信息。
	VideoStreamInfoSet []*VideoStreamInfo `json:"VideoStreamInfoSet,omitnil" name:"VideoStreamInfoSet"`

	// 音频流信息。
	AudioStreamInfoSet []*AudioStreamInfo `json:"AudioStreamInfoSet,omitnil" name:"AudioStreamInfoSet"`
}
...
type MediaReplacementInfo struct {
	...
	// 预处理操作。
	// 注：目前该功能暂不支持，请勿使用。
	PreprocessOperation *MediaPreprocessOperation `json:"PreprocessOperation,omitnil" name:"PreprocessOperation"`
}
...
type MediaTransitionItem struct {
	// 转场 Id 。暂只支持一个转场。
	TransitionId *string `json:"TransitionId,omitnil" name:"TransitionId"`
...
type ModifyVideoEncodingPresetRequestParams struct {
	...
	// 更改后的编码配置的视频设置。
	VideoSetting *VideoEncodingPresetVideoSettingForUpdate `json:"VideoSetting,omitnil" name:"VideoSetting"`

	// 更改后的编码配置的音频设置。
	AudioSetting *VideoEncodingPresetAudioSettingForUpdate `json:"AudioSetting,omitnil" name:"AudioSetting"`
}
...
type MoveResourceRequestParams struct {
	...
	SourceResource *ResourceInfo `json:"SourceResource,omitnil" name:"SourceResource"`

	// 目标信息，包含分类及归属，仅支持移动资源到分类。
	DestinationResource *ResourceInfo `json:"DestinationResource,omitnil" name:"DestinationResource"`
...
type ParseEventRequestParams struct {
	...
	// 回调事件内容。
	EventContent *string `json:"EventContent,omitnil" name:"EventContent"`
}
...
type ParseEventResponseParams struct {
	// 事件内容。
	EventContent *EventContent `json:"EventContent,omitnil" name:"EventContent"`
...
type PenguinMediaPlatformPublishInfo struct {
	...
	Category *int64 `json:"Category,omitnil" name:"Category"`
}
...
type PlatformInfo struct {
	...
	// 云点播子应用 Id。
	VodSubAppId *uint64 `json:"VodSubAppId,omitnil" name:"VodSubAppId"`

	// 平台绑定的 license Id。
	LicenseId *string `json:"LicenseId,omitnil" name:"LicenseId"`
...
type PresetTagInfo struct {
	...
	// 父级预设 Id。
	ParentTagId *string `json:"ParentTagId,omitnil" name:"ParentTagId"`
}
...
type ProjectInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	StreamConnectProjectInfo *StreamConnectProjectInfo `json:"StreamConnectProjectInfo,omitnil" name:"StreamConnectProjectInfo"`

	// 点播转直播项目信息，仅当项目类别取值为 MEDIA_CAST 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MediaCastProjectInfo *MediaCastProjectInfo `json:"MediaCastProjectInfo,omitnil" name:"MediaCastProjectInfo"`
...
type ProjectMediaCastStatusChangedEvent struct {
	...
	SourceInterruptInfo *MediaCastSourceInterruptInfo `json:"SourceInterruptInfo,omitnil" name:"SourceInterruptInfo"`

	// 点播转直播输出断流信息，仅当 Status 取值 DestinationInterrupted 时有效。
	DestinationInterruptInfo *MediaCastDestinationInterruptInfo `json:"DestinationInterruptInfo,omitnil" name:"DestinationInterruptInfo"`
}
...
type ProjectStreamConnectStatusChangedEvent struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	InputInterruptInfo *StreamConnectInputInterruptInfo `json:"InputInterruptInfo,omitnil" name:"InputInterruptInfo"`

	// 云转推输出断流信息，仅当 Status 取值 OutputInterrupted 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OutputInterruptInfo *StreamConnectOutputInterruptInfo `json:"OutputInterruptInfo,omitnil" name:"OutputInterruptInfo"`
}
...
type RecordReplayProjectInput struct {
	// 录制拉流地址。
	PullStreamUrl *string `json:"PullStreamUrl,omitnil" name:"PullStreamUrl"`

	// 录制文件归属者。
	MaterialOwner *Entity `json:"MaterialOwner,omitnil" name:"MaterialOwner"`

	// 录制文件存储分类路径。
	MaterialClassPath *string `json:"MaterialClassPath,omitnil" name:"MaterialClassPath"`
...
type RtmpPushInputInfo struct {
	// 直播推流地址有效期，单位：秒 。
	ExpiredSecond *uint64 `json:"ExpiredSecond,omitnil" name:"ExpiredSecond"`
...
type SearchMaterialRequestParams struct {
	...
	// 指定搜索空间，数组长度不得超过5。
	SearchScopes []*SearchScope `json:"SearchScopes,omitnil" name:"SearchScopes"`
	...
	MaterialTypes []*string `json:"MaterialTypes,omitnil" name:"MaterialTypes"`
	...
	// 按媒体时长检索，单位s。
	DurationRange *IntegerRange `json:"DurationRange,omitnil" name:"DurationRange"`

	// 按照媒体创建时间检索。
	CreateTimeRange *TimeRange `json:"CreateTimeRange,omitnil" name:"CreateTimeRange"`
...
type SlotInfo struct {
	...
	DefaultMaterialId *string `json:"DefaultMaterialId,omitnil" name:"DefaultMaterialId"`

	// 默认文本卡槽信息。当卡槽类型为 TEXT 时有效。
	// 注意：此字段可能返回 null，表示取不到有效值。
	DefaultTextSlotInfo *TextSlotInfo `json:"DefaultTextSlotInfo,omitnil" name:"DefaultTextSlotInfo"`
...
type SlotReplacementInfo struct {
	...
	ReplacementType *string `json:"ReplacementType,omitnil" name:"ReplacementType"`

	// 媒体替换信息，仅当要替换的媒体类型为音频、视频、图片时有效。
	MediaReplacementInfo *MediaReplacementInfo `json:"MediaReplacementInfo,omitnil" name:"MediaReplacementInfo"`

	// 文本替换信息，仅当要替换的卡槽类型为文本时有效。
	TextReplacementInfo *TextReplacementInfo `json:"TextReplacementInfo,omitnil" name:"TextReplacementInfo"`
}
...
type StreamConnectOutputInfo struct {
	// 输出源。
	// 注意：此字段可能返回 null，表示取不到有效值。
	StreamConnectOutput *StreamConnectOutput `json:"StreamConnectOutput,omitnil" name:"StreamConnectOutput"`

	// 输出流状态：
	// <li>On ：开；</li>
	// <li>Off ：关 。</li>
	PushSwitch *string `json:"PushSwitch,omitnil" name:"PushSwitch"`
}
...
type StreamConnectProjectInfo struct {
	...
	// <li>Main ：主输入源；</li>
	// <li>Backup ：备输入源。</li>
	CurrentInputEndpoint *string `json:"CurrentInputEndpoint,omitnil" name:"CurrentInputEndpoint"`
	...
	LastStopTime *string `json:"LastStopTime,omitnil" name:"LastStopTime"`

	// 云转推主输入源。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MainInput *StreamInputInfo `json:"MainInput,omitnil" name:"MainInput"`

	// 云转推备输入源。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BackupInput *StreamInputInfo `json:"BackupInput,omitnil" name:"BackupInput"`

	// 云转推输出源。
	OutputSet []*StreamConnectOutputInfo `json:"OutputSet,omitnil" name:"OutputSet"`
}
...
type StreamConnectProjectInput struct {
	...
	// 云转推输出源信息。
	Outputs []*StreamConnectOutput `json:"Outputs,omitnil" name:"Outputs"`
}
...
type StreamInputInfo struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	VodPullInputInfo *VodPullInputInfo `json:"VodPullInputInfo,omitnil" name:"VodPullInputInfo"`

	// 直播拉流信息，当 InputType = LivePull  时必填。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LivePullInputInfo *LivePullInputInfo `json:"LivePullInputInfo,omitnil" name:"LivePullInputInfo"`

	// 直播推流信息，当 InputType = RtmpPush 时必填。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RtmpPushInputInfo *RtmpPushInputInfo `json:"RtmpPushInputInfo,omitnil" name:"RtmpPushInputInfo"`
}
...
type SwitcherProjectInput struct {
	...
	PgmOutputConfig *SwitcherPgmOutputConfig `json:"PgmOutputConfig,omitnil" name:"PgmOutputConfig"`
}
...
type ThirdPartyPublishInfo struct {
	// 发布通道  ID。
	ChannelMaterialId *string `json:"ChannelMaterialId,omitnil" name:"ChannelMaterialId"`

	// 企鹅号发布信息，如果使用的发布通道为企鹅号时必填。
	PenguinMediaPlatformPublishInfo *PenguinMediaPlatformPublishInfo `json:"PenguinMediaPlatformPublishInfo,omitnil" name:"PenguinMediaPlatformPublishInfo"`

	// 新浪微博发布信息，如果使用的发布通道为新浪微博时必填。
	WeiboPublishInfo *WeiboPublishInfo `json:"WeiboPublishInfo,omitnil" name:"WeiboPublishInfo"`

	// 快手发布信息，如果使用的发布通道为快手时必填。
	KuaishouPublishInfo *KuaishouPublishInfo `json:"KuaishouPublishInfo,omitnil" name:"KuaishouPublishInfo"`

	// 腾讯云对象存储发布信息， 如果使用的发布通道为腾讯云对象存储时必填。
	CosPublishInfo *CosPublishInputInfo `json:"CosPublishInfo,omitnil" name:"CosPublishInfo"`
}
...
type VideoEditProjectInput struct {
	...
	VideoEditTemplateId *string `json:"VideoEditTemplateId,omitnil" name:"VideoEditTemplateId"`
	...
	InitTracks []*MediaTrack `json:"InitTracks,omitnil" name:"InitTracks"`
}
...
type VideoEditTemplateMaterial struct {
	...
	// 卡槽信息。
	SlotSet []*SlotInfo `json:"SlotSet,omitnil" name:"SlotSet"`

	// 模板预览视频 URL 地址 。
	PreviewVideoUrl *string `json:"PreviewVideoUrl,omitnil" name:"PreviewVideoUrl"`
}
...
type VideoEncodingPresetAudioSetting struct {
	...
	// <li>2：双声道。</li> 
	// 默认值：2。
	Channels *uint64 `json:"Channels,omitnil" name:"Channels"`
...
type VideoEncodingPresetAudioSettingForUpdate struct {
	// 音频码率，单位：bps。
	// 不填则不修改。
	Bitrate *string `json:"Bitrate,omitnil" name:"Bitrate"`
...
type VideoExportCompletedEvent struct {
	...
	// 任务输出。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Output *VideoEditProjectOutput `json:"Output,omitnil" name:"Output"`
}
...
type VideoSegmentationProjectInput struct {
	...
	ProcessModel *string `json:"ProcessModel,omitnil" name:"ProcessModel"`
}
...
type VodPullInputInfo struct {
	// 点播输入拉流 URL 。
	InputUrls []*string `json:"InputUrls,omitnil" name:"InputUrls"`
	...
	// 默认不循环。
	LoopTimes *int64 `json:"LoopTimes,omitnil" name:"LoopTimes"`
}
