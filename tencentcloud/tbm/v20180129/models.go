...
type AgePortraitInfo struct {
	// 用户年龄画像数组
	PortraitSet []*AgePortrait `json:"PortraitSet,omitnil" name:"PortraitSet"`
}
...
type BrandReportArticle struct {
	...
	// 文章来源
	FromSite *string `json:"FromSite,omitnil" name:"FromSite"`
	...
	// 文章热度值
	Hot *uint64 `json:"Hot,omitnil" name:"Hot"`
	...
	// 文章ID
	ArticleId *string `json:"ArticleId,omitnil" name:"ArticleId"`
}
...
type Comment struct {
	...
	// 差评的个数
	NegCommentCount *uint64 `json:"NegCommentCount,omitnil" name:"NegCommentCount"`

	// 好评的个数
	PosCommentCount *uint64 `json:"PosCommentCount,omitnil" name:"PosCommentCount"`
}
...
type DescribeBrandCommentCountRequestParams struct {
	// 品牌ID
	BrandId *string `json:"BrandId,omitnil" name:"BrandId"`
...
type DescribeBrandCommentCountResponseParams struct {
	// 按天统计好评/差评数
	CommentSet []*Comment `json:"CommentSet,omitnil" name:"CommentSet"`
...
type DescribeBrandExposureResponseParams struct {
	...
	// 按天计算的统计数据
	DateCountSet []*DateCount `json:"DateCountSet,omitnil" name:"DateCountSet"`
...
type DescribeBrandNegCommentsResponseParams struct {
	// 评论列表
	BrandCommentSet []*CommentInfo `json:"BrandCommentSet,omitnil" name:"BrandCommentSet"`

	// 总的差评个数
	TotalComments *uint64 `json:"TotalComments,omitnil" name:"TotalComments"`
...
type DescribeBrandSocialOpinionRequestParams struct {
	...
	ShowList *bool `json:"ShowList,omitnil" name:"ShowList"`
}
...
type DescribeBrandSocialOpinionResponseParams struct {
	// 文章总数
	ArticleCount *uint64 `json:"ArticleCount,omitnil" name:"ArticleCount"`

	// 来源统计总数
	FromCount *uint64 `json:"FromCount,omitnil" name:"FromCount"`

	// 疑似负面报道总数
	AdverseCount *uint64 `json:"AdverseCount,omitnil" name:"AdverseCount"`

	// 文章列表详情
	ArticleSet []*BrandReportArticle `json:"ArticleSet,omitnil" name:"ArticleSet"`
...
type DescribeIndustryNewsRequestParams struct {
	// 行业ID
	IndustryId *string `json:"IndustryId,omitnil" name:"IndustryId"`
...
type DescribeIndustryNewsResponseParams struct {
	// 总计文章数量
	NewsCount *uint64 `json:"NewsCount,omitnil" name:"NewsCount"`
	...
	// 文章列表
	NewsSet []*IndustryNews `json:"NewsSet,omitnil" name:"NewsSet"`
...
type DescribeUserPortraitResponseParams struct {
	// 年龄画像
	Age *AgePortraitInfo `json:"Age,omitnil" name:"Age"`

	// 性别画像
	Gender *GenderPortraitInfo `json:"Gender,omitnil" name:"Gender"`

	// 省份画像
	Province *ProvincePortraitInfo `json:"Province,omitnil" name:"Province"`

	// 电影喜好画像
	Movie *MoviePortraitInfo `json:"Movie,omitnil" name:"Movie"`

	// 明星喜好画像
	Star *StarPortraitInfo `json:"Star,omitnil" name:"Star"`
...
type GenderPortraitInfo struct {
	// 用户性别画像数组
	PortraitSet []*GenderPortrait `json:"PortraitSet,omitnil" name:"PortraitSet"`
}
...
type MoviePortraitInfo struct {
	// 用户喜好电影画像数组
	PortraitSet []*MoviePortrait `json:"PortraitSet,omitnil" name:"PortraitSet"`
}
...
type ProvincePortraitInfo struct {
	// 用户省份画像数组
	PortraitSet []*ProvincePortrait `json:"PortraitSet,omitnil" name:"PortraitSet"`
}
...
type StarPortraitInfo struct {
	// 用户喜好的明星画像数组
	PortraitSet []*StarPortrait `json:"PortraitSet,omitnil" name:"PortraitSet"`
}