...
type BlockInfo struct {
	...
	// 最晚时间
	MaxDate *string `json:"MaxDate,omitnil,omitempty" name:"MaxDate"`

	// 最近时间
	MinDate *string `json:"MinDate,omitnil,omitempty" name:"MinDate"`

	// 方向  1入站 0出战
	Direction *int64 `json:"Direction,omitnil,omitempty" name:"Direction"`

	// 来源  1拦截列表，2虚拟补丁，3威胁情报，4基础防御
	BlockSource *int64 `json:"BlockSource,omitnil,omitempty" name:"BlockSource"`
	...
	// 拦截频率
	AvgCount *float64 `json:"AvgCount,omitnil,omitempty" name:"AvgCount"`

	// 置顶位
	IsTop *int64 `json:"IsTop,omitnil,omitempty" name:"IsTop"`
	...
	// 1是 0不是
	Block *int64 `json:"Block,omitnil,omitempty" name:"Block"`

	// 1是 0不是
	Ignore *int64 `json:"Ignore,omitnil,omitempty" name:"Ignore"`

	// WhiteTag信息
	WhiteTag *string `json:"WhiteTag,omitnil,omitempty" name:"WhiteTag"`

	// vpc间防火墙日志，目的资产id
	// 注意：此字段可能返回 null，表示取不到有效值。
	DstAssetId *string `json:"DstAssetId,omitnil,omitempty" name:"DstAssetId"`

	// vpc间防火墙日志，目的资产名称
	// 注意：此字段可能返回 null，表示取不到有效值。
	DstAssetName *string `json:"DstAssetName,omitnil,omitempty" name:"DstAssetName"`

	// vpc间防火墙日志，源VPC id
	// 注意：此字段可能返回 null，表示取不到有效值。
	SrcVpc *string `json:"SrcVpc,omitnil,omitempty" name:"SrcVpc"`

	// vpc间防火墙日志，源VPC名称
	// 注意：此字段可能返回 null，表示取不到有效值。
	SrcVpcName *string `json:"SrcVpcName,omitnil,omitempty" name:"SrcVpcName"`

	// vpc间防火墙日志，目的VPC id
	// 注意：此字段可能返回 null，表示取不到有效值。
	DstVpc *string `json:"DstVpc,omitnil,omitempty" name:"DstVpc"`

	// vpc间防火墙日志，目的VPC名称
	// 注意：此字段可能返回 null，表示取不到有效值。
	DstVpcName *string `json:"DstVpcName,omitnil,omitempty" name:"DstVpcName"`
	...
	// 是否加入隔离列表，1是 0不是
	// 注意：此字段可能返回 null，表示取不到有效值。
	Isolate *int64 `json:"Isolate,omitnil,omitempty" name:"Isolate"`
...
type CcnAssociatedInstance struct {
	...
	// <p>是否跨账号</p>
	IsCrossInstance *uint64 `json:"IsCrossInstance,omitnil,omitempty" name:"IsCrossInstance"`
}
...
// Predefined struct for user
type CheckClusterNatFwPreAccessRequestParams struct {
...
type CheckClusterNatFwPreAccessRequest struct {
	*tchttp.BaseRequest
...
func (r *CheckClusterNatFwPreAccessRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CheckClusterNatFwPreAccessRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "NatCcnSwitch")
	delete(f, "CheckMode")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CheckClusterNatFwPreAccessRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CheckClusterNatFwPreAccessResponseParams struct {
	...
	CheckItems []*ClusterFwPreAccessCheckItem `json:"CheckItems,omitnil,omitempty" name:"CheckItems"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type CheckClusterNatFwPreAccessResponse struct {
	*tchttp.BaseResponse
	Response *CheckClusterNatFwPreAccessResponseParams `json:"Response"`
}

func (r *CheckClusterNatFwPreAccessResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CheckClusterNatFwPreAccessResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CheckClusterVpcFwPreAccessRequestParams struct {
...
type CheckClusterVpcFwPreAccessRequest struct {
	*tchttp.BaseRequest
...
func (r *CheckClusterVpcFwPreAccessRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CheckClusterVpcFwPreAccessRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "CheckMode")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CheckClusterVpcFwPreAccessRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CheckClusterVpcFwPreAccessResponseParams struct {
...
type CheckClusterVpcFwPreAccessResponse struct {
	*tchttp.BaseResponse
	Response *CheckClusterVpcFwPreAccessResponseParams `json:"Response"`
}

func (r *CheckClusterVpcFwPreAccessResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CheckClusterVpcFwPreAccessResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *CloseClusterNatFwSwitchRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CloseClusterNatFwSwitchRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "CcnId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CloseClusterNatFwSwitchRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CloseClusterNatFwSwitchResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type CloseClusterNatFwSwitchResponse struct {
	*tchttp.BaseResponse
	Response *CloseClusterNatFwSwitchResponseParams `json:"Response"`
}

func (r *CloseClusterNatFwSwitchResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CloseClusterNatFwSwitchResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type ClusterFwPreAccessCheckItem struct {
...
// Predefined struct for user
type CreateWhiteRuleRequestParams struct {
...
func (r *CreateWhiteRuleRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateWhiteRuleRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "CoverDuplicate")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CreateWhiteRuleRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CreateWhiteRuleResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type CreateWhiteRuleResponse struct {
	*tchttp.BaseResponse
	Response *CreateWhiteRuleResponseParams `json:"Response"`
}

func (r *CreateWhiteRuleResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateWhiteRuleResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DeleteWhiteRuleRequestParams struct {
	// JSON string 数组，至少一项；元素取自 DescribeWhiteRule.Data[].WhiteId，可批量。
	WhiteIdList []*string `json:"WhiteIdList,omitnil,omitempty" name:"WhiteIdList"`
}

type DeleteWhiteRuleRequest struct {
	*tchttp.BaseRequest
...
func (r *DeleteWhiteRuleRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteWhiteRuleRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "WhiteIdList")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DeleteWhiteRuleRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteWhiteRuleResponseParams struct {
	// 状态码，0 表示请求被接受处理。
	ReturnCode *int64 `json:"ReturnCode,omitnil,omitempty" name:"ReturnCode"`
...
type DeleteWhiteRuleResponse struct {
	*tchttp.BaseResponse
	Response *DeleteWhiteRuleResponseParams `json:"Response"`
}

func (r *DeleteWhiteRuleResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteWhiteRuleResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeBlockListRequestParams struct {
	// 偏移量
	Offset *int64 `json:"Offset,omitnil,omitempty" name:"Offset"`
	...
	// 频率类型
	StatTimeSpan *int64 `json:"StatTimeSpan,omitnil,omitempty" name:"StatTimeSpan"`
...
func (r *DescribeBlockListRequest) FromJsonString(s string) error {
	...
	delete(f, "LogSource")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeBlockListRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeBlockListResponseParams struct {
	// 阻断记录集合
	Data []*BlockInfo `json:"Data,omitnil,omitempty" name:"Data"`

	// 置顶阻断记录集合
	TopData []*BlockInfo `json:"TopData,omitnil,omitempty" name:"TopData"`
...
type DescribeBlockListResponse struct {
	*tchttp.BaseResponse
	Response *DescribeBlockListResponseParams `json:"Response"`
}
...
// Predefined struct for user
type DescribeClusterNatCcnFwSwitchListRequestParams struct {
...
type DescribeClusterNatCcnFwSwitchListRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeClusterNatCcnFwSwitchListRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeClusterNatCcnFwSwitchListRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Filters")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeClusterNatCcnFwSwitchListRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeClusterNatCcnFwSwitchListResponseParams struct {
	// <p>符合条件的总记录数</p>
	Total *int64 `json:"Total,omitnil,omitempty" name:"Total"`

	// <p>NAT防火墙开关详情列表</p>
	Data []*NatFwSwitchDetailS `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeClusterNatCcnFwSwitchListResponse struct {
	*tchttp.BaseResponse
	Response *DescribeClusterNatCcnFwSwitchListResponseParams `json:"Response"`
}

func (r *DescribeClusterNatCcnFwSwitchListResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeClusterNatCcnFwSwitchListResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeEdgeIpSimpleRequestParams struct {
	// 过滤条件组合
	Filters []*CommonFilter `json:"Filters,omitnil,omitempty" name:"Filters"`
...
type DescribeEdgeIpSimpleRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeEdgeIpSimpleRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeEdgeIpSimpleRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "By")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeEdgeIpSimpleRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeEdgeIpSimpleResponseParams struct {
	// ip 开关列表
	Data []*EdgeIpInfoSimple `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeEdgeIpSimpleResponse struct {
	*tchttp.BaseResponse
	Response *DescribeEdgeIpSimpleResponseParams `json:"Response"`
}

func (r *DescribeEdgeIpSimpleResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeEdgeIpSimpleResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeFwGroupIdNamesRequestParams struct {
...
func (r *DescribeFwGroupIdNamesRequest) FromJsonString(s string) error {
	...
	delete(f, "IpVersion")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeFwGroupIdNamesRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeFwGroupIdNamesResponseParams struct {
	// <p>防火墙(组列表)</p>
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data []*FwGroupIdName `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeFwGroupIdNamesResponse struct {
	*tchttp.BaseResponse
	Response *DescribeFwGroupIdNamesResponseParams `json:"Response"`
}
...
func (r *DescribeIpsRuleListNewRequest) FromJsonString(s string) error {
	...
	delete(f, "By")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeIpsRuleListNewRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeIpsRuleListNewResponse struct {
	*tchttp.BaseResponse
	Response *DescribeIpsRuleListNewResponseParams `json:"Response"`
}
...
// Predefined struct for user
type DescribeNatCcnFwSwitchRequestParams struct {
	// <p>NAT防火墙实例ID</p>
	NatInsId *string `json:"NatInsId,omitnil,omitempty" name:"NatInsId"`
...
type DescribeNatCcnFwSwitchRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeNatCcnFwSwitchRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeNatCcnFwSwitchRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "CcnId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeNatCcnFwSwitchRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeNatCcnFwSwitchResponseParams struct {
	...
	// <p>接入的实例列表</p>
	AccessInstanceList []*AccessInstanceInfo `json:"AccessInstanceList,omitnil,omitempty" name:"AccessInstanceList"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeNatCcnFwSwitchResponse struct {
	*tchttp.BaseResponse
	Response *DescribeNatCcnFwSwitchResponseParams `json:"Response"`
}

func (r *DescribeNatCcnFwSwitchResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeNatCcnFwSwitchResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeNatFwClusterRegionStatusRequestParams struct {
	// <p>NAT集群防火墙地域状态查询列表</p>
	NatClusterRegionStatusQueryList []*NatClusterRegionStatusQuery `json:"NatClusterRegionStatusQueryList,omitnil,omitempty" name:"NatClusterRegionStatusQueryList"`
}

type DescribeNatFwClusterRegionStatusRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeNatFwClusterRegionStatusRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeNatFwClusterRegionStatusRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "NatClusterRegionStatusQueryList")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeNatFwClusterRegionStatusRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeNatFwClusterRegionStatusResponseParams struct {
	// <p>返回地域数量</p>
	Total *int64 `json:"Total,omitnil,omitempty" name:"Total"`

	// <p>地域防火墙集群状态列表</p>
	// 注意：此字段可能返回 null，表示取不到有效值。
	RegionFwStatus []*NatFwClusterRegionStatus `json:"RegionFwStatus,omitnil,omitempty" name:"RegionFwStatus"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeNatFwClusterRegionStatusResponse struct {
	*tchttp.BaseResponse
	Response *DescribeNatFwClusterRegionStatusResponseParams `json:"Response"`
}

func (r *DescribeNatFwClusterRegionStatusResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeNatFwClusterRegionStatusResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeNatRuleScopesRequestParams struct {
...
func (r *DescribeNatRuleScopesRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeNatRuleScopesRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeNatRuleScopesResponseParams struct {
	// 可选生效范围总数
	Total *int64 `json:"Total,omitnil,omitempty" name:"Total"`

	// 生效范围列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	ScopeItems []*RuleScopeInfo `json:"ScopeItems,omitnil,omitempty" name:"ScopeItems"`
...
type DescribeNatRuleScopesResponse struct {
	*tchttp.BaseResponse
	Response *DescribeNatRuleScopesResponseParams `json:"Response"`
}
...
// Predefined struct for user
type DescribeSecurityGroupRegionListRequestParams struct {

}

type DescribeSecurityGroupRegionListRequest struct {
	*tchttp.BaseRequest
	
}

func (r *DescribeSecurityGroupRegionListRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeSecurityGroupRegionListRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeSecurityGroupRegionListRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeSecurityGroupRegionListResponseParams struct {
	// <p>配置信息</p>
	Data []*SecurityGroupRegion `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeSecurityGroupRegionListResponse struct {
	*tchttp.BaseResponse
	Response *DescribeSecurityGroupRegionListResponseParams `json:"Response"`
}

func (r *DescribeSecurityGroupRegionListResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeSecurityGroupRegionListResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DescribeVpcAclEdgeRangeRequestParams struct {
	// 规则列表来源：rules，来源于当前已配置的规则；switchs，来源于开关列表
	FromList *string `json:"FromList,omitnil,omitempty" name:"FromList"`
...
func (r *DescribeVpcAclEdgeRangeRequest) FromJsonString(s string) error {
	...
	delete(f, "By")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeVpcAclEdgeRangeRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeVpcAclEdgeRangeResponseParams struct {
	// 总条数
	TotalCount *uint64 `json:"TotalCount,omitnil,omitempty" name:"TotalCount"`

	// 内网间访问控制规则的生效范围列表
	EdgeRanges []*EdgeRange `json:"EdgeRanges,omitnil,omitempty" name:"EdgeRanges"`
...
type DescribeVpcAclEdgeRangeResponse struct {
	*tchttp.BaseResponse
	Response *DescribeVpcAclEdgeRangeResponseParams `json:"Response"`
}
...
type EdgeRange struct {
	...
	// 本端网络实例Id
	SrcId *string `json:"SrcId,omitnil,omitempty" name:"SrcId"`
	...
	// 本端网络实例cidr，多个以逗号分隔
	SrcCidr *string `json:"SrcCidr,omitnil,omitempty" name:"SrcCidr"`

	// 对端网络实例Id
	DstId *string `json:"DstId,omitnil,omitempty" name:"DstId"`

	// 对端网络实例所属地域
	DstRegion *string `json:"DstRegion,omitnil,omitempty" name:"DstRegion"`

	// 对端网络实例名称
	DstName *string `json:"DstName,omitnil,omitempty" name:"DstName"`

	// 对端网络实例cidr，多个以逗号分隔
	DstCidr *string `json:"DstCidr,omitnil,omitempty" name:"DstCidr"`
}
...
type IdsWhiteRule struct {
	...
	Info *WhiteRuleInfo `json:"Info,omitnil,omitempty" name:"Info"`
...
func (r *ModifyClusterFwBypassRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyClusterFwBypassRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "NatInsId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ModifyClusterFwBypassRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyClusterFwBypassResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyClusterFwBypassResponse struct {
	*tchttp.BaseResponse
	Response *ModifyClusterFwBypassResponseParams `json:"Response"`
}

func (r *ModifyClusterFwBypassResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyClusterFwBypassResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *ModifyClusterNatFwSwitchRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyClusterNatFwSwitchRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "NatCcnSwitch")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ModifyClusterNatFwSwitchRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyClusterNatFwSwitchResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyClusterNatFwSwitchResponse struct {
	*tchttp.BaseResponse
	Response *ModifyClusterNatFwSwitchResponseParams `json:"Response"`
}

func (r *ModifyClusterNatFwSwitchResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyClusterNatFwSwitchResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ModifyWhiteRuleRequestParams struct {
	...
	Rule *IdsWhiteRule `json:"Rule,omitnil,omitempty" name:"Rule"`
...
type ModifyWhiteRuleRequest struct {
	*tchttp.BaseRequest
...
func (r *ModifyWhiteRuleRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyWhiteRuleRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "CoverDuplicate")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ModifyWhiteRuleRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyWhiteRuleResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyWhiteRuleResponse struct {
	*tchttp.BaseResponse
	Response *ModifyWhiteRuleResponseParams `json:"Response"`
}

func (r *ModifyWhiteRuleResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyWhiteRuleResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type NatCcnSwitchConfig struct {
	// <p>NAT防火墙实例ID</p>
	NatInsId *string `json:"NatInsId,omitnil,omitempty" name:"NatInsId"`
	...
	// <p>引流VPC的CIDR网段</p>
	LeadVpcCidr *string `json:"LeadVpcCidr,omitnil,omitempty" name:"LeadVpcCidr"`
}
...
type NatClusterRegionStatusQuery struct {
	// <p>云联网ID</p>
	CcnId *string `json:"CcnId,omitnil,omitempty" name:"CcnId"`
...
type NatFwClusterRegionStatus struct {
	// <p>NAT网关ID</p>
	NatInsId *string `json:"NatInsId,omitnil,omitempty" name:"NatInsId"`
...
type NatFwSwitchDetailS struct {
	// <p>NAT实例ID</p>
	InsObj *string `json:"InsObj,omitnil,omitempty" name:"InsObj"`
	...
	// <p>流量监控开关</p>
	TransEnable *int64 `json:"TransEnable,omitnil,omitempty" name:"TransEnable"`

	// <p>Bypass状态，0-关闭，1-开启</p>
	Bypass *int64 `json:"Bypass,omitnil,omitempty" name:"Bypass"`

	// <p>关联ID，nat_ccn资产类型时为云联网实例ID, nat资产类型时为空</p>
	AttachId *string `json:"AttachId,omitnil,omitempty" name:"AttachId"`

	// <p>关联ID的实例名称，nat_ccn资产类型时为云联网名称</p>
	AttachName *string `json:"AttachName,omitnil,omitempty" name:"AttachName"`

	// <p>NAT防火墙所在VPC ID</p>
	NatVpcId *string `json:"NatVpcId,omitnil,omitempty" name:"NatVpcId"`

	// <p>NAT防火墙所在VPC的VPC名称</p>
	NatVpcName *string `json:"NatVpcName,omitnil,omitempty" name:"NatVpcName"`
...
func (r *OpenClusterNatFwSwitchRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *OpenClusterNatFwSwitchRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "NatCcnSwitch")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "OpenClusterNatFwSwitchRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type OpenClusterNatFwSwitchResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type OpenClusterNatFwSwitchResponse struct {
	*tchttp.BaseResponse
	Response *OpenClusterNatFwSwitchResponseParams `json:"Response"`
}

func (r *OpenClusterNatFwSwitchResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *OpenClusterNatFwSwitchResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type SecurityGroupRegion struct {
	// <p>地域</p>
	Region *string `json:"Region,omitnil,omitempty" name:"Region"`
...
type WhiteRuleInfo struct {
	...
	// 白名单策略唯一 ID。
	WhiteId *string `json:"WhiteId,omitnil,omitempty" name:"WhiteId"`
