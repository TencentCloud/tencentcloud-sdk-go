...
type Alias struct {
	...
	// 别名的全局唯一资源标识符
	AliasArn *string `json:"AliasArn,omitnil" name:"AliasArn"`
	...
	// 别名的路由配置
	RoutingStrategy *RoutingStrategy `json:"RoutingStrategy,omitnil" name:"RoutingStrategy"`

	// 创建时间
	CreationTime *string `json:"CreationTime,omitnil" name:"CreationTime"`

	// 上次修改此数据对象的时间
	LastUpdatedTime *string `json:"LastUpdatedTime,omitnil" name:"LastUpdatedTime"`
...
type Asset struct {
	...
	AssetVersion *string `json:"AssetVersion,omitnil" name:"AssetVersion"`

	// 生成包可运行的操作系统，暂时只支持CentOS7.16
	OperateSystem *string `json:"OperateSystem,omitnil" name:"OperateSystem"`

	// 生成包状态，0代表上传中，1代表上传失败，2代表上传成功
	Stauts *int64 `json:"Stauts,omitnil" name:"Stauts"`
	...
	// 生成包绑定的Fleet个数，最小值为0
	BindFleetNum *int64 `json:"BindFleetNum,omitnil" name:"BindFleetNum"`

	// 生成包的全局唯一资源标识符
	AssetArn *string `json:"AssetArn,omitnil" name:"AssetArn"`
	...
	SharingStatus *string `json:"SharingStatus,omitnil" name:"SharingStatus"`
...
type AssetSupportSys struct {
	...
	// 生成包操作系统的位数
	OsBit *int64 `json:"OsBit,omitnil" name:"OsBit"`
...
type CreateAliasResponseParams struct {
	// 别名对象
	Alias *Alias `json:"Alias,omitnil" name:"Alias"`
...
type CreateAssetRequestParams struct {
	...
	AssetRegion *string `json:"AssetRegion,omitnil" name:"AssetRegion"`
...
type CreateAssetWithImageRequestParams struct {
	...
	ImageSize *string `json:"ImageSize,omitnil" name:"ImageSize"`

	// 操作系统镜像包名称，最小长度为1，最大长度为64
	ImageOs *string `json:"ImageOs,omitnil" name:"ImageOs"`
...
type CreateGameServerSessionQueueRequestParams struct {
	...
	// 目的服务器舰队（可为别名）列表
	Destinations []*GameServerSessionQueueDestination `json:"Destinations,omitnil" name:"Destinations"`

	// 延迟策略集合
	PlayerLatencyPolicies []*PlayerLatencyPolicy `json:"PlayerLatencyPolicies,omitnil" name:"PlayerLatencyPolicies"`

	// 超时时间（单位秒，默认值为600秒）
	TimeoutInSeconds *uint64 `json:"TimeoutInSeconds,omitnil" name:"TimeoutInSeconds"`
...
type CreateGameServerSessionQueueResponseParams struct {
	// 游戏服务器会话队列
	GameServerSessionQueue *GameServerSessionQueue `json:"GameServerSessionQueue,omitnil" name:"GameServerSessionQueue"`
...
type DescribeAssetSystemsResponseParams struct {
	// 生成包支持的操作系统类型列表
	AssetSupportSys []*AssetSupportSys `json:"AssetSupportSys,omitnil" name:"AssetSupportSys"`
...
type DescribeAssetsResponseParams struct {
	...
	// 生成包列表
	Assets []*Asset `json:"Assets,omitnil" name:"Assets"`
...
type DescribeCcnInstancesResponseParams struct {
	// 云联网实例信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	CcnInstanceSets []*CcnInstanceSets `json:"CcnInstanceSets,omitnil" name:"CcnInstanceSets"`
...
type DescribeFleetAttributesRequestParams struct {
	// 服务器舰队 Ids
	FleetIds []*string `json:"FleetIds,omitnil" name:"FleetIds"`
...
type DescribeFleetCapacityResponseParams struct {
	// 服务器舰队的容量配置
	// 注意：此字段可能返回 null，表示取不到有效值。
	FleetCapacity []*FleetCapacity `json:"FleetCapacity,omitnil" name:"FleetCapacity"`
...
type DescribeFleetRelatedResourcesResponseParams struct {
	// 与服务器舰队关联的资源信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	Resources []*FleetRelatedResource `json:"Resources,omitnil" name:"Resources"`
...
type DescribeFleetStatisticDetailsResponseParams struct {
	// 服务部署统计详情列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	DetailList []*FleetStatisticDetail `json:"DetailList,omitnil" name:"DetailList"`
...
type DescribeFleetStatisticFlowsResponseParams struct {
	// 流量统计列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	UsedFlowList []*FleetStatisticFlows `json:"UsedFlowList,omitnil" name:"UsedFlowList"`

	// 时长统计列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	UsedTimeList []*FleetStatisticTimes `json:"UsedTimeList,omitnil" name:"UsedTimeList"`
...
type DescribeFleetStatisticSummaryResponseParams struct {
	// 总时长，单位秒
	// 注意：此字段可能返回 null，表示取不到有效值。
	TotalUsedTimeSeconds *string `json:"TotalUsedTimeSeconds,omitnil" name:"TotalUsedTimeSeconds"`

	// 总流量，单位MB
	// 注意：此字段可能返回 null，表示取不到有效值。
	TotalUsedFlowMegaBytes *float64 `json:"TotalUsedFlowMegaBytes,omitnil" name:"TotalUsedFlowMegaBytes"`
...
type DescribeFleetUtilizationResponseParams struct {
	// 服务器舰队利用率
	// 注意：此字段可能返回 null，表示取不到有效值。
	FleetUtilization []*FleetUtilization `json:"FleetUtilization,omitnil" name:"FleetUtilization"`
...
type DescribeGameServerSessionQueuesResponseParams struct {
	// 游戏服务器会话队列数组
	// 注意：此字段可能返回 null，表示取不到有效值。
	GameServerSessionQueues []*GameServerSessionQueue `json:"GameServerSessionQueues,omitnil" name:"GameServerSessionQueues"`
...
type DescribeInstanceLimitResponseParams struct {
	...
	// 详细信息
	ExtraInfos []*ExtraInfos `json:"ExtraInfos,omitnil" name:"ExtraInfos"`
...
type DescribeInstancesExtendResponseParams struct {
	// 实例信息列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	Instances []*InstanceExtend `json:"Instances,omitnil" name:"Instances"`
...
type DescribeScalingPoliciesResponseParams struct {
	// 动态扩缩容配置策略数组
	// 注意：此字段可能返回 null，表示取不到有效值。
	ScalingPolicies []*ScalingPolicy `json:"ScalingPolicies,omitnil" name:"ScalingPolicies"`
...
type DescribeUserQuotaResponseParams struct {
	// 配额资源信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	QuotaResource *QuotaResource `json:"QuotaResource,omitnil" name:"QuotaResource"`
...
type Event struct {
	...
	// 事件相关的日志存储路径
	// 注意：此字段可能返回 null，表示取不到有效值。
	PreSignedLogUrl *string `json:"PreSignedLogUrl,omitnil" name:"PreSignedLogUrl"`
...
type ExtraInfos struct {
	...
	// 实例限额数
	// 注意：此字段可能返回 null，表示取不到有效值。
	TotalInstances *uint64 `json:"TotalInstances,omitnil" name:"TotalInstances"`
}
...
type FleetCapacity struct {
	...
	// 服务器实例统计数据
	// 注意：此字段可能返回 null，表示取不到有效值。
	InstanceCounts *InstanceCounts `json:"InstanceCounts,omitnil" name:"InstanceCounts"`

	// 服务器伸缩容间隔，单位分钟，最小值3，最大值30，默认值10
	// 注意：此字段可能返回 null，表示取不到有效值。
	ScalingInterval *uint64 `json:"ScalingInterval,omitnil" name:"ScalingInterval"`
}
...
type FleetUtilization struct {
	// 游戏会话数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ActiveGameServerSessionCount *uint64 `json:"ActiveGameServerSessionCount,omitnil" name:"ActiveGameServerSessionCount"`

	// 活跃进程数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ActiveServerProcessCount *uint64 `json:"ActiveServerProcessCount,omitnil" name:"ActiveServerProcessCount"`
...
type GameServerSessionQueue struct {
	...
	// 服务部署组资源
	GameServerSessionQueueArn *string `json:"GameServerSessionQueueArn,omitnil" name:"GameServerSessionQueueArn"`
...
type GameServerSessionQueueDestination struct {
	// 服务部署组目的的资源描述
	// 注意：此字段可能返回 null，表示取不到有效值。
	DestinationArn *string `json:"DestinationArn,omitnil" name:"DestinationArn"`

	// 服务部署组目的的状态
	// 注意：此字段可能返回 null，表示取不到有效值。
	FleetStatus *string `json:"FleetStatus,omitnil" name:"FleetStatus"`
}
...
type GetGameServerInstanceLogUrlResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	PresignedUrls []*string `json:"PresignedUrls,omitnil" name:"PresignedUrls"`

	// 总条数
	Total *uint64 `json:"Total,omitnil" name:"Total"`

	// 是否还有没拉取完的
	HasNext *bool `json:"HasNext,omitnil" name:"HasNext"`
...
type GetUploadCredentialsResponseParams struct {
	// 上传文件授权信息Auth
	BucketAuth *string `json:"BucketAuth,omitnil" name:"BucketAuth"`
...
type GetUploadFederationTokenResponseParams struct {
	...
	// 临时证书
	AssetCredentials *AssetCredentials `json:"AssetCredentials,omitnil" name:"AssetCredentials"`
...
type InstanceCounts struct {
	...
	// 期望的服务器实例数
	// 注意：此字段可能返回 null，表示取不到有效值。
	Desired *uint64 `json:"Desired,omitnil" name:"Desired"`
	...
	// 服务器实例数最大限制
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaxiNum *uint64 `json:"MaxiNum,omitnil" name:"MaxiNum"`

	// 服务器实例数最小限制
	// 注意：此字段可能返回 null，表示取不到有效值。
	MiniNum *uint64 `json:"MiniNum,omitnil" name:"MiniNum"`

	// 已开始创建，但未激活的服务器实例数
	// 注意：此字段可能返回 null，表示取不到有效值。
	Pending *uint64 `json:"Pending,omitnil" name:"Pending"`

	// 结束中的服务器实例数
	// 注意：此字段可能返回 null，表示取不到有效值。
	Terminating *uint64 `json:"Terminating,omitnil" name:"Terminating"`
}

type InstanceExtend struct {
	// 实例信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	Instance *Instance `json:"Instance,omitnil" name:"Instance"`
	...
	// 健康进程数
	// 注意：此字段可能返回 null，表示取不到有效值。
	HealthyProcessCnt *int64 `json:"HealthyProcessCnt,omitnil" name:"HealthyProcessCnt"`

	// 活跃进程数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ActiveProcessCnt *int64 `json:"ActiveProcessCnt,omitnil" name:"ActiveProcessCnt"`

	// 当前游戏会话总数
	// 注意：此字段可能返回 null，表示取不到有效值。
	GameSessionCnt *int64 `json:"GameSessionCnt,omitnil" name:"GameSessionCnt"`

	// 最大游戏会话数
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaxGameSessionCnt *int64 `json:"MaxGameSessionCnt,omitnil" name:"MaxGameSessionCnt"`

	// 当前玩家会话数
	// 注意：此字段可能返回 null，表示取不到有效值。
	PlayerSessionCnt *int64 `json:"PlayerSessionCnt,omitnil" name:"PlayerSessionCnt"`

	// 最大玩家会话数
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaxPlayerSessionCnt *int64 `json:"MaxPlayerSessionCnt,omitnil" name:"MaxPlayerSessionCnt"`
}
...
type ListAliasesRequestParams struct {
	...
	RoutingStrategyType *string `json:"RoutingStrategyType,omitnil" name:"RoutingStrategyType"`
	...
	// 排序方式，有效值asc|desc
	OrderWay *string `json:"OrderWay,omitnil" name:"OrderWay"`
...
type PlayerLatencyPolicy struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaximumIndividualPlayerLatencyMilliseconds *uint64 `json:"MaximumIndividualPlayerLatencyMilliseconds,omitnil" name:"MaximumIndividualPlayerLatencyMilliseconds"`

	// 放置新GameServerSession时强制实施策略的时间长度，单位：秒
	// 注意：此字段可能返回 null，表示取不到有效值。
	PolicyDurationSeconds *uint64 `json:"PolicyDurationSeconds,omitnil" name:"PolicyDurationSeconds"`
}
...
type PutScalingPolicyRequestParams struct {
	...
	ScalingAdjustment *int64 `json:"ScalingAdjustment,omitnil" name:"ScalingAdjustment"`

	// 扩缩容调整类型，取值（ChangeInCapacity，ExactCapacity，PercentChangeInCapacity）
	ScalingAdjustmentType *string `json:"ScalingAdjustmentType,omitnil" name:"ScalingAdjustmentType"`
	...
	// 单个策略持续时间长度（分钟）
	EvaluationPeriods *int64 `json:"EvaluationPeriods,omitnil" name:"EvaluationPeriods"`
...
type QuotaResource struct {
	...
	// 总额度
	// 注意：此字段可能返回 null，表示取不到有效值。
	HardLimit *uint64 `json:"HardLimit,omitnil" name:"HardLimit"`
...
type ScalingPolicy struct {
	...
	// 保留参数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ScalingAdjustment *string `json:"ScalingAdjustment,omitnil" name:"ScalingAdjustment"`
	...
	// 保留参数
	// 注意：此字段可能返回 null，表示取不到有效值。
	Threshold *string `json:"Threshold,omitnil" name:"Threshold"`

	// 保留参数
	// 注意：此字段可能返回 null，表示取不到有效值。
	EvaluationPeriods *string `json:"EvaluationPeriods,omitnil" name:"EvaluationPeriods"`
...
type UpdateFleetAttributesRequestParams struct {
	...
	// 保护策略：不保护NoProtection、完全保护FullProtection、时限保护TimeLimitProtection
	NewGameSessionProtectionPolicy *string `json:"NewGameSessionProtectionPolicy,omitnil" name:"NewGameSessionProtectionPolicy"`
...
type UpdateFleetCapacityRequestParams struct {
	...
	// 期望的服务器实例数
	DesiredInstances *uint64 `json:"DesiredInstances,omitnil" name:"DesiredInstances"`
...
type UpdateFleetPortSettingsRequestParams struct {
	...
	// 新增安全组
	InboundPermissionAuthorizations []*InboundPermissionAuthorization `json:"InboundPermissionAuthorizations,omitnil" name:"InboundPermissionAuthorizations"`

	// 移除安全组
	InboundPermissionRevocations []*InboundPermissionRevocations `json:"InboundPermissionRevocations,omitnil" name:"InboundPermissionRevocations"`
}
