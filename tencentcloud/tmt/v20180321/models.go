...
type FileTranslateRequestParams struct {
	...
	// 原始文档类型
	BasicDocumentType *string `json:"BasicDocumentType,omitnil" name:"BasicDocumentType"`
...
type GetFileTranslateData struct {
	...
	FileData *string `json:"FileData,omitnil" name:"FileData"`
...
type GetFileTranslateResponseParams struct {
	// 任务id
	Data *GetFileTranslateData `json:"Data,omitnil" name:"Data"`
...
type ImageRecord struct {
	// 图片翻译结果
	Value []*ItemValue `json:"Value,omitnil" name:"Value"`
}

// Predefined struct for user
type ImageTranslateRequestParams struct {
	// 唯一id，返回时原样返回
	SessionUuid *string `json:"SessionUuid,omitnil" name:"SessionUuid"`
...
type ImageTranslateResponseParams struct {
	...
	ImageRecord *ImageRecord `json:"ImageRecord,omitnil" name:"ImageRecord"`
...
type SpeechTranslateRequestParams struct {
	...
	AudioFormat *int64 `json:"AudioFormat,omitnil" name:"AudioFormat"`

	// 语音分片的序号，从0开始
	Seq *int64 `json:"Seq,omitnil" name:"Seq"`

	// 是否最后一片语音分片，0-否，1-是
	IsEnd *int64 `json:"IsEnd,omitnil" name:"IsEnd"`
	...
	// 该参数已废弃
	TransType *int64 `json:"TransType,omitnil" name:"TransType"`
}
...
type SpeechTranslateResponseParams struct {
	...
	// 语音识别状态 1-进行中 0-完成
	RecognizeStatus *int64 `json:"RecognizeStatus,omitnil" name:"RecognizeStatus"`
	...
	VadSeq *int64 `json:"VadSeq,omitnil" name:"VadSeq"`
...
type TextTranslateBatchRequestParams struct {
	...
	SourceTextList []*string `json:"SourceTextList,omitnil" name:"SourceTextList"`
}
...
type TextTranslateBatchResponseParams struct {
	...
	// 翻译后的文本列表
	TargetTextList []*string `json:"TargetTextList,omitnil" name:"TargetTextList"`
