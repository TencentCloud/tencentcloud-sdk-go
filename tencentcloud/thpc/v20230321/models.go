...
type StorageOption struct {
	...
	// 集群挂载GooseFSx文件系统选项。
	GooseFSxOptions []*GooseFSxOption `json:"GooseFSxOptions,omitempty" name:"GooseFSxOptions"`
}
...
type StorageOptionOverview struct {
	...
	// GooseFSx存储选项概览信息列表。
	GooseFSxOptions []*GooseFSxOptionOverview `json:"GooseFSxOptions,omitempty" name:"GooseFSxOptions"`
}
