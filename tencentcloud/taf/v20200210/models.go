...
type ManageDeviceRiskInput struct {
	// 设备操作平台  1：android
...
type ManageDeviceRiskOutput struct {
	...
	Value *ManageDeviceRiskValueOutput `json:"Value,omitnil,omitempty" name:"Value"`
}

// Predefined struct for user
type ManageDeviceRiskRequestParams struct {
	// 业务入参
	BusinessSecurityData *ManageDeviceRiskInput `json:"BusinessSecurityData,omitnil,omitempty" name:"BusinessSecurityData"`
}

type ManageDeviceRiskRequest struct {
	*tchttp.BaseRequest
...
func (r *ManageDeviceRiskRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
func (r *ManageDeviceRiskRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ManageDeviceRiskRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ManageDeviceRiskResponseParams struct {
	// 业务出参
	Data *ManageDeviceRiskOutput `json:"Data,omitnil,omitempty" name:"Data"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ManageDeviceRiskResponse struct {
	*tchttp.BaseResponse
	Response *ManageDeviceRiskResponseParams `json:"Response"`
}

func (r *ManageDeviceRiskResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ManageDeviceRiskResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

type ManageDeviceRiskValueOutput struct {
	// 设备评分
