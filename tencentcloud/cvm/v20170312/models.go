...
type AccountQuota struct {
	// 后付费配额列表
	PostPaidQuotaSet []*PostPaidQuota `json:"PostPaidQuotaSet,omitnil" name:"PostPaidQuotaSet"`

	// 预付费配额列表
	PrePaidQuotaSet []*PrePaidQuota `json:"PrePaidQuotaSet,omitnil" name:"PrePaidQuotaSet"`

	// spot配额列表
	SpotPaidQuotaSet []*SpotPaidQuota `json:"SpotPaidQuotaSet,omitnil" name:"SpotPaidQuotaSet"`

	// 镜像配额列表
	ImageQuotaSet []*ImageQuota `json:"ImageQuotaSet,omitnil" name:"ImageQuotaSet"`

	// 置放群组配额列表
	DisasterRecoverGroupQuotaSet []*DisasterRecoverGroupQuota `json:"DisasterRecoverGroupQuotaSet,omitnil" name:"DisasterRecoverGroupQuotaSet"`
}
...
type AccountQuotaOverview struct {
	...
	// 配额数据
	AccountQuota *AccountQuota `json:"AccountQuota,omitnil" name:"AccountQuota"`
}
...
type CreateHpcClusterResponseParams struct {
	// 高性能计算集群信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	HpcClusterSet []*HpcClusterInfo `json:"HpcClusterSet,omitnil" name:"HpcClusterSet"`
...
type DeleteHpcClustersRequestParams struct {
	// 高性能计算集群ID列表。
	HpcClusterIds []*string `json:"HpcClusterIds,omitnil" name:"HpcClusterIds"`
}
...
type DescribeAccountQuotaResponseParams struct {
	...
	// 配额数据
	AccountQuotaOverview *AccountQuotaOverview `json:"AccountQuotaOverview,omitnil" name:"AccountQuotaOverview"`
...
type DescribeInstanceInternetBandwidthConfigsResponseParams struct {
	// 带宽配置信息列表。
	InternetBandwidthConfigSet []*InternetBandwidthConfig `json:"InternetBandwidthConfigSet,omitnil" name:"InternetBandwidthConfigSet"`
...
type DescribeInstancesModificationResponseParams struct {
	...
	// 实例支持调整的机型配置列表。
	InstanceTypeConfigStatusSet []*InstanceTypeConfigStatus `json:"InstanceTypeConfigStatusSet,omitnil" name:"InstanceTypeConfigStatusSet"`
...
type DescribeReservedInstancesResponseParams struct {
	...
	// 符合条件的预留实例计费列表。
	ReservedInstancesSet []*ReservedInstances `json:"ReservedInstancesSet,omitnil" name:"ReservedInstancesSet"`
...
type DescribeTaskInfoRequestParams struct {
	...
	TaskTypeIds []*int64 `json:"TaskTypeIds,omitnil" name:"TaskTypeIds"`
...
type DescribeTaskInfoResponseParams struct {
	...
	// 查询返回的维修任务列表。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RepairTaskInfoSet []*RepairTaskInfo `json:"RepairTaskInfoSet,omitnil" name:"RepairTaskInfoSet"`
...
type DisasterRecoverGroupQuota struct {
	...
	// 交换机类型容灾组内实例的配额数。
	CvmInSwitchGroupQuota *int64 `json:"CvmInSwitchGroupQuota,omitnil" name:"CvmInSwitchGroupQuota"`
...
type HostPriceInfo struct {
	// 描述了cdh实例相关的价格信息
	HostPrice *ItemPrice `json:"HostPrice,omitnil" name:"HostPrice"`
}
...
type HostResource struct {
	...
	// CDH owner
	// 注意：此字段可能返回 null，表示取不到有效值。
	ExclusiveOwner *string `json:"ExclusiveOwner,omitnil" name:"ExclusiveOwner"`
}
...
type HpcClusterInfo struct {
	...
	// 集群下设备容量
	CvmQuotaTotal *uint64 `json:"CvmQuotaTotal,omitnil" name:"CvmQuotaTotal"`

	// 集群所在可用区
	Zone *string `json:"Zone,omitnil" name:"Zone"`

	// 集群当前已有设备量
	CurrentNum *uint64 `json:"CurrentNum,omitnil" name:"CurrentNum"`
...
type ImageQuota struct {
	// 已使用配额
	UsedQuota *uint64 `json:"UsedQuota,omitnil" name:"UsedQuota"`

	// 总配额
	TotalQuota *uint64 `json:"TotalQuota,omitnil" name:"TotalQuota"`
}
...
type InquiryPriceModifyInstancesChargeTypeRequestParams struct {
	...
	ModifyPortableDataDisk *bool `json:"ModifyPortableDataDisk,omitnil" name:"ModifyPortableDataDisk"`
}
...
type InquiryPriceRenewHostsResponseParams struct {
	// CDH实例续费价格信息
	Price *HostPriceInfo `json:"Price,omitnil" name:"Price"`
...
type InquiryPriceRenewInstancesRequestParams struct {
	...
	RenewPortableDataDisk *bool `json:"RenewPortableDataDisk,omitnil" name:"RenewPortableDataDisk"`
}
...
type InquiryPriceTerminateInstancesResponseParams struct {
	// 退款详情。
	InstanceRefundsSet []*InstanceRefund `json:"InstanceRefundsSet,omitnil" name:"InstanceRefundsSet"`
...
type InstanceRefund struct {
	...
	// 退款数额。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Refunds *float64 `json:"Refunds,omitnil" name:"Refunds"`

	// 退款详情。
	// 注意：此字段可能返回 null，表示取不到有效值。
	PriceDetail *string `json:"PriceDetail,omitnil" name:"PriceDetail"`
}
...
type ModifyInstancesAttributeRequestParams struct {
	...
	// 注意点：本参数仅对修改主机名生效。
	AutoReboot *bool `json:"AutoReboot,omitnil" name:"AutoReboot"`
}
...
type PostPaidQuota struct {
	...
	// 剩余配额
	RemainingQuota *uint64 `json:"RemainingQuota,omitnil" name:"RemainingQuota"`
...
type PrePaidQuota struct {
	...
	// 单次购买最大数量
	OnceQuota *uint64 `json:"OnceQuota,omitnil" name:"OnceQuota"`
...
type ProgramFpgaImageRequestParams struct {
	...
	// FPGA镜像文件的COS URL地址。
	FPGAUrl *string `json:"FPGAUrl,omitnil" name:"FPGAUrl"`

	// 实例上FPGA卡的DBDF号，不填默认烧录FPGA镜像到实例所拥有的所有FPGA卡。
	DBDFs []*string `json:"DBDFs,omitnil" name:"DBDFs"`
...
type RepairTaskControlRequestParams struct {
	...
	OrderAuthTime *string `json:"OrderAuthTime,omitnil" name:"OrderAuthTime"`

	// 附加的授权处理策略。
	TaskSubMethod *string `json:"TaskSubMethod,omitnil" name:"TaskSubMethod"`
}
...
type ReservedInstances struct {
	...
	ReservedInstancesId *string `json:"ReservedInstancesId,omitnil" name:"ReservedInstancesId"`
