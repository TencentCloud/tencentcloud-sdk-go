...
type DescribeTaskDetailRequestParams struct {
	...
	// 任务告警状态
	TaskAlarmStatus *int64 `json:"TaskAlarmStatus,omitnil,omitempty" name:"TaskAlarmStatus"`
}
...
type DescribeTaskDetailResponseParams struct {
	// 任务详情1
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data *TaskInfoData `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeTasksByPageResponseParams struct {
	// 无1
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data *TaskInfoDataPage `json:"Data,omitnil,omitempty" name:"Data"`
...
type TaskInfoData struct {
	...
	// 任务参数
	// 注意：此字段可能返回 null，表示取不到有效值。
	Params []*ParamInfo `json:"Params,omitnil,omitempty" name:"Params"`
	...
	// 依赖配置
	// 注意：此字段可能返回 null，表示取不到有效值。
	DependencyConfigs []*DependencyConfig `json:"DependencyConfigs,omitnil,omitempty" name:"DependencyConfigs"`
...
type TaskInfoDataPage struct {
	...
	// 任务集合信息
	Items []*TaskInfoData `json:"Items,omitnil,omitempty" name:"Items"`
