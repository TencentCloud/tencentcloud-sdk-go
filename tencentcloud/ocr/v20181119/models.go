...
type CardWarnInfo struct {
	...
	ReflectCheck *int64 `json:"ReflectCheck,omitnil,omitempty" name:"ReflectCheck"`
}
...
type ReasoningConfig struct {
	...
	EnableImageInput *bool `json:"EnableImageInput,omitnil,omitempty" name:"EnableImageInput"`
}
...
type ReasoningResult struct {
	...
	RawOutput *string `json:"RawOutput,omitnil,omitempty" name:"RawOutput"`

	// <p>变量替换后的实际 Prompt（脱敏后）。</p>
	RenderedPrompt *string `json:"RenderedPrompt,omitnil,omitempty" name:"RenderedPrompt"`
}
...
type RecognizeValidIDCardOCRRequestParams struct {
	...
	EnableReflectCheck *bool `json:"EnableReflectCheck,omitnil,omitempty" name:"EnableReflectCheck"`
...
type VerifyScenePhotoRequestParams struct {
	...
	ReasoningPrompt *string `json:"ReasoningPrompt,omitnil,omitempty" name:"ReasoningPrompt"`
...
type VerifyScenePhotoResponseParams struct {
	...
	// <p>模板图片提示</p>
	Template *SceneWarnInfo `json:"Template,omitnil,omitempty" name:"Template"`

	// <p>VLM 推理结果。仅当请求中传入 ReasoningPrompt 时返回，否则不返回此字段。</p>
	ReasoningResult *ReasoningResult `json:"ReasoningResult,omitnil,omitempty" name:"ReasoningResult"`
