...
// Predefined struct for user
type BindTWeTalkAgentRequestParams struct {
	// <p>产品 ID</p>
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
	...
	BindingScope *string `json:"BindingScope,omitnil,omitempty" name:"BindingScope"`
...
type BindTWeTalkAgentRequest struct {
	*tchttp.BaseRequest
...
func (r *BindTWeTalkAgentRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *BindTWeTalkAgentRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "ProductId")
	delete(f, "AgentId")
	delete(f, "BindingScope")
	delete(f, "DeviceName")
	delete(f, "Priority")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "BindTWeTalkAgentRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type BindTWeTalkAgentResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type BindTWeTalkAgentResponse struct {
	*tchttp.BaseResponse
	Response *BindTWeTalkAgentResponseParams `json:"Response"`
}

func (r *BindTWeTalkAgentResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *BindTWeTalkAgentResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type CreateTWeSeePersonRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type CreateTWeSeePersonRequest struct {
	*tchttp.BaseRequest
...
func (r *CreateTWeSeePersonRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeSeePersonRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ChannelId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CreateTWeSeePersonRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CreateTWeSeePersonResponseParams struct {
	// 人员信息
	Person *SeePersonInfo `json:"Person,omitnil,omitempty" name:"Person"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type CreateTWeSeePersonResponse struct {
	*tchttp.BaseResponse
	Response *CreateTWeSeePersonResponseParams `json:"Response"`
}

func (r *CreateTWeSeePersonResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeSeePersonResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type CreateTWeSeeServiceRequest struct {
	*tchttp.BaseRequest
...
func (r *CreateTWeSeeServiceRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeSeeServiceRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "Service")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "CreateTWeSeeServiceRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type CreateTWeSeeServiceResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type CreateTWeSeeServiceResponse struct {
	*tchttp.BaseResponse
	Response *CreateTWeSeeServiceResponseParams `json:"Response"`
}

func (r *CreateTWeSeeServiceResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// Predefined struct for user
type CreateTWeTalkAgentRequestParams struct {
	// <p>语音识别配置</p>
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeTalkAgentRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
// Predefined struct for user
type CreateTWeTalkAgentResponseParams struct {
	// <p>智能体ID</p>
	AgentId *string `json:"AgentId,omitnil,omitempty" name:"AgentId"`
...
type CreateTWeTalkAgentResponse struct {
	*tchttp.BaseResponse
	Response *CreateTWeTalkAgentResponseParams `json:"Response"`
}

func (r *CreateTWeTalkAgentResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeTalkAgentResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type CreateTWeTalkProductConfigRequest struct {
	*tchttp.BaseRequest
...
func (r *CreateTWeTalkProductConfigRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeTalkProductConfigRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
// Predefined struct for user
type CreateTWeTalkProductConfigResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type CreateTWeTalkProductConfigResponse struct {
	*tchttp.BaseResponse
	Response *CreateTWeTalkProductConfigResponseParams `json:"Response"`
}

func (r *CreateTWeTalkProductConfigResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *CreateTWeTalkProductConfigResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DeleteTWeSeeFaceRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type DeleteTWeSeeFaceRequest struct {
	*tchttp.BaseRequest
...
func (r *DeleteTWeSeeFaceRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeSeeFaceRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ChannelId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DeleteTWeSeeFaceRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteTWeSeeFaceResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DeleteTWeSeeFaceResponse struct {
	*tchttp.BaseResponse
	Response *DeleteTWeSeeFaceResponseParams `json:"Response"`
}

func (r *DeleteTWeSeeFaceResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeSeeFaceResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteTWeSeePersonRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
	...
	DeleteFaces *bool `json:"DeleteFaces,omitnil,omitempty" name:"DeleteFaces"`
}

type DeleteTWeSeePersonRequest struct {
	*tchttp.BaseRequest
...
func (r *DeleteTWeSeePersonRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeSeePersonRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "PersonId")
	delete(f, "ChannelId")
	delete(f, "DeleteFaces")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DeleteTWeSeePersonRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteTWeSeePersonResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DeleteTWeSeePersonResponse struct {
	*tchttp.BaseResponse
	Response *DeleteTWeSeePersonResponseParams `json:"Response"`
}

func (r *DeleteTWeSeePersonResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeSeePersonResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteTWeSeeTasksByConditionRequestParams struct {
	// <p>产品 ID</p>
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
	...
	Conditions []*SeeDeleteTaskCondition `json:"Conditions,omitnil,omitempty" name:"Conditions"`

	// <p>通道 ID</p><p>默认值：0</p>
	ChannelId *uint64 `json:"ChannelId,omitnil,omitempty" name:"ChannelId"`
}

type DeleteTWeSeeTasksByConditionRequest struct {
	*tchttp.BaseRequest
...
func (r *DeleteTWeSeeTasksByConditionRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeSeeTasksByConditionRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ChannelId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DeleteTWeSeeTasksByConditionRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteTWeSeeTasksByConditionResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DeleteTWeSeeTasksByConditionResponse struct {
	*tchttp.BaseResponse
	Response *DeleteTWeSeeTasksByConditionResponseParams `json:"Response"`
}

func (r *DeleteTWeSeeTasksByConditionResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeSeeTasksByConditionResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type DeleteTWeTalkAgentRequestParams struct {
	// <p>智能体ID</p>
	AgentId *string `json:"AgentId,omitnil,omitempty" name:"AgentId"`
}

type DeleteTWeTalkAgentRequest struct {
	*tchttp.BaseRequest
...
func (r *DeleteTWeTalkAgentRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeTalkAgentRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "AgentId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DeleteTWeTalkAgentRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DeleteTWeTalkAgentResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DeleteTWeTalkAgentResponse struct {
	*tchttp.BaseResponse
	Response *DeleteTWeTalkAgentResponseParams `json:"Response"`
}

func (r *DeleteTWeTalkAgentResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DeleteTWeTalkAgentResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeTWeSeeFaceRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeSeeFaceRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeSeeFaceRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ChannelId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeSeeFaceRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeSeeFaceResponseParams struct {
	// 人脸元数据
	Face *SeeFaceInfo `json:"Face,omitnil,omitempty" name:"Face"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeTWeSeeFaceResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeSeeFaceResponseParams `json:"Response"`
}

func (r *DescribeTWeSeeFaceResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeSeeFaceResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeSeePersonRequestParams struct {
	// 设备名称
	DeviceName *string `json:"DeviceName,omitnil,omitempty" name:"DeviceName"`
	...
	FaceLimit *uint64 `json:"FaceLimit,omitnil,omitempty" name:"FaceLimit"`
}

type DescribeTWeSeePersonRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeSeePersonRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeSeePersonRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "FaceLimit")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeSeePersonRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeSeePersonResponseParams struct {
	// 人员信息
	Person *SeePersonInfo `json:"Person,omitnil,omitempty" name:"Person"`
...
type DescribeTWeSeePersonResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeSeePersonResponseParams `json:"Response"`
}

func (r *DescribeTWeSeePersonResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeSeePersonResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeTWeSeeRecognitionTaskRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeSeeRecognitionTaskRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeSeeRecognitionTaskRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "FileURLExpireTime")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeSeeRecognitionTaskRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeSeeRecognitionTaskResponseParams struct {
	// 任务信息
	TaskInfo *VisionRecognitionTask `json:"TaskInfo,omitnil,omitempty" name:"TaskInfo"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeTWeSeeRecognitionTaskResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeSeeRecognitionTaskResponseParams `json:"Response"`
}

func (r *DescribeTWeSeeRecognitionTaskResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// Predefined struct for user
type DescribeTWeTalkAgentBindingRequestParams struct {
	// <p>产品 ID</p>
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type DescribeTWeTalkAgentBindingRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeTalkAgentBindingRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkAgentBindingRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeTalkAgentBindingRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeTalkAgentBindingResponseParams struct {
	// <p>总数</p>
...
type DescribeTWeTalkAgentBindingResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeTalkAgentBindingResponseParams `json:"Response"`
}

func (r *DescribeTWeTalkAgentBindingResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkAgentBindingResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeTalkAgentListRequestParams struct {
	// <p>产品 ID</p>
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type DescribeTWeTalkAgentListRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeTalkAgentListRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkAgentListRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeTalkAgentListRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeTalkAgentListResponseParams struct {
	// <p>总数</p>
	TotalCount *int64 `json:"TotalCount,omitnil,omitempty" name:"TotalCount"`

	// <p>智能体列</p>
	Data []*TalkAgentInfo `json:"Data,omitnil,omitempty" name:"Data"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeTWeTalkAgentListResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeTalkAgentListResponseParams `json:"Response"`
}

func (r *DescribeTWeTalkAgentListResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkAgentListResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeTalkAgentRequestParams struct {
	// <p>智能体ID</p>
	AgentId *string `json:"AgentId,omitnil,omitempty" name:"AgentId"`
}

type DescribeTWeTalkAgentRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeTalkAgentRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkAgentRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	delete(f, "AgentId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeTalkAgentRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeTalkAgentResponseParams struct {
	// <p>智能体详情</p>
	Data *TalkAgentInfo `json:"Data,omitnil,omitempty" name:"Data"`
...
type DescribeTWeTalkAgentResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeTalkAgentResponseParams `json:"Response"`
}

func (r *DescribeTWeTalkAgentResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkAgentResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type DescribeTWeTalkProductConfigRequest struct {
	*tchttp.BaseRequest
...
func (r *DescribeTWeTalkProductConfigRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkProductConfigRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "TargetLanguage")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "DescribeTWeTalkProductConfigRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type DescribeTWeTalkProductConfigResponseParams struct {
	// 配置信息
	Data *TalkProductConfigInfo `json:"Data,omitnil,omitempty" name:"Data"`

	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type DescribeTWeTalkProductConfigResponse struct {
	*tchttp.BaseResponse
	Response *DescribeTWeTalkProductConfigResponseParams `json:"Response"`
}

func (r *DescribeTWeTalkProductConfigResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeTWeTalkProductConfigResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type GetTWeTalkProductConfigListRequest struct {
	*tchttp.BaseRequest
...
func (r *GetTWeTalkProductConfigListRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *GetTWeTalkProductConfigListRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Limit")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "GetTWeTalkProductConfigListRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type GetTWeTalkProductConfigListResponseParams struct {
	// 配置信息列表
	Data []*TalkProductConfigInfo `json:"Data,omitnil,omitempty" name:"Data"`
...
type GetTWeTalkProductConfigListResponse struct {
	*tchttp.BaseResponse
	Response *GetTWeTalkProductConfigListResponseParams `json:"Response"`
}

func (r *GetTWeTalkProductConfigListResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *GetTWeTalkProductConfigListResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ImportTWeSeeFacesRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type ImportTWeSeeFacesRequest struct {
	*tchttp.BaseRequest
...
func (r *ImportTWeSeeFacesRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ImportTWeSeeFacesRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ChannelId")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ImportTWeSeeFacesRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ImportTWeSeeFacesResponseParams struct {
	// 检测到的人脸列表
	Faces []*SeeFaceInfo `json:"Faces,omitnil,omitempty" name:"Faces"`
...
type ImportTWeSeeFacesResponse struct {
	*tchttp.BaseResponse
	Response *ImportTWeSeeFacesResponseParams `json:"Response"`
}

func (r *ImportTWeSeeFacesResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ImportTWeSeeFacesResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ListTWeSeePersonsRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
	...
	IsRemembered *bool `json:"IsRemembered,omitnil,omitempty" name:"IsRemembered"`
}

type ListTWeSeePersonsRequest struct {
	*tchttp.BaseRequest
...
func (r *ListTWeSeePersonsRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ListTWeSeePersonsRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "ChannelId")
	delete(f, "FaceLimit")
	delete(f, "IsRemembered")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ListTWeSeePersonsRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ListTWeSeePersonsResponseParams struct {
	// 本次请求的分页数量
	Limit *uint64 `json:"Limit,omitnil,omitempty" name:"Limit"`
	...
	// 人员列表
	Persons []*SeePersonInfo `json:"Persons,omitnil,omitempty" name:"Persons"`
...
type ListTWeSeePersonsResponse struct {
	*tchttp.BaseResponse
	Response *ListTWeSeePersonsResponseParams `json:"Response"`
}

func (r *ListTWeSeePersonsResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ListTWeSeePersonsResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ModifyTWeSeeFaceRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
	...
	IsPrototype *bool `json:"IsPrototype,omitnil,omitempty" name:"IsPrototype"`
}

type ModifyTWeSeeFaceRequest struct {
	*tchttp.BaseRequest
...
func (r *ModifyTWeSeeFaceRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeSeeFaceRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "FaceId")
	delete(f, "ChannelId")
	delete(f, "IsPrototype")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ModifyTWeSeeFaceRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyTWeSeeFaceResponseParams struct {
	// 人脸元数据
	Face *SeeFaceInfo `json:"Face,omitnil,omitempty" name:"Face"`
...
type ModifyTWeSeeFaceResponse struct {
	*tchttp.BaseResponse
	Response *ModifyTWeSeeFaceResponseParams `json:"Response"`
}

func (r *ModifyTWeSeeFaceResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeSeeFaceResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyTWeSeePersonRequestParams struct {
	// 产品 ID
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type ModifyTWeSeePersonRequest struct {
	*tchttp.BaseRequest
...
func (r *ModifyTWeSeePersonRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeSeePersonRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "Name")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "ModifyTWeSeePersonRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type ModifyTWeSeePersonResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyTWeSeePersonResponse struct {
	*tchttp.BaseResponse
	Response *ModifyTWeSeePersonResponseParams `json:"Response"`
}

func (r *ModifyTWeSeePersonResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeSeePersonResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
// Predefined struct for user
type ModifyTWeTalkAgentRequestParams struct {
	// <p>智能体ID</p>
	AgentId *string `json:"AgentId,omitnil,omitempty" name:"AgentId"`
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeTalkAgentRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
// Predefined struct for user
type ModifyTWeTalkAgentResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyTWeTalkAgentResponse struct {
	*tchttp.BaseResponse
	Response *ModifyTWeTalkAgentResponseParams `json:"Response"`
}

func (r *ModifyTWeTalkAgentResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeTalkAgentResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type ModifyTWeTalkProductConfigRequest struct {
	*tchttp.BaseRequest
...
func (r *ModifyTWeTalkProductConfigRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeTalkProductConfigRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
// Predefined struct for user
type ModifyTWeTalkProductConfigResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type ModifyTWeTalkProductConfigResponse struct {
	*tchttp.BaseResponse
	Response *ModifyTWeTalkProductConfigResponseParams `json:"Response"`
}

func (r *ModifyTWeTalkProductConfigResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *ModifyTWeTalkProductConfigResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
...
type SeeComprehensionConfig struct {
	...
	// <p>是否开启人脸检测</p>
	EnableFaceDetection *bool `json:"EnableFaceDetection,omitnil,omitempty" name:"EnableFaceDetection"`
...
type SeeFaceInfo struct {
	...
	// 人脸所在画面的毫秒级 UNIX 时间戳
	TimestampMs *int64 `json:"TimestampMs,omitnil,omitempty" name:"TimestampMs"`
}
...
type SeeTaskPersonInfo struct {
	// 该人员在任务中的人脸列表
	Faces []*SeeTaskFaceInfo `json:"Faces,omitnil,omitempty" name:"Faces"`
...
type TalkConversationConfig struct {
	// 欢迎语
...
type TalkLLMConfig struct {
	...
	History *int64 `json:"History,omitnil,omitempty" name:"History"`
...
type TalkSTTConfig struct {
	// 当前仅支持 `trtc`（使用 TRTC 内置语音识别）。
	Type *string `json:"Type,omitnil,omitempty" name:"Type"`

	// `Type=trtc` 时生效。整体省略表示全部使用 TRTC 默认值。
	TRTC *TalkSTTTRTC `json:"TRTC,omitnil,omitempty" name:"TRTC"`
}
...
type TalkSTTTRTC struct {
	...
	// <p>远场人声抑制等级，范围 0–5</p>
	VADLevel *int64 `json:"VADLevel,omitnil,omitempty" name:"VADLevel"`
}

type TalkTTSConfig struct {
	// TTS的类型
	Type *string `json:"Type,omitnil,omitempty" name:"Type"`

	// Flow TTS 的具体配置
	Flow *TalkTTSFlow `json:"Flow,omitnil,omitempty" name:"Flow"`
}
...
type TalkWebhookTool struct {
	...
	// Webhook HTTP端点配置
	Endpoint *TalkWebhookEndpoint `json:"Endpoint,omitnil,omitempty" name:"Endpoint"`

	// 必填参数名列表，必须存在于Parameters.properties中
	Required []*string `json:"Required,omitnil,omitempty" name:"Required"`

	// Webhook鉴权配置
	Auth *TalkWebhookAuth `json:"Auth,omitnil,omitempty" name:"Auth"`
}
...
// Predefined struct for user
type UnbindTWeTalkAgentRequestParams struct {
	// <p>产品 ID</p>
	ProductId *string `json:"ProductId,omitnil,omitempty" name:"ProductId"`
...
type UnbindTWeTalkAgentRequest struct {
	*tchttp.BaseRequest
...
func (r *UnbindTWeTalkAgentRequest) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *UnbindTWeTalkAgentRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
	...
	delete(f, "BindingScope")
	if len(f) > 0 {
		return tcerr.NewTencentCloudSDKError("ClientError.BuildRequestError", "UnbindTWeTalkAgentRequest has unknown keys!", "")
	}
	return json.Unmarshal([]byte(s), &r)
}

// Predefined struct for user
type UnbindTWeTalkAgentResponseParams struct {
	// 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。
	RequestId *string `json:"RequestId,omitnil,omitempty" name:"RequestId"`
}

type UnbindTWeTalkAgentResponse struct {
	*tchttp.BaseResponse
	Response *UnbindTWeTalkAgentResponseParams `json:"Response"`
}

func (r *UnbindTWeTalkAgentResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *UnbindTWeTalkAgentResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
