...
type AgentAuditedClient struct {
	...
	// 代客账号ID
	ClientUin *string `json:"ClientUin,omitnil" name:"ClientUin"`

	// 代客审核通过时间戳
	AgentTime *string `json:"AgentTime,omitnil" name:"AgentTime"`

	// 代客类型，可能值为a/b/c
	ClientFlag *string `json:"ClientFlag,omitnil" name:"ClientFlag"`

	// 代客备注
	ClientRemark *string `json:"ClientRemark,omitnil" name:"ClientRemark"`

	// 代客名称（首选实名认证名称）
	ClientName *string `json:"ClientName,omitnil" name:"ClientName"`
	...
	// 上月消费金额
	LastMonthAmt *int64 `json:"LastMonthAmt,omitnil" name:"LastMonthAmt"`

	// 本月消费金额
	ThisMonthAmt *int64 `json:"ThisMonthAmt,omitnil" name:"ThisMonthAmt"`

	// 是否欠费,0：不欠费；1：欠费
	HasOverdueBill *uint64 `json:"HasOverdueBill,omitnil" name:"HasOverdueBill"`
	...
	SalesUin *string `json:"SalesUin,omitnil" name:"SalesUin"`

	// 业务员姓名
	// 注意：此字段可能返回 null，表示取不到有效值。
	SalesName *string `json:"SalesName,omitnil" name:"SalesName"`
...
type AgentBillElem struct {
	...
	// 云产品名称
	GoodsType *string `json:"GoodsType,omitnil" name:"GoodsType"`

	// 预付费/后付费
	PayMode *string `json:"PayMode,omitnil" name:"PayMode"`

	// 支付月份
	SettleMonth *string `json:"SettleMonth,omitnil" name:"SettleMonth"`

	// 支付金额，单位分
	Amt *int64 `json:"Amt,omitnil" name:"Amt"`

	// agentpay：代付；selfpay：自付
	PayerMode *string `json:"PayerMode,omitnil" name:"PayerMode"`
...
type AgentClientElem struct {
	...
	// 代客申请时间戳
	ApplyTime *uint64 `json:"ApplyTime,omitnil" name:"ApplyTime"`
...
type AgentDealNewElem struct {
	...
	// 商品类型 ID
	GoodsCategoryId *string `json:"GoodsCategoryId,omitnil" name:"GoodsCategoryId"`
	...
	// 商品数量
	// 注意：此字段可能返回 null，表示取不到有效值。
	GoodsNum *string `json:"GoodsNum,omitnil" name:"GoodsNum"`

	// 价格详情
	// 注意：此字段可能返回 null，表示取不到有效值。
	GoodsPrice *DealGoodsPriceNewElem `json:"GoodsPrice,omitnil" name:"GoodsPrice"`
	...
	// 支付结束时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	PayEndTime *string `json:"PayEndTime,omitnil" name:"PayEndTime"`
	...
	// 订单状态，中文描述
	// 注意：此字段可能返回 null，表示取不到有效值。
	DealStatus *string `json:"DealStatus,omitnil" name:"DealStatus"`
	...
	// 代金券抵扣金额，单位分
	// 注意：此字段可能返回 null，表示取不到有效值。
	VoucherDecline *string `json:"VoucherDecline,omitnil" name:"VoucherDecline"`
	...
	// 产品详情
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProductInfo []*ProductInfoElem `json:"ProductInfo,omitnil" name:"ProductInfo"`

	// 付款方式
	// 注意：此字段可能返回 null，表示取不到有效值。
	PaymentMethod *string `json:"PaymentMethod,omitnil" name:"PaymentMethod"`
...
type AgentPayDealsRequestParams struct {
	...
	// 代付标志，1：代付；0：自付
	AgentPay *uint64 `json:"AgentPay,omitnil" name:"AgentPay"`
...
type AssignClientsToSalesRequestParams struct {
	// 代客/申请中代客uin列表，最大50条
	ClientUins []*string `json:"ClientUins,omitnil" name:"ClientUins"`

	// 业务员uin
	SalesUin *string `json:"SalesUin,omitnil" name:"SalesUin"`

	// 代客类型:normal-代客 apply-申请中代客
	AssignClientStatus *string `json:"AssignClientStatus,omitnil" name:"AssignClientStatus"`

	// 操作类型:assign-执行分派 cancel-取消分派
	AssignActionType *string `json:"AssignActionType,omitnil" name:"AssignActionType"`
}
...
type AssignClientsToSalesResponseParams struct {
	// 处理成功的代客uin列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	SucceedUins []*string `json:"SucceedUins,omitnil" name:"SucceedUins"`

	// 处理失败的代客uin列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	FailedUins []*string `json:"FailedUins,omitnil" name:"FailedUins"`
...
type AuditApplyClientResponseParams struct {
	...
	// 关联时间对应的时间戳
	// 注意：此字段可能返回 null，表示取不到有效值。
	AgentTime *uint64 `json:"AgentTime,omitnil" name:"AgentTime"`
...
type DealGoodsPriceNewElem struct {
	...
	// 原始金额（不含折扣，单位：分）
	OriginalTotalCost *int64 `json:"OriginalTotalCost,omitnil" name:"OriginalTotalCost"`
}
...
type DescribeAgentAuditedClientsResponseParams struct {
	// 已审核代客列表
	AgentClientSet []*AgentAuditedClient `json:"AgentClientSet,omitnil" name:"AgentClientSet"`
...
type DescribeAgentBillsResponseParams struct {
	...
	// 业务明细列表
	AgentBillSet []*AgentBillElem `json:"AgentBillSet,omitnil" name:"AgentBillSet"`
...
type DescribeAgentClientGradeResponseParams struct {
	// 审核状态：0待审核，1，已审核
	AuditStatus *uint64 `json:"AuditStatus,omitnil" name:"AuditStatus"`

	// 实名认证状态：0，未实名认证，1实名认证
	AuthState *uint64 `json:"AuthState,omitnil" name:"AuthState"`

	// 客户级别
	ClientGrade *string `json:"ClientGrade,omitnil" name:"ClientGrade"`

	// 客户类型：1，个人；2，企业；3，其他
	ClientType *uint64 `json:"ClientType,omitnil" name:"ClientType"`
...
type DescribeAgentClientsResponseParams struct {
	// 待审核代客列表
	AgentClientSet []*AgentClientElem `json:"AgentClientSet,omitnil" name:"AgentClientSet"`
...
type DescribeAgentDealsByCacheRequestParams struct {
	...
	CreatTimeRangeStart *string `json:"CreatTimeRangeStart,omitnil" name:"CreatTimeRangeStart"`

	// 下单时间范围终止点【请保持时间范围最大90天】
	CreatTimeRangeEnd *string `json:"CreatTimeRangeEnd,omitnil" name:"CreatTimeRangeEnd"`
	...
	// 下单人账号ID列表
	OwnerUins []*string `json:"OwnerUins,omitnil" name:"OwnerUins"`
	...
	// 支付方式，0：自付；1：代付
	PayerMode *uint64 `json:"PayerMode,omitnil" name:"PayerMode"`
}
...
type DescribeAgentDealsByCacheResponseParams struct {
	// 订单数组
	AgentDealSet []*AgentDealNewElem `json:"AgentDealSet,omitnil" name:"AgentDealSet"`
...
type DescribeAgentPayDealsV2ResponseParams struct {
	// 订单数组
	AgentPayDealSet []*AgentDealNewElem `json:"AgentPayDealSet,omitnil" name:"AgentPayDealSet"`
...
type DescribeRebateInfosNewRequestParams struct {
	// 返佣月份，如2018-02
	RebateMonth *string `json:"RebateMonth,omitnil" name:"RebateMonth"`
...
type DescribeRebateInfosNewResponseParams struct {
	// 返佣信息列表
	RebateInfoSet []*RebateInfoElemNew `json:"RebateInfoSet,omitnil" name:"RebateInfoSet"`
...
type DescribeRebateInfosResponseParams struct {
	// 返佣信息列表
	RebateInfoSet []*RebateInfoElem `json:"RebateInfoSet,omitnil" name:"RebateInfoSet"`
...
type DescribeSalesmansResponseParams struct {
	// 业务员列表
	AgentSalesmanSet []*AgentSalesmanElem `json:"AgentSalesmanSet,omitnil" name:"AgentSalesmanSet"`
...
type DescribeUnbindClientListRequestParams struct {
	...
	// 解绑账号ID
	UnbindUin *string `json:"UnbindUin,omitnil" name:"UnbindUin"`

	// 解绑申请时间范围起始点
	ApplyTimeStart *string `json:"ApplyTimeStart,omitnil" name:"ApplyTimeStart"`

	// 解绑申请时间范围终止点
	ApplyTimeEnd *string `json:"ApplyTimeEnd,omitnil" name:"ApplyTimeEnd"`
...
type DescribeUnbindClientListResponseParams struct {
	...
	// 符合条件的解绑客户列表
	UnbindClientList []*UnbindClientElem `json:"UnbindClientList,omitnil" name:"UnbindClientList"`
...
type RebateInfoElem struct {
	...
	// 返佣金额，单位分
	Amt *uint64 `json:"Amt,omitnil" name:"Amt"`

	// 月度业绩，单位分
	MonthSales *uint64 `json:"MonthSales,omitnil" name:"MonthSales"`

	// 季度业绩，单位分
	QuarterSales *uint64 `json:"QuarterSales,omitnil" name:"QuarterSales"`

	// NORMAL(正常)/HAS_OVERDUE_BILL(欠费)/NO_CONTRACT(缺合同)
	ExceptionFlag *string `json:"ExceptionFlag,omitnil" name:"ExceptionFlag"`
}
...
type RebateInfoElemNew struct {
	...
	// 月度业绩，单位分
	MonthSales *int64 `json:"MonthSales,omitnil" name:"MonthSales"`

	// 季度业绩，单位分
	QuarterSales *int64 `json:"QuarterSales,omitnil" name:"QuarterSales"`
...
type RefundMap struct {
	...
	// 退款金额，单位分
	// 注意：此字段可能返回 null，表示取不到有效值。
	RefundAmount *int64 `json:"RefundAmount,omitnil" name:"RefundAmount"`
}
