...
type AddExistedInstancesRequest struct {
	*tchttp.BaseRequest
	...
	// 实例额外需要设置参数信息
	InstanceAdvancedSettings *InstanceAdvancedSettings `json:"InstanceAdvancedSettings" name:"InstanceAdvancedSettings"`
...
type Cluster struct {
	...
	// 集群描述
	ClusterDescription []*string `json:"ClusterDescription" name:"ClusterDescription" list`

	// 集群版本（默认值为1.10.5）
	ClusterVersion *string `json:"ClusterVersion" name:"ClusterVersion"`

	// 集群系统。centos7.2x86_64 或者 ubuntu16.04.1 LTSx86_64，默认取值为ubuntu16.04.1 LTSx86_64
	ClusterOs *string `json:"ClusterOs" name:"ClusterOs"`

	// 集群类型，托管集群：MANAGED_CLUSTER，独立集群：INDEPENDENT_CLUSTER。
	ClusterType *string `json:"ClusterType" name:"ClusterType"`

	// 集群网络相关参数
	ClusterNetworkSettings *ClusterNetworkSettings `json:"ClusterNetworkSettings" name:"ClusterNetworkSettings"`
}
...
type ClusterNetworkSettings struct {
	...
	IgnoreClusterCIDRConflict *bool `json:"IgnoreClusterCIDRConflict" name:"IgnoreClusterCIDRConflict"`

	// 集群中每个Node上最大的Pod数量(默认为256)
	MaxNodePodNum *uint64 `json:"MaxNodePodNum" name:"MaxNodePodNum"`

	// 集群最大的service数量(默认为256)
	MaxClusterServiceNum *uint64 `json:"MaxClusterServiceNum" name:"MaxClusterServiceNum"`

	// 是否启用IPVS(默认不开启)
	IPVS *bool `json:"IPVS" name:"IPVS"`
...
type DeleteClusterInstancesRequest struct {
	*tchttp.BaseRequest
	...
	InstanceDeleteMode *string `json:"InstanceDeleteMode" name:"InstanceDeleteMode"`
}
...
type DescribeClustersRequest struct {
	*tchttp.BaseRequest
	...
	// 集群ID列表(为空时，
	// 表示获取账号下所有集群)
	ClusterIds []*string `json:"ClusterIds" name:"ClusterIds" list`
...
type DescribeClustersResponse struct {
	*tchttp.BaseResponse
	Response *struct {
		...
		// 集群信息列表
		Clusters []*Cluster `json:"Clusters" name:"Clusters" list`
...
type Instance struct {
	...
	// 实例的附加信息
	InstanceAdvanceSettings *InstanceAdvancedSettings `json:"InstanceAdvanceSettings" name:"InstanceAdvanceSettings"`
...
type InstanceAdvancedSettings struct {
	...
	DockerGraphPath *string `json:"DockerGraphPath" name:"DockerGraphPath"`

	// base64 编码的用户脚本, 此脚本会在 k8s 组件运行后执行, 需要用户保证脚本的可重入及重试逻辑, 脚本及其生成的日志文件可在节点的 /data/ccs_userscript/ 路径查看, 如果要求节点需要在进行初始化完成后才可加入调度, 可配合 unschedulable 参数使用, 在 userScript 最后初始化完成后, 添加 kubectl uncordon nodename --kubeconfig=/root/.kube/config 命令使节点加入调度
	UserScript *string `json:"UserScript" name:"UserScript"`

	// 设置加入的节点是否参与调度，默认值为0，表示参与调度；非0表示不参与调度, 待节点初始化完成之后, 可执行kubectl uncordon nodename使node加入调度.
	Unschedulable *int64 `json:"Unschedulable" name:"Unschedulable"`
}
