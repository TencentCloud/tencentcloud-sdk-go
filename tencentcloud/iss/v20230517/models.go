...
type AIConfig struct {
	...
	// 截图频率。可选值1～20秒
	TimeInterval *uint64 `json:"TimeInterval,omitempty" name:"TimeInterval"`
...
type AITaskInfo struct {
	...
	// AI 配置列表
	Templates []*AITemplates `json:"Templates,omitempty" name:"Templates"`
...
type AITaskResultInfo struct {
	// 人体识别结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	Body []*BodyAIResultInfo `json:"Body,omitempty" name:"Body"`

	// 宠物识别结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	Pet []*PetAIResultInfo `json:"Pet,omitempty" name:"Pet"`

	// 车辆车牌识别结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	Car []*CarAIResultInfo `json:"Car,omitempty" name:"Car"`

	// 厨师帽结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChefHat []*ChefHatAIResultInfo `json:"ChefHat,omitempty" name:"ChefHat"`

	// 厨师服结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChefCloth []*ChefClothAIResultInfo `json:"ChefCloth,omitempty" name:"ChefCloth"`

	// 口罩识别结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	FaceMask []*FaceMaskAIResultInfo `json:"FaceMask,omitempty" name:"FaceMask"`

	// 抽烟检测结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	Smoking []*SmokingAIResultInfo `json:"Smoking,omitempty" name:"Smoking"`
...
type AITemplates struct {
	...
	AIConfig *AIConfig `json:"AIConfig,omitempty" name:"AIConfig"`
...
type AddAITaskRequestParams struct {
	...
	IsStartTheTask *bool `json:"IsStartTheTask,omitempty" name:"IsStartTheTask"`
}
...
type AddAITaskResponseParams struct {
	// AI任务信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data *AITaskInfo `json:"Data,omitempty" name:"Data"`
...
type AddDeviceData struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	AccessProtocol *int64 `json:"AccessProtocol,omitempty" name:"AccessProtocol"`
	...
	// 设备流传输协议，1:UDP,2:TCP 
	// 注意：此字段可能返回 null，表示取不到有效值。
	TransportProtocol *int64 `json:"TransportProtocol,omitempty" name:"TransportProtocol"`
	...
	// 设备所属组织ID
	// 注意：此字段可能返回 null，表示取不到有效值。
	OrganizationId *int64 `json:"OrganizationId,omitempty" name:"OrganizationId"`
...
type AddOrgData struct {
	...
	// 组织结构
	// 注意：此字段可能返回 null，表示取不到有效值。
	ParentIds *string `json:"ParentIds,omitempty" name:"ParentIds"`
...
type AddRecordBackupPlanRequestParams struct {
	...
	Channels []*ChannelInfo `json:"Channels,omitempty" name:"Channels"`
...
type AddRecordPlanRequestParams struct {
	...
	StreamType *string `json:"StreamType,omitempty" name:"StreamType"`
...
type AddRecordTemplateResponseParams struct {
	// 返回结果
	Data *RecordTemplateInfo `json:"Data,omitempty" name:"Data"`
...
type BodyAIResultInfo struct {
	...
	// 人体信息
	BodyInfo []*BaseAIResultInfo `json:"BodyInfo,omitempty" name:"BodyInfo"`
}
...
type CarAIResultInfo struct {
	...
	// 车牌信息
	PlateContent *PlateContent `json:"PlateContent,omitempty" name:"PlateContent"`
...
type ChefClothAIResultInfo struct {
	...
	// 厨师服信息
	ChefClothInfoInfo []*BaseAIResultInfo `json:"ChefClothInfoInfo,omitempty" name:"ChefClothInfoInfo"`
}
...
type ChefHatAIResultInfo struct {
	...
	// 厨师帽信息
	ChefHatInfo []*BaseAIResultInfo `json:"ChefHatInfo,omitempty" name:"ChefHatInfo"`
}
...
type ControlRecordRequestParams struct {
	...
	ControlAction *string `json:"ControlAction,omitempty" name:"ControlAction"`
...
type ControlRecordTimelineResponseParams struct {
	// 返回数据
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data []*Timeline `json:"Data,omitempty" name:"Data"`
...
type DescribeDeviceChannelData struct {
	...
	// 是否可控 Ptz（0:不可控,1:可控）
	// 注意：此字段可能返回 null，表示取不到有效值。
	PTZType *int64 `json:"PTZType,omitempty" name:"PTZType"`
...
type DescribeDeviceData struct {
	...
	// sip服务ID
	// 注意：此字段可能返回 null，表示取不到有效值。
	SipId *string `json:"SipId,omitempty" name:"SipId"`

	// sip服务域
	// 注意：此字段可能返回 null，表示取不到有效值。
	SipDomain *string `json:"SipDomain,omitempty" name:"SipDomain"`

	// sip服务IP地址
	// 注意：此字段可能返回 null，表示取不到有效值。
	SipIp *string `json:"SipIp,omitempty" name:"SipIp"`

	// sip服务端口
	// 注意：此字段可能返回 null，表示取不到有效值。
	SipPort *int64 `json:"SipPort,omitempty" name:"SipPort"`
...
type DescribeGatewayMonitor struct {
	// 设备接入总数
	// 注意：此字段可能返回 null，表示取不到有效值。
	DeviceTotal *int64 `json:"DeviceTotal,omitempty" name:"DeviceTotal"`

	// 设备在线数
	// 注意：此字段可能返回 null，表示取不到有效值。
	DeviceOnline *int64 `json:"DeviceOnline,omitempty" name:"DeviceOnline"`

	// 设备离线数
	// 注意：此字段可能返回 null，表示取不到有效值。
	DeviceOffline *int64 `json:"DeviceOffline,omitempty" name:"DeviceOffline"`

	// 视频通道总数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChannelTotal *int64 `json:"ChannelTotal,omitempty" name:"ChannelTotal"`

	// 视频通道在线数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChannelOnline *int64 `json:"ChannelOnline,omitempty" name:"ChannelOnline"`

	// 视频通道离线数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChannelOffline *int64 `json:"ChannelOffline,omitempty" name:"ChannelOffline"`

	// 网关上行流量,单位kbps
	// 注意：此字段可能返回 null，表示取不到有效值。
	UpFlow *int64 `json:"UpFlow,omitempty" name:"UpFlow"`

	// 流在传输中的通道数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChannelPull *int64 `json:"ChannelPull,omitempty" name:"ChannelPull"`

	// 流未传输中的通道数
	// 注意：此字段可能返回 null，表示取不到有效值。
	ChannelUnPull *int64 `json:"ChannelUnPull,omitempty" name:"ChannelUnPull"`
}
...
type DescribeGatewayMonitorResponseParams struct {
	// 返回数据
	Data *DescribeGatewayMonitor `json:"Data,omitempty" name:"Data"`
...
type DescribeRecordPlanResponseParams struct {
	// 返回结果
	Data *RecordPlanBaseInfo `json:"Data,omitempty" name:"Data"`
...
type DescribeRecordPlaybackUrlResponseParams struct {
	// 返回结果
	Data *RecordPlaybackUrl `json:"Data,omitempty" name:"Data"`
...
type DescribeVideoDownloadUrlRequestParams struct {
	...
	IsRespActualTime *bool `json:"IsRespActualTime,omitempty" name:"IsRespActualTime"`
}
...
type LifeCycleData struct {
	...
	Transition *int64 `json:"Transition,omitempty" name:"Transition"`
...
type ListAITaskData struct {
	// AI任务列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	List []*AITaskInfo `json:"List,omitempty" name:"List"`
}

// Predefined struct for user
type ListAITasksRequestParams struct {
	// 是否包含通道列表。"true"代表包含通道列表，"false"代表不包含通道列表，默认为 false
	IsContainChannelList *bool `json:"IsContainChannelList,omitempty" name:"IsContainChannelList"`

	// 是否包含AI配置。"true"代表包含任务配置，"false"代表不包含任务配置，默认为 false。
	IsContainTemplate *bool `json:"IsContainTemplate,omitempty" name:"IsContainTemplate"`
...
type ListAITasksResponseParams struct {
	...
	// AI任务列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data *ListAITaskData `json:"Data,omitempty" name:"Data"`
...
type ListDeviceInfo struct {
	...
	// 设备流传输协议。1:UDP,2:TCP
	TransportProtocol *uint64 `json:"TransportProtocol,omitempty" name:"TransportProtocol"`
	...
	AccessProtocol *uint64 `json:"AccessProtocol,omitempty" name:"AccessProtocol"`
...
type ListDevicesRequestParams struct {
	...
	IsContainSubLevel *bool `json:"IsContainSubLevel,omitempty" name:"IsContainSubLevel"`
	...
	// 当前用户Uin
	CurrentUin *uint64 `json:"CurrentUin,omitempty" name:"CurrentUin"`
...
type ListDevicesResponseParams struct {
	// 设备列表详情
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data []*ListDeviceInfo `json:"Data,omitempty" name:"Data"`
...
type ListRecordRetrieveTasksResponseParams struct {
	// 返回结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data []*RecordRetrieveTaskDetailsInfo `json:"Data,omitempty" name:"Data"`
...
type OrganizationChannelInfo struct {
	...
	InPlan *bool `json:"InPlan,omitempty" name:"InPlan"`
}
...
type PetAIResultInfo struct {
	...
	// 宠物信息
	PetInfo []*BaseAIResultInfo `json:"PetInfo,omitempty" name:"PetInfo"`
}
...
type PhoneCallAIResultInfo struct {
	...
	// 打电话信息
	PhoneCallInfo []*BaseAIResultInfo `json:"PhoneCallInfo,omitempty" name:"PhoneCallInfo"`
}
...
type RecordTimeLine struct {
	...
	Begin *uint64 `json:"Begin,omitempty" name:"Begin"`
...
type SmokingAIResultInfo struct {
	...
	// 抽烟信息
	SmokingInfo []*BaseAIResultInfo `json:"SmokingInfo,omitempty" name:"SmokingInfo"`
}
...
type Timeline struct {
	// 分片起始时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	Begin *int64 `json:"Begin,omitempty" name:"Begin"`
...
type UpdateRecordBackupPlanModify struct {
	...
	Del *string `json:"Del,omitempty" name:"Del"`
...
type UpdateRecordBackupPlanRequestParams struct {
	...
	// 修改的内容
	Mod *UpdateRecordBackupPlanModify `json:"Mod,omitempty" name:"Mod"`
}
...
type UpdateRecordBackupTemplateRequestParams struct {
	...
	// 修改录像上云模板数据
	Mod *UpdateRecordBackupTemplateModify `json:"Mod,omitempty" name:"Mod"`
}
...
type UpdateRecordPlanData struct {
	...
	// 要新增的设备通道,Json数组，没有新增时，不需要该字段，一次添加通道总数不超过5000个，包括组织目录下的通道数量
	Add []*ChannelInfo `json:"Add,omitempty" name:"Add"`
...
type UpdateRecordPlanRequestParams struct {
	...
	// 修改计划的内容
	Mod *UpdateRecordPlanData `json:"Mod,omitempty" name:"Mod"`
}
...
type UpdateRecordTemplateRequestParams struct {
	...
	// 修改内容
	Mod *UpdateRecordTemplateData `json:"Mod,omitempty" name:"Mod"`
}
