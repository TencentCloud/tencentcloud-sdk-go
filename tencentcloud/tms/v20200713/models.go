...
type AccountTipoffAccessRequestParams struct {
	// 被举报账号，长度低于 128 个字符
	ReportedAccount *string `json:"ReportedAccount,omitnil" name:"ReportedAccount"`

	// 被举报账号类型(1-手机号 2-QQ号 3-微信号 4-QQ群号 5-微信openid 6-QQopenid 0-其它)
	ReportedAccountType *int64 `json:"ReportedAccountType,omitnil" name:"ReportedAccountType"`

	// 被举报账号所属恶意类型(1-诈骗，2-骚扰，3-广告，4-违法违规，5-赌博传销，0-其他)
	EvilType *int64 `json:"EvilType,omitnil" name:"EvilType"`

	// 举报者账号，长度低于 128 个字符
	SenderAccount *string `json:"SenderAccount,omitnil" name:"SenderAccount"`

	// 举报者账号类型(1-手机号 2-QQ号 3-微信号 4-QQ群号 5-微信openid 6-QQopenid 0-其它)
	SenderAccountType *int64 `json:"SenderAccountType,omitnil" name:"SenderAccountType"`

	// 举报者IP地址
	SenderIP *string `json:"SenderIP,omitnil" name:"SenderIP"`

	// 包含被举报账号的恶意内容（比如文本、图片链接，长度低于1024个字符）
	EvilContent *string `json:"EvilContent,omitnil" name:"EvilContent"`
}
...
type AccountTipoffAccessResponseParams struct {
	...
	Data *TipoffResponse `json:"Data,omitnil" name:"Data"`
...
type DescribeTextLibResponseParams struct {
	// 文本库id和name列表
	TextLib []*TextLib `json:"TextLib,omitnil" name:"TextLib"`
...
type TextLib struct {
	// 库id
	LibId *int64 `json:"LibId,omitnil" name:"LibId"`
