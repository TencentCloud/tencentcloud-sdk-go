...
type Application struct {
	...
	// 审批人
	// 注意：此字段可能返回 null，表示取不到有效值。
	ExecuteUser *string `json:"ExecuteUser,omitnil" name:"ExecuteUser"`

	// 执行状态
	// 注意：此字段可能返回 null，表示取不到有效值。
	ExecuteStatus *string `json:"ExecuteStatus,omitnil" name:"ExecuteStatus"`

	// 该申请单是否可以被当前用户审批
	// 注意：此字段可能返回 null，表示取不到有效值。
	CanCensor *bool `json:"CanCensor,omitnil" name:"CanCensor"`

	// 该申请单是否可以被当前用户撤回
	// 注意：此字段可能返回 null，表示取不到有效值。
	CanWithdrawal *bool `json:"CanWithdrawal,omitnil" name:"CanWithdrawal"`
}
...
type DescribeApplicationsRequestParams struct {
	...
	CensorStatus *int64 `json:"CensorStatus,omitnil" name:"CensorStatus"`
	...
	ApplyType *int64 `json:"ApplyType,omitnil" name:"ApplyType"`
}
...
type DescribeApplicationsResponseParams struct {
	// 申请单列表
	Applications []*Application `json:"Applications,omitnil" name:"Applications"`
