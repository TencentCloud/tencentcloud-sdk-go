...
type AmsDetailInfo struct {
	...
	// 数据来源 0机审，其他为自主审核
	DataForm *int64 `json:"DataForm,omitnil" name:"DataForm"`

	// 操作人
	Operator *string `json:"Operator,omitnil" name:"Operator"`

	// 原始命中标签
	OriginalLabel []*string `json:"OriginalLabel,omitnil" name:"OriginalLabel"`
	...
	// 短音频个数
	DetailCount *int64 `json:"DetailCount,omitnil" name:"DetailCount"`
...
type DescribeAmsListRequestParams struct {
	...
	// 查询方向
	PageDirection *string `json:"PageDirection,omitnil" name:"PageDirection"`
...
type DescribeAmsListResponseParams struct {
	...
	AmsDetailSet []*AmsDetailInfo `json:"AmsDetailSet,omitnil" name:"AmsDetailSet"`
