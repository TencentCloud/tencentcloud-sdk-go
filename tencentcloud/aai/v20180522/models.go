...
type SimultaneousInterpretingRequestParams struct {
	...
	RecEngineModelType *string `json:"RecEngineModelType,omitnil" name:"RecEngineModelType"`
	...
	// 声音id，标识一句话。
	VoiceId *string `json:"VoiceId,omitnil" name:"VoiceId"`

	// 是否是一句话的结束。
	IsEnd *uint64 `json:"IsEnd,omitnil" name:"IsEnd"`

	// 声音编码的格式1:pcm，4:speex，6:silk，默认为1。
	VoiceFormat *uint64 `json:"VoiceFormat,omitnil" name:"VoiceFormat"`

	// 是否需要翻译结果，1表示需要翻译，0是不需要。
	OpenTranslate *uint64 `json:"OpenTranslate,omitnil" name:"OpenTranslate"`

	// 如果需要翻译，表示源语言类型，可取值：zh，en。
	SourceLanguage *string `json:"SourceLanguage,omitnil" name:"SourceLanguage"`

	// 如果需要翻译，表示目标语言类型，可取值：zh，en。
	TargetLanguage *string `json:"TargetLanguage,omitnil" name:"TargetLanguage"`

	// 表明当前语音分片的索引，从0开始
	Seq *uint64 `json:"Seq,omitnil" name:"Seq"`
}
...
type SimultaneousInterpretingResponseParams struct {
	// 语音识别的结果
	AsrText *string `json:"AsrText,omitnil" name:"AsrText"`

	// 机器翻译的结果
	NmtText *string `json:"NmtText,omitnil" name:"NmtText"`
...
type TextToVoiceRequestParams struct {
	...
	PrimaryLanguage *uint64 `json:"PrimaryLanguage,omitnil" name:"PrimaryLanguage"`
