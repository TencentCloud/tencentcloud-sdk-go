...
// Predefined struct for user
type GetRealNameAuthResultRequestParams struct {
	// 实名认证凭证
...
// Predefined struct for user
type GetRealNameAuthResultResponseParams struct {
	// 认证结果码，收费情况如下：
	// 
	// 收费码：
	// 0:  姓名和身份证号一致
...
type GetRealNameAuthResultResponse struct {
	*tchttp.BaseResponse
	Response *GetRealNameAuthResultResponseParams `json:"Response"`
}
...
// Predefined struct for user
type GetRealNameAuthTokenRequestParams struct {
	// 姓名
	Name *string `json:"Name,omitempty" name:"Name"`
...
// Predefined struct for user
type GetRealNameAuthTokenResponseParams struct {
	// 查询实名认证结果的唯一凭证
	AuthToken *string `json:"AuthToken,omitempty" name:"AuthToken"`
...
type GetRealNameAuthTokenResponse struct {
	*tchttp.BaseResponse
	Response *GetRealNameAuthTokenResponseParams `json:"Response"`
}
