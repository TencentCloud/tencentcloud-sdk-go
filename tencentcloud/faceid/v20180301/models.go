...
type BankCard2EVerificationRequestParams struct {
	...
	// 银行卡
	BankCard *string `json:"BankCard,omitnil" name:"BankCard"`
...
type ChargeDetail struct {
	// 一比一时间时间戳，13位。
	ReqTime *string `json:"ReqTime,omitnil" name:"ReqTime"`
	...
	Sim *string `json:"Sim,omitnil" name:"Sim"`
...
type CheckBankCardInformationResponseParams struct {
	...
	// 开户行
	AccountBank *string `json:"AccountBank,omitnil" name:"AccountBank"`
...
type CheckEidTokenStatusRequestParams struct {
	...
	EidToken *string `json:"EidToken,omitnil" name:"EidToken"`
}
...
type CheckIdCardInformationRequestParams struct {
	...
	IsEncrypt *bool `json:"IsEncrypt,omitnil" name:"IsEncrypt"`
}
...
type CheckIdCardInformationResponseParams struct {
	...
	Portrait *string `json:"Portrait,omitnil" name:"Portrait"`
	...
	Warnings *string `json:"Warnings,omitnil" name:"Warnings"`
...
type CheckIdNameDateRequestParams struct {
	...
	ValidityBegin *string `json:"ValidityBegin,omitnil" name:"ValidityBegin"`

	// 身份证有效期到期时间，格式：YYYYMMDD，长期用“00000000”代替；如：20210701
	ValidityEnd *string `json:"ValidityEnd,omitnil" name:"ValidityEnd"`
...
type DetectAuthRequestParams struct {
	...
	IntentionVerifyText *string `json:"IntentionVerifyText,omitnil" name:"IntentionVerifyText"`

	// 意愿核身语音问答模式（即语音播报+语音回答）使用的文案，包括：系统语音播报的文本、需要核验的标准文本。当前仅支持1轮问答。
	IntentionQuestions []*IntentionQuestion `json:"IntentionQuestions,omitnil" name:"IntentionQuestions"`

	// RuleId相关配置
	Config *RuleIdConfig `json:"Config,omitnil" name:"Config"`

	// 意愿核身（点头确认模式）使用的文案，若未使用意愿核身（点头确认模式），则该字段无需传入。当前仅支持一个提示文本。
	IntentionActions []*IntentionActionConfig `json:"IntentionActions,omitnil" name:"IntentionActions"`
}
...
type DetectDetail struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	Livemsg *string `json:"Livemsg,omitnil" name:"Livemsg"`

	// 本次一比一结果。0为成功
	// 注意：此字段可能返回 null，表示取不到有效值。
	Comparestatus *int64 `json:"Comparestatus,omitnil" name:"Comparestatus"`

	// 本次一比一结果描述。（仅描述用，文案更新时不会通知。）
	// 注意：此字段可能返回 null，表示取不到有效值。
	Comparemsg *string `json:"Comparemsg,omitnil" name:"Comparemsg"`
	...
	// 人工审核库；
	// 注意：此字段可能返回 null，表示取不到有效值。
	CompareLibType *string `json:"CompareLibType,omitnil" name:"CompareLibType"`
	...
	// 4：一闪活体（动作+光线）
	// 注意：此字段可能返回 null，表示取不到有效值。
	LivenessMode *uint64 `json:"LivenessMode,omitnil" name:"LivenessMode"`
}
...
type DetectInfoBestFrame struct {
	...
	// 自截帧Base64编码数组。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BestFrames []*string `json:"BestFrames,omitnil" name:"BestFrames"`
}

type DetectInfoIdCardData struct {
	// OCR正面照片的base64编码。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrFront *string `json:"OcrFront,omitnil" name:"OcrFront"`

	// OCR反面照片的base64编码
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrBack *string `json:"OcrBack,omitnil" name:"OcrBack"`

	// 旋转裁边后的正面照片base64编码。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProcessedFrontImage *string `json:"ProcessedFrontImage,omitnil" name:"ProcessedFrontImage"`

	// 旋转裁边后的背面照片base64编码。
	// 注意：此字段可能返回 null，表示取不到有效值。
	ProcessedBackImage *string `json:"ProcessedBackImage,omitnil" name:"ProcessedBackImage"`
	...
	// -9107 身份证反光告警。
	// 注意：此字段可能返回 null，表示取不到有效值。
	WarnInfos []*int64 `json:"WarnInfos,omitnil" name:"WarnInfos"`
	...
	// -9107 身份证反光告警。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BackWarnInfos []*int64 `json:"BackWarnInfos,omitnil" name:"BackWarnInfos"`
}
...
type DetectInfoText struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	UseIDType *uint64 `json:"UseIDType,omitnil" name:"UseIDType"`
	...
	// 身份校验环节识别结果：民族。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrNation *string `json:"OcrNation,omitnil" name:"OcrNation"`

	// 身份校验环节识别结果：家庭住址。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrAddress *string `json:"OcrAddress,omitnil" name:"OcrAddress"`

	// 身份校验环节识别结果：生日。格式为：YYYY/M/D
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrBirth *string `json:"OcrBirth,omitnil" name:"OcrBirth"`

	// 身份校验环节识别结果：签发机关。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrAuthority *string `json:"OcrAuthority,omitnil" name:"OcrAuthority"`

	// 身份校验环节识别结果：有效日期。格式为：YYYY.MM.DD-YYYY.MM.DD
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrValidDate *string `json:"OcrValidDate,omitnil" name:"OcrValidDate"`

	// 身份校验环节识别结果：姓名。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrName *string `json:"OcrName,omitnil" name:"OcrName"`

	// 身份校验环节识别结果：身份证号。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrIdCard *string `json:"OcrIdCard,omitnil" name:"OcrIdCard"`

	// 身份校验环节识别结果：性别。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OcrGender *string `json:"OcrGender,omitnil" name:"OcrGender"`

	// 身份校验环节采用的信息上传方式。
	// 取值有"NFC"、"OCR"、"手动输入"、"其他"
	// 注意：此字段可能返回 null，表示取不到有效值。
	IdInfoFrom *string `json:"IdInfoFrom,omitnil" name:"IdInfoFrom"`
	...
	// 本次流程进行的活体一比一流水。
	// 注意：此字段可能返回 null，表示取不到有效值。
	LivenessDetail []*DetectDetail `json:"LivenessDetail,omitnil" name:"LivenessDetail"`
	...
	// nfc重复计费requestId列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	NFCRequestIds []*string `json:"NFCRequestIds,omitnil" name:"NFCRequestIds"`

	// nfc重复计费计数
	// 注意：此字段可能返回 null，表示取不到有效值。
	NFCBillingCounts *int64 `json:"NFCBillingCounts,omitnil" name:"NFCBillingCounts"`
...
type DetectInfoVideoData struct {
	// 活体视频的base64编码
	// 注意：此字段可能返回 null，表示取不到有效值。
	LivenessVideo *string `json:"LivenessVideo,omitnil" name:"LivenessVideo"`
}

type EidInfo struct {
	// 商户方 appeIDcode 的数字证书
	EidCode *string `json:"EidCode,omitnil" name:"EidCode"`

	// Eid中心针对商户方EidCode的电子签名
	EidSign *string `json:"EidSign,omitnil" name:"EidSign"`

	// 商户方公钥加密的会话密钥的base64字符串，[指引详见](https://cloud.tencent.com/document/product/1007/63370)
	DesKey *string `json:"DesKey,omitnil" name:"DesKey"`

	// 会话密钥sm2加密后的base64字符串，[指引详见](https://cloud.tencent.com/document/product/1007/63370)
	UserInfo *string `json:"UserInfo,omitnil" name:"UserInfo"`
}
...
type EncryptedPhoneVerificationRequestParams struct {
	...
	// 1:   使用MD5加密
	// 2:   使用SHA256
	EncryptionMode *string `json:"EncryptionMode,omitnil" name:"EncryptionMode"`
}
...
type GetActionSequenceResponseParams struct {
	...
	ActionSequence *string `json:"ActionSequence,omitnil" name:"ActionSequence"`
...
type GetDetectInfoEnhancedRequestParams struct {
	...
	// 默认值：0
	InfoType *string `json:"InfoType,omitnil" name:"InfoType"`
...
type GetDetectInfoEnhancedResponseParams struct {
	// 文本类信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	Text *DetectInfoText `json:"Text,omitnil" name:"Text"`

	// 身份证照片信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	IdCardData *DetectInfoIdCardData `json:"IdCardData,omitnil" name:"IdCardData"`

	// 最佳帧信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BestFrame *DetectInfoBestFrame `json:"BestFrame,omitnil" name:"BestFrame"`

	// 视频信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	VideoData *DetectInfoVideoData `json:"VideoData,omitnil" name:"VideoData"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	IntentionVerifyData *IntentionVerifyData `json:"IntentionVerifyData,omitnil" name:"IntentionVerifyData"`

	// 意愿核身问答模式结果。若未使用该意愿核身功能，该字段返回值可以不处理。
	// 注意：此字段可能返回 null，表示取不到有效值。
	IntentionQuestionResult *IntentionQuestionResult `json:"IntentionQuestionResult,omitnil" name:"IntentionQuestionResult"`
...
type GetDetectInfoResponseParams struct {
	...
	//   }
	// }
	DetectInfo *string `json:"DetectInfo,omitnil" name:"DetectInfo"`
...
type GetEidResultResponseParams struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	EidInfo *EidInfo `json:"EidInfo,omitnil" name:"EidInfo"`
...
type GetEidTokenConfig struct {
	...
	UseIntentionVerify *bool `json:"UseIntentionVerify,omitnil" name:"UseIntentionVerify"`

	// 意愿核身模式。枚举值：1( 语音朗读模式)，2（语音问答模式） ，3（点头确认模式）。默认值为1。
	IntentionMode *string `json:"IntentionMode,omitnil" name:"IntentionMode"`
	...
	IntentionRecognition *bool `json:"IntentionRecognition,omitnil" name:"IntentionRecognition"`

	// 是否支持港澳台居住证识别
	IsSupportHMTResidentPermitOCR *bool `json:"IsSupportHMTResidentPermitOCR,omitnil" name:"IsSupportHMTResidentPermitOCR"`
}
...
type GetEidTokenRequestParams struct {
	...
	Config *GetEidTokenConfig `json:"Config,omitnil" name:"Config"`
...
type GetFaceIdResultRequestParams struct {
	...
	FaceIdToken *string `json:"FaceIdToken,omitnil" name:"FaceIdToken"`

	// 是否需要拉取视频，默认false不需要
	IsNeedVideo *bool `json:"IsNeedVideo,omitnil" name:"IsNeedVideo"`

	// 是否需要拉取截帧，默认false不需要
	IsNeedBestFrame *bool `json:"IsNeedBestFrame,omitnil" name:"IsNeedBestFrame"`
}
...
type GetFaceIdResultResponseParams struct {
	...
	// 8000：设备疑似存在异常篡改行为
	// 注意：此字段可能返回 null，表示取不到有效值。
	DeviceInfoTag *string `json:"DeviceInfoTag,omitnil" name:"DeviceInfoTag"`

	// 行为风险标签，仅错误码返回1007（设备疑似被劫持）时返回风险标签。标签说明：
	// 02：攻击风险
	// 注意：此字段可能返回 null，表示取不到有效值。
	RiskInfoTag *string `json:"RiskInfoTag,omitnil" name:"RiskInfoTag"`
...
type GetFaceIdTokenRequestParams struct {
	...
	CompareLib *string `json:"CompareLib,omitnil" name:"CompareLib"`
	...
	UseCos *bool `json:"UseCos,omitnil" name:"UseCos"`
...
type GetLiveCodeResponseParams struct {
	// 数字验证码，如：1234
	LiveCode *string `json:"LiveCode,omitnil" name:"LiveCode"`
...
type GetWeChatBillDetailsRequestParams struct {
	...
	Cursor *uint64 `json:"Cursor,omitnil" name:"Cursor"`
...
type GetWeChatBillDetailsResponseParams struct {
	...
	HasNextPage *bool `json:"HasNextPage,omitnil" name:"HasNextPage"`

	// 下一页的游标。用于分页。
	NextCursor *uint64 `json:"NextCursor,omitnil" name:"NextCursor"`

	// 数据
	WeChatBillDetails []*WeChatBillDetail `json:"WeChatBillDetails,omitnil" name:"WeChatBillDetails"`
...
type IntentionActionResult struct {
	...
	// -999: "系统未知错误，请联系人工核实"   
	// 注意：此字段可能返回 null，表示取不到有效值。
	FinalResultDetailCode *int64 `json:"FinalResultDetailCode,omitnil" name:"FinalResultDetailCode"`

	// 意愿核身错误信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	FinalResultMessage *string `json:"FinalResultMessage,omitnil" name:"FinalResultMessage"`

	// 意愿核身结果详细数据，与每段点头确认过程一一对应
	// 注意：此字段可能返回 null，表示取不到有效值。
	Details []*IntentionActionResultDetail `json:"Details,omitnil" name:"Details"`
}
...
type IntentionActionResultDetail struct {
	...
	// 屏幕截图base64编码列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	ScreenShot []*string `json:"ScreenShot,omitnil" name:"ScreenShot"`
}
...
type IntentionQuestion struct {
	...
	Answers []*string `json:"Answers,omitnil" name:"Answers"`
}
...
type IntentionQuestionResult struct {
	...
	// 回答问题语音识别结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	AsrResult []*string `json:"AsrResult,omitnil" name:"AsrResult"`

	// 答案录音音频
	// 注意：此字段可能返回 null，表示取不到有效值。
	Audios []*string `json:"Audios,omitnil" name:"Audios"`

	// 意愿核身最终结果：
	// 0：认证通过，-1：认证未通过，-2：浏览器内核不兼容，无法进行意愿校验。建议使用“FinalResultDetailCode”参数获取详细的错误码信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	FinalResultCode *string `json:"FinalResultCode,omitnil" name:"FinalResultCode"`
}

type IntentionVerifyData struct {
	// 意愿确认环节中录制的视频（base64）。若不存在则为空字符串。
	// 注意：此字段可能返回 null，表示取不到有效值。
	IntentionVerifyVideo *string `json:"IntentionVerifyVideo,omitnil" name:"IntentionVerifyVideo"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	IntentionVerifyBestFrame *string `json:"IntentionVerifyBestFrame,omitnil" name:"IntentionVerifyBestFrame"`

	// 本次流程用户语音与传入文本比对的相似度分值，取值范围 [0.00, 100.00]。只有配置了相似度阈值后才进行语音校验并返回相似度分值。
	// 注意：此字段可能返回 null，表示取不到有效值。
	//
	// Deprecated: AsrResultSimilarity is deprecated.
	AsrResultSimilarity *string `json:"AsrResultSimilarity,omitnil" name:"AsrResultSimilarity"`
}
...
type MinorsVerificationResponseParams struct {
	...
	// [18,+)表示年龄大于18周岁。
	AgeRange *string `json:"AgeRange,omitnil" name:"AgeRange"`
...
type ParseNfcDataResponseParams struct {
	...
	// 照片
	// 注意：此字段可能返回 null，表示取不到有效值。
	Picture *string `json:"Picture,omitnil" name:"Picture"`
	...
	// 签发机关
	// 注意：此字段可能返回 null，表示取不到有效值。
	SigningOrganization *string `json:"SigningOrganization,omitnil" name:"SigningOrganization"`

	// 港澳台居民居住证，通行证号码
	// 注意：此字段可能返回 null，表示取不到有效值。
	OtherIdNum *string `json:"OtherIdNum,omitnil" name:"OtherIdNum"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	CheckMRTD *string `json:"CheckMRTD,omitnil" name:"CheckMRTD"`
	...
	// 对result code的结果描述
	// 注意：此字段可能返回 null，表示取不到有效值。
	ResultDescription *string `json:"ResultDescription,omitnil" name:"ResultDescription"`
...
type RuleIdConfig struct {
	...
	IntentionType *int64 `json:"IntentionType,omitnil" name:"IntentionType"`
}
...
type WeChatBillDetail struct {
	...
	// 本token收费次数
	ChargeCount *uint64 `json:"ChargeCount,omitnil" name:"ChargeCount"`

	// 本token计费详情
	ChargeDetails []*ChargeDetail `json:"ChargeDetails,omitnil" name:"ChargeDetails"`
