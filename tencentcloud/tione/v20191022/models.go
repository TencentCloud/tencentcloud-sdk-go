...
type AlgorithmSpecification struct {
	...
	TrainingImageName *string `json:"TrainingImageName,omitnil" name:"TrainingImageName"`

	// 输入模式File|Pipe
	// 注意：此字段可能返回 null，表示取不到有效值。
	TrainingInputMode *string `json:"TrainingInputMode,omitnil" name:"TrainingInputMode"`

	// 算法名字
	// 注意：此字段可能返回 null，表示取不到有效值。
	AlgorithmName *string `json:"AlgorithmName,omitnil" name:"AlgorithmName"`
}
...
type BillingLabel struct {
	...
	// 存储大小
	VolumeSize *int64 `json:"VolumeSize,omitnil" name:"VolumeSize"`
...
type CodeRepoSummary struct {
	...
	// 更新时间
	LastModifiedTime *string `json:"LastModifiedTime,omitnil" name:"LastModifiedTime"`

	// 存储库名称
	CodeRepositoryName *string `json:"CodeRepositoryName,omitnil" name:"CodeRepositoryName"`

	// Git配置
	GitConfig *GitConfig `json:"GitConfig,omitnil" name:"GitConfig"`

	// 是否有Git凭证
	NoSecret *bool `json:"NoSecret,omitnil" name:"NoSecret"`
}
...
type CosDataSource struct {
	...
	// cos文件key
	// 注意：此字段可能返回 null，表示取不到有效值。
	KeyPrefix *string `json:"KeyPrefix,omitnil" name:"KeyPrefix"`

	// 分布式数据下载方式
	// 注意：此字段可能返回 null，表示取不到有效值。
	DataDistributionType *string `json:"DataDistributionType,omitnil" name:"DataDistributionType"`
...
type CreateCodeRepositoryRequestParams struct {
	...
	// Git凭证
	GitSecret *GitSecret `json:"GitSecret,omitnil" name:"GitSecret"`
}
...
type CreateNotebookInstanceRequestParams struct {
	...
	NotebookInstanceName *string `json:"NotebookInstanceName,omitnil" name:"NotebookInstanceName"`
	...
	DirectInternetAccess *string `json:"DirectInternetAccess,omitnil" name:"DirectInternetAccess"`

	// Root用户权限，可取值Enabled/Disabled
	// 开启后，Notebook实例可以切换至root用户执行命令
	RootAccess *string `json:"RootAccess,omitnil" name:"RootAccess"`
	...
	LifecycleScriptsName *string `json:"LifecycleScriptsName,omitnil" name:"LifecycleScriptsName"`

	// 默认存储库名称
	// 可以是已创建的存储库名称或者已https://开头的公共git库
	// 参考https://cloud.tencent.com/document/product/851/43139
	DefaultCodeRepository *string `json:"DefaultCodeRepository,omitnil" name:"DefaultCodeRepository"`

	// 其他存储库列表
	// 每个元素可以是已创建的存储库名称或者已https://开头的公共git库
	// 参考https://cloud.tencent.com/document/product/851/43139
	AdditionalCodeRepositories []*string `json:"AdditionalCodeRepositories,omitnil" name:"AdditionalCodeRepositories"`

	// 已弃用，请使用ClsConfig配置。
	// 是否开启CLS日志服务，可取值Enabled/Disabled，默认为Disabled
	// 开启后，Notebook运行的日志会收集到CLS中，CLS会产生费用，请根据需要选择
	ClsAccess *string `json:"ClsAccess,omitnil" name:"ClsAccess"`

	// 自动停止配置
	// 选择定时停止Notebook实例
	StoppingCondition *StoppingCondition `json:"StoppingCondition,omitnil" name:"StoppingCondition"`

	// 自动停止，可取值Enabled/Disabled
	// 取值为Disabled的时候StoppingCondition将被忽略
	// 取值为Enabled的时候读取StoppingCondition作为自动停止的配置
	AutoStopping *string `json:"AutoStopping,omitnil" name:"AutoStopping"`

	// 接入日志的配置，默认接入免费日志
	ClsConfig *ClsConfig `json:"ClsConfig,omitnil" name:"ClsConfig"`
}
...
type CreateNotebookLifecycleScriptRequestParams struct {
	// Notebook生命周期脚本名称
	NotebookLifecycleScriptsName *string `json:"NotebookLifecycleScriptsName,omitnil" name:"NotebookLifecycleScriptsName"`

	// 创建脚本，base64编码
	// base64后的脚本长度不能超过16384个字符
	CreateScript *string `json:"CreateScript,omitnil" name:"CreateScript"`
...
type CreatePresignedNotebookInstanceUrlRequestParams struct {
	...
	SessionExpirationDurationInSeconds *int64 `json:"SessionExpirationDurationInSeconds,omitnil" name:"SessionExpirationDurationInSeconds"`
}
...
type CreatePresignedNotebookInstanceUrlResponseParams struct {
	// 授权url
	AuthorizedUrl *string `json:"AuthorizedUrl,omitnil" name:"AuthorizedUrl"`
...
type CreateTrainingJobRequestParams struct {
	// 算法镜像配置
	AlgorithmSpecification *AlgorithmSpecification `json:"AlgorithmSpecification,omitnil" name:"AlgorithmSpecification"`

	// 输出数据配置
	OutputDataConfig *OutputDataConfig `json:"OutputDataConfig,omitnil" name:"OutputDataConfig"`

	// 资源实例配置
	ResourceConfig *ResourceConfig `json:"ResourceConfig,omitnil" name:"ResourceConfig"`

	// 训练任务名称
	TrainingJobName *string `json:"TrainingJobName,omitnil" name:"TrainingJobName"`

	// 输入数据配置
	InputDataConfig []*InputDataConfig `json:"InputDataConfig,omitnil" name:"InputDataConfig"`
	...
	// 算法超级参数
	HyperParameters *string `json:"HyperParameters,omitnil" name:"HyperParameters"`

	// 环境变量配置
	EnvConfig []*EnvConfig `json:"EnvConfig,omitnil" name:"EnvConfig"`
	...
	RetryWhenResourceInsufficient *string `json:"RetryWhenResourceInsufficient,omitnil" name:"RetryWhenResourceInsufficient"`
}
...
type DataSource struct {
	// cos数据源
	// 注意：此字段可能返回 null，表示取不到有效值。
	CosDataSource *CosDataSource `json:"CosDataSource,omitnil" name:"CosDataSource"`

	// 文件系统输入源
	// 注意：此字段可能返回 null，表示取不到有效值。
	FileSystemDataSource *FileSystemDataSource `json:"FileSystemDataSource,omitnil" name:"FileSystemDataSource"`
}
...
type DeleteNotebookLifecycleScriptRequestParams struct {
	...
	Forcible *bool `json:"Forcible,omitnil" name:"Forcible"`
}
...
type DescribeCodeRepositoriesResponseParams struct {
	...
	// 存储库列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	CodeRepoSet []*CodeRepoSummary `json:"CodeRepoSet,omitnil" name:"CodeRepoSet"`
...
type DescribeNotebookInstanceResponseParams struct {
	...
	// Failed: 失败
	// 注意：此字段可能返回 null，表示取不到有效值。
	NotebookInstanceStatus *string `json:"NotebookInstanceStatus,omitnil" name:"NotebookInstanceStatus"`
	...
	// 是否预付费实例
	// 注意：此字段可能返回 null，表示取不到有效值。
	Prepay *bool `json:"Prepay,omitnil" name:"Prepay"`
...
type DescribeNotebookInstancesResponseParams struct {
	// Notebook实例列表
	NotebookInstanceSet []*NotebookInstanceSummary `json:"NotebookInstanceSet,omitnil" name:"NotebookInstanceSet"`
...
type DescribeNotebookLifecycleScriptsResponseParams struct {
	// Notebook生命周期脚本列表
	NotebookLifecycleScriptsSet []*NotebookLifecycleScriptsSummary `json:"NotebookLifecycleScriptsSet,omitnil" name:"NotebookLifecycleScriptsSet"`
...
type DescribeNotebookSummaryResponseParams struct {
	// 实例总数
	AllInstanceCnt *int64 `json:"AllInstanceCnt,omitnil" name:"AllInstanceCnt"`

	// 计费实例总数
	BillingInstanceCnt *int64 `json:"BillingInstanceCnt,omitnil" name:"BillingInstanceCnt"`

	// 仅存储计费的实例总数
	StorageOnlyBillingInstanceCnt *int64 `json:"StorageOnlyBillingInstanceCnt,omitnil" name:"StorageOnlyBillingInstanceCnt"`

	// 计算和存储都计费的实例总数
	ComputingBillingInstanceCnt *int64 `json:"ComputingBillingInstanceCnt,omitnil" name:"ComputingBillingInstanceCnt"`
...
type DescribeTrainingJobResponseParams struct {
	...
	// 任务开始时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	TrainingStartTime *string `json:"TrainingStartTime,omitnil" name:"TrainingStartTime"`

	// 任务完成时间
	// 注意：此字段可能返回 null，表示取不到有效值。
	TrainingEndTime *string `json:"TrainingEndTime,omitnil" name:"TrainingEndTime"`

	// 模型输出配置
	// 注意：此字段可能返回 null，表示取不到有效值。
	ModelArtifacts *ModelArtifacts `json:"ModelArtifacts,omitnil" name:"ModelArtifacts"`
	...
	// Stopping: 停止中
	// Stopped：已停止
	SecondaryStatus *string `json:"SecondaryStatus,omitnil" name:"SecondaryStatus"`

	// 详细状态事件记录
	// 注意：此字段可能返回 null，表示取不到有效值。
	SecondaryStatusTransitions []*SecondaryStatusTransition `json:"SecondaryStatusTransitions,omitnil" name:"SecondaryStatusTransitions"`
	...
	// Stopping: 停止中
	// Stopped：已停止
	TrainingJobStatus *string `json:"TrainingJobStatus,omitnil" name:"TrainingJobStatus"`
...
type DescribeTrainingJobsRequestParams struct {
	...
	// 创建时间晚于
	CreationTimeAfter *string `json:"CreationTimeAfter,omitnil" name:"CreationTimeAfter"`

	// 创建时间早于
	CreationTimeBefore *string `json:"CreationTimeBefore,omitnil" name:"CreationTimeBefore"`

	// 根据名称过滤
	NameContains *string `json:"NameContains,omitnil" name:"NameContains"`

	// 根据状态过滤
	StatusEquals *string `json:"StatusEquals,omitnil" name:"StatusEquals"`
...
type DescribeTrainingJobsResponseParams struct {
	// 训练任务列表
	TrainingJobSet []*TrainingJobSummary `json:"TrainingJobSet,omitnil" name:"TrainingJobSet"`
...
type FileSystemDataSource struct {
	// 文件系统目录
	// 注意：此字段可能返回 null，表示取不到有效值。
	DirectoryPath *string `json:"DirectoryPath,omitnil" name:"DirectoryPath"`
	...
	// 文件系统访问模式
	// 注意：此字段可能返回 null，表示取不到有效值。
	FileSystemAccessMode *string `json:"FileSystemAccessMode,omitnil" name:"FileSystemAccessMode"`
...
type GitConfig struct {
	// git地址
	RepositoryUrl *string `json:"RepositoryUrl,omitnil" name:"RepositoryUrl"`
...
type InputDataConfig struct {
	...
	// 数据源配置
	// 注意：此字段可能返回 null，表示取不到有效值。
	DataSource *DataSource `json:"DataSource,omitnil" name:"DataSource"`
...
type ModelArtifacts struct {
	// cos输出路径
	// 注意：此字段可能返回 null，表示取不到有效值。
	CosModelArtifacts *string `json:"CosModelArtifacts,omitnil" name:"CosModelArtifacts"`
}
...
type NotebookInstanceSummary struct {
	...
	// 计费标识
	// 注意：此字段可能返回 null，表示取不到有效值。
	BillingLabel *BillingLabel `json:"BillingLabel,omitnil" name:"BillingLabel"`

	// 运行时长，秒
	// 注意：此字段可能返回 null，表示取不到有效值。
	RuntimeInSeconds *int64 `json:"RuntimeInSeconds,omitnil" name:"RuntimeInSeconds"`

	// 剩余时长，秒
	// 注意：此字段可能返回 null，表示取不到有效值。
	RemainTimeInSeconds *int64 `json:"RemainTimeInSeconds,omitnil" name:"RemainTimeInSeconds"`
}
...
type OutputDataConfig struct {
	// cos输出桶
	// 注意：此字段可能返回 null，表示取不到有效值。
	CosOutputBucket *string `json:"CosOutputBucket,omitnil" name:"CosOutputBucket"`

	// cos输出key前缀
	// 注意：此字段可能返回 null，表示取不到有效值。
	CosOutputKeyPrefix *string `json:"CosOutputKeyPrefix,omitnil" name:"CosOutputKeyPrefix"`
...
type StoppingCondition struct {
	// 最长运行运行时间（秒）
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaxRuntimeInSeconds *uint64 `json:"MaxRuntimeInSeconds,omitnil" name:"MaxRuntimeInSeconds"`

	// 最长等待运行时间（秒）
	// 注意：此字段可能返回 null，表示取不到有效值。
	MaxWaitTimeInSeconds *uint64 `json:"MaxWaitTimeInSeconds,omitnil" name:"MaxWaitTimeInSeconds"`
}
...
type UpdateNotebookInstanceRequestParams struct {
	...
	DisassociateLifecycleScript *bool `json:"DisassociateLifecycleScript,omitnil" name:"DisassociateLifecycleScript"`
	...
	DisassociateDefaultCodeRepository *bool `json:"DisassociateDefaultCodeRepository,omitnil" name:"DisassociateDefaultCodeRepository"`

	// 是否取消关联其他存储库，默认false
	// 该值为true时，AdditionalCodeRepositories将被忽略
	DisassociateAdditionalCodeRepositories *bool `json:"DisassociateAdditionalCodeRepositories,omitnil" name:"DisassociateAdditionalCodeRepositories"`
