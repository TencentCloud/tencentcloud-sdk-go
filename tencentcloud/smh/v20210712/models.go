...
type CreateLibraryRequestParams struct {
	...
	// 媒体库配置项，部分参数新建后不可更改
	LibraryExtension *LibraryExtension `json:"LibraryExtension,omitnil" name:"LibraryExtension"`
}
...
type CreateLibraryResponseParams struct {
	// 媒体库 ID
	LibraryId *string `json:"LibraryId,omitnil" name:"LibraryId"`
...
type DescribeLibrariesRequestParams struct {
	...
	LibraryIds []*string `json:"LibraryIds,omitnil" name:"LibraryIds"`
...
type DescribeLibrariesResponseParams struct {
	// 媒体库列表
	List []*Library `json:"List,omitnil" name:"List"`
...
type DescribeLibrarySecretResponseParams struct {
	...
	// 查询到的媒体库密钥
	LibrarySecret *string `json:"LibrarySecret,omitnil" name:"LibrarySecret"`
...
type DescribeOfficialInstancesRequestParams struct {
	...
	SuperAdminAccount *bool `json:"SuperAdminAccount,omitnil" name:"SuperAdminAccount"`
	...
	// 超级管理管理员账号是否绑定了手机号
	BindPhone *bool `json:"BindPhone,omitnil" name:"BindPhone"`
}
...
type DescribeOfficialInstancesResponseParams struct {
	// 实例列表
	List []*Instance `json:"List,omitnil" name:"List"`
...
type DescribeOfficialOverviewResponseParams struct {
	// 云盘实例数量
	Quantity *uint64 `json:"Quantity,omitnil" name:"Quantity"`
	...
	InternetTraffic *string `json:"InternetTraffic,omitnil" name:"InternetTraffic"`
...
type DescribeTrafficPackagesResponseParams struct {
	// 流量包列表
	List []*TrafficPackage `json:"List,omitnil" name:"List"`
...
type Instance struct {
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	UserLimit *uint64 `json:"UserLimit,omitnil" name:"UserLimit"`

	// 存储容量，单位为 Bytes，由于数字类型精度限制，该字段为 String 类型。如果为按量计费或不限制存储容量实例，该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	StorageLimit *string `json:"StorageLimit,omitnil" name:"StorageLimit"`

	// 存储容量，单位为 GB。如果为按量计费或不限制存储容量实例，该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	StorageLimitGB *uint64 `json:"StorageLimitGB,omitnil" name:"StorageLimitGB"`

	// 是否过期隔离
	Isolated *bool `json:"Isolated,omitnil" name:"Isolated"`
	...
	// 注意：此字段可能返回 null，表示取不到有效值。
	SuperAdminAccount *string `json:"SuperAdminAccount,omitnil" name:"SuperAdminAccount"`
}
...
type LibraryExtension struct {
	...
	CosStorageClass *string `json:"CosStorageClass,omitnil" name:"CosStorageClass"`

	// 是否开启回收站功能。默认为 false。
	UseRecycleBin *bool `json:"UseRecycleBin,omitnil" name:"UseRecycleBin"`

	// 当开启回收站时，自动删除回收站项目的天数，不能超过 1095（3 年），指定为 0 则不自动删除，默认为 0。当未开启回收站时，该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AutoRemoveRecycledDays *uint64 `json:"AutoRemoveRecycledDays,omitnil" name:"AutoRemoveRecycledDays"`

	// 是否启用文件路径搜索功能。默认为 false。
	EnableSearch *bool `json:"EnableSearch,omitnil" name:"EnableSearch"`

	// 设置媒体库或租户空间配额且配额小于已使用存储量时，是否拒绝设置请求。默认为 false。
	DenyOnQuotaLessThanUsage *bool `json:"DenyOnQuotaLessThanUsage,omitnil" name:"DenyOnQuotaLessThanUsage"`

	// 是否开启历史版本。默认为 false。
	EnableFileHistory *bool `json:"EnableFileHistory,omitnil" name:"EnableFileHistory"`

	// 当开启历史版本时，指定单个文件保留的历史版本的数量上限，不能超过 999，指定为 0 则不限制，默认为 0。当未开启历史版本时，该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	FileHistoryCount *uint64 `json:"FileHistoryCount,omitnil" name:"FileHistoryCount"`

	// 当开启历史版本时，指定历史版本保留的最长天数，不能超过 999，指定为 0 则不限制，默认为 0。当未开启历史版本时，该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	FileHistoryExpireDay *uint64 `json:"FileHistoryExpireDay,omitnil" name:"FileHistoryExpireDay"`

	// 目录或文件名的最长长度，不能超过 255，默认为 255。修改该参数不会影响存量目录或文件名，即如果将该字段的值改小，已经存在的长度超过目标值的目录或文件名不会发生变化。
	MaxDirFileNameLength *uint64 `json:"MaxDirFileNameLength,omitnil" name:"MaxDirFileNameLength"`

	// 是否开启公有读，开启后读操作无需使用访问令牌，默认为 false。仅单租户空间媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	IsPublicRead *bool `json:"IsPublicRead,omitnil" name:"IsPublicRead"`

	// 媒体类型媒体库是否开启多相簿，开启后可创建一级目录（即相簿）且媒体文件只能保存在各相簿中，否则不能创建相簿且媒体文件只能保存在根目录。默认为 false。仅单租户空间媒体类型媒体库支持该属性，否则该属性为 null。在媒体库创建后不能修改。
	// 注意：此字段可能返回 null，表示取不到有效值。
	IsMultiAlbum *bool `json:"IsMultiAlbum,omitnil" name:"IsMultiAlbum"`

	// 媒体类型媒体库是否允许上传照片，默认为 true。仅单租户空间媒体类型媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AllowPhoto *bool `json:"AllowPhoto,omitnil" name:"AllowPhoto"`

	// 当媒体类型媒体库允许上传照片时，指定允许的扩展名，默认为空数组，此时将根据文件扩展名对应的 MIME 类型自动判断。仅单租户空间媒体类型媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AllowPhotoExtName []*string `json:"AllowPhotoExtName,omitnil" name:"AllowPhotoExtName"`

	// 媒体类型媒体库是否允许上传视频，默认为 true。仅单租户空间媒体类型媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AllowVideo *bool `json:"AllowVideo,omitnil" name:"AllowVideo"`

	// 当媒体类型媒体库允许上传视频时，指定允许的扩展名，默认为空数组，此时将根据文件扩展名对应的 MIME 类型自动判断。仅单租户空间媒体类型媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AllowVideoExtName []*string `json:"AllowVideoExtName,omitnil" name:"AllowVideoExtName"`

	// 指定文件类型媒体库允许的文件扩展名，默认为空数组，此时允许上传所有类型文件。仅单租户空间文件类型媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	AllowFileExtName []*string `json:"AllowFileExtName,omitnil" name:"AllowFileExtName"`

	// 照片上传时是否进行敏感内容鉴定，默认为 false。仅单租户空间媒体库支持该属性，否则该属性为 null。
	// 注意：此字段可能返回 null，表示取不到有效值。
	RecognizeSensitiveContent *bool `json:"RecognizeSensitiveContent,omitnil" name:"RecognizeSensitiveContent"`
}
...
type TrafficPackage struct {
	...
	// 总流量，单位为 GB
	SizeGB *uint64 `json:"SizeGB,omitnil" name:"SizeGB"`

	// 剩余流量，单位为 Bytes，由于数字类型精度限制，该字段为 String 类型。
	Remain *string `json:"Remain,omitnil" name:"Remain"`

	// 已使用流量，单位为 Bytes，由于数字类型精度限制，该字段为 String 类型。
	Used *string `json:"Used,omitnil" name:"Used"`

	// 已使用百分比，由于数字类型精度限制，该字段为 String 类型。
	UsedPercentage *string `json:"UsedPercentage,omitnil" name:"UsedPercentage"`
