...
type AntiFraudFilter struct {
	...
	// 是否使用旧回包
	OldResponseType *string `json:"OldResponseType,omitnil" name:"OldResponseType"`
}
...
type AntiFraudRecord struct {
	...
	// 要时用到；
	// 注意：此字段可能返回 null，表示取不到有效值。
	OtherModelScores []*OtherModelScoresDetail `json:"OtherModelScores,omitnil" name:"OtherModelScores"`
...
type DescribeAntiFraudRequestParams struct {
	// 原始业务入参(二选一）
	BusinessSecurityData *FinanceAntiFraudFilter `json:"BusinessSecurityData,omitnil" name:"BusinessSecurityData"`

	// 密文业务入参(二选一）
	BusinessCryptoData *FinanceAntiFraudCryptoFilter `json:"BusinessCryptoData,omitnil" name:"BusinessCryptoData"`
}
...
type DescribeAntiFraudResponseParams struct {
	// 返回结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	Data *FinanceAntiFraudRecord `json:"Data,omitnil" name:"Data"`
...
type FinanceAntiFraudRecord struct {
	...
	// 扩展字段，对风险类型的说明
	// 注意：此字段可能返回 null，表示取不到有效值。
	RiskInfo []*RiskDetailInfo `json:"RiskInfo,omitnil" name:"RiskInfo"`

	// 多模型返回结果
	// 注意：此字段可能返回 null，表示取不到有效值。
	OtherModelScores []*FinanceOtherModelScores `json:"OtherModelScores,omitnil" name:"OtherModelScores"`
...
type GetAntiFraudRequestParams struct {
	...
	// BusinessCryptoData)。
	BusinessSecurityData *AntiFraudFilter `json:"BusinessSecurityData,omitnil" name:"BusinessSecurityData"`

	// 默认不传，约定用密文业务
	// 入参(二选一
	// BusinessSecurityData 或
	// BusinessCryptoData)。
	BusinessCryptoData *AntiFraudCryptoFilter `json:"BusinessCryptoData,omitnil" name:"BusinessCryptoData"`
}
...
type GetAntiFraudResponseParams struct {
	// 反欺诈评分接口结果
	Data *AntiFraudRecord `json:"Data,omitnil" name:"Data"`
...
type RiskDetailInfo struct {
	...
	// 风险码对应的风险值
	// 注意：此字段可能返回 null，表示取不到有效值。
	RiskValue *string `json:"RiskValue,omitnil" name:"RiskValue"`
}
