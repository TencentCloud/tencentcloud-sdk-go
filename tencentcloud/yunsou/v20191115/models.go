...
type DataManipulationResponseParams struct {
	// 数据操作结果
	Data *DataManipulationResult `json:"Data,omitnil" name:"Data"`
...
type DataManipulationResult struct {
	...
	// 结果
	TotalResult *string `json:"TotalResult,omitnil" name:"TotalResult"`

	// 操作结果明细
	// 注意：此字段可能返回 null，表示取不到有效值。
	Result []*DataManipulationResultItem `json:"Result,omitnil" name:"Result"`

	// 异常信息
	// 注意：此字段可能返回 null，表示取不到有效值。
	ErrorResult *string `json:"ErrorResult,omitnil" name:"ErrorResult"`
}
...
type DataManipulationResultItem struct {
	...
	// 文档ID
	DocId *string `json:"DocId,omitnil" name:"DocId"`
...
type DataSearchRequestParams struct {
	...
	// 检索串
	SearchQuery *string `json:"SearchQuery,omitnil" name:"SearchQuery"`

	// 当前页，从第0页开始计算
	PageId *uint64 `json:"PageId,omitnil" name:"PageId"`

	// 每页结果数
	NumPerPage *uint64 `json:"NumPerPage,omitnil" name:"NumPerPage"`

	// 当前检索号，用于定位问题，建议指定并且全局唯一
	SearchId *string `json:"SearchId,omitnil" name:"SearchId"`

	// 请求编码，0表示utf8，1表示gbk，建议指定
	QueryEncode *uint64 `json:"QueryEncode,omitnil" name:"QueryEncode"`

	// 排序类型
	RankType *uint64 `json:"RankType,omitnil" name:"RankType"`

	// 数值过滤，结果中按属性过滤
	NumFilter *string `json:"NumFilter,omitnil" name:"NumFilter"`

	// 分类过滤，导航类检索请求
	ClFilter *string `json:"ClFilter,omitnil" name:"ClFilter"`

	// 检索用户相关字段
	Extra *string `json:"Extra,omitnil" name:"Extra"`

	// 检索来源
	SourceId *uint64 `json:"SourceId,omitnil" name:"SourceId"`

	// 是否进行二次检索，0关闭，1打开
	SecondSearch *uint64 `json:"SecondSearch,omitnil" name:"SecondSearch"`

	// 指定返回最大篇数，无特殊原因不建议指定
	MaxDocReturn *uint64 `json:"MaxDocReturn,omitnil" name:"MaxDocReturn"`

	// 是否smartbox检索，0关闭，1打开
	IsSmartbox *uint64 `json:"IsSmartbox,omitnil" name:"IsSmartbox"`

	// 是否打开高红标亮，0关闭，1打开
	EnableAbsHighlight *uint64 `json:"EnableAbsHighlight,omitnil" name:"EnableAbsHighlight"`

	// 指定访问QC纠错业务ID
	QcBid *uint64 `json:"QcBid,omitnil" name:"QcBid"`

	// 按指定字段进行group by，只能对数值字段进行操作
	GroupBy *string `json:"GroupBy,omitnil" name:"GroupBy"`

	// 按指定字段进行distinct，只能对数值字段进行操作
	Distinct *string `json:"Distinct,omitnil" name:"Distinct"`

	// 高级排序参数，具体参见高级排序说明
	L4RankExpression *string `json:"L4RankExpression,omitnil" name:"L4RankExpression"`
	...
	// 分类过滤并集
	MultiFilter []*string `json:"MultiFilter,omitnil" name:"MultiFilter"`
}
...
type DataSearchResponseParams struct {
	// 检索结果
	Data *SearchResult `json:"Data,omitnil" name:"Data"`
...
type SearchResult struct {
	...
	// 搜索最多可以展示的结果数，多页
	DisplayNum *uint64 `json:"DisplayNum,omitnil" name:"DisplayNum"`

	// 和检索请求中的echo相对应
	Echo *string `json:"Echo,omitnil" name:"Echo"`

	// 检索结果的估算篇数，由索引平台估算
	EResultNum *uint64 `json:"EResultNum,omitnil" name:"EResultNum"`

	// 检索返回的当前页码结果数
	ResultNum *uint64 `json:"ResultNum,omitnil" name:"ResultNum"`

	// 检索结果列表
	// 注意：此字段可能返回 null，表示取不到有效值。
	ResultList []*SearchResultItem `json:"ResultList,omitnil" name:"ResultList"`

	// 检索的分词结果，array类型，可包含多个
	// 注意：此字段可能返回 null，表示取不到有效值。
	SegList []*SearchResultSeg `json:"SegList,omitnil" name:"SegList"`
}

type SearchResultItem struct {
	// 动态摘要信息
	DocAbs *string `json:"DocAbs,omitnil" name:"DocAbs"`

	// 检索文档id
	DocId *string `json:"DocId,omitnil" name:"DocId"`

	// 原始文档信息
	DocMeta *string `json:"DocMeta,omitnil" name:"DocMeta"`

	// 精计算得分
	L2Score *float64 `json:"L2Score,omitnil" name:"L2Score"`

	// 文档级回传信息
	SearchDebuginfo *string `json:"SearchDebuginfo,omitnil" name:"SearchDebuginfo"`
}

type SearchResultSeg struct {
	// 分词
	SegStr *string `json:"SegStr,omitnil" name:"SegStr"`
}