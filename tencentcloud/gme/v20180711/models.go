...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeAuditResultExternalRequest) FromJsonString(s string) error {
	f := make(map[string]interface{})
	if err := json.Unmarshal([]byte(s), &f); err != nil {
		return err
	}
...
type DescribeAuditResultExternalResponse struct {
	*tchttp.BaseResponse
	Response *DescribeAuditResultExternalResponseParams `json:"Response"`
}

func (r *DescribeAuditResultExternalResponse) ToJsonString() string {
    b, _ := json.Marshal(r)
    return string(b)
}
...
// FromJsonString It is highly **NOT** recommended to use this function
// because it has no param check, nor strict type check
func (r *DescribeAuditResultExternalResponse) FromJsonString(s string) error {
	return json.Unmarshal([]byte(s), &r)
}
