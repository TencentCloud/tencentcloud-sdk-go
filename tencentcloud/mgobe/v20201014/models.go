...
type ChangeRoomPlayerProfileResponseParams struct {
	// 房间信息。
	Room *Room `json:"Room,omitnil,omitempty" name:"Room"`
...
type ChangeRoomPlayerStatusRequestParams struct {
	...
	// 玩家自定义状态。
	CustomStatus *uint64 `json:"CustomStatus,omitnil,omitempty" name:"CustomStatus"`
...
type DescribePlayerResponseParams struct {
	// 玩家信息。
	Player *Player `json:"Player,omitnil,omitempty" name:"Player"`
...
type ModifyRoomRequestParams struct {
	...
	ChangeRoomOptionList []*int64 `json:"ChangeRoomOptionList,omitnil,omitempty" name:"ChangeRoomOptionList"`

	// 房间名称。
	RoomName *string `json:"RoomName,omitnil,omitempty" name:"RoomName"`

	// 变更房主。
	Owner *string `json:"Owner,omitnil,omitempty" name:"Owner"`

	// 是否支持观战。
	IsViewed *bool `json:"IsViewed,omitnil,omitempty" name:"IsViewed"`

	// 是否支持邀请码/密码。
	IsInvited *bool `json:"IsInvited,omitnil,omitempty" name:"IsInvited"`
	...
	// 房间是否禁止加人。
	IsForbidJoin *bool `json:"IsForbidJoin,omitnil,omitempty" name:"IsForbidJoin"`
}
...
type Player struct {
	...
	// 是否为机器人。
	IsRobot *bool `json:"IsRobot,omitnil,omitempty" name:"IsRobot"`
...
type RemoveRoomPlayerRequestParams struct {
	...
	// 被踢出房间的玩家Id。
	RemovePlayerId *string `json:"RemovePlayerId,omitnil,omitempty" name:"RemovePlayerId"`
}
...
type Room struct {
	...
	MaxPlayers *int64 `json:"MaxPlayers,omitnil,omitempty" name:"MaxPlayers"`
	...
	// 表示团队属性列表。
	Teams []*Team `json:"Teams,omitnil,omitempty" name:"Teams"`
	...
	FrameSyncState *int64 `json:"FrameSyncState,omitnil,omitempty" name:"FrameSyncState"`
	...
	StartGameTime *int64 `json:"StartGameTime,omitnil,omitempty" name:"StartGameTime"`
...
type Team struct {
	...
	// 队伍最小人数。最大不超过100人。
	MinPlayers *int64 `json:"MinPlayers,omitnil,omitempty" name:"MinPlayers"`
