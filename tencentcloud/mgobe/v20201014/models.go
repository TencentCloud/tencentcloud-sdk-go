...
type ChangeRoomPlayerProfileResponseParams struct {
	// 房间信息。
	Room *Room `json:"Room,omitnil" name:"Room"`
...
type ChangeRoomPlayerStatusRequestParams struct {
	...
	// 玩家自定义状态。
	CustomStatus *uint64 `json:"CustomStatus,omitnil" name:"CustomStatus"`
...
type DescribePlayerResponseParams struct {
	// 玩家信息。
	Player *Player `json:"Player,omitnil" name:"Player"`
...
type ModifyRoomRequestParams struct {
	...
	ChangeRoomOptionList []*int64 `json:"ChangeRoomOptionList,omitnil" name:"ChangeRoomOptionList"`

	// 房间名称。
	RoomName *string `json:"RoomName,omitnil" name:"RoomName"`

	// 变更房主。
	Owner *string `json:"Owner,omitnil" name:"Owner"`

	// 是否支持观战。
	IsViewed *bool `json:"IsViewed,omitnil" name:"IsViewed"`

	// 是否支持邀请码/密码。
	IsInvited *bool `json:"IsInvited,omitnil" name:"IsInvited"`

	// 是否私有。
	IsPrivate *bool `json:"IsPrivate,omitnil" name:"IsPrivate"`

	// 自定义房间属性。
	CustomProperties *string `json:"CustomProperties,omitnil" name:"CustomProperties"`

	// 房间是否禁止加人。
	IsForbidJoin *bool `json:"IsForbidJoin,omitnil" name:"IsForbidJoin"`
}
...
type Player struct {
	...
	// 队伍 ID。最长不超过16个字符。
	TeamId *string `json:"TeamId,omitnil" name:"TeamId"`

	// 是否为机器人。
	IsRobot *bool `json:"IsRobot,omitnil" name:"IsRobot"`
...
type RemoveRoomPlayerRequestParams struct {
	...
	// 被踢出房间的玩家Id。
	RemovePlayerId *string `json:"RemovePlayerId,omitnil" name:"RemovePlayerId"`
}
...
type Room struct {
	...
	MaxPlayers *int64 `json:"MaxPlayers,omitnil" name:"MaxPlayers"`

	// 表示房主OpenId。最长不超过16个字符。
	OwnerOpenId *string `json:"OwnerOpenId,omitnil" name:"OwnerOpenId"`
	...
	// 表示团队属性列表。
	Teams []*Team `json:"Teams,omitnil" name:"Teams"`
	...
	FrameSyncState *int64 `json:"FrameSyncState,omitnil" name:"FrameSyncState"`

	// 表示帧率。由控制台设置，用于出参。
	FrameRate *int64 `json:"FrameRate,omitnil" name:"FrameRate"`
	...
	StartGameTime *int64 `json:"StartGameTime,omitnil" name:"StartGameTime"`
...
type Team struct {
	...
	// 队伍最小人数。最大不超过100人。
	MinPlayers *int64 `json:"MinPlayers,omitnil" name:"MinPlayers"`
