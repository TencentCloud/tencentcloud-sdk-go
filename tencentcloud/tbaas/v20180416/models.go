...
// Predefined struct for user
type BlockByNumberHandlerRequestParams struct {
	// 模块名，固定字段：block
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type BlockByNumberHandlerResponseParams struct {
	// 返回区块json字符串
...
type BlockByNumberHandlerResponse struct {
	*tchttp.BaseResponse
	Response *BlockByNumberHandlerResponseParams `json:"Response"`
}
...
// Predefined struct for user
type DeployDynamicContractHandlerRequestParams struct {
	// 模块名，固定字段：contract
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type DeployDynamicContractHandlerResponseParams struct {
	// 部署成功返回的合约地址
	ContractAddress *string `json:"ContractAddress,omitempty" name:"ContractAddress"`
...
type DeployDynamicContractHandlerResponse struct {
	*tchttp.BaseResponse
	Response *DeployDynamicContractHandlerResponseParams `json:"Response"`
}
...
// Predefined struct for user
type GetBlockListHandlerRequestParams struct {
	// 模块名，固定字段：block
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type GetBlockListHandlerResponseParams struct {
	// 总记录数
	TotalCount *int64 `json:"TotalCount,omitempty" name:"TotalCount"`
...
type GetBlockListHandlerResponse struct {
	*tchttp.BaseResponse
	Response *GetBlockListHandlerResponseParams `json:"Response"`
}
...
// Predefined struct for user
type GetTransByHashHandlerRequestParams struct {
	// 模块名，固定字段：transaction
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type GetTransByHashHandlerResponseParams struct {
	// 交易信息json字符串
	TransactionJson *string `json:"TransactionJson,omitempty" name:"TransactionJson"`
...
type GetTransByHashHandlerResponse struct {
	*tchttp.BaseResponse
	Response *GetTransByHashHandlerResponseParams `json:"Response"`
}
...
// Predefined struct for user
type GetTransListHandlerRequestParams struct {
	// 模块名，固定字段：transaction
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type GetTransListHandlerResponseParams struct {
	// 总记录数
	TotalCount *int64 `json:"TotalCount,omitempty" name:"TotalCount"`
...
type GetTransListHandlerResponse struct {
	*tchttp.BaseResponse
	Response *GetTransListHandlerResponseParams `json:"Response"`
}
...
// Predefined struct for user
type SendTransactionHandlerRequestParams struct {
	// 模块名，固定字段：transaction
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type SendTransactionHandlerResponseParams struct {
	// 交易结果json字符串
	TransactionRsp *string `json:"TransactionRsp,omitempty" name:"TransactionRsp"`
...
type SendTransactionHandlerResponse struct {
	*tchttp.BaseResponse
	Response *SendTransactionHandlerResponseParams `json:"Response"`
}
...
// Predefined struct for user
type TransByDynamicContractHandlerRequestParams struct {
	// 模块名，固定字段：transaction
	Module *string `json:"Module,omitempty" name:"Module"`
...
// Predefined struct for user
type TransByDynamicContractHandlerResponseParams struct {
	// 交易结果json字符串
	TransactionRsp *string `json:"TransactionRsp,omitempty" name:"TransactionRsp"`
...
type TransByDynamicContractHandlerResponse struct {
	*tchttp.BaseResponse
	Response *TransByDynamicContractHandlerResponseParams `json:"Response"`
}
