...
type Address struct {
	...
	// 区县
	County *string `json:"County,omitnil" name:"County"`
...
type CatalogApprovers struct {
	...
	// 参与者列表
	Approvers []*FlowApproverInfo `json:"Approvers,omitnil" name:"Approvers"`
}
...
type CheckFaceIdentifyRequestParams struct {
	...
	VerifyResult *string `json:"VerifyResult,omitnil" name:"VerifyResult"`
	...
	// 是否取认证时的照片
	GetPhoto *bool `json:"GetPhoto,omitnil" name:"GetPhoto"`
}
...
type CheckFaceIdentifyResponseParams struct {
	...
	// 渠道核身服务器IP
	// 注意：此字段可能返回 null，表示取不到有效值。
	VerifyServerIp *string `json:"VerifyServerIp,omitnil" name:"VerifyServerIp"`

	// 核身照片文件名
	// 注意：此字段可能返回 null，表示取不到有效值。
	PhotoFileName *string `json:"PhotoFileName,omitnil" name:"PhotoFileName"`

	// 核身照片内容base64(文件格式见文件名后缀,一般为jpg)
	// 注意：此字段可能返回 null，表示取不到有效值。
	PhotoFileData *string `json:"PhotoFileData,omitnil" name:"PhotoFileData"`
...
type Component struct {
	...
	// 2 - html 控件
	// 3 - 关键字
	GenerateMode *int64 `json:"GenerateMode,omitnil" name:"GenerateMode"`
	...
	SealOperate *int64 `json:"SealOperate,omitnil" name:"SealOperate"`

	// 不同GenerateMode对应的额外信息
	GenerateExtra *string `json:"GenerateExtra,omitnil" name:"GenerateExtra"`
}
...
type CreateFlowByFilesRequestParams struct {
	...
	// 流程创建信息
	FlowInfo *FlowInfo `json:"FlowInfo,omitnil" name:"FlowInfo"`
...
type CreateH5FaceIdUrlRequestParams struct {
	...
	WbAppId *string `json:"WbAppId,omitnil" name:"WbAppId"`
	...
	JumpType *string `json:"JumpType,omitnil" name:"JumpType"`

	// browser:表示在浏览器启动刷脸, app:表示在App里启动刷脸,默认值为browser; 可选
	OpenFrom *string `json:"OpenFrom,omitnil" name:"OpenFrom"`
...
type CreatePreviewSignUrlRequestParams struct {
	...
	CatalogId *string `json:"CatalogId,omitnil" name:"CatalogId"`
	...
	// 1. FLOW - 单流程签署 (默认) 
	// 2. CATALOG - 目录签署
	SignUrlType *string `json:"SignUrlType,omitnil" name:"SignUrlType"`
}
...
type CreatePreviewSignUrlResponseParams struct {
	// 合同预览URL
	PreviewSignUrl *string `json:"PreviewSignUrl,omitnil" name:"PreviewSignUrl"`
...
type CreateServerFlowSignResponseParams struct {
	...
	// 0：失败
	// 1：成功
	SignStatus *int64 `json:"SignStatus,omitnil" name:"SignStatus"`
...
type CreateSubOrganizationAndSealRequestParams struct {
	...
	// 4. OTHERS - 其他组织
	OrganizationType *string `json:"OrganizationType,omitnil" name:"OrganizationType"`
	...
	LegalIdCardType *string `json:"LegalIdCardType,omitnil" name:"LegalIdCardType"`

	// 机构法人/经营者证件号码；
	// OrganizationType 为 ENTERPRISE时，INDIVIDUALBIZ 时必填，其他情况选填
	LegalIdCardNumber *string `json:"LegalIdCardNumber,omitnil" name:"LegalIdCardNumber"`

	// 实名认证的客户端IP/请求生成企业印章的客户端Ip
	VerifyClientIp *string `json:"VerifyClientIp,omitnil" name:"VerifyClientIp"`
	...
	// 2. LICENSEFILE - 营业执照
	IdCardFileType *string `json:"IdCardFileType,omitnil" name:"IdCardFileType"`

	// 机构证件照片文件，base64编码，支持jpg、jpeg、png格式
	BizLicenseFile *string `json:"BizLicenseFile,omitnil" name:"BizLicenseFile"`

	// 机构证件照片文件名
	BizLicenseFileName *string `json:"BizLicenseFileName,omitnil" name:"BizLicenseFileName"`

	// 机构法人/经营者/联系人手机号码
	LegalMobile *string `json:"LegalMobile,omitnil" name:"LegalMobile"`
	...
	// 企业联系地址
	ContactAddress *Address `json:"ContactAddress,omitnil" name:"ContactAddress"`
	...
	UseOpenId *bool `json:"UseOpenId,omitnil" name:"UseOpenId"`
}
...
type DescribeCatalogApproversResponseParams struct {
	// 参与者列表
	Approvers []*CatalogApprovers `json:"Approvers,omitnil" name:"Approvers"`
...
type DescribeCatalogSignComponentsResponseParams struct {
	// 签署区列表
	SignComponents []*CatalogComponents `json:"SignComponents,omitnil" name:"SignComponents"`
...
type DescribeCustomFlowIdsByFlowIdResponseParams struct {
	// 自定义流程 id 映射列表
	CustomIdList []*CustomFlowIdMap `json:"CustomIdList,omitnil" name:"CustomIdList"`
...
type DescribeFaceIdPhotosRequestParams struct {
	...
	OrderNumbers []*string `json:"OrderNumbers,omitnil" name:"OrderNumbers"`
}
...
type DescribeFaceIdPhotosResponseParams struct {
	// 照片信息列表
	Photos []*FaceIdPhoto `json:"Photos,omitnil" name:"Photos"`
...
type DescribeFaceIdResultsResponseParams struct {
	// 核身结果列表
	Results []*FaceIdResult `json:"Results,omitnil" name:"Results"`
...
type DescribeFileIdsByCustomIdsResponseParams struct {
	// <自定义Id,文件id>数组
	CustomIdList []*CustomFileIdMap `json:"CustomIdList,omitnil" name:"CustomIdList"`
...
type DescribeFileUrlsRequestParams struct {
	...
	ResourceOffset *int64 `json:"ResourceOffset,omitnil" name:"ResourceOffset"`

	// 单个业务ID多个资源情况下，指定资源数量
	ResourceLimit *int64 `json:"ResourceLimit,omitnil" name:"ResourceLimit"`
...
type DescribeFlowResponseParams struct {
	// 流程创建者信息
	Creator *Caller `json:"Creator,omitnil" name:"Creator"`
	...
	// 流程完成时间
	UpdatedOn *int64 `json:"UpdatedOn,omitnil" name:"UpdatedOn"`
...
type DescribeSealsRequestParams struct {
	...
	// 印章ID列表
	SealIds []*string `json:"SealIds,omitnil" name:"SealIds"`
...
type DescribeSealsResponseParams struct {
	// 印章信息
	Seals []*Seal `json:"Seals,omitnil" name:"Seals"`
...
type DescribeSubOrganizationsResponseParams struct {
	// 子机构信息列表
	SubOrganizationInfos []*SubOrganizationDetail `json:"SubOrganizationInfos,omitnil" name:"SubOrganizationInfos"`
...
type DescribeUsersResponseParams struct {
	// 用户信息查询结果
	Users []*UserDescribe `json:"Users,omitnil" name:"Users"`
...
type FaceIdResult struct {
	...
	// 活体检测得分 (百分制)
	// 注意：此字段可能返回 null，表示取不到有效值。
	LiveRate *int64 `json:"LiveRate,omitnil" name:"LiveRate"`
	...
	// 刷脸时间 (UNIX时间戳)
	// 注意：此字段可能返回 null，表示取不到有效值。
	OccurredTime *int64 `json:"OccurredTime,omitnil" name:"OccurredTime"`
...
type FlowApproverInfo struct {
	...
	// 用户签署区ID到印章ID的映射集合
	// 注意：此字段可能返回 null，表示取不到有效值。
	ComponentSeals []*ComponentSeal `json:"ComponentSeals,omitnil" name:"ComponentSeals"`
	...
	IsLastApprover *bool `json:"IsLastApprover,omitnil" name:"IsLastApprover"`

	// 短信模板
	// 注意：此字段可能返回 null，表示取不到有效值。
	SmsTemplate *SmsTemplate `json:"SmsTemplate,omitnil" name:"SmsTemplate"`
	...
	// 是否支持线下核身
	CanOffLine *bool `json:"CanOffLine,omitnil" name:"CanOffLine"`
...
type RejectFlowRequestParams struct {
	...
	// 拒签原因
	RejectMessage *string `json:"RejectMessage,omitnil" name:"RejectMessage"`
...
type Seal struct {
	...
	// CREATE - 通过图片上传
	// GENERATE - 通过文字生成
	SealSource *string `json:"SealSource,omitnil" name:"SealSource"`
	...
	// 电子印章URL
	FileUrl *FileUrl `json:"FileUrl,omitnil" name:"FileUrl"`

	// 是否为默认印章，false-非默认，true-默认
	DefaultSeal *bool `json:"DefaultSeal,omitnil" name:"DefaultSeal"`
}
...
type SendSignInnerVerifyCodeRequestParams struct {
	...
	// 模板 id
	VerifyTemplateId *string `json:"VerifyTemplateId,omitnil" name:"VerifyTemplateId"`

	// 签名
	VerifySign *string `json:"VerifySign,omitnil" name:"VerifySign"`

	// 流程(目录) id
	FlowId *string `json:"FlowId,omitnil" name:"FlowId"`

	// 三要素检测结果
	CheckThreeElementResult *int64 `json:"CheckThreeElementResult,omitnil" name:"CheckThreeElementResult"`
}
...
type SignFlowRequestParams struct {
	...
	// 签署内容
	SignSeals []*SignSeal `json:"SignSeals,omitnil" name:"SignSeals"`
...
type SignSeal struct {
	...
	// SIGN_DATE - 日期
	// SIGN_IMAGE - 图片
	SignType *string `json:"SignType,omitnil" name:"SignType"`
	...
	SealContent *string `json:"SealContent,omitnil" name:"SealContent"`
}
...
type VerifyUserRequestParams struct {
	...
	CertificateRequired *bool `json:"CertificateRequired,omitnil" name:"CertificateRequired"`
}
