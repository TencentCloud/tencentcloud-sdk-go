...
import (
	...
	cetcdv20220325 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/cetcd/v20220325"
	...
	cngwv20230418 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/cngw/v20230418"
	...
	databuddyv20260715 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/databuddy/v20260715"
	...
	dbsv20211108 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dbs/v20211108"
	...
	evtv20250217 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/evt/v20250217"
	...
	fwmv20250611 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/fwm/v20250611"
	...
	rcev20260130 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/rce/v20260130"
	...
	tdaiv20250717 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tdai/v20250717"
	...
	wimgsv20251106 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/wimgs/v20251106"
	workbuddyenterprisev20260709 "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/workbuddyenterprise/v20260709"
...
func TestAgsv20250920Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := agsv20250920.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init ags_v20250920 client: %v", err)
    }
}
...
func TestCetcdv20220325Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := cetcdv20220325.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init cetcd_v20220325 client: %v", err)
    }
}
...
func TestCloudmatev20251030Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := cloudmatev20251030.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
...
func TestCngwv20230418Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := cngwv20230418.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init cngw_v20230418 client: %v", err)
    }
}
...
func TestDatabuddyv20260715Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := databuddyv20260715.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init databuddy_v20260715 client: %v", err)
    }
}
...
func TestDbsv20211108Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := dbsv20211108.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init dbs_v20211108 client: %v", err)
    }
}
...
func TestEvtv20250217Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := evtv20250217.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init evt_v20250217 client: %v", err)
    }
}
...
func TestFwmv20250611Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := fwmv20250611.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init fwm_v20250611 client: %v", err)
    }
}
...
func TestRcev20260130Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := rcev20260130.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init rce_v20260130 client: %v", err)
    }
}
...
func TestTdaiv20250717Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := tdaiv20250717.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init tdai_v20250717 client: %v", err)
    }
}
...
func TestWimgsv20251106Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := wimgsv20251106.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init wimgs_v20251106 client: %v", err)
    }
}

func TestWorkbuddyenterprisev20260709Import(t *testing.T) {
    credential := common.NewCredential(
        os.Getenv("TENCENTCLOUD_SECRET_ID"),
        os.Getenv("TENCENTCLOUD_SECRET_KEY"))
    client, err := workbuddyenterprisev20260709.NewClient(
        credential,
        regions.Guangzhou,
        profile.NewClientProfile())
    if err != nil || client == nil {
        t.Errorf("fail to init workbuddyenterprise_v20260709 client: %v", err)
    }
}
